...
fun makeInfo
    ...
    InfoType.OBJECT objectInfo       =>
      let
        ...
        val cInterfaceDecls'1 =
          addObjectCInterfaceDecl namespace objectInfo fieldInfos cInterfaceDecls'0
      in
  ...
  | InfoType.STRUCT structInfo       =>
      let
        ...
        val cInterfaceDecls'1 =
          addStructCInterfaceDecl repo vers namespace structInfo fieldInfos cInterfaceDecls'0
      in
        ((files'3, exts'1, modules'1, constants'0, functions'0, structDeps'0, cInterfaceDecls'1), excls'3)
      end
