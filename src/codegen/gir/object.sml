...
fun addObjectFieldOffsetFunctionStrDecs isPolyML objectIRef (fieldInfos, acc) =
  revFold (Option.fold (addFieldOffsetFunctionStrDec isPolyML objectIRef))
    (fieldInfos, acc)
...
fun addObjectMethodStrDecsLowLevel
  ...
  addFunctionStrDecsLowLevel
    ...
    vers
    addInitStrDecs
    (addObjectFieldOffsetFunctionStrDecs isPolyML objectIRef)
    (SOME objectIRef)
    fieldInfos
...
fun addObjectCInterfaceDecl
  ...
  let
    ...
    val cInterfaceDecls'1 =
      revFold
        (Option.fold (addFieldCInterfaceDecl objectNamespace objectName))
