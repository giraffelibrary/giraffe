structure GtkEntryCompletion :>
  ...
  struct
    ...
    in
      ...
      val deleteAction_ = call (load_sym libgtk "gtk_entry_completion_delete_action") (GObjectObjectClass.PolyML.PTR &&> FFI.Int32.PolyML.VAL --> FFI.PolyML.VOID)
      ...
      val getMinimumKeyLength_ = call (load_sym libgtk "gtk_entry_completion_get_minimum_key_length") (GObjectObjectClass.PolyML.PTR --> FFI.Int32.PolyML.VAL)
      ...
      val getTextColumn_ = call (load_sym libgtk "gtk_entry_completion_get_text_column") (GObjectObjectClass.PolyML.PTR --> FFI.Int32.PolyML.VAL)
      ...
      val setMinimumKeyLength_ = call (load_sym libgtk "gtk_entry_completion_set_minimum_key_length") (GObjectObjectClass.PolyML.PTR &&> FFI.Int32.PolyML.VAL --> FFI.PolyML.VOID)
      ...
      val setTextColumn_ = call (load_sym libgtk "gtk_entry_completion_set_text_column") (GObjectObjectClass.PolyML.PTR &&> FFI.Int32.PolyML.VAL --> FFI.PolyML.VOID)
    end
