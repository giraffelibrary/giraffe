structure GtkIconSourceRecord :>
  ...
  struct
    ...
    in
      val new_ =
        call
          (load_sym libgtk "gtk_icon_source_new")
          (FFI.PolyML.VOID --> PTR);

      val copy_ =
        call
          (load_sym libgtk "gtk_icon_source_copy")
          (PTR --> PTR);

      val free_sym = load_sym libgtk "gtk_icon_source_free";
    end
    ...
    in
      val getType_ =
        call
          (load_sym libgtk "gtk_icon_source_get_type")
