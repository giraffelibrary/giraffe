  ...
  struct
    ...
    in
      fun classify e =
        ...
        | GdkEventType.TWOBUTTONPRESS   => SOME (mkT (BUTTON, GdkEventButtonRecord.C.fromPtr, GdkEventButtonRecord.TWOBUTTONPRESS) e)
        | GdkEventType.THREEBUTTONPRESS => SOME (mkT (BUTTON, GdkEventButtonRecord.C.fromPtr, GdkEventButtonRecord.THREEBUTTONPRESS) e)
