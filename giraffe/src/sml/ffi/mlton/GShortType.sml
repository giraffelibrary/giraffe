...
structure GShortType :> C_VALUE_EQ_NULL_TYPE where type t = LargeInt.int =
  struct
    type t = LargeInt.int

    structure Pointer = MLtonIntPointer(C_Short)
    ...
    val toC = C_Short.fromLarge
    val updateC = Fn.const Fn.ignore
    val fromC = C_Short.toLarge
