...
structure GUInt64Type :> C_VALUE_EQ_NULL_TYPE where type t = LargeInt.int =
  struct
    type t = LargeInt.int

    structure Pointer = MLtonWordPointer(Word64)
    ...
    val toC = Word64.fromLargeInt
    val updateC = Fn.const Fn.ignore
    val fromC = Word64.toLargeIntX
