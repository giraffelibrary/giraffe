...
structure GInt16Type :> C_VALUE_EQ_NULL_TYPE where type t = LargeInt.int =
  struct
    type t = LargeInt.int

    structure Pointer = MLtonIntPointer(Int16)
    ...
    val toC = Int16.fromLarge
    val updateC = Fn.const Fn.ignore
    val fromC = Int16.toLarge
