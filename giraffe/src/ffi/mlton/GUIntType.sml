...
structure GUIntType :> C_VALUE_EQ_NULL_TYPE where type t = LargeInt.int =
  struct
    type t = LargeInt.int

    structure Pointer = MLtonWordPointer(C_UInt)
    ...
    val toC = C_UInt.fromLargeInt
    val updateC = Fn.const Fn.ignore
    val fromC = C_UInt.toLargeIntX
