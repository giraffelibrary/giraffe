structure GdkPixbufPixbufFormat :>
  ...
  struct
    ...
    val getDescription_ = _import "gdk_pixbuf_format_get_description" : GdkPixbufPixbufFormatRecord.C.notnull GdkPixbufPixbufFormatRecord.C.p -> FFI.String.C.notnull FFI.String.C.out_p;
    val getLicense_ = _import "gdk_pixbuf_format_get_license" : GdkPixbufPixbufFormatRecord.C.notnull GdkPixbufPixbufFormatRecord.C.p -> FFI.String.C.notnull FFI.String.C.out_p;
    val getName_ = _import "gdk_pixbuf_format_get_name" : GdkPixbufPixbufFormatRecord.C.notnull GdkPixbufPixbufFormatRecord.C.p -> FFI.String.C.notnull FFI.String.C.out_p;
