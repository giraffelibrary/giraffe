structure VtePty :>
  ...
  struct
    ...
    val newForeign_ = fn x1 & x2 => (_import "vte_pty_new_foreign" : FFI.Int32.val_ * (unit, unit) GLibErrorRecord.C.r -> GObjectObjectClass.C.notnull GObjectObjectClass.C.p;) (x1, x2)
    ...
    val getFd_ = _import "vte_pty_get_fd" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val getSize_ =
      fn
        x1
         & x2
