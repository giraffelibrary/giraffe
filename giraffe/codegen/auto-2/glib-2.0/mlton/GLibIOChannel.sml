structure GLibIOChannel :>
  ...
  struct
    ...
    val unixNew_ = _import "g_io_channel_unix_new" : FileDesc.C.val_ -> GLibIOChannelRecord.C.notnull GLibIOChannelRecord.C.p;
    ...
    val getBufferSize_ = _import "g_io_channel_get_buffer_size" : GLibIOChannelRecord.C.notnull GLibIOChannelRecord.C.p -> FFI.UInt64.val_;
    ...
    val setBufferSize_ = fn x1 & x2 => (_import "g_io_channel_set_buffer_size" : GLibIOChannelRecord.C.notnull GLibIOChannelRecord.C.p * FFI.UInt64.val_ -> unit;) (x1, x2)
    ...
    val unixGetFd_ = _import "g_io_channel_unix_get_fd" : GLibIOChannelRecord.C.notnull GLibIOChannelRecord.C.p -> FileDesc.C.val_;
    val writeUnichar_ =
      fn
        x1
         & x2
