structure GioMemoryOutputStream :>
  ...
  struct
    ...
    val getDataSize_ = _import "g_memory_output_stream_get_data_size" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.UInt64.val_;
    val getSize_ = _import "g_memory_output_stream_get_size" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.UInt64.val_;
    ...
    fun getDataSize self = (GObjectObjectClass.C.withPtr ---> FFI.UInt64.fromVal) getDataSize_ self
