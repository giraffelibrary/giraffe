structure GioNetworkAddress :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgio "g_network_address_new") (FFI.PolyML.String.INPTR &&> FFI.PolyML.UInt16.VAL --> GObjectObjectClass.PolyML.PTR)
      val parse_ =
      ...
      val getPort_ = call (load_sym libgio "g_network_address_get_port") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.UInt16.VAL)
    ...
    fun new hostname port = (FFI.String.withConstPtr &&&> FFI.UInt16.withVal ---> GioSocketConnectableClass.C.fromPtr true) new_ (hostname & port)
