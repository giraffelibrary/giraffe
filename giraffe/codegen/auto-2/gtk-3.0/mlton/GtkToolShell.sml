structure GtkToolShell :>
  ...
  struct
    ...
    val getIconSize_ = _import "gtk_tool_shell_get_icon_size" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    ...
    val getTextAlignment_ = _import "gtk_tool_shell_get_text_alignment" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Float.val_;
