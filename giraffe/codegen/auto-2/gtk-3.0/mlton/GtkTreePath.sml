structure GtkTreePath :>
  ...
  struct
    ...
    val appendIndex_ = fn x1 & x2 => (_import "gtk_tree_path_append_index" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    val compare_ = fn x1 & x2 => (_import "gtk_tree_path_compare" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p * GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p -> FFI.Int32.val_;) (x1, x2)
    ...
    val getDepth_ = _import "gtk_tree_path_get_depth" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p -> FFI.Int32.val_;
    val isAncestor_ = fn x1 & x2 => (_import "gtk_tree_path_is_ancestor" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p * GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p -> FFI.Bool.val_;) (x1, x2)
    val isDescendant_ = fn x1 & x2 => (_import "gtk_tree_path_is_descendant" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p * GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p -> FFI.Bool.val_;) (x1, x2)
    val next_ = _import "gtk_tree_path_next" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p -> unit;
    val prependIndex_ = fn x1 & x2 => (_import "gtk_tree_path_prepend_index" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    val prev_ = _import "gtk_tree_path_prev" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p -> FFI.Bool.val_;
    val toString_ = _import "gtk_tree_path_to_string" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val up_ = _import "gtk_tree_path_up" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p -> FFI.Bool.val_;
