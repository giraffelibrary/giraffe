structure GtkColorSelection :>
  ...
  struct
    ...
    val getCurrentAlpha_ = _import "gtk_color_selection_get_current_alpha" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.UInt16.val_;
    ...
    val getPreviousAlpha_ = _import "gtk_color_selection_get_previous_alpha" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.UInt16.val_;
    ...
    val setCurrentAlpha_ = fn x1 & x2 => (_import "gtk_color_selection_set_current_alpha" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.UInt16.val_ -> unit;) (x1, x2)
    ...
    val setPreviousAlpha_ = fn x1 & x2 => (_import "gtk_color_selection_set_previous_alpha" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.UInt16.val_ -> unit;) (x1, x2)
