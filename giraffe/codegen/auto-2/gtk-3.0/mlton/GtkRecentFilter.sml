structure GtkRecentFilter :>
  ...
  struct
    ...
    val addAge_ = fn x1 & x2 => (_import "gtk_recent_filter_add_age" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    val addApplication_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val filter_ = fn x1 & x2 => (_import "gtk_recent_filter_filter" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * GtkRecentFilterInfoRecord.C.notnull GtkRecentFilterInfoRecord.C.p -> FFI.Bool.val_;) (x1, x2)
    val getName_ = _import "gtk_recent_filter_get_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
