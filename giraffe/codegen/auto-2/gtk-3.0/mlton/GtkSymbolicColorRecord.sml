structure GtkSymbolicColorRecord :>
  sig
    include GTK_SYMBOLIC_COLOR_RECORD
  end =
  struct
    type notnull = CPointer.notnull
    type 'a p = 'a CPointer.t

    val ref_ = _import "gtk_symbolic_color_ref" : notnull p -> notnull p;

    val unref_ = _import "gtk_symbolic_color_unref" : notnull p -> unit;
    ...
    val getType_ =
      _import "gtk_symbolic_color_get_type" : unit -> GObjectType.C.val_;
