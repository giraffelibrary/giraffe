structure GtkSelectionData :>
  ...
  struct
    ...
    val getFormat_ = _import "gtk_selection_data_get_format" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p -> FFI.Int32.val_;
    val getLength_ = _import "gtk_selection_data_get_length" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p -> FFI.Int32.val_;
    ...
    val getText_ = _import "gtk_selection_data_get_text" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val setPixbuf_ = fn x1 & x2 => (_import "gtk_selection_data_set_pixbuf" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p * GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;) (x1, x2)
    val setText_ =
      fn
        x1
         & (x2, x3)
    ...
    val targetsIncludeImage_ = fn x1 & x2 => (_import "gtk_selection_data_targets_include_image" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p * FFI.Bool.val_ -> FFI.Bool.val_;) (x1, x2)
    val targetsIncludeRichText_ = fn x1 & x2 => (_import "gtk_selection_data_targets_include_rich_text" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p * GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;) (x1, x2)
    val targetsIncludeText_ = _import "gtk_selection_data_targets_include_text" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p -> FFI.Bool.val_;
    val targetsIncludeUri_ = _import "gtk_selection_data_targets_include_uri" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p -> FFI.Bool.val_;
