structure GtkSource : GTK_SOURCE =
  struct
    local
      open PolyMLFFI
    in
      val completionErrorQuark_ = call (load_sym libgtksourceview "gtk_source_completion_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
    end
    ...
    fun completionErrorQuark () = (I ---> FFI.UInt32.fromVal) completionErrorQuark_ ()
  end
