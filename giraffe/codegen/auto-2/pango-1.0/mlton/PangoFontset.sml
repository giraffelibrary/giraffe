structure PangoFontset :>
  ...
  struct
    ...
    val getFont_ = fn x1 & x2 => (_import "pango_fontset_get_font" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Word32.val_ -> GObjectObjectClass.C.notnull GObjectObjectClass.C.p;) (x1, x2)
    ...
    fun getFont self wc = (GObjectObjectClass.C.withPtr &&&> FFI.Word32.withVal ---> PangoFontClass.C.fromPtr true) getFont_ (self & wc)
