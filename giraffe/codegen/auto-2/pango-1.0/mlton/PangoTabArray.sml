structure PangoTabArray :>
  ...
  struct
    ...
    val new_ = fn x1 & x2 => (_import "pango_tab_array_new" : FFI.Int32.val_ * FFI.Bool.val_ -> PangoTabArrayRecord.C.notnull PangoTabArrayRecord.C.p;) (x1, x2)
    ...
    val getPositionsInPixels_ = _import "pango_tab_array_get_positions_in_pixels" : PangoTabArrayRecord.C.notnull PangoTabArrayRecord.C.p -> FFI.Bool.val_;
    val getSize_ = _import "pango_tab_array_get_size" : PangoTabArrayRecord.C.notnull PangoTabArrayRecord.C.p -> FFI.Int32.val_;
    val getTab_ =
      fn
        x1
         & x2
    ...
    val resize_ = fn x1 & x2 => (_import "pango_tab_array_resize" : PangoTabArrayRecord.C.notnull PangoTabArrayRecord.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    val setTab_ =
      fn
        x1
         & x2
