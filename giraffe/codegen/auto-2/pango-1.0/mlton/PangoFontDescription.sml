structure PangoFontDescription :>
  ...
  struct
    ...
    val equal_ = fn x1 & x2 => (_import "pango_font_description_equal" : PangoFontDescriptionRecord.C.notnull PangoFontDescriptionRecord.C.p * PangoFontDescriptionRecord.C.notnull PangoFontDescriptionRecord.C.p -> FFI.Bool.val_;) (x1, x2)
    val getFamily_ = _import "pango_font_description_get_family" : PangoFontDescriptionRecord.C.notnull PangoFontDescriptionRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    ...
    val getSize_ = _import "pango_font_description_get_size" : PangoFontDescriptionRecord.C.notnull PangoFontDescriptionRecord.C.p -> FFI.Int32.val_;
    val getSizeIsAbsolute_ = _import "pango_font_description_get_size_is_absolute" : PangoFontDescriptionRecord.C.notnull PangoFontDescriptionRecord.C.p -> FFI.Bool.val_;
    ...
    val setAbsoluteSize_ = fn x1 & x2 => (_import "pango_font_description_set_absolute_size" : PangoFontDescriptionRecord.C.notnull PangoFontDescriptionRecord.C.p * FFI.Double.val_ -> unit;) (x1, x2)
    val setFamily_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val setSize_ = fn x1 & x2 => (_import "pango_font_description_set_size" : PangoFontDescriptionRecord.C.notnull PangoFontDescriptionRecord.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    ...
    val toFilename_ = _import "pango_font_description_to_filename" : PangoFontDescriptionRecord.C.notnull PangoFontDescriptionRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val toString_ = _import "pango_font_description_to_string" : PangoFontDescriptionRecord.C.notnull PangoFontDescriptionRecord.C.p -> FFI.String.notnull FFI.String.out_p;
