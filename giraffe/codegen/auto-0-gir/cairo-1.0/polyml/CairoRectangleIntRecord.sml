structure CairoRectangleIntRecord :> CAIRO_RECTANGLE_INT_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val new_ = call (getSymbol "giraffe_cairo_rectangle_int_new") (PolyMLFFI.cVoid --> cPtr)
      val copy_ = call (getSymbol "giraffe_cairo_rectangle_int_copy") (cPtr &&> cPtr --> PolyMLFFI.cVoid)
      val free_ = call (getSymbol "giraffe_cairo_rectangle_int_free") (cPtr --> PolyMLFFI.cVoid)
      val size_ = call (getSymbol "giraffe_cairo_rectangle_int_size") (PolyMLFFI.cVoid --> GUInt.PolyML.cVal)
    end
    structure Record =
      BoxedValueRecord(
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "cairo_gobject_rectangle_int_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
