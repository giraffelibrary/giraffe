structure GtkLabel :>
  ...
  struct
    ...
    in
      ...
      val getLines_ = call (getSymbol "gtk_label_get_lines") (GtkLabelClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val setLines_ = call (getSymbol "gtk_label_set_lines") (GtkLabelClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
