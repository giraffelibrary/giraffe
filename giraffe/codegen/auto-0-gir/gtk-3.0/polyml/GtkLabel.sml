structure GtkLabel :>
  ...
  struct
    ...
    in
      ...
      val setAttributes_ = call (getSymbol "gtk_label_set_attributes") (GtkLabelClass.PolyML.cPtr &&> PangoAttrListRecord.PolyML.cPtr --> cVoid)
      ...
      val setMaxWidthChars_ = call (getSymbol "gtk_label_set_max_width_chars") (GtkLabelClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      ...
      val setWidthChars_ = call (getSymbol "gtk_label_set_width_chars") (GtkLabelClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
    end
