structure GtkColorSelection :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_color_selection_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      val new_ = call (getSymbol "gtk_color_selection_new") (PolyMLFFI.cVoid --> GtkWidgetClass.PolyML.cPtr)
      ...
      val getCurrentColor_ = call (getSymbol "gtk_color_selection_get_current_color") (GtkColorSelectionClass.PolyML.cPtr &&> GdkColorRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      val getCurrentRgba_ = call (getSymbol "gtk_color_selection_get_current_rgba") (GtkColorSelectionClass.PolyML.cPtr &&> GdkRgbaRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      ...
      val getPreviousColor_ = call (getSymbol "gtk_color_selection_get_previous_color") (GtkColorSelectionClass.PolyML.cPtr &&> GdkColorRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      val getPreviousRgba_ = call (getSymbol "gtk_color_selection_get_previous_rgba") (GtkColorSelectionClass.PolyML.cPtr &&> GdkRgbaRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      val isAdjusting_ = call (getSymbol "gtk_color_selection_is_adjusting") (GtkColorSelectionClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val setCurrentAlpha_ = call (getSymbol "gtk_color_selection_set_current_alpha") (GtkColorSelectionClass.PolyML.cPtr &&> GUInt16.PolyML.cVal --> PolyMLFFI.cVoid)
      val setCurrentColor_ = call (getSymbol "gtk_color_selection_set_current_color") (GtkColorSelectionClass.PolyML.cPtr &&> GdkColorRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      val setCurrentRgba_ = call (getSymbol "gtk_color_selection_set_current_rgba") (GtkColorSelectionClass.PolyML.cPtr &&> GdkRgbaRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      val setHasOpacityControl_ = call (getSymbol "gtk_color_selection_set_has_opacity_control") (GtkColorSelectionClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setHasPalette_ = call (getSymbol "gtk_color_selection_set_has_palette") (GtkColorSelectionClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setPreviousAlpha_ = call (getSymbol "gtk_color_selection_set_previous_alpha") (GtkColorSelectionClass.PolyML.cPtr &&> GUInt16.PolyML.cVal --> PolyMLFFI.cVoid)
      val setPreviousColor_ = call (getSymbol "gtk_color_selection_set_previous_color") (GtkColorSelectionClass.PolyML.cPtr &&> GdkColorRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      val setPreviousRgba_ = call (getSymbol "gtk_color_selection_set_previous_rgba") (GtkColorSelectionClass.PolyML.cPtr &&> GdkRgbaRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
    end
