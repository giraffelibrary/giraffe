structure GtkColorSelection :>
  ...
  struct
    ...
    in
      ...
      val getCurrentAlpha_ = call (load_sym libgtk "gtk_color_selection_get_current_alpha") (GtkColorSelectionClass.PolyML.cPtr --> GUInt16.PolyML.cVal)
      ...
      val getHasOpacityControl_ = call (load_sym libgtk "gtk_color_selection_get_has_opacity_control") (GtkColorSelectionClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getHasPalette_ = call (load_sym libgtk "gtk_color_selection_get_has_palette") (GtkColorSelectionClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getPreviousAlpha_ = call (load_sym libgtk "gtk_color_selection_get_previous_alpha") (GtkColorSelectionClass.PolyML.cPtr --> GUInt16.PolyML.cVal)
      ...
      val isAdjusting_ = call (load_sym libgtk "gtk_color_selection_is_adjusting") (GtkColorSelectionClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val setCurrentAlpha_ = call (load_sym libgtk "gtk_color_selection_set_current_alpha") (GtkColorSelectionClass.PolyML.cPtr &&> GUInt16.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setHasOpacityControl_ = call (load_sym libgtk "gtk_color_selection_set_has_opacity_control") (GtkColorSelectionClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setHasPalette_ = call (load_sym libgtk "gtk_color_selection_set_has_palette") (GtkColorSelectionClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setPreviousAlpha_ = call (load_sym libgtk "gtk_color_selection_set_previous_alpha") (GtkColorSelectionClass.PolyML.cPtr &&> GUInt16.PolyML.cVal --> PolyMLFFI.cVoid)
