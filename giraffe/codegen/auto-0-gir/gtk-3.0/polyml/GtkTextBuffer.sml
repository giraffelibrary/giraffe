structure GtkTextBuffer :>
  ...
  struct
    ...
    in
      ...
      val getCharCount_ = call (load_sym libgtk "gtk_text_buffer_get_char_count") (GtkTextBufferClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getDeserializeFormats_ = call (load_sym libgtk "gtk_text_buffer_get_deserialize_formats") (GtkTextBufferClass.PolyML.cPtr &&> GInt.PolyML.cRef --> GdkAtomRecordCVectorN.PolyML.cOutPtr)
      ...
      val getLineCount_ = call (load_sym libgtk "gtk_text_buffer_get_line_count") (GtkTextBufferClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getSerializeFormats_ = call (load_sym libgtk "gtk_text_buffer_get_serialize_formats") (GtkTextBufferClass.PolyML.cPtr &&> GInt.PolyML.cRef --> GdkAtomRecordCVectorN.PolyML.cOutPtr)
      val getSlice_ =
