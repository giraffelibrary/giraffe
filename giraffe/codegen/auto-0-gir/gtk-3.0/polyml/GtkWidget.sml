structure GtkWidget :>
  ...
  struct
    ...
    fun addEvents self events = (GtkWidgetClass.FFI.withPtr false &&&> GInt.FFI.withVal ---> I) addEvents_ (self & events)
    ...
    fun getEvents self = (GtkWidgetClass.FFI.withPtr false ---> GInt.FFI.fromVal) getEvents_ self
    ...
    fun setEvents self events = (GtkWidgetClass.FFI.withPtr false &&&> GInt.FFI.withVal ---> I) setEvents_ (self & events)
