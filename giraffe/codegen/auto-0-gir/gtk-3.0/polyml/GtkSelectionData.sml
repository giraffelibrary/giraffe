structure GtkSelectionData :>
  ...
  struct
    ...
    in
      ...
      val getDataWithLength_ = call (load_sym libgtk "gtk_selection_data_get_data_with_length") (GtkSelectionDataRecord.PolyML.cPtr &&> GInt.PolyML.cRef --> GUInt8CVectorN.PolyML.cOutPtr)
      ...
      val getFormat_ = call (load_sym libgtk "gtk_selection_data_get_format") (GtkSelectionDataRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val getLength_ = call (load_sym libgtk "gtk_selection_data_get_length") (GtkSelectionDataRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val getPixbuf_ = call (load_sym libgtk "gtk_selection_data_get_pixbuf") (GtkSelectionDataRecord.PolyML.cPtr --> GdkPixbufPixbufClass.PolyML.cPtr)
      ...
      val getTargets_ =
        call (load_sym libgtk "gtk_selection_data_get_targets")
          (
      ...
      val getUris_ = call (load_sym libgtk "gtk_selection_data_get_uris") (GtkSelectionDataRecord.PolyML.cPtr --> Utf8CVector.PolyML.cOutPtr)
      val set_ =
        call (load_sym libgtk "gtk_selection_data_set")
          (
            GtkSelectionDataRecord.PolyML.cPtr
      ...
      val setPixbuf_ = call (load_sym libgtk "gtk_selection_data_set_pixbuf") (GtkSelectionDataRecord.PolyML.cPtr &&> GdkPixbufPixbufClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val setText_ =
      ...
      val setUris_ = call (load_sym libgtk "gtk_selection_data_set_uris") (GtkSelectionDataRecord.PolyML.cPtr &&> Utf8CVector.PolyML.cInPtr --> GBool.PolyML.cVal)
      val targetsIncludeImage_ = call (load_sym libgtk "gtk_selection_data_targets_include_image") (GtkSelectionDataRecord.PolyML.cPtr &&> GBool.PolyML.cVal --> GBool.PolyML.cVal)
      val targetsIncludeRichText_ = call (load_sym libgtk "gtk_selection_data_targets_include_rich_text") (GtkSelectionDataRecord.PolyML.cPtr &&> GtkTextBufferClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val targetsIncludeText_ = call (load_sym libgtk "gtk_selection_data_targets_include_text") (GtkSelectionDataRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val targetsIncludeUri_ = call (load_sym libgtk "gtk_selection_data_targets_include_uri") (GtkSelectionDataRecord.PolyML.cPtr --> GBool.PolyML.cVal)
    end
