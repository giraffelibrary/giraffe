structure GtkDrawingArea :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_drawing_area_get_type") (cVoid --> GObjectType.PolyML.cVal)
      val new_ = call (getSymbol "gtk_drawing_area_new") (cVoid --> GtkWidgetClass.PolyML.cPtr)
    end
