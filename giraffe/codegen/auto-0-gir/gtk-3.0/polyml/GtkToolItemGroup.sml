structure GtkToolItemGroup :>
  ...
  struct
    ...
    in
      ...
      val getItemPosition_ = call (load_sym libgtk "gtk_tool_item_group_get_item_position") (GObjectObjectClass.PolyML.cPtr &&> GObjectObjectClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      ...
      val getNItems_ = call (load_sym libgtk "gtk_tool_item_group_get_n_items") (GObjectObjectClass.PolyML.cPtr --> FFI.UInt.PolyML.cVal)
      val getNthItem_ = call (load_sym libgtk "gtk_tool_item_group_get_nth_item") (GObjectObjectClass.PolyML.cPtr &&> FFI.UInt.PolyML.cVal --> GObjectObjectClass.PolyML.cPtr)
      val insert_ =
