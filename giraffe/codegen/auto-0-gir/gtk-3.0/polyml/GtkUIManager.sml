structure GtkUIManager :>
  ...
  struct
    ...
    fun newMergeId self = (GtkUIManagerClass.FFI.withPtr ---> GUInt.FFI.fromVal) newMergeId_ self
    ...
    fun removeUi self mergeId = (GtkUIManagerClass.FFI.withPtr &&&> GUInt.FFI.withVal ---> I) removeUi_ (self & mergeId)
