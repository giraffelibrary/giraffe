structure GtkInfoBar :>
  ...
  struct
    ...
    in
      ...
      val response_ = call (load_sym libgtk "gtk_info_bar_response") (GtkInfoBarClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
      val setDefaultResponse_ = call (load_sym libgtk "gtk_info_bar_set_default_response") (GtkInfoBarClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
