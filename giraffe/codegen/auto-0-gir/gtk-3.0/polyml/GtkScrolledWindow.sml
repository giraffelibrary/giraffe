structure GtkScrolledWindow :>
  ...
  struct
    ...
    in
      ...
      val getMaxContentHeight_ = call (getSymbol "gtk_scrolled_window_get_max_content_height") (GtkScrolledWindowClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getMaxContentWidth_ = call (getSymbol "gtk_scrolled_window_get_max_content_width") (GtkScrolledWindowClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val setMaxContentHeight_ = call (getSymbol "gtk_scrolled_window_set_max_content_height") (GtkScrolledWindowClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      val setMaxContentWidth_ = call (getSymbol "gtk_scrolled_window_set_max_content_width") (GtkScrolledWindowClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
