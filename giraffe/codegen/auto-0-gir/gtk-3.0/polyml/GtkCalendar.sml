structure GtkCalendar :>
  ...
  struct
    ...
    in
      ...
      val markDay_ = call (getSymbol "gtk_calendar_mark_day") (GtkCalendarClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> cVoid)
      val selectDay_ = call (getSymbol "gtk_calendar_select_day") (GtkCalendarClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> cVoid)
      val selectMonth_ =
      ...
      val setDetailHeightRows_ = call (getSymbol "gtk_calendar_set_detail_height_rows") (GtkCalendarClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      val setDetailWidthChars_ = call (getSymbol "gtk_calendar_set_detail_width_chars") (GtkCalendarClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      ...
      val unmarkDay_ = call (getSymbol "gtk_calendar_unmark_day") (GtkCalendarClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> cVoid)
    end
