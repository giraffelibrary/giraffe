structure GtkToolPaletteDragTargets :>
  sig
    include GTK_TOOL_PALETTE_DRAG_TARGETS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtk "gtk_tool_palette_drag_targets_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
