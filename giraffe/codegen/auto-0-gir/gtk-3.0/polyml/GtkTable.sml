structure GtkTable :>
  ...
  struct
    ...
    fun getColSpacing self column = (GtkTableClass.FFI.withPtr false &&&> GUInt.FFI.withVal ---> GUInt.FFI.fromVal) getColSpacing_ (self & column)
    fun getDefaultColSpacing self = (GtkTableClass.FFI.withPtr false ---> GUInt.FFI.fromVal) getDefaultColSpacing_ self
    fun getDefaultRowSpacing self = (GtkTableClass.FFI.withPtr false ---> GUInt.FFI.fromVal) getDefaultRowSpacing_ self
    fun getHomogeneous self = (GtkTableClass.FFI.withPtr false ---> GBool.FFI.fromVal) getHomogeneous_ self
    fun getRowSpacing self row = (GtkTableClass.FFI.withPtr false &&&> GUInt.FFI.withVal ---> GUInt.FFI.fromVal) getRowSpacing_ (self & row)
    fun getSize self =
      let
        val rows
         & columns
    ...
    fun setColSpacings self spacing = (GtkTableClass.FFI.withPtr false &&&> GUInt.FFI.withVal ---> I) setColSpacings_ (self & spacing)
    ...
    fun setRowSpacings self spacing = (GtkTableClass.FFI.withPtr false &&&> GUInt.FFI.withVal ---> I) setRowSpacings_ (self & spacing)
    local
      open Property
    in
