structure GtkPaned :>
  ...
  struct
    ...
    in
      ...
      val getPosition_ = call (load_sym libgtk "gtk_paned_get_position") (GObjectObjectClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      val pack1_ =
      ...
      val setPosition_ = call (load_sym libgtk "gtk_paned_set_position") (GObjectObjectClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
    end
