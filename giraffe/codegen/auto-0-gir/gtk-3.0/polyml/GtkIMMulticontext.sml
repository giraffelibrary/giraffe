structure GtkIMMulticontext :>
  ...
  struct
    ...
    in
      ...
      val getContextId_ = call (load_sym libgtk "gtk_im_multicontext_get_context_id") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      val setContextId_ = call (load_sym libgtk "gtk_im_multicontext_set_context_id") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INPTR --> FFI.PolyML.VOID)
    end
