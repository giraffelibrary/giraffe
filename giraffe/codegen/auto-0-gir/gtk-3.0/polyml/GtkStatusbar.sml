structure GtkStatusbar :>
  ...
  struct
    ...
    in
      ...
      val pop_ = call (getSymbol "gtk_statusbar_pop") (GtkStatusbarClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val push_ =
      ...
      val removeAll_ = call (getSymbol "gtk_statusbar_remove_all") (GtkStatusbarClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
    end
