structure GtkStatusbar :>
  ...
  struct
    ...
    in
      ...
      val getContextId_ = call (load_sym libgtk "gtk_statusbar_get_context_id") (GtkStatusbarClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> GUInt.PolyML.cVal)
      ...
      val pop_ = call (load_sym libgtk "gtk_statusbar_pop") (GtkStatusbarClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val push_ =
      ...
      val removeAll_ = call (load_sym libgtk "gtk_statusbar_remove_all") (GtkStatusbarClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
    end
