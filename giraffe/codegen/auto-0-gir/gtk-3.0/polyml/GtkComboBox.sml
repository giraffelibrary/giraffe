structure GtkComboBox :>
  ...
  struct
    ...
    in
      ...
      val getColumnSpanColumn_ = call (getSymbol "gtk_combo_box_get_column_span_column") (GtkComboBoxClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getEntryTextColumn_ = call (getSymbol "gtk_combo_box_get_entry_text_column") (GtkComboBoxClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getIdColumn_ = call (getSymbol "gtk_combo_box_get_id_column") (GtkComboBoxClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getRowSpanColumn_ = call (getSymbol "gtk_combo_box_get_row_span_column") (GtkComboBoxClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getTitle_ = call (getSymbol "gtk_combo_box_get_title") (GtkComboBoxClass.PolyML.cPtr --> Utf8.PolyML.cOutPtr)
      val getWrapWidth_ = call (getSymbol "gtk_combo_box_get_wrap_width") (GtkComboBoxClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val setActive_ = call (getSymbol "gtk_combo_box_set_active") (GtkComboBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      ...
      val setColumnSpanColumn_ = call (getSymbol "gtk_combo_box_set_column_span_column") (GtkComboBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      val setEntryTextColumn_ = call (getSymbol "gtk_combo_box_set_entry_text_column") (GtkComboBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      ...
      val setIdColumn_ = call (getSymbol "gtk_combo_box_set_id_column") (GtkComboBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      ...
      val setRowSpanColumn_ = call (getSymbol "gtk_combo_box_set_row_span_column") (GtkComboBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      val setTitle_ = call (getSymbol "gtk_combo_box_set_title") (GtkComboBoxClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> cVoid)
      val setWrapWidth_ = call (getSymbol "gtk_combo_box_set_wrap_width") (GtkComboBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
    end
