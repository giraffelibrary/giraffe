structure GtkComboBox :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgtk "gtk_combo_box_new") (FFI.PolyML.cVoid --> GtkWidgetClass.PolyML.cPtr)
      ...
      val newWithEntry_ = call (load_sym libgtk "gtk_combo_box_new_with_entry") (FFI.PolyML.cVoid --> GtkWidgetClass.PolyML.cPtr)
      ...
      val getActive_ = call (load_sym libgtk "gtk_combo_box_get_active") (GtkComboBoxClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      ...
      val getColumnSpanColumn_ = call (load_sym libgtk "gtk_combo_box_get_column_span_column") (GtkComboBoxClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      val getEntryTextColumn_ = call (load_sym libgtk "gtk_combo_box_get_entry_text_column") (GtkComboBoxClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      ...
      val getIdColumn_ = call (load_sym libgtk "gtk_combo_box_get_id_column") (GtkComboBoxClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      ...
      val getRowSpanColumn_ = call (load_sym libgtk "gtk_combo_box_get_row_span_column") (GtkComboBoxClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      val getTitle_ = call (load_sym libgtk "gtk_combo_box_get_title") (GtkComboBoxClass.PolyML.cPtr --> Utf8.PolyML.cOutPtr)
      val getWrapWidth_ = call (load_sym libgtk "gtk_combo_box_get_wrap_width") (GtkComboBoxClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      val popdown_ = call (load_sym libgtk "gtk_combo_box_popdown") (GtkComboBoxClass.PolyML.cPtr --> FFI.PolyML.cVoid)
      val popup_ = call (load_sym libgtk "gtk_combo_box_popup") (GtkComboBoxClass.PolyML.cPtr --> FFI.PolyML.cVoid)
      val popupForDevice_ = call (load_sym libgtk "gtk_combo_box_popup_for_device") (GtkComboBoxClass.PolyML.cPtr &&> GdkDeviceClass.PolyML.cPtr --> FFI.PolyML.cVoid)
      val setActive_ = call (load_sym libgtk "gtk_combo_box_set_active") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
      ...
      val setActiveIter_ = call (load_sym libgtk "gtk_combo_box_set_active_iter") (GtkComboBoxClass.PolyML.cPtr &&> GtkTreeIterRecord.PolyML.cOptPtr --> FFI.PolyML.cVoid)
      val setAddTearoffs_ = call (load_sym libgtk "gtk_combo_box_set_add_tearoffs") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> FFI.PolyML.cVoid)
      val setButtonSensitivity_ = call (load_sym libgtk "gtk_combo_box_set_button_sensitivity") (GtkComboBoxClass.PolyML.cPtr &&> GtkSensitivityType.PolyML.cVal --> FFI.PolyML.cVoid)
      val setColumnSpanColumn_ = call (load_sym libgtk "gtk_combo_box_set_column_span_column") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
      val setEntryTextColumn_ = call (load_sym libgtk "gtk_combo_box_set_entry_text_column") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
      val setFocusOnClick_ = call (load_sym libgtk "gtk_combo_box_set_focus_on_click") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> FFI.PolyML.cVoid)
      val setIdColumn_ = call (load_sym libgtk "gtk_combo_box_set_id_column") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
      val setModel_ = call (load_sym libgtk "gtk_combo_box_set_model") (GtkComboBoxClass.PolyML.cPtr &&> GtkTreeModelClass.PolyML.cOptPtr --> FFI.PolyML.cVoid)
      val setPopupFixedWidth_ = call (load_sym libgtk "gtk_combo_box_set_popup_fixed_width") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> FFI.PolyML.cVoid)
      val setRowSpanColumn_ = call (load_sym libgtk "gtk_combo_box_set_row_span_column") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
      val setTitle_ = call (load_sym libgtk "gtk_combo_box_set_title") (GtkComboBoxClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> FFI.PolyML.cVoid)
      val setWrapWidth_ = call (load_sym libgtk "gtk_combo_box_set_wrap_width") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
    end
