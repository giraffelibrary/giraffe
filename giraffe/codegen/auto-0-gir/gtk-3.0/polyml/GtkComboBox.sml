structure GtkComboBox :>
  ...
  struct
    ...
    in
      ...
      val getActive_ = call (load_sym libgtk "gtk_combo_box_get_active") (GtkComboBoxClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getColumnSpanColumn_ = call (load_sym libgtk "gtk_combo_box_get_column_span_column") (GtkComboBoxClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getEntryTextColumn_ = call (load_sym libgtk "gtk_combo_box_get_entry_text_column") (GtkComboBoxClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getIdColumn_ = call (load_sym libgtk "gtk_combo_box_get_id_column") (GtkComboBoxClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getRowSpanColumn_ = call (load_sym libgtk "gtk_combo_box_get_row_span_column") (GtkComboBoxClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getTitle_ = call (load_sym libgtk "gtk_combo_box_get_title") (GtkComboBoxClass.PolyML.cPtr --> Utf8.PolyML.cOutPtr)
      val getWrapWidth_ = call (load_sym libgtk "gtk_combo_box_get_wrap_width") (GtkComboBoxClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val setActive_ = call (load_sym libgtk "gtk_combo_box_set_active") (GtkComboBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setColumnSpanColumn_ = call (load_sym libgtk "gtk_combo_box_set_column_span_column") (GtkComboBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setEntryTextColumn_ = call (load_sym libgtk "gtk_combo_box_set_entry_text_column") (GtkComboBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setIdColumn_ = call (load_sym libgtk "gtk_combo_box_set_id_column") (GtkComboBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setRowSpanColumn_ = call (load_sym libgtk "gtk_combo_box_set_row_span_column") (GtkComboBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setWrapWidth_ = call (load_sym libgtk "gtk_combo_box_set_wrap_width") (GtkComboBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
    end
