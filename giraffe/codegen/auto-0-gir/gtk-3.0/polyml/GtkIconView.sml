structure GtkIconView :>
  ...
  struct
    ...
    in
      ...
      val getColumnSpacing_ = call (load_sym libgtk "gtk_icon_view_get_column_spacing") (GtkIconViewClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getColumns_ = call (load_sym libgtk "gtk_icon_view_get_columns") (GtkIconViewClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getCursor_ =
      ...
      val getItemColumn_ = call (load_sym libgtk "gtk_icon_view_get_item_column") (GtkIconViewClass.PolyML.cPtr &&> GtkTreePathRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getItemPadding_ = call (load_sym libgtk "gtk_icon_view_get_item_padding") (GtkIconViewClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getItemRow_ = call (load_sym libgtk "gtk_icon_view_get_item_row") (GtkIconViewClass.PolyML.cPtr &&> GtkTreePathRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val getItemWidth_ = call (load_sym libgtk "gtk_icon_view_get_item_width") (GtkIconViewClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getMargin_ = call (load_sym libgtk "gtk_icon_view_get_margin") (GtkIconViewClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getMarkupColumn_ = call (load_sym libgtk "gtk_icon_view_get_markup_column") (GtkIconViewClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getPixbufColumn_ = call (load_sym libgtk "gtk_icon_view_get_pixbuf_column") (GtkIconViewClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getReorderable_ = call (load_sym libgtk "gtk_icon_view_get_reorderable") (GtkIconViewClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getRowSpacing_ = call (load_sym libgtk "gtk_icon_view_get_row_spacing") (GtkIconViewClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getSpacing_ = call (load_sym libgtk "gtk_icon_view_get_spacing") (GtkIconViewClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getTextColumn_ = call (load_sym libgtk "gtk_icon_view_get_text_column") (GtkIconViewClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getTooltipColumn_ = call (load_sym libgtk "gtk_icon_view_get_tooltip_column") (GtkIconViewClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val setColumnSpacing_ = call (load_sym libgtk "gtk_icon_view_set_column_spacing") (GtkIconViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setColumns_ = call (load_sym libgtk "gtk_icon_view_set_columns") (GtkIconViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setCursor_ =
      ...
      val setItemPadding_ = call (load_sym libgtk "gtk_icon_view_set_item_padding") (GtkIconViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setItemWidth_ = call (load_sym libgtk "gtk_icon_view_set_item_width") (GtkIconViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setMargin_ = call (load_sym libgtk "gtk_icon_view_set_margin") (GtkIconViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setMarkupColumn_ = call (load_sym libgtk "gtk_icon_view_set_markup_column") (GtkIconViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setPixbufColumn_ = call (load_sym libgtk "gtk_icon_view_set_pixbuf_column") (GtkIconViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setRowSpacing_ = call (load_sym libgtk "gtk_icon_view_set_row_spacing") (GtkIconViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setSpacing_ = call (load_sym libgtk "gtk_icon_view_set_spacing") (GtkIconViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setTextColumn_ = call (load_sym libgtk "gtk_icon_view_set_text_column") (GtkIconViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setTooltipCell_ =
      ...
      val setTooltipColumn_ = call (load_sym libgtk "gtk_icon_view_set_tooltip_column") (GtkIconViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setTooltipItem_ =
