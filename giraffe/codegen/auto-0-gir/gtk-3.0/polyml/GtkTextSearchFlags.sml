structure GtkTextSearchFlags :>
  sig
    include GTK_TEXT_SEARCH_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtk "gtk_text_search_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
