structure GtkPrintSettings :>
  ...
  struct
    ...
    in
      ...
      val getInt_ = call (load_sym libgtk "gtk_print_settings_get_int") (GtkPrintSettingsClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> FFI.Int.PolyML.cVal)
      ...
      val getNCopies_ = call (load_sym libgtk "gtk_print_settings_get_n_copies") (GtkPrintSettingsClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      val getNumberUp_ = call (load_sym libgtk "gtk_print_settings_get_number_up") (GtkPrintSettingsClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      ...
      val getResolution_ = call (load_sym libgtk "gtk_print_settings_get_resolution") (GtkPrintSettingsClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      val getResolutionX_ = call (load_sym libgtk "gtk_print_settings_get_resolution_x") (GtkPrintSettingsClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      val getResolutionY_ = call (load_sym libgtk "gtk_print_settings_get_resolution_y") (GtkPrintSettingsClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      ...
      val setCollate_ = call (load_sym libgtk "gtk_print_settings_set_collate") (GtkPrintSettingsClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setNCopies_ = call (load_sym libgtk "gtk_print_settings_set_n_copies") (GtkPrintSettingsClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> PolyMLFFI.cVoid)
      val setNumberUp_ = call (load_sym libgtk "gtk_print_settings_set_number_up") (GtkPrintSettingsClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setPrinterLpi_ = call (load_sym libgtk "gtk_print_settings_set_printer_lpi") (GtkPrintSettingsClass.PolyML.cPtr &&> FFI.Double.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setResolution_ = call (load_sym libgtk "gtk_print_settings_set_resolution") (GtkPrintSettingsClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setReverse_ = call (load_sym libgtk "gtk_print_settings_set_reverse") (GtkPrintSettingsClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setScale_ = call (load_sym libgtk "gtk_print_settings_set_scale") (GtkPrintSettingsClass.PolyML.cPtr &&> FFI.Double.PolyML.cVal --> PolyMLFFI.cVoid)
      val setUseColor_ = call (load_sym libgtk "gtk_print_settings_set_use_color") (GtkPrintSettingsClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> PolyMLFFI.cVoid)
      val toFile_ =
