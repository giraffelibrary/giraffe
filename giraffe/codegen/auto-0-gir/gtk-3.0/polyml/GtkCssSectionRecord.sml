structure GtkCssSectionRecord :> GTK_CSS_SECTION_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "gtk_css_section_ref") (cPtr --> cPtr)
      val free_ = call (getSymbol "gtk_css_section_unref") (cPtr --> cVoid)
    end
    structure Record =
      BoxedRecord(
