structure GtkFileChooserButton :>
  ...
  struct
    ...
    in
      ...
      val setWidthChars_ = call (load_sym libgtk "gtk_file_chooser_button_set_width_chars") (GtkFileChooserButtonClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
    end
