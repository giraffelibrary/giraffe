structure GtkTextIter :>
  ...
  struct
    ...
    in
      ...
      val setLine_ = call (getSymbol "gtk_text_iter_set_line") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setLineIndex_ = call (getSymbol "gtk_text_iter_set_line_index") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setLineOffset_ = call (getSymbol "gtk_text_iter_set_line_offset") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setOffset_ = call (getSymbol "gtk_text_iter_set_offset") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setVisibleLineIndex_ = call (getSymbol "gtk_text_iter_set_visible_line_index") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setVisibleLineOffset_ = call (getSymbol "gtk_text_iter_set_visible_line_offset") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
