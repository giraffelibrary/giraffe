structure GtkTextIter :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtk "gtk_text_iter_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      val assign_ = call (load_sym libgtk "gtk_text_iter_assign") (GtkTextIterRecord.PolyML.cPtr &&> GtkTextIterRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      val backwardChar_ = call (load_sym libgtk "gtk_text_iter_backward_char") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val backwardChars_ = call (load_sym libgtk "gtk_text_iter_backward_chars") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val backwardCursorPosition_ = call (load_sym libgtk "gtk_text_iter_backward_cursor_position") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val backwardCursorPositions_ = call (load_sym libgtk "gtk_text_iter_backward_cursor_positions") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val backwardLine_ = call (load_sym libgtk "gtk_text_iter_backward_line") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val backwardLines_ = call (load_sym libgtk "gtk_text_iter_backward_lines") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val backwardSearch_ =
      ...
      val backwardSentenceStart_ = call (load_sym libgtk "gtk_text_iter_backward_sentence_start") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val backwardSentenceStarts_ = call (load_sym libgtk "gtk_text_iter_backward_sentence_starts") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val backwardToTagToggle_ = call (load_sym libgtk "gtk_text_iter_backward_to_tag_toggle") (GtkTextIterRecord.PolyML.cPtr &&> GtkTextTagClass.PolyML.cOptPtr --> GBool.PolyML.cVal)
      val backwardVisibleCursorPosition_ = call (load_sym libgtk "gtk_text_iter_backward_visible_cursor_position") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val backwardVisibleCursorPositions_ = call (load_sym libgtk "gtk_text_iter_backward_visible_cursor_positions") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val backwardVisibleLine_ = call (load_sym libgtk "gtk_text_iter_backward_visible_line") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val backwardVisibleLines_ = call (load_sym libgtk "gtk_text_iter_backward_visible_lines") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val backwardVisibleWordStart_ = call (load_sym libgtk "gtk_text_iter_backward_visible_word_start") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val backwardVisibleWordStarts_ = call (load_sym libgtk "gtk_text_iter_backward_visible_word_starts") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val backwardWordStart_ = call (load_sym libgtk "gtk_text_iter_backward_word_start") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val backwardWordStarts_ = call (load_sym libgtk "gtk_text_iter_backward_word_starts") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val beginsTag_ = call (load_sym libgtk "gtk_text_iter_begins_tag") (GtkTextIterRecord.PolyML.cPtr &&> GtkTextTagClass.PolyML.cOptPtr --> GBool.PolyML.cVal)
      val canInsert_ = call (load_sym libgtk "gtk_text_iter_can_insert") (GtkTextIterRecord.PolyML.cPtr &&> GBool.PolyML.cVal --> GBool.PolyML.cVal)
      val compare_ = call (load_sym libgtk "gtk_text_iter_compare") (GtkTextIterRecord.PolyML.cPtr &&> GtkTextIterRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val copy_ = call (load_sym libgtk "gtk_text_iter_copy") (GtkTextIterRecord.PolyML.cPtr --> GtkTextIterRecord.PolyML.cPtr)
      val editable_ = call (load_sym libgtk "gtk_text_iter_editable") (GtkTextIterRecord.PolyML.cPtr &&> GBool.PolyML.cVal --> GBool.PolyML.cVal)
      val endsLine_ = call (load_sym libgtk "gtk_text_iter_ends_line") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val endsSentence_ = call (load_sym libgtk "gtk_text_iter_ends_sentence") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val endsTag_ = call (load_sym libgtk "gtk_text_iter_ends_tag") (GtkTextIterRecord.PolyML.cPtr &&> GtkTextTagClass.PolyML.cOptPtr --> GBool.PolyML.cVal)
      val endsWord_ = call (load_sym libgtk "gtk_text_iter_ends_word") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val equal_ = call (load_sym libgtk "gtk_text_iter_equal") (GtkTextIterRecord.PolyML.cPtr &&> GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val forwardChar_ = call (load_sym libgtk "gtk_text_iter_forward_char") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val forwardChars_ = call (load_sym libgtk "gtk_text_iter_forward_chars") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val forwardCursorPosition_ = call (load_sym libgtk "gtk_text_iter_forward_cursor_position") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val forwardCursorPositions_ = call (load_sym libgtk "gtk_text_iter_forward_cursor_positions") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val forwardLine_ = call (load_sym libgtk "gtk_text_iter_forward_line") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val forwardLines_ = call (load_sym libgtk "gtk_text_iter_forward_lines") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val forwardSearch_ =
      ...
      val forwardSentenceEnd_ = call (load_sym libgtk "gtk_text_iter_forward_sentence_end") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val forwardSentenceEnds_ = call (load_sym libgtk "gtk_text_iter_forward_sentence_ends") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val forwardToEnd_ = call (load_sym libgtk "gtk_text_iter_forward_to_end") (GtkTextIterRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      val forwardToLineEnd_ = call (load_sym libgtk "gtk_text_iter_forward_to_line_end") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val forwardToTagToggle_ = call (load_sym libgtk "gtk_text_iter_forward_to_tag_toggle") (GtkTextIterRecord.PolyML.cPtr &&> GtkTextTagClass.PolyML.cOptPtr --> GBool.PolyML.cVal)
      val forwardVisibleCursorPosition_ = call (load_sym libgtk "gtk_text_iter_forward_visible_cursor_position") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val forwardVisibleCursorPositions_ = call (load_sym libgtk "gtk_text_iter_forward_visible_cursor_positions") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val forwardVisibleLine_ = call (load_sym libgtk "gtk_text_iter_forward_visible_line") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val forwardVisibleLines_ = call (load_sym libgtk "gtk_text_iter_forward_visible_lines") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val forwardVisibleWordEnd_ = call (load_sym libgtk "gtk_text_iter_forward_visible_word_end") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val forwardVisibleWordEnds_ = call (load_sym libgtk "gtk_text_iter_forward_visible_word_ends") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val forwardWordEnd_ = call (load_sym libgtk "gtk_text_iter_forward_word_end") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val forwardWordEnds_ = call (load_sym libgtk "gtk_text_iter_forward_word_ends") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val getAttributes_ = call (load_sym libgtk "gtk_text_iter_get_attributes") (GtkTextIterRecord.PolyML.cPtr &&> GtkTextAttributesRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val getBuffer_ = call (load_sym libgtk "gtk_text_iter_get_buffer") (GtkTextIterRecord.PolyML.cPtr --> GtkTextBufferClass.PolyML.cPtr)
      val getBytesInLine_ = call (load_sym libgtk "gtk_text_iter_get_bytes_in_line") (GtkTextIterRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val getChar_ = call (load_sym libgtk "gtk_text_iter_get_char") (GtkTextIterRecord.PolyML.cPtr --> GChar.PolyML.cVal)
      val getCharsInLine_ = call (load_sym libgtk "gtk_text_iter_get_chars_in_line") (GtkTextIterRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val getChildAnchor_ = call (load_sym libgtk "gtk_text_iter_get_child_anchor") (GtkTextIterRecord.PolyML.cPtr --> GtkTextChildAnchorClass.PolyML.cPtr)
      ...
      val getLine_ = call (load_sym libgtk "gtk_text_iter_get_line") (GtkTextIterRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val getLineIndex_ = call (load_sym libgtk "gtk_text_iter_get_line_index") (GtkTextIterRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val getLineOffset_ = call (load_sym libgtk "gtk_text_iter_get_line_offset") (GtkTextIterRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val getOffset_ = call (load_sym libgtk "gtk_text_iter_get_offset") (GtkTextIterRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val getPixbuf_ = call (load_sym libgtk "gtk_text_iter_get_pixbuf") (GtkTextIterRecord.PolyML.cPtr --> GdkPixbufPixbufClass.PolyML.cPtr)
      ...
      val getVisibleLineIndex_ = call (load_sym libgtk "gtk_text_iter_get_visible_line_index") (GtkTextIterRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val getVisibleLineOffset_ = call (load_sym libgtk "gtk_text_iter_get_visible_line_offset") (GtkTextIterRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val hasTag_ = call (load_sym libgtk "gtk_text_iter_has_tag") (GtkTextIterRecord.PolyML.cPtr &&> GtkTextTagClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val inRange_ =
      ...
      val insideSentence_ = call (load_sym libgtk "gtk_text_iter_inside_sentence") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val insideWord_ = call (load_sym libgtk "gtk_text_iter_inside_word") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val isCursorPosition_ = call (load_sym libgtk "gtk_text_iter_is_cursor_position") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val isEnd_ = call (load_sym libgtk "gtk_text_iter_is_end") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val isStart_ = call (load_sym libgtk "gtk_text_iter_is_start") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val order_ = call (load_sym libgtk "gtk_text_iter_order") (GtkTextIterRecord.PolyML.cPtr &&> GtkTextIterRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      val setLine_ = call (load_sym libgtk "gtk_text_iter_set_line") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setLineIndex_ = call (load_sym libgtk "gtk_text_iter_set_line_index") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setLineOffset_ = call (load_sym libgtk "gtk_text_iter_set_line_offset") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setOffset_ = call (load_sym libgtk "gtk_text_iter_set_offset") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setVisibleLineIndex_ = call (load_sym libgtk "gtk_text_iter_set_visible_line_index") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setVisibleLineOffset_ = call (load_sym libgtk "gtk_text_iter_set_visible_line_offset") (GtkTextIterRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val startsLine_ = call (load_sym libgtk "gtk_text_iter_starts_line") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val startsSentence_ = call (load_sym libgtk "gtk_text_iter_starts_sentence") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val startsWord_ = call (load_sym libgtk "gtk_text_iter_starts_word") (GtkTextIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val togglesTag_ = call (load_sym libgtk "gtk_text_iter_toggles_tag") (GtkTextIterRecord.PolyML.cPtr &&> GtkTextTagClass.PolyML.cOptPtr --> GBool.PolyML.cVal)
    end
