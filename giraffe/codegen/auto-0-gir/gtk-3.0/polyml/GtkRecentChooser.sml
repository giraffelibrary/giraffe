structure GtkRecentChooser :>
  ...
  struct
    ...
    in
      ...
      val getUris_ = call (getSymbol "gtk_recent_chooser_get_uris") (GtkRecentChooserClass.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CPtrArrayN.PolyML.cOutPtr)
      ...
      val setLimit_ = call (getSymbol "gtk_recent_chooser_set_limit") (GtkRecentChooserClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
