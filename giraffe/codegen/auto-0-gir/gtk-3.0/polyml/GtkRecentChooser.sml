structure GtkRecentChooser :>
  ...
  struct
    ...
    in
      ...
      val getLimit_ = call (load_sym libgtk "gtk_recent_chooser_get_limit") (GtkRecentChooserClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getUris_ = call (load_sym libgtk "gtk_recent_chooser_get_uris") (GtkRecentChooserClass.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      ...
      val setLimit_ = call (load_sym libgtk "gtk_recent_chooser_set_limit") (GtkRecentChooserClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
