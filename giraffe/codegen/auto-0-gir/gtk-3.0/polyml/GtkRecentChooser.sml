structure GtkRecentChooser :>
  ...
  struct
    ...
    in
      ...
      val getLimit_ = call (load_sym libgtk "gtk_recent_chooser_get_limit") (GtkRecentChooserClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      ...
      val setLimit_ = call (load_sym libgtk "gtk_recent_chooser_set_limit") (GtkRecentChooserClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
