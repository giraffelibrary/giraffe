structure GtkCellEditable :>
  ...
  struct
    ...
    in
      ...
      val editingDone_ = call (load_sym libgtk "gtk_cell_editable_editing_done") (GtkCellEditableClass.PolyML.cPtr --> FFI.PolyML.cVoid)
      val removeWidget_ = call (load_sym libgtk "gtk_cell_editable_remove_widget") (GtkCellEditableClass.PolyML.cPtr --> FFI.PolyML.cVoid)
      val startEditing_ = call (load_sym libgtk "gtk_cell_editable_start_editing") (GtkCellEditableClass.PolyML.cPtr &&> GdkEvent.PolyML.cOptPtr --> FFI.PolyML.cVoid)
    end
