structure GtkTreeView :>
  ...
  struct
    ...
    in
      ...
      val getColumn_ = call (getSymbol "gtk_tree_view_get_column") (GtkTreeViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> GtkTreeViewColumnClass.PolyML.cOptPtr)
      val getCursor_ =
      ...
      val setLevelIndentation_ = call (getSymbol "gtk_tree_view_set_level_indentation") (GtkTreeViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      ...
      val setSearchColumn_ = call (getSymbol "gtk_tree_view_set_search_column") (GtkTreeViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      ...
      val setTooltipColumn_ = call (getSymbol "gtk_tree_view_set_tooltip_column") (GtkTreeViewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      val setTooltipRow_ =
