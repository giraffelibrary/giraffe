structure GtkSymbolicColorRecord :> GTK_SYMBOLIC_COLOR_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "gtk_symbolic_color_ref") (cPtr --> cPtr)
      val free_ = call (getSymbol "gtk_symbolic_color_unref") (cPtr --> PolyMLFFI.cVoid)
    end
    structure Record =
      BoxedRecord(
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_symbolic_color_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
