structure GtkRange :>
  ...
  struct
    ...
    in
      ...
      val getRangeRect_ = call (load_sym libgtk "gtk_range_get_range_rect") (GtkRangeClass.PolyML.cPtr &&> GdkRectangleRecord.PolyML.cPtr --> FFI.PolyML.cVoid)
      ...
      val setMinSliderSize_ = call (load_sym libgtk "gtk_range_set_min_slider_size") (GtkRangeClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
      val setRange_ =
      ...
      val setRoundDigits_ = call (load_sym libgtk "gtk_range_set_round_digits") (GtkRangeClass.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
