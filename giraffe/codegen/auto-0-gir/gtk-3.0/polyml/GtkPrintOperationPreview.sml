structure GtkPrintOperationPreview :>
  ...
  struct
    ...
    in
      ...
      val isSelected_ = call (getSymbol "gtk_print_operation_preview_is_selected") (GtkPrintOperationPreviewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val renderPage_ = call (getSymbol "gtk_print_operation_preview_render_page") (GtkPrintOperationPreviewClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
    end
