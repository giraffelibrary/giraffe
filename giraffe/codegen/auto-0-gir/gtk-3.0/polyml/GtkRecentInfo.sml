structure GtkRecentInfo :>
  ...
  struct
    ...
    in
      ...
      val getApplications_ = call (getSymbol "gtk_recent_info_get_applications") (GtkRecentInfoRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CPtrArrayN.PolyML.cOutPtr)
      ...
      val getGroups_ = call (getSymbol "gtk_recent_info_get_groups") (GtkRecentInfoRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CPtrArrayN.PolyML.cOutPtr)
