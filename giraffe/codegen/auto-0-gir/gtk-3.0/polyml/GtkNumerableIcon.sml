structure GtkNumerableIcon :>
  ...
  struct
    ...
    in
      ...
      val getCount_ = call (load_sym libgtk "gtk_numerable_icon_get_count") (GtkNumerableIconClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val setCount_ = call (load_sym libgtk "gtk_numerable_icon_set_count") (GtkNumerableIconClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
