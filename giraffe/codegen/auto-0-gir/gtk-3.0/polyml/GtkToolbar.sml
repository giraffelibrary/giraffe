structure GtkToolbar :>
  ...
  struct
    ...
    fun getNthItem self n = (GtkToolbarClass.FFI.withPtr false &&&> GInt.FFI.withVal ---> GtkToolItemClass.FFI.fromOptPtr false) getNthItem_ (self & n) before GtkToolbarClass.FFI.touchPtr self
