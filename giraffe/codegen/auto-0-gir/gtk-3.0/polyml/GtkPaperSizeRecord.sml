structure GtkPaperSizeRecord :> GTK_PAPER_SIZE_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "gtk_paper_size_copy") (cPtr --> cPtr)
      val free_ = call (getSymbol "gtk_paper_size_free") (cPtr --> PolyMLFFI.cVoid)
    end
    structure Record =
      BoxedRecord(
