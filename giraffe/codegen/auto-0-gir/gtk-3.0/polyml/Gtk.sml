structure Gtk : GTK =
  struct
    ...
    in
      ...
      val init_ = call (getSymbol "gtk_init") (GInt.PolyML.cRef &&> Utf8CPtrArrayN.PolyML.cInOutRef --> cVoid)
      val initCheck_ = call (getSymbol "gtk_init_check") (GInt.PolyML.cRef &&> Utf8CPtrArrayN.PolyML.cInOutRef --> GBool.PolyML.cVal)
      ...
      val mainLevel_ = call (getSymbol "gtk_main_level") (cVoid --> GUInt.PolyML.cVal)
      ...
      val parseArgs_ = call (getSymbol "gtk_parse_args") (GInt.PolyML.cRef &&> Utf8CPtrArrayN.PolyML.cInOutRef --> GBool.PolyML.cVal)
      ...
      val setDebugFlags_ = call (getSymbol "gtk_set_debug_flags") (GUInt.PolyML.cVal --> cVoid)
      val showUri_ =
      ...
      val stockAdd_ = call (getSymbol "gtk_stock_add") (GtkStockItemRecordCArrayN.PolyML.cInPtr &&> GUInt.PolyML.cVal --> cVoid)
      val stockAddStatic_ = call (getSymbol "gtk_stock_add_static") (GtkStockItemRecordCArrayN.PolyML.cInPtr &&> GUInt.PolyML.cVal --> cVoid)
      val stockLookup_ = call (getSymbol "gtk_stock_lookup") (Utf8.PolyML.cInPtr &&> GtkStockItemRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val targetTableFree_ = call (getSymbol "gtk_target_table_free") (GtkTargetEntryRecordCArrayN.PolyML.cInPtr &&> GInt.PolyML.cVal --> cVoid)
      val targetTableNewFromList_ = call (getSymbol "gtk_target_table_new_from_list") (GtkTargetListRecord.PolyML.cPtr &&> GInt.PolyML.cRef --> GtkTargetEntryRecordCArrayN.PolyML.cOutPtr)
      ...
      val targetsIncludeText_ = call (getSymbol "gtk_targets_include_text") (GdkAtomRecordCPtrArrayN.PolyML.cInPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val targetsIncludeUri_ = call (getSymbol "gtk_targets_include_uri") (GdkAtomRecordCPtrArrayN.PolyML.cInPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      ...
      val testListAllTypes_ = call (getSymbol "gtk_test_list_all_types") (GUInt.PolyML.cRef --> GObjectTypeCArray.PolyML.cOutPtr)
    ...
    structure TableRowColRecord = GtkTableRowColRecord
    ...
    structure TextAppearanceRecord = GtkTextAppearanceRecord
    ...
    structure TreeRowReferenceRecord = GtkTreeRowReferenceRecord
    ...
    structure Gradient = GtkGradient
    ...
    structure TableRowCol = GtkTableRowCol
    structure TargetEntry = GtkTargetEntry
    structure TextAppearance = GtkTextAppearance
    ...
    structure TreeRowReference = GtkTreeRowReference
    ...
    fun testListAllTypes () =
      let
        val _ & retVal = (GUInt.FFI.withRefVal ---> GUInt.FFI.fromVal && GObjectTypeCArray.FFI.fromPtr 0) testListAllTypes_ GUInt.null
      in
        retVal
      end
