structure GtkWindow :>
  ...
  struct
    ...
    in
      ...
      val getResizeGripArea_ = call (load_sym libgtk "gtk_window_get_resize_grip_area") (GtkWindowClass.PolyML.cPtr &&> GdkRectangleRecord.PolyML.cPtr --> GBool.PolyML.cVal)
