structure GtkTextIterRecord :> GTK_TEXT_ITER_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val new_ = call (getSymbol "giraffe_gtk_text_iter_new") (cVoid --> cPtr)
      val copy_ = call (getSymbol "giraffe_gtk_text_iter_copy") (cPtr &&> cPtr --> cVoid)
      val free_ = call (getSymbol "giraffe_gtk_text_iter_free") (cPtr --> cVoid)
      val size_ = call (getSymbol "giraffe_gtk_text_iter_size") (cVoid --> GUInt.PolyML.cVal)
    end
    structure Record =
      BoxedValueRecord(
