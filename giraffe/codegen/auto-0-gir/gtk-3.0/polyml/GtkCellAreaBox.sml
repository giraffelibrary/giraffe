structure GtkCellAreaBox :>
  ...
  struct
    ...
    in
      ...
      val getSpacing_ = call (getSymbol "gtk_cell_area_box_get_spacing") (GtkCellAreaBoxClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val packEnd_ =
      ...
      val setSpacing_ = call (getSymbol "gtk_cell_area_box_set_spacing") (GtkCellAreaBoxClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
    end
