structure GtkRevealer :>
  ...
  struct
    ...
    in
      ...
      val getTransitionDuration_ = call (getSymbol "gtk_revealer_get_transition_duration") (GtkRevealerClass.PolyML.cPtr --> GUInt.PolyML.cVal)
      ...
      val setTransitionDuration_ = call (getSymbol "gtk_revealer_set_transition_duration") (GtkRevealerClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> cVoid)
