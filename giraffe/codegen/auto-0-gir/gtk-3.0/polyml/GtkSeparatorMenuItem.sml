structure GtkSeparatorMenuItem :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtk "gtk_separator_menu_item_get_type") (FFI.PolyML.VOID --> GObjectType.PolyML.VAL)
      val new_ = call (load_sym libgtk "gtk_separator_menu_item_new") (FFI.PolyML.VOID --> GObjectObjectClass.PolyML.PTR)
    end
