structure GtkTreePath :>
  ...
  struct
    ...
    in
      ...
      val appendIndex_ = call (getSymbol "gtk_tree_path_append_index") (GtkTreePathRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val prependIndex_ = call (getSymbol "gtk_tree_path_prepend_index") (GtkTreePathRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
