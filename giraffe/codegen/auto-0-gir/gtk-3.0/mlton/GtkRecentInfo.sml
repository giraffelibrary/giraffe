structure GtkRecentInfo :>
  ...
  struct
    ...
    val getAdded_ = _import "gtk_recent_info_get_added" : GtkRecentInfoRecord.FFI.non_opt GtkRecentInfoRecord.FFI.p -> GLong.FFI.val_;
    val getAge_ = _import "gtk_recent_info_get_age" : GtkRecentInfoRecord.FFI.non_opt GtkRecentInfoRecord.FFI.p -> GInt.FFI.val_;
    ...
    val getVisited_ = _import "gtk_recent_info_get_visited" : GtkRecentInfoRecord.FFI.non_opt GtkRecentInfoRecord.FFI.p -> GLong.FFI.val_;
    val hasApplication_ =
      fn
        x1 & (x2, x3) =>
          (
