structure GtkSelectionData :>
  ...
  struct
    ...
    val getDisplay_ = _import "gtk_selection_data_get_display" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p -> GdkDisplayClass.C.notnull GdkDisplayClass.C.p;
    val getFormat_ = _import "gtk_selection_data_get_format" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p -> FFI.Int.C.val_;
    val getLength_ = _import "gtk_selection_data_get_length" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p -> FFI.Int.C.val_;
    val getPixbuf_ = _import "gtk_selection_data_get_pixbuf" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p -> GdkPixbufPixbufClass.C.notnull GdkPixbufPixbufClass.C.p;
    ...
    val setPixbuf_ = fn x1 & x2 => (_import "gtk_selection_data_set_pixbuf" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p * GdkPixbufPixbufClass.C.notnull GdkPixbufPixbufClass.C.p -> FFI.Bool.C.val_;) (x1, x2)
    val setText_ =
      fn
        x1
         & (x2, x3)
    ...
    val targetsIncludeRichText_ = fn x1 & x2 => (_import "gtk_selection_data_targets_include_rich_text" : GtkSelectionDataRecord.C.notnull GtkSelectionDataRecord.C.p * GtkTextBufferClass.C.notnull GtkTextBufferClass.C.p -> FFI.Bool.C.val_;) (x1, x2)
    ...
    fun setPixbuf self pixbuf = (GtkSelectionDataRecord.C.withPtr &&&> GdkPixbufPixbufClass.C.withPtr ---> FFI.Bool.C.fromVal) setPixbuf_ (self & pixbuf)
    ...
    fun targetsIncludeRichText self buffer = (GtkSelectionDataRecord.C.withPtr &&&> GtkTextBufferClass.C.withPtr ---> FFI.Bool.C.fromVal) targetsIncludeRichText_ (self & buffer)
