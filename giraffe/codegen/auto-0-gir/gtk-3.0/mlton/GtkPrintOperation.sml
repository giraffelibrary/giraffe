structure GtkPrintOperation :>
  ...
  struct
    ...
    val getNPagesToPrint_ = _import "gtk_print_operation_get_n_pages_to_print" : GtkPrintOperationClass.FFI.notnull GtkPrintOperationClass.FFI.p -> GInt.FFI.val_;
    ...
    val setCurrentPage_ = fn x1 & x2 => (_import "gtk_print_operation_set_current_page" : GtkPrintOperationClass.FFI.notnull GtkPrintOperationClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    ...
    val setNPages_ = fn x1 & x2 => (_import "gtk_print_operation_set_n_pages" : GtkPrintOperationClass.FFI.notnull GtkPrintOperationClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
