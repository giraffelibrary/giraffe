structure GtkRecentManager :>
  ...
  struct
    ...
    val purgeItems_ = fn x1 & x2 => (_import "gtk_recent_manager_purge_items" : GtkRecentManagerClass.C.notnull GtkRecentManagerClass.C.p * (unit, unit) GLibErrorRecord.C.r -> FFI.Int.C.val_;) (x1, x2)
    val removeItem_ =
      fn
        x1
         & (x2, x3)
