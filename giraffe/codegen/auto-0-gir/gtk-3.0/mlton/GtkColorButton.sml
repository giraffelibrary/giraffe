structure GtkColorButton :>
  ...
  struct
    ...
    val getRgba_ = fn x1 & x2 => (_import "gtk_color_button_get_rgba" : GtkColorButtonClass.FFI.notnull GtkColorButtonClass.FFI.p * GdkRgbaRecord.FFI.notnull GdkRgbaRecord.FFI.p -> unit;) (x1, x2)
    ...
    val setRgba_ = fn x1 & x2 => (_import "gtk_color_button_set_rgba" : GtkColorButtonClass.FFI.notnull GtkColorButtonClass.FFI.p * GdkRgbaRecord.FFI.notnull GdkRgbaRecord.FFI.p -> unit;) (x1, x2)
    val setTitle_ =
      fn
        x1 & (x2, x3) =>
          (
