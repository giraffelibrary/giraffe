structure GtkShortcutLabel :>
  ...
  struct
    ...
    val getAccelerator_ = _import "gtk_shortcut_label_get_accelerator" : GtkShortcutLabelClass.FFI.notnull GtkShortcutLabelClass.FFI.p -> Utf8.FFI.notnull Utf8.FFI.out_p;
    val getDisabledText_ = _import "gtk_shortcut_label_get_disabled_text" : GtkShortcutLabelClass.FFI.notnull GtkShortcutLabelClass.FFI.p -> Utf8.FFI.notnull Utf8.FFI.out_p;
    val setAccelerator_ =
      fn
        x1 & (x2, x3) =>
          (
