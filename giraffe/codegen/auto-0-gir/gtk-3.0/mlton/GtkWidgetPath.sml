structure GtkWidgetPath :>
  ...
  struct
    ...
    val appendForWidget_ = fn x1 & x2 => (_import "gtk_widget_path_append_for_widget" : GtkWidgetPathRecord.C.notnull GtkWidgetPathRecord.C.p * GtkWidgetClass.C.notnull GtkWidgetClass.C.p -> FFI.Int.C.val_;) (x1, x2)
