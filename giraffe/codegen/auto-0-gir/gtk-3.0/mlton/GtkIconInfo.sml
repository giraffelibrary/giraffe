structure GtkIconInfo :>
  ...
  struct
    ...
    val getBaseScale_ = _import "gtk_icon_info_get_base_scale" : GtkIconInfoClass.FFI.non_opt GtkIconInfoClass.FFI.p -> GInt.FFI.val_;
    val getBaseSize_ = _import "gtk_icon_info_get_base_size" : GtkIconInfoClass.FFI.non_opt GtkIconInfoClass.FFI.p -> GInt.FFI.val_;
