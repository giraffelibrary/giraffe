structure GtkTable :>
  ...
  struct
    ...
    val getColSpacing_ = fn x1 & x2 => (_import "gtk_table_get_col_spacing" : GtkTableClass.FFI.notnull GtkTableClass.FFI.p * GUInt.FFI.val_ -> GUInt.FFI.val_;) (x1, x2)
    val getDefaultColSpacing_ = _import "gtk_table_get_default_col_spacing" : GtkTableClass.FFI.notnull GtkTableClass.FFI.p -> GUInt.FFI.val_;
    val getDefaultRowSpacing_ = _import "gtk_table_get_default_row_spacing" : GtkTableClass.FFI.notnull GtkTableClass.FFI.p -> GUInt.FFI.val_;
    val getHomogeneous_ = _import "gtk_table_get_homogeneous" : GtkTableClass.FFI.notnull GtkTableClass.FFI.p -> GBool.FFI.val_;
    val getRowSpacing_ = fn x1 & x2 => (_import "gtk_table_get_row_spacing" : GtkTableClass.FFI.notnull GtkTableClass.FFI.p * GUInt.FFI.val_ -> GUInt.FFI.val_;) (x1, x2)
    val getSize_ =
      fn
        x1
         & x2
    ...
    val setColSpacings_ = fn x1 & x2 => (_import "gtk_table_set_col_spacings" : GtkTableClass.FFI.notnull GtkTableClass.FFI.p * GUInt.FFI.val_ -> unit;) (x1, x2)
    ...
    val setRowSpacings_ = fn x1 & x2 => (_import "gtk_table_set_row_spacings" : GtkTableClass.FFI.notnull GtkTableClass.FFI.p * GUInt.FFI.val_ -> unit;) (x1, x2)
