structure GtkAppChooser :>
  ...
  struct
    ...
    val getAppInfo_ = _import "gtk_app_chooser_get_app_info" : GtkAppChooserClass.FFI.notnull GtkAppChooserClass.FFI.p -> GioAppInfoClass.FFI.notnull GioAppInfoClass.FFI.p;
