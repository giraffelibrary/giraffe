structure GtkBox :>
  ...
  struct
    ...
    val new_ = fn x1 & x2 => (_import "gtk_box_new" : GtkOrientation.FFI.val_ * GInt.FFI.val_ -> GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p;) (x1, x2)
    ...
    val getSpacing_ = _import "gtk_box_get_spacing" : GtkBoxClass.FFI.non_opt GtkBoxClass.FFI.p -> GInt.FFI.val_;
    val packEnd_ =
      fn
        x1
         & x2
    ...
    val setSpacing_ = fn x1 & x2 => (_import "gtk_box_set_spacing" : GtkBoxClass.FFI.non_opt GtkBoxClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
