structure GtkRcStyle :>
  ...
  struct
    ...
    val new_ = _import "gtk_rc_style_new" : unit -> GtkRcStyleClass.FFI.notnull GtkRcStyleClass.FFI.p;
    val copy_ = _import "gtk_rc_style_copy" : GtkRcStyleClass.FFI.notnull GtkRcStyleClass.FFI.p -> GtkRcStyleClass.FFI.notnull GtkRcStyleClass.FFI.p;
