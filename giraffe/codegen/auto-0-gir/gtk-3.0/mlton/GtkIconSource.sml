structure GtkIconSource :>
  ...
  struct
    ...
    fun getSize self = (GtkIconSourceRecord.FFI.withPtr false ---> GInt.FFI.fromVal) getSize_ self
    ...
    fun setSize self size = (GtkIconSourceRecord.FFI.withPtr false &&&> GInt.FFI.withVal ---> I) setSize_ (self & size)
