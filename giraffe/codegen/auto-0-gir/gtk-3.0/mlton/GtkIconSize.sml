structure GtkIconSize :>
  ...
  struct
    ...
    val null = INVALID
    val fromName_ = _import "mlton_gtk_icon_size_from_name" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Int.C.val_;
    val getName_ = _import "gtk_icon_size_get_name" : FFI.Int.C.val_ -> Utf8.C.notnull Utf8.C.out_p;
    val lookup_ =
      fn
        x1
         & x2
    ...
    fun registerAlias alias target = (Utf8.C.withPtr &&&> FFI.Int.C.withVal ---> I) registerAlias_ (alias & target)
  end
