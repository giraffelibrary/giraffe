structure GtkIconSize :>
  ...
  struct
    ...
    val fromName_ = _import "mlton_gtk_icon_size_from_name" : Utf8.MLton.p1 * Utf8.FFI.non_opt Utf8.MLton.p2 -> GInt.FFI.val_;
    val getName_ = _import "gtk_icon_size_get_name" : GInt.FFI.val_ -> Utf8.FFI.non_opt Utf8.FFI.out_p;
    val lookup_ =
      fn
        x1
         & x2
    ...
    fun fromName name = (Utf8.FFI.withPtr 0 ---> GInt.FFI.fromVal) fromName_ name
    ...
    fun registerAlias (alias, target) = (Utf8.FFI.withPtr 0 &&&> GInt.FFI.withVal ---> I) registerAlias_ (alias & target)
  end
