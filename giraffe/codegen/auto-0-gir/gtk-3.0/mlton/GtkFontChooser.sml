structure GtkFontChooser :>
  ...
  struct
    ...
    val getFontMap_ = _import "gtk_font_chooser_get_font_map" : GtkFontChooserClass.FFI.notnull GtkFontChooserClass.FFI.p -> PangoFontMapClass.FFI.notnull PangoFontMapClass.FFI.p;
