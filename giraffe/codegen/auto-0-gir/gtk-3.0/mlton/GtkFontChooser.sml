structure GtkFontChooser :>
  ...
  struct
    ...
    val getFontSize_ = _import "gtk_font_chooser_get_font_size" : GtkFontChooserClass.C.notnull GtkFontChooserClass.C.p -> FFI.Int.C.val_;
    ...
    fun getFontSize self = (GtkFontChooserClass.C.withPtr ---> FFI.Int.C.fromVal) getFontSize_ self
