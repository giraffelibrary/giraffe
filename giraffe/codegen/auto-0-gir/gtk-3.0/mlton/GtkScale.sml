structure GtkScale :>
  ...
  struct
    ...
    val getDigits_ = _import "gtk_scale_get_digits" : GtkScaleClass.FFI.non_opt GtkScaleClass.FFI.p -> GInt.FFI.val_;
    ...
    val setDigits_ = fn x1 & x2 => (_import "gtk_scale_set_digits" : GtkScaleClass.FFI.non_opt GtkScaleClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
