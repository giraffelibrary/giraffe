structure GtkTreeDragSource :>
  ...
  struct
    ...
    val dragDataDelete_ = fn x1 & x2 => (_import "gtk_tree_drag_source_drag_data_delete" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p -> FFI.Bool.C.val_;) (x1, x2)
