structure GtkRevealer :>
  ...
  struct
    ...
    val getTransitionDuration_ = _import "gtk_revealer_get_transition_duration" : GtkRevealerClass.FFI.notnull GtkRevealerClass.FFI.p -> GUInt.FFI.val_;
    ...
    val setTransitionDuration_ = fn x1 & x2 => (_import "gtk_revealer_set_transition_duration" : GtkRevealerClass.FFI.notnull GtkRevealerClass.FFI.p * GUInt.FFI.val_ -> unit;) (x1, x2)
