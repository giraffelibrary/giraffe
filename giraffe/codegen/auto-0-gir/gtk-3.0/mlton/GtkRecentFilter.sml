structure GtkRecentFilter :>
  ...
  struct
    ...
    val addAge_ = fn x1 & x2 => (_import "gtk_recent_filter_add_age" : GtkRecentFilterClass.C.notnull GtkRecentFilterClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
    val addApplication_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    fun addAge self days = (GtkRecentFilterClass.C.withPtr &&&> FFI.Int.C.withVal ---> I) addAge_ (self & days)
