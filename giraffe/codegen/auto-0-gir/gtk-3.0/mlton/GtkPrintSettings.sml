structure GtkPrintSettings :>
  ...
  struct
    ...
    val getNCopies_ = _import "gtk_print_settings_get_n_copies" : GtkPrintSettingsClass.FFI.notnull GtkPrintSettingsClass.FFI.p -> GInt.FFI.val_;
    val getNumberUp_ = _import "gtk_print_settings_get_number_up" : GtkPrintSettingsClass.FFI.notnull GtkPrintSettingsClass.FFI.p -> GInt.FFI.val_;
    ...
    val getResolution_ = _import "gtk_print_settings_get_resolution" : GtkPrintSettingsClass.FFI.notnull GtkPrintSettingsClass.FFI.p -> GInt.FFI.val_;
    val getResolutionX_ = _import "gtk_print_settings_get_resolution_x" : GtkPrintSettingsClass.FFI.notnull GtkPrintSettingsClass.FFI.p -> GInt.FFI.val_;
    val getResolutionY_ = _import "gtk_print_settings_get_resolution_y" : GtkPrintSettingsClass.FFI.notnull GtkPrintSettingsClass.FFI.p -> GInt.FFI.val_;
    ...
    val setNCopies_ = fn x1 & x2 => (_import "gtk_print_settings_set_n_copies" : GtkPrintSettingsClass.FFI.notnull GtkPrintSettingsClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    val setNumberUp_ = fn x1 & x2 => (_import "gtk_print_settings_set_number_up" : GtkPrintSettingsClass.FFI.notnull GtkPrintSettingsClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    ...
    val setResolution_ = fn x1 & x2 => (_import "gtk_print_settings_set_resolution" : GtkPrintSettingsClass.FFI.notnull GtkPrintSettingsClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
