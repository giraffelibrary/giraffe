structure GtkContainer :>
  ...
  struct
    ...
    val getBorderWidth_ = _import "gtk_container_get_border_width" : GtkContainerClass.C.notnull GtkContainerClass.C.p -> FFI.UInt.C.val_;
    ...
    val setBorderWidth_ = fn x1 & x2 => (_import "gtk_container_set_border_width" : GtkContainerClass.C.notnull GtkContainerClass.C.p * FFI.UInt.C.val_ -> unit;) (x1, x2)
