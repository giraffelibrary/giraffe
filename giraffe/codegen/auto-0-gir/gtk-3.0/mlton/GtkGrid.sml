structure GtkGrid :>
  ...
  struct
    ...
    val getColumnSpacing_ = _import "gtk_grid_get_column_spacing" : GtkGridClass.C.notnull GtkGridClass.C.p -> FFI.UInt.C.val_;
    val getRowHomogeneous_ = _import "gtk_grid_get_row_homogeneous" : GtkGridClass.C.notnull GtkGridClass.C.p -> FFI.Bool.C.val_;
    val getRowSpacing_ = _import "gtk_grid_get_row_spacing" : GtkGridClass.C.notnull GtkGridClass.C.p -> FFI.UInt.C.val_;
    val insertColumn_ = fn x1 & x2 => (_import "gtk_grid_insert_column" : GtkGridClass.C.notnull GtkGridClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
    val insertNextTo_ =
      fn
        x1
         & x2
    ...
    val insertRow_ = fn x1 & x2 => (_import "gtk_grid_insert_row" : GtkGridClass.C.notnull GtkGridClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
    ...
    val setColumnSpacing_ = fn x1 & x2 => (_import "gtk_grid_set_column_spacing" : GtkGridClass.C.notnull GtkGridClass.C.p * FFI.UInt.C.val_ -> unit;) (x1, x2)
    ...
    val setRowSpacing_ = fn x1 & x2 => (_import "gtk_grid_set_row_spacing" : GtkGridClass.C.notnull GtkGridClass.C.p * FFI.UInt.C.val_ -> unit;) (x1, x2)
