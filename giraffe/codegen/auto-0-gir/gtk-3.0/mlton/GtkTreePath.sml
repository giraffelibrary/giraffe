structure GtkTreePath :>
  ...
  struct
    ...
    val appendIndex_ = fn x1 & x2 => (_import "gtk_tree_path_append_index" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
    val compare_ = fn x1 & x2 => (_import "gtk_tree_path_compare" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p * GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p -> FFI.Int.C.val_;) (x1, x2)
    ...
    val getDepth_ = _import "gtk_tree_path_get_depth" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p -> FFI.Int.C.val_;
    ...
    val prependIndex_ = fn x1 & x2 => (_import "gtk_tree_path_prepend_index" : GtkTreePathRecord.C.notnull GtkTreePathRecord.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
