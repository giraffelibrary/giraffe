structure GtkNotebookPageAccessible :>
  ...
  struct
    ...
    val new_ = fn x1 & x2 => (_import "gtk_notebook_page_accessible_new" : GtkNotebookAccessibleClass.FFI.notnull GtkNotebookAccessibleClass.FFI.p * GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> AtkObjectClass.FFI.notnull AtkObjectClass.FFI.p;) (x1, x2)
    val invalidate_ = _import "gtk_notebook_page_accessible_invalidate" : GtkNotebookPageAccessibleClass.FFI.notnull GtkNotebookPageAccessibleClass.FFI.p -> unit;
