structure GtkEntryCompletion :>
  ...
  struct
    ...
    val deleteAction_ = fn x1 & x2 => (_import "gtk_entry_completion_delete_action" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
    val getCompletionPrefix_ = _import "gtk_entry_completion_get_completion_prefix" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val getMinimumKeyLength_ = _import "gtk_entry_completion_get_minimum_key_length" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int.C.val_;
    ...
    val getTextColumn_ = _import "gtk_entry_completion_get_text_column" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int.C.val_;
    ...
    val setMinimumKeyLength_ = fn x1 & x2 => (_import "gtk_entry_completion_set_minimum_key_length" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
