structure GtkEntryCompletion :>
  ...
  struct
    ...
    val deleteAction_ = fn x1 & x2 => (_import "gtk_entry_completion_delete_action" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
    ...
    val getMinimumKeyLength_ = _import "gtk_entry_completion_get_minimum_key_length" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> FFI.Int.C.val_;
    ...
    val getTextColumn_ = _import "gtk_entry_completion_get_text_column" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> FFI.Int.C.val_;
    ...
    val setMinimumKeyLength_ = fn x1 & x2 => (_import "gtk_entry_completion_set_minimum_key_length" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
    ...
    val setTextColumn_ = fn x1 & x2 => (_import "gtk_entry_completion_set_text_column" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
