structure GtkToolItem :>
  ...
  struct
    ...
    val getIconSize_ = _import "gtk_tool_item_get_icon_size" : GtkToolItemClass.C.notnull GtkToolItemClass.C.p -> FFI.Int.C.val_;
    ...
    fun getIconSize self = (GtkToolItemClass.C.withPtr ---> FFI.Int.C.fromVal) getIconSize_ self
