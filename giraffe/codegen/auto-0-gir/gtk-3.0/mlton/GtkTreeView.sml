structure GtkTreeView :>
  ...
  struct
    ...
    val appendColumn_ = fn x1 & x2 => (_import "gtk_tree_view_append_column" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p * GtkTreeViewColumnClass.FFI.notnull GtkTreeViewColumnClass.FFI.p -> GInt.FFI.val_;) (x1, x2)
    ...
    val getActivateOnSingleClick_ = _import "gtk_tree_view_get_activate_on_single_click" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p -> GBool.FFI.val_;
    ...
    val getHadjustment_ = _import "gtk_tree_view_get_hadjustment" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p -> GtkAdjustmentClass.FFI.notnull GtkAdjustmentClass.FFI.p;
    ...
    val getSearchColumn_ = _import "gtk_tree_view_get_search_column" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p -> GInt.FFI.val_;
    ...
    val getTooltipColumn_ = _import "gtk_tree_view_get_tooltip_column" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p -> GInt.FFI.val_;
    ...
    val getVadjustment_ = _import "gtk_tree_view_get_vadjustment" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p -> GtkAdjustmentClass.FFI.notnull GtkAdjustmentClass.FFI.p;
    ...
    val getVisibleRect_ = fn x1 & x2 => (_import "gtk_tree_view_get_visible_rect" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p * GdkRectangleRecord.FFI.notnull GdkRectangleRecord.FFI.p -> unit;) (x1, x2)
    val insertColumn_ =
      fn
        x1
         & x2
    ...
    val removeColumn_ = fn x1 & x2 => (_import "gtk_tree_view_remove_column" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p * GtkTreeViewColumnClass.FFI.notnull GtkTreeViewColumnClass.FFI.p -> GInt.FFI.val_;) (x1, x2)
    val rowActivated_ =
      fn
        x1
         & x2
    ...
    val setActivateOnSingleClick_ = fn x1 & x2 => (_import "gtk_tree_view_set_activate_on_single_click" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p * GBool.FFI.val_ -> unit;) (x1, x2)
    val setCursor_ =
      fn
        x1
         & x2
    ...
    val setHadjustment_ = fn x1 & x2 => (_import "gtk_tree_view_set_hadjustment" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p * unit GtkAdjustmentClass.FFI.p -> unit;) (x1, x2)
    ...
    val setLevelIndentation_ = fn x1 & x2 => (_import "gtk_tree_view_set_level_indentation" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    ...
    val setSearchColumn_ = fn x1 & x2 => (_import "gtk_tree_view_set_search_column" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    ...
    val setTooltipColumn_ = fn x1 & x2 => (_import "gtk_tree_view_set_tooltip_column" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    val setTooltipRow_ =
      fn
        x1
         & x2
    ...
    val setVadjustment_ = fn x1 & x2 => (_import "gtk_tree_view_set_vadjustment" : GtkTreeViewClass.FFI.notnull GtkTreeViewClass.FFI.p * unit GtkAdjustmentClass.FFI.p -> unit;) (x1, x2)
