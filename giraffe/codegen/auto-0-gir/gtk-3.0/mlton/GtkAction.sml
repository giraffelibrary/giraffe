structure GtkAction :>
  ...
  struct
    ...
    val createIcon_ = fn x1 & x2 => (_import "gtk_action_create_icon" : GtkActionClass.C.notnull GtkActionClass.C.p * FFI.Int.C.val_ -> GtkWidgetClass.C.notnull GtkWidgetClass.C.p;) (x1, x2)
    ...
    fun createIcon self iconSize = (GtkActionClass.C.withPtr &&&> FFI.Int.C.withVal ---> GtkWidgetClass.C.fromPtr false) createIcon_ (self & iconSize)
