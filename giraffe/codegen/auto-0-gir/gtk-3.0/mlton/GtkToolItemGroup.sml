structure GtkToolItemGroup :>
  ...
  struct
    ...
    val getItemPosition_ = fn x1 & x2 => (_import "gtk_tool_item_group_get_item_position" : GtkToolItemGroupClass.C.notnull GtkToolItemGroupClass.C.p * GtkToolItemClass.C.notnull GtkToolItemClass.C.p -> FFI.Int.C.val_;) (x1, x2)
    ...
    val getNItems_ = _import "gtk_tool_item_group_get_n_items" : GtkToolItemGroupClass.C.notnull GtkToolItemGroupClass.C.p -> FFI.UInt.C.val_;
    val getNthItem_ = fn x1 & x2 => (_import "gtk_tool_item_group_get_nth_item" : GtkToolItemGroupClass.C.notnull GtkToolItemGroupClass.C.p * FFI.UInt.C.val_ -> GtkToolItemClass.C.notnull GtkToolItemClass.C.p;) (x1, x2)
    val insert_ =
      fn
        x1
         & x2
