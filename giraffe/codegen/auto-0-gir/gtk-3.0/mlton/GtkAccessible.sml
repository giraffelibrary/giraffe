structure GtkAccessible :>
  ...
  struct
    ...
    val setWidget_ = fn x1 & x2 => (_import "gtk_accessible_set_widget" : GtkAccessibleClass.FFI.notnull GtkAccessibleClass.FFI.p * GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> unit;) (x1, x2)
