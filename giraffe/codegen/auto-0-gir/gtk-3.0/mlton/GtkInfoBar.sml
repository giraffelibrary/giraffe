structure GtkInfoBar :>
  ...
  struct
    ...
    val response_ = fn x1 & x2 => (_import "gtk_info_bar_response" : GtkInfoBarClass.C.notnull GtkInfoBarClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
    val setDefaultResponse_ = fn x1 & x2 => (_import "gtk_info_bar_set_default_response" : GtkInfoBarClass.C.notnull GtkInfoBarClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
