structure GtkFlowBoxChild :>
  ...
  struct
    ...
    val getIndex_ = _import "gtk_flow_box_child_get_index" : GtkFlowBoxChildClass.FFI.notnull GtkFlowBoxChildClass.FFI.p -> GInt.FFI.val_;
    ...
    fun getIndex self = (GtkFlowBoxChildClass.FFI.withPtr ---> GInt.FFI.fromVal) getIndex_ self
