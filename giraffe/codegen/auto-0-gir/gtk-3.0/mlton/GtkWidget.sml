structure GtkWidget :>
  ...
  struct
    ...
    val addEvents_ = fn x1 & x2 => (_import "gtk_widget_add_events" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    ...
    val canActivateAccel_ = fn x1 & x2 => (_import "gtk_widget_can_activate_accel" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GUInt.FFI.val_ -> GBool.FFI.val_;) (x1, x2)
    ...
    val dragDestGetTargetList_ = _import "gtk_drag_dest_get_target_list" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GtkTargetListRecord.FFI.notnull GtkTargetListRecord.FFI.p;
    ...
    val dragSourceGetTargetList_ = _import "gtk_drag_source_get_target_list" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GtkTargetListRecord.FFI.notnull GtkTargetListRecord.FFI.p;
    val dragSourceSet_ =
      fn
        x1
         & x2
    ...
    val getAllocatedBaseline_ = _import "gtk_widget_get_allocated_baseline" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GInt.FFI.val_;
    val getAllocatedHeight_ = _import "gtk_widget_get_allocated_height" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GInt.FFI.val_;
         ...
         & x3 =>
          (
            _import "gtk_widget_get_allocated_size" :
              GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p
               * GtkAllocationRecord.FFI.notnull GtkAllocationRecord.FFI.p
               * GInt.FFI.ref_
               -> unit;
          )
            (
    ...
    val getClip_ = fn x1 & x2 => (_import "gtk_widget_get_clip" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GtkAllocationRecord.FFI.notnull GtkAllocationRecord.FFI.p -> unit;) (x1, x2)
    ...
    val getEvents_ = _import "gtk_widget_get_events" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GInt.FFI.val_;
    ...
    val getFontMap_ = _import "gtk_widget_get_font_map" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> PangoFontMapClass.FFI.notnull PangoFontMapClass.FFI.p;
    val getFontOptions_ = _import "gtk_widget_get_font_options" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> CairoFontOptionsRecord.FFI.notnull CairoFontOptionsRecord.FFI.p;
    val getFrameClock_ = _import "gtk_widget_get_frame_clock" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GdkFrameClockClass.FFI.notnull GdkFrameClockClass.FFI.p;
    ...
    val getMarginBottom_ = _import "gtk_widget_get_margin_bottom" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GInt.FFI.val_;
    val getMarginEnd_ = _import "gtk_widget_get_margin_end" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GInt.FFI.val_;
    val getMarginLeft_ = _import "gtk_widget_get_margin_left" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GInt.FFI.val_;
    val getMarginRight_ = _import "gtk_widget_get_margin_right" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GInt.FFI.val_;
    val getMarginStart_ = _import "gtk_widget_get_margin_start" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GInt.FFI.val_;
    val getMarginTop_ = _import "gtk_widget_get_margin_top" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GInt.FFI.val_;
    ...
    val getParent_ = _import "gtk_widget_get_parent" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p;
    ...
    val getScaleFactor_ = _import "gtk_widget_get_scale_factor" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GInt.FFI.val_;
    ...
    val getWindow_ = _import "gtk_widget_get_window" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GdkWindowClass.FFI.notnull GdkWindowClass.FFI.p;
    ...
    val removeTickCallback_ = fn x1 & x2 => (_import "gtk_widget_remove_tick_callback" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GUInt.FFI.val_ -> unit;) (x1, x2)
    val renderIcon_ =
      fn
        x1
         & (x2, x3)
    ...
    val sendExpose_ = fn x1 & x2 => (_import "gtk_widget_send_expose" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GdkEvent.FFI.notnull GdkEvent.FFI.p -> GInt.FFI.val_;) (x1, x2)
    ...
    val setAllocation_ = fn x1 & x2 => (_import "gtk_widget_set_allocation" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GtkAllocationRecord.FFI.notnull GtkAllocationRecord.FFI.p -> unit;) (x1, x2)
    ...
    val setClip_ = fn x1 & x2 => (_import "gtk_widget_set_clip" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GtkAllocationRecord.FFI.notnull GtkAllocationRecord.FFI.p -> unit;) (x1, x2)
    ...
    val setEvents_ = fn x1 & x2 => (_import "gtk_widget_set_events" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    ...
    val setMarginBottom_ = fn x1 & x2 => (_import "gtk_widget_set_margin_bottom" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    val setMarginEnd_ = fn x1 & x2 => (_import "gtk_widget_set_margin_end" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    val setMarginLeft_ = fn x1 & x2 => (_import "gtk_widget_set_margin_left" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    val setMarginRight_ = fn x1 & x2 => (_import "gtk_widget_set_margin_right" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    val setMarginStart_ = fn x1 & x2 => (_import "gtk_widget_set_margin_start" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    val setMarginTop_ = fn x1 & x2 => (_import "gtk_widget_set_margin_top" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    val setName_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    fun getClip self =
      let
        val clip & () = (GtkWidgetClass.FFI.withPtr &&&> GtkAllocationRecord.FFI.withNewPtr ---> GtkAllocationRecord.FFI.fromPtr true && I) getClip_ (self & ())
      in
        clip
      end
    ...
    fun getMarginEnd self = (GtkWidgetClass.FFI.withPtr ---> GInt.FFI.fromVal) getMarginEnd_ self
    ...
    fun getMarginStart self = (GtkWidgetClass.FFI.withPtr ---> GInt.FFI.fromVal) getMarginStart_ self
    ...
    fun getScaleFactor self = (GtkWidgetClass.FFI.withPtr ---> GInt.FFI.fromVal) getScaleFactor_ self
    ...
    fun removeTickCallback self id = (GtkWidgetClass.FFI.withPtr &&&> GUInt.FFI.withVal ---> I) removeTickCallback_ (self & id)
    fun renderIcon
      self
      (
        stockId,
    ...
    fun setClip self clip = (GtkWidgetClass.FFI.withPtr &&&> GtkAllocationRecord.FFI.withPtr ---> I) setClip_ (self & clip)
    ...
    fun setMarginEnd self margin = (GtkWidgetClass.FFI.withPtr &&&> GInt.FFI.withVal ---> I) setMarginEnd_ (self & margin)
    ...
    fun setMarginStart self margin = (GtkWidgetClass.FFI.withPtr &&&> GInt.FFI.withVal ---> I) setMarginStart_ (self & margin)
    ...
    fun sizeAllocateWithBaseline self (allocation, baseline) =
      (
        GtkWidgetClass.FFI.withPtr
         &&&> GtkAllocationRecord.FFI.withPtr
         &&&> GInt.FFI.withVal
         ---> I
      )
