structure GtkListBox :>
  ...
  struct
    ...
    val getRowAtIndex_ = fn x1 & x2 => (_import "gtk_list_box_get_row_at_index" : GtkListBoxClass.FFI.non_opt GtkListBoxClass.FFI.p * GInt.FFI.val_ -> GtkListBoxRowClass.FFI.opt GtkListBoxRowClass.FFI.p;) (x1, x2)
    val getRowAtY_ = fn x1 & x2 => (_import "gtk_list_box_get_row_at_y" : GtkListBoxClass.FFI.non_opt GtkListBoxClass.FFI.p * GInt.FFI.val_ -> GtkListBoxRowClass.FFI.opt GtkListBoxRowClass.FFI.p;) (x1, x2)
    ...
    fun getRowAtIndex self index = (GtkListBoxClass.FFI.withPtr false &&&> GInt.FFI.withVal ---> GtkListBoxRowClass.FFI.fromOptPtr false) getRowAtIndex_ (self & index) before GtkListBoxClass.FFI.touchPtr self
    fun getRowAtY self y = (GtkListBoxClass.FFI.withPtr false &&&> GInt.FFI.withVal ---> GtkListBoxRowClass.FFI.fromOptPtr false) getRowAtY_ (self & y) before GtkListBoxClass.FFI.touchPtr self
