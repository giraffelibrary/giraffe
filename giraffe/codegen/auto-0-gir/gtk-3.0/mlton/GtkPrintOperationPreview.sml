structure GtkPrintOperationPreview :>
  ...
  struct
    ...
    val isSelected_ = fn x1 & x2 => (_import "gtk_print_operation_preview_is_selected" : GtkPrintOperationPreviewClass.FFI.non_opt GtkPrintOperationPreviewClass.FFI.p * GInt.FFI.val_ -> GBool.FFI.val_;) (x1, x2)
    val renderPage_ = fn x1 & x2 => (_import "gtk_print_operation_preview_render_page" : GtkPrintOperationPreviewClass.FFI.non_opt GtkPrintOperationPreviewClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    ...
    fun isSelected self pageNr = (GtkPrintOperationPreviewClass.FFI.withPtr false &&&> GInt.FFI.withVal ---> GBool.FFI.fromVal) isSelected_ (self & pageNr)
    fun renderPage self pageNr = (GtkPrintOperationPreviewClass.FFI.withPtr false &&&> GInt.FFI.withVal ---> I) renderPage_ (self & pageNr)
    local
