structure GdkPixbufPixbufAnimationIter :>
  ...
  struct
    ...
    val getDelayTime_ = _import "gdk_pixbuf_animation_iter_get_delay_time" : GdkPixbufPixbufAnimationIterClass.C.notnull GdkPixbufPixbufAnimationIterClass.C.p -> FFI.Int.C.val_;
