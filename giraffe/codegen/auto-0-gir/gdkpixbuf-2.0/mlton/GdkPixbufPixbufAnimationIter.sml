structure GdkPixbufPixbufAnimationIter :>
  ...
  struct
    ...
    val advance_ = fn x1 & x2 => (_import "gdk_pixbuf_animation_iter_advance" : GdkPixbufPixbufAnimationIterClass.FFI.notnull GdkPixbufPixbufAnimationIterClass.FFI.p * GLibTimeValRecord.FFI.notnull GLibTimeValRecord.FFI.p -> GBool.FFI.val_;) (x1, x2)
