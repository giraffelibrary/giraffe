structure GModule : G_MODULE =
  struct
    ...
    in
      ...
      val moduleError_ = call (getSymbol "g_module_error") (PolyMLFFI.cVoid --> Utf8.PolyML.cOutPtr)
      val moduleSupported_ = call (getSymbol "g_module_supported") (PolyMLFFI.cVoid --> GBool.PolyML.cVal)
    end
