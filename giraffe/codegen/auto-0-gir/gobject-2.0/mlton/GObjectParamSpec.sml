structure GObjectParamSpec :>
  ...
  struct
    ...
    val getDefaultValue_ = _import "g_param_spec_get_default_value" : GObjectParamSpecClass.FFI.notnull GObjectParamSpecClass.FFI.p -> GObjectValueRecord.FFI.notnull GObjectValueRecord.FFI.p;
    ...
    val getNameQuark_ = _import "g_param_spec_get_name_quark" : GObjectParamSpecClass.FFI.notnull GObjectParamSpecClass.FFI.p -> GLibQuark.FFI.val_;
    ...
    fun getNameQuark self = (GObjectParamSpecClass.FFI.withPtr ---> GLibQuark.FFI.fromVal) getNameQuark_ self
