structure GObjectValueArray :>
  ...
  struct
    ...
    val new_ = _import "g_value_array_new" : GUInt.FFI.val_ -> GObjectValueArrayRecord.FFI.non_opt GObjectValueArrayRecord.FFI.p;
    ...
    val getNth_ = fn x1 & x2 => (_import "g_value_array_get_nth" : GObjectValueArrayRecord.FFI.non_opt GObjectValueArrayRecord.FFI.p * GUInt.FFI.val_ -> GObjectValueRecord.FFI.non_opt GObjectValueRecord.FFI.p;) (x1, x2)
    val insert_ =
      fn
        x1
         & x2
    ...
    val remove_ = fn x1 & x2 => (_import "g_value_array_remove" : GObjectValueArrayRecord.FFI.non_opt GObjectValueArrayRecord.FFI.p * GUInt.FFI.val_ -> GObjectValueArrayRecord.FFI.non_opt GObjectValueArrayRecord.FFI.p;) (x1, x2)
