...
use "GDK_EVENT_PAD_AXIS_RECORD.sml";
use "GDK_EVENT_PAD_BUTTON_RECORD.sml";
use "GDK_EVENT_PAD_GROUP_MODE_RECORD.sml";
...
use "GDK_DEVICE_PAD_CLASS.sml";
use "GDK_DEVICE_PAD.sml";
use "GDK_DEVICE_PAD_FEATURE.sml";
use "GDK_DEVICE_TOOL_CLASS.sml";
use "GDK_DEVICE_TOOL.sml";
use "GDK_DEVICE_TOOL_TYPE.sml";
...
use "GDK_DRAG_CANCEL_REASON.sml";
use "GDK_DRAG_CONTEXT_CLASS.sml";
use "GDK_DRAG_CONTEXT.sml";
use "GDK_DRAG_PROTOCOL.sml";
use "GDK_DRAWING_CONTEXT_CLASS.sml";
use "GDK_DRAWING_CONTEXT.sml";
use "GDK_EVENT.sml";
use "GDK_EVENT_MASK.sml";
use "GDK_EVENT_SEQUENCE_RECORD.sml";
use "GDK_EVENT_SEQUENCE.sml";
use "GDK_EVENT_TYPE.sml";
use "GDK_FILTER_RETURN.sml";
use "GDK_FRAME_CLOCK_CLASS.sml";
use "GDK_FRAME_CLOCK.sml";
use "GDK_FRAME_CLOCK_PHASE.sml";
use "GDK_FRAME_TIMINGS_RECORD.sml";
use "GDK_FRAME_TIMINGS.sml";
use "GDK_FULLSCREEN_MODE.sml";
use "GDK_G_L_CONTEXT_CLASS.sml";
use "GDK_G_L_CONTEXT.sml";
use "GDK_G_L_ERROR.sml";
...
use "GDK_MODIFIER_INTENT.sml";
use "GDK_MODIFIER_TYPE.sml";
use "GDK_MONITOR_CLASS.sml";
use "GDK_MONITOR.sml";
use "GDK_NOTIFY_TYPE.sml";
use "GDK_OWNER_CHANGE.sml";
use "GDK_POINT_RECORD.sml";
use "GDK_POINT.sml";
use "GDK_PROP_MODE.sml";
use "GDK_PROPERTY_STATE.sml";
use "GDK_RGBA_RECORD.sml";
use "GDK_RGBA.sml";
use "GDK_RECTANGLE_RECORD.sml";
use "GDK_RECTANGLE.sml";
use "GDK_SCREEN_CLASS.sml";
use "GDK_SCREEN.sml";
use "GDK_SCROLL_DIRECTION.sml";
use "GDK_SEAT_CLASS.sml";
use "GDK_SEAT.sml";
use "GDK_SEAT_CAPABILITIES.sml";
use "GDK_SETTING_ACTION.sml";
use "GDK_STATUS.sml";
use "GDK_SUBPIXEL_LAYOUT.sml";
use "GDK_TOUCHPAD_GESTURE_PHASE.sml";
