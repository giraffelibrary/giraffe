structure Gdk : GDK =
  struct
    ...
    in
      ...
      val cairoRectangle_ = call (getSymbol "gdk_cairo_rectangle") (CairoContextRecord.PolyML.cPtr &&> GdkRectangleRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      ...
      val errorTrapPop_ = call (getSymbol "gdk_error_trap_pop") (PolyMLFFI.cVoid --> GInt.PolyML.cVal)
      ...
      val init_ = call (getSymbol "gdk_init") (GInt.PolyML.cRef &&> Utf8CVectorN.PolyML.cInOutRef --> PolyMLFFI.cVoid)
      val initCheck_ = call (getSymbol "gdk_init_check") (GInt.PolyML.cRef &&> Utf8CVectorN.PolyML.cInOutRef --> GBool.PolyML.cVal)
      ...
      val keyvalName_ = call (getSymbol "gdk_keyval_name") (GUInt.PolyML.cVal --> Utf8.PolyML.cOutPtr)
      ...
      val parseArgs_ = call (getSymbol "gdk_parse_args") (GInt.PolyML.cRef &&> Utf8CVectorN.PolyML.cInOutRef --> PolyMLFFI.cVoid)
      ...
      val queryDepths_ = call (getSymbol "gdk_query_depths") (GIntCVectorN.PolyML.cOutRef &&> GInt.PolyML.cRef --> PolyMLFFI.cVoid)
      val queryVisualTypes_ = call (getSymbol "gdk_query_visual_types") (GdkVisualTypeCVectorN.PolyML.cOutRef &&> GInt.PolyML.cRef --> PolyMLFFI.cVoid)
      ...
      val setDoubleClickTime_ = call (getSymbol "gdk_set_double_click_time") (GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
