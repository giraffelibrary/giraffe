structure GdkEventSequenceRecord :> GDK_EVENT_SEQUENCE_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "gdk_event_sequence_copy") (cPtr --> cPtr)
      val free_ = call (getSymbol "gdk_event_sequence_free") (cPtr --> cVoid)
    end
    structure Record =
      BoxedRecord(
