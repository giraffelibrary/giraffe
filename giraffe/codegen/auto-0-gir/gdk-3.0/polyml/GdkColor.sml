structure GdkColor :>
  ...
  struct
    ...
    in
      ...
      val hash_ = call (load_sym libgdk "gdk_color_hash") (GdkColorRecord.PolyML.PTR --> FFI.UInt.PolyML.VAL)
      val toString_ = call (load_sym libgdk "gdk_color_to_string") (GdkColorRecord.PolyML.PTR --> FFI.String.PolyML.RETPTR)
      val parse_ = call (load_sym libgdk "gdk_color_parse") (FFI.String.PolyML.INPTR &&> GdkColorRecord.PolyML.PTR --> FFI.Bool.PolyML.VAL)
    end
