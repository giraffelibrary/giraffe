structure GdkColorRecord :> GDK_COLOR_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val new_ = call (getSymbol "giraffe_gdk_color_new") (cVoid --> cPtr)
      val copy_ = call (getSymbol "giraffe_gdk_color_copy") (cPtr &&> cPtr --> cVoid)
      val free_ = call (getSymbol "giraffe_gdk_color_free") (cPtr --> cVoid)
      val size_ = call (getSymbol "giraffe_gdk_color_size") (cVoid --> GUInt.PolyML.cVal)
    end
    structure Record =
      BoxedValueRecord(
