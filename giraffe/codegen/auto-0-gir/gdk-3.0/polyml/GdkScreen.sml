structure GdkScreen :>
  ...
  struct
    ...
    in
      ...
      val height_ = call (load_sym libgdk "gdk_screen_height") (PolyMLFFI.cVoid --> FFI.Int.PolyML.cVal)
      val heightMm_ = call (load_sym libgdk "gdk_screen_height_mm") (PolyMLFFI.cVoid --> FFI.Int.PolyML.cVal)
      val width_ = call (load_sym libgdk "gdk_screen_width") (PolyMLFFI.cVoid --> FFI.Int.PolyML.cVal)
      val widthMm_ = call (load_sym libgdk "gdk_screen_width_mm") (PolyMLFFI.cVoid --> FFI.Int.PolyML.cVal)
