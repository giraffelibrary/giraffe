structure GdkDisplay :>
  ...
  struct
    ...
    in
      ...
      val getMonitor_ = call (getSymbol "gdk_display_get_monitor") (GdkDisplayClass.PolyML.cPtr &&> GInt.PolyML.cVal --> GdkMonitorClass.PolyML.cOptPtr)
      ...
      val getNMonitors_ = call (getSymbol "gdk_display_get_n_monitors") (GdkDisplayClass.PolyML.cPtr --> GInt.PolyML.cVal)
        ...
        call (getSymbol "gdk_display_store_clipboard")
          (
            GdkDisplayClass.PolyML.cPtr
             ...
             &&> GUInt32.PolyML.cVal
             &&> GdkAtomRecordCArrayN.PolyML.cInOptPtr
             &&> GInt.PolyML.cVal
             --> cVoid
          )
