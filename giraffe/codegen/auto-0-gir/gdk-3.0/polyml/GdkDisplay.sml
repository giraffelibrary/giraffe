structure GdkDisplay :>
  ...
  struct
    ...
    in
      ...
      val open_ = call (load_sym libgdk "gdk_display_open") (Utf8.PolyML.INPTR --> GObjectObjectClass.PolyML.PTR)
      ...
      val getName_ = call (load_sym libgdk "gdk_display_get_name") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      ...
      val notifyStartupComplete_ = call (load_sym libgdk "gdk_display_notify_startup_complete") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INPTR --> FFI.PolyML.VOID)
