structure GdkDisplay :>
  ...
  struct
    ...
    in
      ...
      val setDoubleClickDistance_ = call (getSymbol "gdk_display_set_double_click_distance") (GdkDisplayClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setDoubleClickTime_ = call (getSymbol "gdk_display_set_double_click_time") (GdkDisplayClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val storeClipboard_ =
