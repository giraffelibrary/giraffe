structure GdkDisplay :>
  ...
  struct
    ...
    in
      ...
      val getDefaultCursorSize_ = call (load_sym libgdk "gdk_display_get_default_cursor_size") (GdkDisplayClass.PolyML.cPtr --> GUInt.PolyML.cVal)
      ...
      val getNScreens_ = call (load_sym libgdk "gdk_display_get_n_screens") (GdkDisplayClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getName_ = call (load_sym libgdk "gdk_display_get_name") (GdkDisplayClass.PolyML.cPtr --> Utf8.PolyML.cOutPtr)
      val getScreen_ = call (load_sym libgdk "gdk_display_get_screen") (GdkDisplayClass.PolyML.cPtr &&> GInt.PolyML.cVal --> GdkScreenClass.PolyML.cPtr)
      ...
      val setDoubleClickDistance_ = call (load_sym libgdk "gdk_display_set_double_click_distance") (GdkDisplayClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setDoubleClickTime_ = call (load_sym libgdk "gdk_display_set_double_click_time") (GdkDisplayClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val storeClipboard_ =
