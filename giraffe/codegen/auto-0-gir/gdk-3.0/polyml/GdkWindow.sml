structure GdkWindow :>
  ...
  struct
    ...
    in
      ...
      val getHeight_ = call (load_sym libgdk "gdk_window_get_height") (GdkWindowClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getWidth_ = call (load_sym libgdk "gdk_window_get_width") (GdkWindowClass.PolyML.cPtr --> GInt.PolyML.cVal)
