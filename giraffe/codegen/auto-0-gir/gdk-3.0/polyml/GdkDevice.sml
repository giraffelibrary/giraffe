structure GdkDevice :>
  ...
  struct
    ...
    in
      ...
      val getAxisUse_ = call (load_sym libgdk "gdk_device_get_axis_use") (GdkDeviceClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> GdkAxisUse.PolyML.cVal)
      ...
      val getNAxes_ = call (load_sym libgdk "gdk_device_get_n_axes") (GdkDeviceClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getNKeys_ = call (load_sym libgdk "gdk_device_get_n_keys") (GdkDeviceClass.PolyML.cPtr --> GInt.PolyML.cVal)
