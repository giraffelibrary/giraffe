structure GdkDrawingContext :>
  ...
  struct
    ...
    val getClip_ = _import "gdk_drawing_context_get_clip" : GdkDrawingContextClass.FFI.notnull GdkDrawingContextClass.FFI.p -> CairoRegionRecord.FFI.notnull CairoRegionRecord.FFI.p;
