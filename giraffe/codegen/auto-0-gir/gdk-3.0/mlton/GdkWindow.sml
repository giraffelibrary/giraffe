structure GdkWindow :>
  ...
  struct
    ...
    val beginPaintRect_ = fn x1 & x2 => (_import "gdk_window_begin_paint_rect" : GdkWindowClass.C.notnull GdkWindowClass.C.p * GdkRectangleRecord.C.notnull GdkRectangleRecord.C.p -> unit;) (x1, x2)
    ...
    val getFrameExtents_ = fn x1 & x2 => (_import "gdk_window_get_frame_extents" : GdkWindowClass.C.notnull GdkWindowClass.C.p * GdkRectangleRecord.C.notnull GdkRectangleRecord.C.p -> unit;) (x1, x2)
    val getGeometry_ =
      fn
        x1
         & x2
    ...
    val getHeight_ = _import "gdk_window_get_height" : GdkWindowClass.C.notnull GdkWindowClass.C.p -> FFI.Int.C.val_;
    ...
    val getWidth_ = _import "gdk_window_get_width" : GdkWindowClass.C.notnull GdkWindowClass.C.p -> FFI.Int.C.val_;
