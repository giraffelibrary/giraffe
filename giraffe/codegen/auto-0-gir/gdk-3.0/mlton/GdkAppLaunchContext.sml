structure GdkAppLaunchContext :>
  ...
  struct
    ...
    val setDesktop_ = fn x1 & x2 => (_import "gdk_app_launch_context_set_desktop" : GdkAppLaunchContextClass.C.notnull GdkAppLaunchContextClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
