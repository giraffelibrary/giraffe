structure GdkVisual :>
  ...
  struct
    ...
    val getBestWithBoth_ = fn x1 & x2 => (_import "gdk_visual_get_best_with_both" : GInt.FFI.val_ * GdkVisualType.FFI.val_ -> GdkVisualClass.FFI.notnull GdkVisualClass.FFI.p;) (x1, x2)
    val getBestWithDepth_ = _import "gdk_visual_get_best_with_depth" : GInt.FFI.val_ -> GdkVisualClass.FFI.notnull GdkVisualClass.FFI.p;
    ...
    val getBitsPerRgb_ = _import "gdk_visual_get_bits_per_rgb" : GdkVisualClass.FFI.notnull GdkVisualClass.FFI.p -> GInt.FFI.val_;
    ...
    val getColormapSize_ = _import "gdk_visual_get_colormap_size" : GdkVisualClass.FFI.notnull GdkVisualClass.FFI.p -> GInt.FFI.val_;
    val getDepth_ = _import "gdk_visual_get_depth" : GdkVisualClass.FFI.notnull GdkVisualClass.FFI.p -> GInt.FFI.val_;
