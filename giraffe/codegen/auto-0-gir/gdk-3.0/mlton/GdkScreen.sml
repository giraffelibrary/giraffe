structure GdkScreen :>
  ...
  struct
    ...
    val getHeight_ = _import "gdk_screen_get_height" : GdkScreenClass.FFI.non_opt GdkScreenClass.FFI.p -> GInt.FFI.val_;
    val getHeightMm_ = _import "gdk_screen_get_height_mm" : GdkScreenClass.FFI.non_opt GdkScreenClass.FFI.p -> GInt.FFI.val_;
    ...
    val getMonitorAtWindow_ = fn x1 & x2 => (_import "gdk_screen_get_monitor_at_window" : GdkScreenClass.FFI.non_opt GdkScreenClass.FFI.p * GdkWindowClass.FFI.non_opt GdkWindowClass.FFI.p -> GInt.FFI.val_;) (x1, x2)
    ...
    val getMonitorHeightMm_ = fn x1 & x2 => (_import "gdk_screen_get_monitor_height_mm" : GdkScreenClass.FFI.non_opt GdkScreenClass.FFI.p * GInt.FFI.val_ -> GInt.FFI.val_;) (x1, x2)
    val getMonitorPlugName_ = fn x1 & x2 => (_import "gdk_screen_get_monitor_plug_name" : GdkScreenClass.FFI.non_opt GdkScreenClass.FFI.p * GInt.FFI.val_ -> Utf8.FFI.opt Utf8.FFI.out_p;) (x1, x2)
    val getMonitorScaleFactor_ = fn x1 & x2 => (_import "gdk_screen_get_monitor_scale_factor" : GdkScreenClass.FFI.non_opt GdkScreenClass.FFI.p * GInt.FFI.val_ -> GInt.FFI.val_;) (x1, x2)
    val getMonitorWidthMm_ = fn x1 & x2 => (_import "gdk_screen_get_monitor_width_mm" : GdkScreenClass.FFI.non_opt GdkScreenClass.FFI.p * GInt.FFI.val_ -> GInt.FFI.val_;) (x1, x2)
    ...
    val getNMonitors_ = _import "gdk_screen_get_n_monitors" : GdkScreenClass.FFI.non_opt GdkScreenClass.FFI.p -> GInt.FFI.val_;
    val getNumber_ = _import "gdk_screen_get_number" : GdkScreenClass.FFI.non_opt GdkScreenClass.FFI.p -> GInt.FFI.val_;
    val getPrimaryMonitor_ = _import "gdk_screen_get_primary_monitor" : GdkScreenClass.FFI.non_opt GdkScreenClass.FFI.p -> GInt.FFI.val_;
    ...
    val getWidth_ = _import "gdk_screen_get_width" : GdkScreenClass.FFI.non_opt GdkScreenClass.FFI.p -> GInt.FFI.val_;
    val getWidthMm_ = _import "gdk_screen_get_width_mm" : GdkScreenClass.FFI.non_opt GdkScreenClass.FFI.p -> GInt.FFI.val_;
