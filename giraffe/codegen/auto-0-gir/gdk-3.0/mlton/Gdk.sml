structure Gdk : GDK =
  struct
    ...
    val keyvalFromName_ = _import "mlton_gdk_keyval_from_name" : Utf8.MLton.p1 * Utf8.FFI.non_opt Utf8.MLton.p2 -> GUInt.FFI.val_;
    ...
    val keyvalName_ = _import "gdk_keyval_name" : GUInt.FFI.val_ -> Utf8.FFI.opt Utf8.FFI.out_p;
