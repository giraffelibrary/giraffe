structure GdkFrameClock :>
  ...
  struct
    ...
    val getCurrentTimings_ = _import "gdk_frame_clock_get_current_timings" : GdkFrameClockClass.FFI.notnull GdkFrameClockClass.FFI.p -> GdkFrameTimingsRecord.FFI.notnull GdkFrameTimingsRecord.FFI.p;
    ...
    val getTimings_ = fn x1 & x2 => (_import "gdk_frame_clock_get_timings" : GdkFrameClockClass.FFI.notnull GdkFrameClockClass.FFI.p * GInt64.FFI.val_ -> GdkFrameTimingsRecord.FFI.notnull GdkFrameTimingsRecord.FFI.p;) (x1, x2)
