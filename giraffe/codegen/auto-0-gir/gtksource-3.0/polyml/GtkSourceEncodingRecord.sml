structure GtkSourceEncodingRecord :> GTK_SOURCE_ENCODING_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "gtk_source_encoding_copy") (cPtr --> cPtr)
      val free_ = call (getSymbol "gtk_source_encoding_free") (cPtr --> cVoid)
    end
    structure Record =
      BoxedRecord(
