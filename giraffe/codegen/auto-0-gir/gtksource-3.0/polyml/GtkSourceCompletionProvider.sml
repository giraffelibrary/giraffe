structure GtkSourceCompletionProvider :>
  ...
  struct
    ...
    in
      ...
      val getInteractiveDelay_ = call (load_sym libgtksourceview "gtk_source_completion_provider_get_interactive_delay") (GtkSourceCompletionProviderClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getPriority_ = call (load_sym libgtksourceview "gtk_source_completion_provider_get_priority") (GtkSourceCompletionProviderClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getStartIter_ =
