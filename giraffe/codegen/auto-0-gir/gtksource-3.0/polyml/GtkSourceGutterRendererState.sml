structure GtkSourceGutterRendererState :>
  sig
    include GTK_SOURCE_GUTTER_RENDERER_STATE
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtksourceview "gtk_source_gutter_renderer_state_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
