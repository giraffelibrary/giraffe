structure GtkSourceCompletionContext :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtksourceview "gtk_source_completion_context_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      ...
      val getIter_ = call (load_sym libgtksourceview "gtk_source_completion_context_get_iter") (GtkSourceCompletionContextClass.PolyML.cPtr &&> GtkTextIterRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
    end
