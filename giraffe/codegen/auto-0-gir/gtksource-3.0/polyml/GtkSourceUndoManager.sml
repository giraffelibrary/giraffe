structure GtkSourceUndoManager :>
  ...
  struct
    ...
    in
      ...
      val canRedo_ = call (load_sym libgtksourceview "gtk_source_undo_manager_can_redo") (GtkSourceUndoManagerClass.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val canUndo_ = call (load_sym libgtksourceview "gtk_source_undo_manager_can_undo") (GtkSourceUndoManagerClass.PolyML.cPtr --> GBool.PolyML.cVal)
