structure GtkSourcePrintCompositor :>
  ...
  struct
    ...
    in
      ...
      val getNPages_ = call (load_sym libgtksourceview "gtk_source_print_compositor_get_n_pages") (GtkSourcePrintCompositorClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getPrintLineNumbers_ = call (load_sym libgtksourceview "gtk_source_print_compositor_get_print_line_numbers") (GtkSourcePrintCompositorClass.PolyML.cPtr --> GUInt.PolyML.cVal)
      ...
      val getTabWidth_ = call (load_sym libgtksourceview "gtk_source_print_compositor_get_tab_width") (GtkSourcePrintCompositorClass.PolyML.cPtr --> GUInt.PolyML.cVal)
      ...
      val setPrintLineNumbers_ = call (load_sym libgtksourceview "gtk_source_print_compositor_set_print_line_numbers") (GtkSourcePrintCompositorClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setRightMargin_ =
      ...
      val setTabWidth_ = call (load_sym libgtksourceview "gtk_source_print_compositor_set_tab_width") (GtkSourcePrintCompositorClass.PolyML.cPtr &&> GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val setTopMargin_ =
