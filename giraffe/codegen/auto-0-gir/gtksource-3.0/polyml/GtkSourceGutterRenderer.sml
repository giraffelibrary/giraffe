structure GtkSourceGutterRenderer :>
  ...
  struct
    ...
    in
      ...
      val getSize_ = call (getSymbol "gtk_source_gutter_renderer_get_size") (GtkSourceGutterRendererClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val setSize_ = call (getSymbol "gtk_source_gutter_renderer_set_size") (GtkSourceGutterRendererClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
