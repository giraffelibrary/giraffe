structure GtkSourceCompletionActivation :> GTK_SOURCE_COMPLETION_ACTIVATION =
  struct
    local
      fun NONE () = 0w0
    in
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_source_completion_activation_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
