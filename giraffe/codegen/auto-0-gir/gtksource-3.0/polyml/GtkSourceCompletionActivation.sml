structure GtkSourceCompletionActivation :>
  sig
    include GTK_SOURCE_COMPLETION_ACTIVATION
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtksourceview "gtk_source_completion_activation_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
