structure GtkSourceLanguage :>
  ...
  struct
    ...
    in
      ...
      val getGlobs_ = call (getSymbol "gtk_source_language_get_globs") (GtkSourceLanguageClass.PolyML.cPtr --> Utf8CArray.PolyML.cOutOptPtr)
      ...
      val getMimeTypes_ = call (getSymbol "gtk_source_language_get_mime_types") (GtkSourceLanguageClass.PolyML.cPtr --> Utf8CArray.PolyML.cOutOptPtr)
      ...
      val getStyleIds_ = call (getSymbol "gtk_source_language_get_style_ids") (GtkSourceLanguageClass.PolyML.cPtr --> Utf8CArray.PolyML.cOutOptPtr)
