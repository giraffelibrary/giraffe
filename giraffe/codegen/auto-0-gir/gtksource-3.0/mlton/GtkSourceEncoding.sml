structure GtkSourceEncoding :>
  ...
  struct
    ...
    val getFromCharset_ = _import "mlton_gtk_source_encoding_get_from_charset" : Utf8.MLton.p1 * Utf8.FFI.notnull Utf8.MLton.p2 -> GtkSourceEncodingRecord.FFI.notnull GtkSourceEncodingRecord.FFI.p;
