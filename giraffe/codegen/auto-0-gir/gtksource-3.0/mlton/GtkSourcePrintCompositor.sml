structure GtkSourcePrintCompositor :>
  ...
  struct
    ...
    val getNPages_ = _import "gtk_source_print_compositor_get_n_pages" : GtkSourcePrintCompositorClass.FFI.non_opt GtkSourcePrintCompositorClass.FFI.p -> GInt.FFI.val_;
    ...
    val getPrintLineNumbers_ = _import "gtk_source_print_compositor_get_print_line_numbers" : GtkSourcePrintCompositorClass.FFI.non_opt GtkSourcePrintCompositorClass.FFI.p -> GUInt.FFI.val_;
    ...
    val getTabWidth_ = _import "gtk_source_print_compositor_get_tab_width" : GtkSourcePrintCompositorClass.FFI.non_opt GtkSourcePrintCompositorClass.FFI.p -> GUInt.FFI.val_;
    ...
    val setPrintLineNumbers_ = fn x1 & x2 => (_import "gtk_source_print_compositor_set_print_line_numbers" : GtkSourcePrintCompositorClass.FFI.non_opt GtkSourcePrintCompositorClass.FFI.p * GUInt.FFI.val_ -> unit;) (x1, x2)
    val setRightMargin_ =
      fn
        x1
         & x2
    ...
    val setTabWidth_ = fn x1 & x2 => (_import "gtk_source_print_compositor_set_tab_width" : GtkSourcePrintCompositorClass.FFI.non_opt GtkSourcePrintCompositorClass.FFI.p * GUInt.FFI.val_ -> unit;) (x1, x2)
    val setTopMargin_ =
      fn
        x1
         & x2
