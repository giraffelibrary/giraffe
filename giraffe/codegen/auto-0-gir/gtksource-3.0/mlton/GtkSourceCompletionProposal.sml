structure GtkSourceCompletionProposal :>
  ...
  struct
    ...
    val getGicon_ = _import "gtk_source_completion_proposal_get_gicon" : GtkSourceCompletionProposalClass.FFI.notnull GtkSourceCompletionProposalClass.FFI.p -> GioIconClass.FFI.notnull GioIconClass.FFI.p;
    ...
    val getIconName_ = _import "gtk_source_completion_proposal_get_icon_name" : GtkSourceCompletionProposalClass.FFI.notnull GtkSourceCompletionProposalClass.FFI.p -> Utf8.FFI.notnull Utf8.FFI.out_p;
