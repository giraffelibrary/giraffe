structure GtkSourceSearchContext :>
  ...
  struct
    ...
    val getOccurrencesCount_ = _import "gtk_source_search_context_get_occurrences_count" : GtkSourceSearchContextClass.FFI.non_opt GtkSourceSearchContextClass.FFI.p -> GInt.FFI.val_;
