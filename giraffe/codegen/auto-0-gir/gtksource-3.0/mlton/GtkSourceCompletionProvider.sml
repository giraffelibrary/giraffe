structure GtkSourceCompletionProvider :>
  ...
  struct
    ...
    val getInteractiveDelay_ = _import "gtk_source_completion_provider_get_interactive_delay" : GtkSourceCompletionProviderClass.FFI.non_opt GtkSourceCompletionProviderClass.FFI.p -> GInt.FFI.val_;
    ...
    val getPriority_ = _import "gtk_source_completion_provider_get_priority" : GtkSourceCompletionProviderClass.FFI.non_opt GtkSourceCompletionProviderClass.FFI.p -> GInt.FFI.val_;
    val getStartIter_ =
      fn
        x1
         & x2
