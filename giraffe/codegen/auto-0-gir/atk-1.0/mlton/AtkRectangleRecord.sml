structure AtkRectangleRecord :> ATK_RECTANGLE_RECORD =
  struct
    structure Pointer = CPointerInternal
    type notnull = Pointer.notnull
    type 'a p = 'a Pointer.p
    val new_ = _import "giraffe_atk_rectangle_new" : unit -> notnull p;
    val copy_ = fn x1 & x2 => (_import "giraffe_atk_rectangle_copy" : notnull p * notnull p -> unit;) (x1, x2)
    val free_ = _import "giraffe_atk_rectangle_free" : notnull p -> unit;
    val size_ = _import "giraffe_atk_rectangle_size" : unit -> GUInt.FFI.val_;
    structure Record =
      BoxedValueRecord(
