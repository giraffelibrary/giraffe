structure AtkHyperlink :>
  ...
  struct
    ...
    val getEndIndex_ = _import "atk_hyperlink_get_end_index" : AtkHyperlinkClass.C.notnull AtkHyperlinkClass.C.p -> FFI.Int.C.val_;
    val getNAnchors_ = _import "atk_hyperlink_get_n_anchors" : AtkHyperlinkClass.C.notnull AtkHyperlinkClass.C.p -> FFI.Int.C.val_;
    val getObject_ = fn x1 & x2 => (_import "atk_hyperlink_get_object" : AtkHyperlinkClass.C.notnull AtkHyperlinkClass.C.p * FFI.Int.C.val_ -> AtkObjectClass.C.notnull AtkObjectClass.C.p;) (x1, x2)
    val getStartIndex_ = _import "atk_hyperlink_get_start_index" : AtkHyperlinkClass.C.notnull AtkHyperlinkClass.C.p -> FFI.Int.C.val_;
    val getUri_ = fn x1 & x2 => (_import "atk_hyperlink_get_uri" : AtkHyperlinkClass.C.notnull AtkHyperlinkClass.C.p * FFI.Int.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
