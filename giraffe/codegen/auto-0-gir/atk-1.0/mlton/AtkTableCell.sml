structure AtkTableCell :>
  ...
  struct
    ...
    val getColumnSpan_ = _import "atk_table_cell_get_column_span" : AtkTableCellClass.FFI.non_opt AtkTableCellClass.FFI.p -> GInt.FFI.val_;
    val getPosition_ =
      fn
        x1
         & x2
    ...
    val getRowSpan_ = _import "atk_table_cell_get_row_span" : AtkTableCellClass.FFI.non_opt AtkTableCellClass.FFI.p -> GInt.FFI.val_;
