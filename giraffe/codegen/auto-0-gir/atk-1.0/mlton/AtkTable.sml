structure AtkTable :>
  ...
  struct
    ...
    val getColumnHeader_ = fn x1 & x2 => (_import "atk_table_get_column_header" : AtkTableClass.FFI.notnull AtkTableClass.FFI.p * GInt.FFI.val_ -> unit AtkObjectClass.FFI.p;) (x1, x2)
    val getIndexAt_ =
      fn
        x1
         & x2
    ...
    val getRowDescription_ = fn x1 & x2 => (_import "atk_table_get_row_description" : AtkTableClass.FFI.notnull AtkTableClass.FFI.p * GInt.FFI.val_ -> unit Utf8.FFI.out_p;) (x1, x2)
    val getRowExtentAt_ =
      fn
        x1
         & x2
    ...
    val getRowHeader_ = fn x1 & x2 => (_import "atk_table_get_row_header" : AtkTableClass.FFI.notnull AtkTableClass.FFI.p * GInt.FFI.val_ -> unit AtkObjectClass.FFI.p;) (x1, x2)
