structure AtkRelationSet :>
  ...
  struct
    ...
    val getNRelations_ = _import "atk_relation_set_get_n_relations" : AtkRelationSetClass.FFI.non_opt AtkRelationSetClass.FFI.p -> GInt.FFI.val_;
    val getRelation_ = fn x1 & x2 => (_import "atk_relation_set_get_relation" : AtkRelationSetClass.FFI.non_opt AtkRelationSetClass.FFI.p * GInt.FFI.val_ -> AtkRelationClass.FFI.non_opt AtkRelationClass.FFI.p;) (x1, x2)
    ...
    fun getNRelations self = (AtkRelationSetClass.FFI.withPtr false ---> GInt.FFI.fromVal) getNRelations_ self
    fun getRelation self i = (AtkRelationSetClass.FFI.withPtr false &&&> GInt.FFI.withVal ---> AtkRelationClass.FFI.fromPtr false) getRelation_ (self & i) before AtkRelationSetClass.FFI.touchPtr self
