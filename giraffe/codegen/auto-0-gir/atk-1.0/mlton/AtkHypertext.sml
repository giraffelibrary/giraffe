structure AtkHypertext :>
  ...
  struct
    ...
    val getLink_ = fn x1 & x2 => (_import "atk_hypertext_get_link" : AtkHypertextClass.FFI.notnull AtkHypertextClass.FFI.p * GInt.FFI.val_ -> AtkHyperlinkClass.FFI.notnull AtkHyperlinkClass.FFI.p;) (x1, x2)
    val getLinkIndex_ = fn x1 & x2 => (_import "atk_hypertext_get_link_index" : AtkHypertextClass.FFI.notnull AtkHypertextClass.FFI.p * GInt.FFI.val_ -> GInt.FFI.val_;) (x1, x2)
    val getNLinks_ = _import "atk_hypertext_get_n_links" : AtkHypertextClass.FFI.notnull AtkHypertextClass.FFI.p -> GInt.FFI.val_;
