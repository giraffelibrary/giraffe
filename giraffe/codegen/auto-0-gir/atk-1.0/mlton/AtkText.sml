structure AtkText :>
  ...
  struct
    ...
    val getCaretOffset_ = _import "atk_text_get_caret_offset" : AtkTextClass.FFI.non_opt AtkTextClass.FFI.p -> GInt.FFI.val_;
    val getCharacterAtOffset_ = fn x1 & x2 => (_import "atk_text_get_character_at_offset" : AtkTextClass.FFI.non_opt AtkTextClass.FFI.p * GInt.FFI.val_ -> GChar.FFI.val_;) (x1, x2)
    val getCharacterCount_ = _import "atk_text_get_character_count" : AtkTextClass.FFI.non_opt AtkTextClass.FFI.p -> GInt.FFI.val_;
    ...
    val getNSelections_ = _import "atk_text_get_n_selections" : AtkTextClass.FFI.non_opt AtkTextClass.FFI.p -> GInt.FFI.val_;
    ...
    val removeSelection_ = fn x1 & x2 => (_import "atk_text_remove_selection" : AtkTextClass.FFI.non_opt AtkTextClass.FFI.p * GInt.FFI.val_ -> GBool.FFI.val_;) (x1, x2)
    val setCaretOffset_ = fn x1 & x2 => (_import "atk_text_set_caret_offset" : AtkTextClass.FFI.non_opt AtkTextClass.FFI.p * GInt.FFI.val_ -> GBool.FFI.val_;) (x1, x2)
    val setSelection_ =
      fn
        x1
         & x2
