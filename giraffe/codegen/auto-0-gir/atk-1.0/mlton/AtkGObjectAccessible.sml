structure AtkGObjectAccessible :>
  ...
  struct
    ...
    val forObject_ = _import "atk_gobject_accessible_for_object" : GObjectObjectClass.FFI.notnull GObjectObjectClass.FFI.p -> AtkObjectClass.FFI.notnull AtkObjectClass.FFI.p;
    val getObject_ = _import "atk_gobject_accessible_get_object" : AtkGObjectAccessibleClass.FFI.notnull AtkGObjectAccessibleClass.FFI.p -> GObjectObjectClass.FFI.notnull GObjectObjectClass.FFI.p;
