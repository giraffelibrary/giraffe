structure AtkAction :>
  ...
  struct
    ...
    in
      ...
      val getDescription_ = call (load_sym libatk "atk_action_get_description") (GObjectObjectClass.PolyML.PTR &&> FFI.Int.PolyML.VAL --> Utf8.PolyML.RETPTR)
      val getKeybinding_ = call (load_sym libatk "atk_action_get_keybinding") (GObjectObjectClass.PolyML.PTR &&> FFI.Int.PolyML.VAL --> Utf8.PolyML.RETPTR)
      val getLocalizedName_ = call (load_sym libatk "atk_action_get_localized_name") (GObjectObjectClass.PolyML.PTR &&> FFI.Int.PolyML.VAL --> Utf8.PolyML.RETPTR)
      val getNActions_ = call (load_sym libatk "atk_action_get_n_actions") (GObjectObjectClass.PolyML.PTR --> FFI.Int.PolyML.VAL)
      val getName_ = call (load_sym libatk "atk_action_get_name") (GObjectObjectClass.PolyML.PTR &&> FFI.Int.PolyML.VAL --> Utf8.PolyML.RETPTR)
      val setDescription_ =
