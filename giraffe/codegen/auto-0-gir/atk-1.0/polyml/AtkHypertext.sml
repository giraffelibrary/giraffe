structure AtkHypertext :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "atk_hypertext_get_type") (cVoid --> GObjectType.PolyML.cVal)
    ...
    fun getLink self linkIndex = (AtkHypertextClass.FFI.withPtr false &&&> GInt.FFI.withVal ---> AtkHyperlinkClass.FFI.fromPtr false) getLink_ (self & linkIndex) before AtkHypertextClass.FFI.touchPtr self
