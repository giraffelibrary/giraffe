structure AtkSelection :>
  ...
  struct
    ...
    in
      ...
      val addSelection_ = call (load_sym libatk "atk_selection_add_selection") (AtkSelectionClass.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val clearSelection_ = call (load_sym libatk "atk_selection_clear_selection") (AtkSelectionClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getSelectionCount_ = call (load_sym libatk "atk_selection_get_selection_count") (AtkSelectionClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val isChildSelected_ = call (load_sym libatk "atk_selection_is_child_selected") (AtkSelectionClass.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
      val refSelection_ = call (load_sym libatk "atk_selection_ref_selection") (AtkSelectionClass.PolyML.cPtr &&> GInt.PolyML.cVal --> AtkObjectClass.PolyML.cPtr)
      val removeSelection_ = call (load_sym libatk "atk_selection_remove_selection") (AtkSelectionClass.PolyML.cPtr &&> GInt.PolyML.cVal --> GBool.PolyML.cVal)
