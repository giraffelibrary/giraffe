structure Atk : ATK =
  struct
    ...
    in
      ...
      val removeFocusTracker_ = call (load_sym libatk "atk_remove_focus_tracker") (GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val removeGlobalEventListener_ = call (load_sym libatk "atk_remove_global_event_listener") (GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val removeKeyEventListener_ = call (load_sym libatk "atk_remove_key_event_listener") (GUInt.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val textAttributeGetValue_ = call (load_sym libatk "atk_text_attribute_get_value") (AtkTextAttribute.PolyML.cVal &&> GInt.PolyML.cVal --> Utf8.PolyML.cOutPtr)
