structure Atk : ATK =
  struct
    ...
    in
      ...
      val relationTypeForName_ = call (load_sym libatk "atk_relation_type_for_name") (FFI.String.PolyML.INPTR --> AtkRelationType.PolyML.VAL)
      val relationTypeGetName_ = call (load_sym libatk "atk_relation_type_get_name") (AtkRelationType.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val relationTypeRegister_ = call (load_sym libatk "atk_relation_type_register") (FFI.String.PolyML.INPTR --> AtkRelationType.PolyML.VAL)
      val removeFocusTracker_ = call (load_sym libatk "atk_remove_focus_tracker") (FFI.UInt.PolyML.VAL --> FFI.PolyML.VOID)
      val removeGlobalEventListener_ = call (load_sym libatk "atk_remove_global_event_listener") (FFI.UInt.PolyML.VAL --> FFI.PolyML.VOID)
      val removeKeyEventListener_ = call (load_sym libatk "atk_remove_key_event_listener") (FFI.UInt.PolyML.VAL --> FFI.PolyML.VOID)
      val roleForName_ = call (load_sym libatk "atk_role_for_name") (FFI.String.PolyML.INPTR --> AtkRole.PolyML.VAL)
      val roleGetLocalizedName_ = call (load_sym libatk "atk_role_get_localized_name") (AtkRole.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val roleGetName_ = call (load_sym libatk "atk_role_get_name") (AtkRole.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val roleRegister_ = call (load_sym libatk "atk_role_register") (FFI.String.PolyML.INPTR --> AtkRole.PolyML.VAL)
      val stateTypeForName_ = call (load_sym libatk "atk_state_type_for_name") (FFI.String.PolyML.INPTR --> AtkStateType.PolyML.VAL)
      val stateTypeGetName_ = call (load_sym libatk "atk_state_type_get_name") (AtkStateType.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val stateTypeRegister_ = call (load_sym libatk "atk_state_type_register") (FFI.String.PolyML.INPTR --> AtkStateType.PolyML.VAL)
      val textAttributeForName_ = call (load_sym libatk "atk_text_attribute_for_name") (FFI.String.PolyML.INPTR --> AtkTextAttribute.PolyML.VAL)
      val textAttributeGetName_ = call (load_sym libatk "atk_text_attribute_get_name") (AtkTextAttribute.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val textAttributeGetValue_ = call (load_sym libatk "atk_text_attribute_get_value") (AtkTextAttribute.PolyML.VAL &&> FFI.Int.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val textAttributeRegister_ = call (load_sym libatk "atk_text_attribute_register") (FFI.String.PolyML.INPTR --> AtkTextAttribute.PolyML.VAL)
