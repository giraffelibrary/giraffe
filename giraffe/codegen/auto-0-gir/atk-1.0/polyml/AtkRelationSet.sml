structure AtkRelationSet :>
  ...
  struct
    ...
    in
      ...
      val getNRelations_ = call (load_sym libatk "atk_relation_set_get_n_relations") (AtkRelationSetClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val getRelation_ = call (load_sym libatk "atk_relation_set_get_relation") (AtkRelationSetClass.PolyML.cPtr &&> GInt.PolyML.cVal --> AtkRelationClass.PolyML.cPtr)
