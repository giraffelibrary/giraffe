structure AtkHyperlinkStateFlags :> ATK_HYPERLINK_STATE_FLAGS =
  struct
    val INLINE = 0w1
    val allFlags = [INLINE]
    structure Flags =
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "atk_hyperlink_state_flags_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
