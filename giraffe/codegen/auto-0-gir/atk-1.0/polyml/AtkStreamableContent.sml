structure AtkStreamableContent :>
  ...
  struct
    ...
    fun getMimeType self i = (AtkStreamableContentClass.FFI.withPtr false &&&> GInt.FFI.withVal ---> Utf8.FFI.fromPtr 0) getMimeType_ (self & i) before AtkStreamableContentClass.FFI.touchPtr self
