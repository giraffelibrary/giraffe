...
use "PANGO_GLYPH_GEOMETRY_RECORD-sig.sml";
use "PANGO_GLYPH_GEOMETRY-sig.sml";
use "PANGO_GLYPH_INFO_RECORD-sig.sml";
use "PANGO_GLYPH_INFO-sig.sml";
use "PANGO_GLYPH_ITEM_RECORD-sig.sml";
use "PANGO_GLYPH_ITEM-sig.sml";
use "PANGO_GLYPH_ITEM_ITER_RECORD-sig.sml";
use "PANGO_GLYPH_ITEM_ITER-sig.sml";
use "PANGO_GLYPH_STRING_RECORD-sig.sml";
use "PANGO_GLYPH_STRING-sig.sml";
use "PANGO_GLYPH_VIS_ATTR_RECORD-sig.sml";
use "PANGO_GLYPH_VIS_ATTR-sig.sml";
...
use "polyml/PangoGlyphGeometryRecord.sml";
use "polyml/PangoGlyphInfoRecord.sml";
use "polyml/PangoGlyphItemRecord.sml";
use "polyml/PangoGlyphItemIterRecord.sml";
use "polyml/PangoGlyphStringRecord.sml";
use "polyml/PangoGlyphVisAttrRecord.sml";
...
use "PangoFontFaceClassCPtrArrayN.sml";
use "PangoFontFamilyClassCPtrArrayN.sml";
use "polyml/PangoFontMetrics.sml";
use "polyml/PangoFontset.sml";
use "polyml/PangoFontsetSimpleClass.sml";
use "polyml/PangoGlyphGeometry.sml";
use "polyml/PangoGlyphInfo.sml";
use "polyml/PangoGlyphItem.sml";
use "polyml/PangoGlyphItemIter.sml";
use "polyml/PangoGlyphString.sml";
use "polyml/PangoGlyphVisAttr.sml";
