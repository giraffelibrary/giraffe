structure PangoFontMetricsRecord :> PANGO_FONT_METRICS_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "pango_font_metrics_ref") (cPtr --> cPtr)
      val free_ = call (getSymbol "pango_font_metrics_unref") (cPtr --> PolyMLFFI.cVoid)
    end
    structure Record =
      BoxedRecord(
