structure Pango : PANGO =
  struct
    ...
    structure GlyphGeometryRecord = PangoGlyphGeometryRecord
    structure GlyphInfoRecord = PangoGlyphInfoRecord
    structure GlyphItemRecord = PangoGlyphItemRecord
    structure GlyphItemIterRecord = PangoGlyphItemIterRecord
    structure GlyphStringRecord = PangoGlyphStringRecord
    structure GlyphVisAttrRecord = PangoGlyphVisAttrRecord
    ...
    structure GlyphGeometry = PangoGlyphGeometry
    structure GlyphInfo = PangoGlyphInfo
    structure GlyphItem = PangoGlyphItem
    structure GlyphItemIter = PangoGlyphItemIter
    structure GlyphString = PangoGlyphString
    structure GlyphVisAttr = PangoGlyphVisAttr
    ...
    fun findBaseDir (text, length) = (Utf8.FFI.withPtr 0 &&&> GInt.FFI.withVal ---> PangoDirection.FFI.fromVal) findBaseDir_ (text & length)
