structure PangoLayoutIter :>
  PANGO_LAYOUT_ITER
    ...
    where type layout_run_record_t = PangoLayoutRunRecord.t =
  struct
    local
      open PolyMLFFI
    in
      ...
      val getBaseline_ = call (load_sym libpango "pango_layout_iter_get_baseline") (PangoLayoutIterRecord.PolyML.PTR --> FFI.Int.PolyML.VAL)
      ...
      val getIndex_ = call (load_sym libpango "pango_layout_iter_get_index") (PangoLayoutIterRecord.PolyML.PTR --> FFI.Int.PolyML.VAL)
      ...
      val getRun_ = call (load_sym libpango "pango_layout_iter_get_run") (PangoLayoutIterRecord.PolyML.PTR --> PangoLayoutRunRecord.PolyML.PTR)
      val getRunExtents_ =
      ...
      val getRunReadonly_ = call (load_sym libpango "pango_layout_iter_get_run_readonly") (PangoLayoutIterRecord.PolyML.PTR --> PangoLayoutRunRecord.PolyML.PTR)
    ...
    type layout_run_record_t = PangoLayoutRunRecord.t
    type t = record_t
