structure PangoLayoutIterRecord :> PANGO_LAYOUT_ITER_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "pango_layout_iter_copy") (cPtr --> cPtr)
      val free_ = call (getSymbol "pango_layout_iter_free") (cPtr --> PolyMLFFI.cVoid)
    end
    structure Record =
      BoxedRecord(
