structure PangoLayout :>
  ...
  struct
    ...
    val getBaseline_ = _import "pango_layout_get_baseline" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p -> GInt.FFI.val_;
    val getCharacterCount_ = _import "pango_layout_get_character_count" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p -> GInt.FFI.val_;
    ...
    val getHeight_ = _import "pango_layout_get_height" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p -> GInt.FFI.val_;
    val getIndent_ = _import "pango_layout_get_indent" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p -> GInt.FFI.val_;
    ...
    val getLine_ = fn x1 & x2 => (_import "pango_layout_get_line" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p * GInt.FFI.val_ -> PangoLayoutLineRecord.FFI.opt PangoLayoutLineRecord.FFI.p;) (x1, x2)
    val getLineCount_ = _import "pango_layout_get_line_count" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p -> GInt.FFI.val_;
    val getLineReadonly_ = fn x1 & x2 => (_import "pango_layout_get_line_readonly" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p * GInt.FFI.val_ -> PangoLayoutLineRecord.FFI.opt PangoLayoutLineRecord.FFI.p;) (x1, x2)
    val getLogAttrs_ =
      fn
        x1
         & (x2, x3)
    ...
    val getLogAttrsReadonly_ = fn x1 & x2 => (_import "pango_layout_get_log_attrs_readonly" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p * GInt.FFI.ref_ -> PangoLogAttrRecordCArrayN.FFI.non_opt PangoLogAttrRecordCArrayN.FFI.out_p;) (x1, x2)
    ...
    val getSerial_ = _import "pango_layout_get_serial" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p -> GUInt.FFI.val_;
    ...
    val getSpacing_ = _import "pango_layout_get_spacing" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p -> GInt.FFI.val_;
    ...
    val getUnknownGlyphsCount_ = _import "pango_layout_get_unknown_glyphs_count" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p -> GInt.FFI.val_;
    val getWidth_ = _import "pango_layout_get_width" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p -> GInt.FFI.val_;
    ...
    val setHeight_ = fn x1 & x2 => (_import "pango_layout_set_height" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    val setIndent_ = fn x1 & x2 => (_import "pango_layout_set_indent" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    ...
    val setSpacing_ = fn x1 & x2 => (_import "pango_layout_set_spacing" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    ...
    val setWidth_ = fn x1 & x2 => (_import "pango_layout_set_width" : PangoLayoutClass.FFI.non_opt PangoLayoutClass.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
