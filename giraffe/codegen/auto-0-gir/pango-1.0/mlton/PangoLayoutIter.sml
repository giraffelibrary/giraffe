structure PangoLayoutIter :>
  ...
  struct
    ...
    val getBaseline_ = _import "pango_layout_iter_get_baseline" : PangoLayoutIterRecord.C.notnull PangoLayoutIterRecord.C.p -> FFI.Int.C.val_;
    ...
    val getRun_ = _import "pango_layout_iter_get_run" : PangoLayoutIterRecord.C.notnull PangoLayoutIterRecord.C.p -> PangoLayoutRunRecord.C.notnull PangoLayoutRunRecord.C.p;
    val getRunExtents_ =
      fn
        x1
         & x2
    ...
    val getRunReadonly_ = _import "pango_layout_iter_get_run_readonly" : PangoLayoutIterRecord.C.notnull PangoLayoutIterRecord.C.p -> PangoLayoutRunRecord.C.notnull PangoLayoutRunRecord.C.p;
