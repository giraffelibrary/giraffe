structure PangoFontset :>
  ...
  struct
    ...
    val getFont_ = fn x1 & x2 => (_import "pango_fontset_get_font" : PangoFontsetClass.FFI.non_opt PangoFontsetClass.FFI.p * GUInt.FFI.val_ -> PangoFontClass.FFI.non_opt PangoFontClass.FFI.p;) (x1, x2)
