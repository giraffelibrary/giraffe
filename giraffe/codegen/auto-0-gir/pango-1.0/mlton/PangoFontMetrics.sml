structure PangoFontMetrics :>
  ...
  struct
    ...
    val getApproximateCharWidth_ = _import "pango_font_metrics_get_approximate_char_width" : PangoFontMetricsRecord.FFI.non_opt PangoFontMetricsRecord.FFI.p -> GInt.FFI.val_;
    val getApproximateDigitWidth_ = _import "pango_font_metrics_get_approximate_digit_width" : PangoFontMetricsRecord.FFI.non_opt PangoFontMetricsRecord.FFI.p -> GInt.FFI.val_;
    val getAscent_ = _import "pango_font_metrics_get_ascent" : PangoFontMetricsRecord.FFI.non_opt PangoFontMetricsRecord.FFI.p -> GInt.FFI.val_;
    val getDescent_ = _import "pango_font_metrics_get_descent" : PangoFontMetricsRecord.FFI.non_opt PangoFontMetricsRecord.FFI.p -> GInt.FFI.val_;
    val getStrikethroughPosition_ = _import "pango_font_metrics_get_strikethrough_position" : PangoFontMetricsRecord.FFI.non_opt PangoFontMetricsRecord.FFI.p -> GInt.FFI.val_;
    val getStrikethroughThickness_ = _import "pango_font_metrics_get_strikethrough_thickness" : PangoFontMetricsRecord.FFI.non_opt PangoFontMetricsRecord.FFI.p -> GInt.FFI.val_;
    val getUnderlinePosition_ = _import "pango_font_metrics_get_underline_position" : PangoFontMetricsRecord.FFI.non_opt PangoFontMetricsRecord.FFI.p -> GInt.FFI.val_;
    val getUnderlineThickness_ = _import "pango_font_metrics_get_underline_thickness" : PangoFontMetricsRecord.FFI.non_opt PangoFontMetricsRecord.FFI.p -> GInt.FFI.val_;
