structure PangoGlyphString :>
  ...
  struct
    ...
    val getWidth_ = _import "pango_glyph_string_get_width" : PangoGlyphStringRecord.FFI.non_opt PangoGlyphStringRecord.FFI.p -> GInt.FFI.val_;
    val setSize_ = fn x1 & x2 => (_import "pango_glyph_string_set_size" : PangoGlyphStringRecord.FFI.non_opt PangoGlyphStringRecord.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
