structure PangoLanguage :>
  ...
  struct
    ...
    val getScripts_ = fn x1 & x2 => (_import "pango_language_get_scripts" : PangoLanguageRecord.FFI.non_opt PangoLanguageRecord.FFI.p * GInt.FFI.ref_ -> PangoScriptCArrayN.FFI.opt PangoScriptCArrayN.FFI.out_p;) (x1, x2)
