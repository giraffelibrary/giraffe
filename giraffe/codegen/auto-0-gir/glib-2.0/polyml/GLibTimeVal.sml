structure GLibTimeVal :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val add_ = call (getSymbol "g_time_val_add") (GLibTimeValRecord.PolyML.cPtr &&> GLong.PolyML.cVal --> cVoid)
    ...
    fun add self microseconds = (GLibTimeValRecord.FFI.withPtr false &&&> GLong.FFI.withVal ---> I) add_ (self & microseconds)
