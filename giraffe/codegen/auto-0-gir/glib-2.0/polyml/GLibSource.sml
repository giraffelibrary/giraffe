structure GLibSource :>
  ...
  struct
    ...
    in
      ...
      val attach_ = call (load_sym libglib "g_source_attach") (GLibSourceRecord.PolyML.cPtr &&> GLibMainContextRecord.PolyML.cOptPtr --> GUInt.PolyML.cVal)
      ...
      val getId_ = call (load_sym libglib "g_source_get_id") (GLibSourceRecord.PolyML.cPtr --> GUInt.PolyML.cVal)
      val getName_ = call (load_sym libglib "g_source_get_name") (GLibSourceRecord.PolyML.cPtr --> Utf8.PolyML.cOutPtr)
      val getPriority_ = call (load_sym libglib "g_source_get_priority") (GLibSourceRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val setPriority_ = call (load_sym libglib "g_source_set_priority") (GLibSourceRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val remove_ = call (load_sym libglib "g_source_remove") (GUInt.PolyML.cVal --> GBool.PolyML.cVal)
      val setNameById_ = call (load_sym libglib "g_source_set_name_by_id") (GUInt.PolyML.cVal &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
    end
