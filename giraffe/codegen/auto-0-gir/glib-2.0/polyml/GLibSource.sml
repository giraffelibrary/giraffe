structure GLibSource :>
  ...
  struct
    ...
    in
      ...
      val setPriority_ = call (getSymbol "g_source_set_priority") (GLibSourceRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val remove_ = call (getSymbol "g_source_remove") (GUInt.PolyML.cVal --> GBool.PolyML.cVal)
      val setNameById_ = call (getSymbol "g_source_set_name_by_id") (GUInt.PolyML.cVal &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
    end
