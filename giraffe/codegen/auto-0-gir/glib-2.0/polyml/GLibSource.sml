structure GLibSource :>
  ...
  struct
    ...
    in
      ...
      val setPriority_ = call (load_sym libglib "g_source_set_priority") (GLibSourceRecord.PolyML.cPtr &&> FFI.Int.PolyML.cVal --> FFI.PolyML.cVoid)
      val remove_ = call (load_sym libglib "g_source_remove") (FFI.UInt.PolyML.cVal --> FFI.Bool.PolyML.cVal)
      val setNameById_ = call (load_sym libglib "g_source_set_name_by_id") (FFI.UInt.PolyML.cVal &&> Utf8.PolyML.cInPtr --> FFI.PolyML.cVoid)
    end
