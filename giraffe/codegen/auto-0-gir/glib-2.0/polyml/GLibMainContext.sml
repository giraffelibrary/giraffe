structure GLibMainContext :>
  ...
  struct
    ...
    in
      ...
      val findSourceById_ = call (load_sym libglib "g_main_context_find_source_by_id") (GLibMainContextRecord.PolyML.cPtr &&> GUInt.PolyML.cVal --> GLibSourceRecord.PolyML.cPtr)
