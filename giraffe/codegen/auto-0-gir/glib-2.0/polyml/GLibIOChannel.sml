structure GLibIOChannel :>
  ...
  struct
    ...
    in
      ...
      val unixNew_ = call (load_sym libglib "g_io_channel_unix_new") (FFI.Int.PolyML.VAL --> GLibIOChannelRecord.PolyML.PTR)
      ...
      val unixGetFd_ = call (load_sym libglib "g_io_channel_unix_get_fd") (GLibIOChannelRecord.PolyML.PTR --> FFI.Int.PolyML.VAL)
      val writeUnichar_ =
