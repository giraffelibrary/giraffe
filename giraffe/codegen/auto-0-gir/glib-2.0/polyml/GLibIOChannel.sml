structure GLibIOChannel :>
  ...
  struct
    ...
    in
      ...
      val unixNew_ = call (load_sym libglib "g_io_channel_unix_new") (FFI.Int.PolyML.cVal --> GLibIOChannelRecord.PolyML.cPtr)
      ...
      val setBufferSize_ = call (load_sym libglib "g_io_channel_set_buffer_size") (GLibIOChannelRecord.PolyML.cPtr &&> FFI.Size.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val unixGetFd_ = call (load_sym libglib "g_io_channel_unix_get_fd") (GLibIOChannelRecord.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      val writeUnichar_ =
