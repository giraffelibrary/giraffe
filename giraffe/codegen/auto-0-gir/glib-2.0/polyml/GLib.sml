structure GLib : G_LIB =
  struct
    ...
    in
      ...
      val datalistSetFlags_ = call (load_sym libglib "g_datalist_set_flags") (GLibDataRecord.PolyML.cPtr &&> FFI.UInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val datalistUnsetFlags_ = call (load_sym libglib "g_datalist_unset_flags") (GLibDataRecord.PolyML.cPtr &&> FFI.UInt.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val logRemoveHandler_ = call (load_sym libglib "g_log_remove_handler") (Utf8.PolyML.cInPtr &&> FFI.UInt.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val mainDepth_ = call (load_sym libglib "g_main_depth") (PolyMLFFI.cVoid --> FFI.Int.PolyML.cVal)
      ...
      val sourceSetNameById_ = call (load_sym libglib "g_source_set_name_by_id") (FFI.UInt.PolyML.cVal &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
      ...
      val testRun_ = call (load_sym libglib "g_test_run") (PolyMLFFI.cVoid --> FFI.Int.PolyML.cVal)
      ...
      val threadPoolGetMaxIdleTime_ = call (load_sym libglib "g_thread_pool_get_max_idle_time") (PolyMLFFI.cVoid --> FFI.UInt.PolyML.cVal)
      val threadPoolGetMaxUnusedThreads_ = call (load_sym libglib "g_thread_pool_get_max_unused_threads") (PolyMLFFI.cVoid --> FFI.Int.PolyML.cVal)
      val threadPoolGetNumUnusedThreads_ = call (load_sym libglib "g_thread_pool_get_num_unused_threads") (PolyMLFFI.cVoid --> FFI.UInt.PolyML.cVal)
      val threadPoolSetMaxIdleTime_ = call (load_sym libglib "g_thread_pool_set_max_idle_time") (FFI.UInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val threadPoolSetMaxUnusedThreads_ = call (load_sym libglib "g_thread_pool_set_max_unused_threads") (FFI.Int.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val usleep_ = call (load_sym libglib "g_usleep") (FFI.ULong.PolyML.cVal --> PolyMLFFI.cVoid)
