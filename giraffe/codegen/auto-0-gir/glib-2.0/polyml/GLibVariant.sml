structure GLibVariant :>
  ...
  struct
    ...
    in
      ...
      val newBytestringArray_ = call (getSymbol "g_variant_new_bytestring_array") (Utf8CArrayN.PolyML.cInPtr &&> GSSize.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      ...
      val newObjv_ = call (getSymbol "g_variant_new_objv") (Utf8CArrayN.PolyML.cInPtr &&> GSSize.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      ...
      val newStrv_ = call (getSymbol "g_variant_new_strv") (Utf8CArrayN.PolyML.cInPtr &&> GSSize.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      val newTuple_ = call (getSymbol "g_variant_new_tuple") (GLibVariantRecordCArrayN.PolyML.cInPtr &&> GSize.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      ...
      val dupBytestringArray_ = call (getSymbol "g_variant_dup_bytestring_array") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CArrayN.PolyML.cOutPtr)
      val dupObjv_ = call (getSymbol "g_variant_dup_objv") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CArrayN.PolyML.cOutPtr)
      val dupString_ = call (getSymbol "g_variant_dup_string") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8.PolyML.cOutPtr)
      val dupStrv_ = call (getSymbol "g_variant_dup_strv") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CArrayN.PolyML.cOutPtr)
      ...
      val getBytestringArray_ = call (getSymbol "g_variant_get_bytestring_array") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CArrayN.PolyML.cOutPtr)
      ...
      val getObjv_ = call (getSymbol "g_variant_get_objv") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CArrayN.PolyML.cOutPtr)
      ...
      val getStrv_ = call (getSymbol "g_variant_get_strv") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CArrayN.PolyML.cOutPtr)
    ...
    fun newBytestringArray strv =
      let
        ...
        val retVal = (Utf8CArrayN.FFI.withPtr &&&> GSSize.FFI.withVal ---> GLibVariantRecord.FFI.fromPtr false) newBytestringArray_ (strv & length)
      in
        retVal
      end
    ...
    fun newObjv strv =
      let
        val length = LargeInt.fromInt (Utf8CArrayN.length strv)
        val retVal = (Utf8CArrayN.FFI.withPtr &&&> GSSize.FFI.withVal ---> GLibVariantRecord.FFI.fromPtr false) newObjv_ (strv & length)
      in
        retVal
      end
    ...
    fun newStrv strv =
      let
        val length = LargeInt.fromInt (Utf8CArrayN.length strv)
        val retVal = (Utf8CArrayN.FFI.withPtr &&&> GSSize.FFI.withVal ---> GLibVariantRecord.FFI.fromPtr false) newStrv_ (strv & length)
      in
        retVal
      end
    fun newTuple children =
      let
        ...
        val retVal = (GLibVariantRecordCArrayN.FFI.withPtr &&&> GSize.FFI.withVal ---> GLibVariantRecord.FFI.fromPtr false) newTuple_ (children & nChildren)
      in
        retVal
      end
    ...
    fun dupBytestringArray self =
      let
        val length & retVal = (GLibVariantRecord.FFI.withPtr &&&> GSize.FFI.withRefVal ---> GSize.FFI.fromVal && Utf8CArrayN.FFI.fromPtr 2) dupBytestringArray_ (self & GSize.null)
      in
        retVal (LargeInt.toInt length)
      end
    fun dupObjv self =
      let
        val length & retVal = (GLibVariantRecord.FFI.withPtr &&&> GSize.FFI.withRefVal ---> GSize.FFI.fromVal && Utf8CArrayN.FFI.fromPtr 2) dupObjv_ (self & GSize.null)
      in
        retVal (LargeInt.toInt length)
      end
    fun dupString self =
    ...
    fun dupStrv self =
      let
        val length & retVal = (GLibVariantRecord.FFI.withPtr &&&> GSize.FFI.withRefVal ---> GSize.FFI.fromVal && Utf8CArrayN.FFI.fromPtr 2) dupStrv_ (self & GSize.null)
      in
        retVal (LargeInt.toInt length)
      end
    ...
    fun getBytestringArray self =
      let
        val length & retVal = (GLibVariantRecord.FFI.withPtr &&&> GSize.FFI.withRefVal ---> GSize.FFI.fromVal && Utf8CArrayN.FFI.fromPtr 1) getBytestringArray_ (self & GSize.null)
      in
        retVal (LargeInt.toInt length)
      end
    ...
    fun getObjv self =
      let
        val length & retVal = (GLibVariantRecord.FFI.withPtr &&&> GSize.FFI.withRefVal ---> GSize.FFI.fromVal && Utf8CArrayN.FFI.fromPtr 1) getObjv_ (self & GSize.null)
      in
        retVal (LargeInt.toInt length)
      end
    ...
    fun getStrv self =
      let
        val length & retVal = (GLibVariantRecord.FFI.withPtr &&&> GSize.FFI.withRefVal ---> GSize.FFI.fromVal && Utf8CArrayN.FFI.fromPtr 1) getStrv_ (self & GSize.null)
      in
        retVal (LargeInt.toInt length)
      end
