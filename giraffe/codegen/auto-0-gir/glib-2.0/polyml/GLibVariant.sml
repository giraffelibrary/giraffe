structure GLibVariant :>
  ...
  struct
    ...
    in
      ...
      val newBytestring_ = call (getSymbol "g_variant_new_bytestring") (GUInt8CVector.PolyML.cInPtr --> GLibVariantRecord.PolyML.cPtr)
      val newBytestringArray_ = call (getSymbol "g_variant_new_bytestring_array") (Utf8CVectorN.PolyML.cInPtr &&> GSSize.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      ...
      val newObjv_ = call (getSymbol "g_variant_new_objv") (Utf8CVectorN.PolyML.cInPtr &&> GSSize.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      ...
      val newStrv_ = call (getSymbol "g_variant_new_strv") (Utf8CVectorN.PolyML.cInPtr &&> GSSize.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      val newTuple_ = call (getSymbol "g_variant_new_tuple") (GLibVariantRecordCVectorN.PolyML.cInPtr &&> GSize.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      ...
      val dupBytestring_ = call (getSymbol "g_variant_dup_bytestring") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> GUInt8CVectorN.PolyML.cOutPtr)
      val dupBytestringArray_ = call (getSymbol "g_variant_dup_bytestring_array") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      val dupObjv_ = call (getSymbol "g_variant_dup_objv") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      val dupString_ = call (getSymbol "g_variant_dup_string") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8.PolyML.cOutPtr)
      val dupStrv_ = call (getSymbol "g_variant_dup_strv") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      ...
      val getBytestring_ = call (getSymbol "g_variant_get_bytestring") (GLibVariantRecord.PolyML.cPtr --> GUInt8CVector.PolyML.cOutPtr)
      val getBytestringArray_ = call (getSymbol "g_variant_get_bytestring_array") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      ...
      val getMaybe_ = call (getSymbol "g_variant_get_maybe") (GLibVariantRecord.PolyML.cPtr --> GLibVariantRecord.PolyML.cPtr)
      val getNormalForm_ = call (getSymbol "g_variant_get_normal_form") (GLibVariantRecord.PolyML.cPtr --> GLibVariantRecord.PolyML.cPtr)
      val getObjv_ = call (getSymbol "g_variant_get_objv") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      ...
      val getStrv_ = call (getSymbol "g_variant_get_strv") (GLibVariantRecord.PolyML.cPtr &&> GSize.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      ...
      val parserGetErrorQuark_ = call (getSymbol "g_variant_parser_get_error_quark") (PolyMLFFI.cVoid --> GLibQuark.PolyML.cVal)
    end
