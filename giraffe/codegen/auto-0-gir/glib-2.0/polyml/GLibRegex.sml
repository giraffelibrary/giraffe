structure GLibRegex :>
  ...
  struct
    ...
    in
      ...
      val getStringNumber_ = call (load_sym libglib "g_regex_get_string_number") (GLibRegexRecord.PolyML.PTR &&> Utf8.PolyML.INPTR --> FFI.Int.PolyML.VAL)
      val match_ =
      ...
      val escapeNul_ = call (load_sym libglib "g_regex_escape_nul") (Utf8.PolyML.INPTR &&> FFI.Int.PolyML.VAL --> Utf8.PolyML.RETPTR)
      val matchSimple_ =
