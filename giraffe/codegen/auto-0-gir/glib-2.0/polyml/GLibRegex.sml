structure GLibRegex :>
  ...
  struct
    ...
    in
      ...
      val getCaptureCount_ = call (load_sym libglib "g_regex_get_capture_count") (GLibRegexRecord.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      ...
      val getMaxBackref_ = call (load_sym libglib "g_regex_get_max_backref") (GLibRegexRecord.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      val getPattern_ = call (load_sym libglib "g_regex_get_pattern") (GLibRegexRecord.PolyML.cPtr --> Utf8.PolyML.cOutPtr)
      val getStringNumber_ = call (load_sym libglib "g_regex_get_string_number") (GLibRegexRecord.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> FFI.Int.PolyML.cVal)
      val match_ =
      ...
      val escapeNul_ = call (load_sym libglib "g_regex_escape_nul") (Utf8.PolyML.cInPtr &&> FFI.Int.PolyML.cVal --> Utf8.PolyML.cOutPtr)
      val matchSimple_ =
