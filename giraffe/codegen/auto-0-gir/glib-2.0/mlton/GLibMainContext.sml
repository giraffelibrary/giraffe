structure GLibMainContext :>
  ...
  struct
    ...
    fun findSourceById self sourceId = (GLibMainContextRecord.FFI.withPtr false &&&> GUInt.FFI.withVal ---> GLibSourceRecord.FFI.fromPtr false) findSourceById_ (self & sourceId)
