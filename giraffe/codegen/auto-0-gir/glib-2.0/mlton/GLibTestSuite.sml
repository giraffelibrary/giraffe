structure GLibTestSuite :>
  ...
  struct
    val add_ = fn x1 & x2 => (_import "g_test_suite_add" : GLibTestSuiteRecord.FFI.notnull GLibTestSuiteRecord.FFI.p * GLibTestCaseRecord.FFI.notnull GLibTestCaseRecord.FFI.p -> unit;) (x1, x2)
    val addSuite_ = fn x1 & x2 => (_import "g_test_suite_add_suite" : GLibTestSuiteRecord.FFI.notnull GLibTestSuiteRecord.FFI.p * GLibTestSuiteRecord.FFI.notnull GLibTestSuiteRecord.FFI.p -> unit;) (x1, x2)
