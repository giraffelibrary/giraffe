structure GLibString :>
  ...
  struct
    ...
    val appendC_ = fn x1 & x2 => (_import "g_string_append_c" : GLibStringRecord.FFI.notnull GLibStringRecord.FFI.p * GChar.FFI.val_ -> GLibStringRecord.FFI.notnull GLibStringRecord.FFI.p;) (x1, x2)
    val appendLen_ =
      fn
        x1
         & (x2, x3)
    ...
    val hash_ = _import "g_string_hash" : GLibStringRecord.FFI.notnull GLibStringRecord.FFI.p -> GUInt.FFI.val_;
    val insert_ =
      fn
        x1
         & x2
    ...
    val prependC_ = fn x1 & x2 => (_import "g_string_prepend_c" : GLibStringRecord.FFI.notnull GLibStringRecord.FFI.p * GChar.FFI.val_ -> GLibStringRecord.FFI.notnull GLibStringRecord.FFI.p;) (x1, x2)
    val prependLen_ =
      fn
        x1
         & (x2, x3)
    ...
    val setSize_ = fn x1 & x2 => (_import "g_string_set_size" : GLibStringRecord.FFI.notnull GLibStringRecord.FFI.p * GSize.FFI.val_ -> GLibStringRecord.FFI.notnull GLibStringRecord.FFI.p;) (x1, x2)
    val truncate_ = fn x1 & x2 => (_import "g_string_truncate" : GLibStringRecord.FFI.notnull GLibStringRecord.FFI.p * GSize.FFI.val_ -> GLibStringRecord.FFI.notnull GLibStringRecord.FFI.p;) (x1, x2)
