structure GLib : G_LIB =
  struct
    ...
    val chdir_ = _import "mlton_g_chdir" : cstring * unit CPointer.t -> FFI.Int.C.val_;
    val checkVersion_ =
      fn
        x1
         & x2
    ...
    val mkstemp_ = _import "mlton_g_mkstemp" : cstring * unit CPointer.t -> FFI.Int.C.val_;
    val mkstempFull_ =
      fn
        (x1, x2)
         & x3
    ...
    val quarkFromStaticString_ = _import "mlton_g_quark_from_static_string" : cstring * unit CPointer.t -> GLibQuark.C.val_;
    val quarkFromString_ = _import "mlton_g_quark_from_string" : cstring * unit CPointer.t -> GLibQuark.C.val_;
    val quarkToString_ = _import "g_quark_to_string" : GLibQuark.C.val_ -> FFI.String.C.notnull FFI.String.C.out_p;
    val quarkTryString_ = _import "mlton_g_quark_try_string" : cstring * unit CPointer.t -> GLibQuark.C.val_;
    ...
    val rmdir_ = _import "mlton_g_rmdir" : cstring * unit CPointer.t -> FFI.Int.C.val_;
    ...
    val strvLength_ = _import "mlton_g_strv_length" : cstring * unit CPointer.t -> FFI.UInt.C.val_;
    ...
    val unlink_ = _import "mlton_g_unlink" : cstring * unit CPointer.t -> FFI.Int.C.val_;
