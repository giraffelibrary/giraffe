structure GLibKeyFile :>
  ...
  struct
    ...
    val getGroups_ = fn x1 & x2 => (_import "g_key_file_get_groups" : GLibKeyFileRecord.FFI.non_opt GLibKeyFileRecord.FFI.p * GSize.FFI.ref_ -> Utf8CPtrArray.FFI.non_opt Utf8CPtrArray.FFI.out_p;) (x1, x2)
    val getInt64_ =
      fn
        x1
         & (x2, x3)
         ...
         & x7 =>
          (
            _import "mlton_g_key_file_get_integer_list" :
               ...
               * GSize.FFI.ref_
               * (GLibErrorRecord.FFI.opt, GLibErrorRecord.FFI.opt) GLibErrorRecord.FFI.r
               -> GIntCArrayN.FFI.non_opt GIntCArrayN.FFI.out_p;
          )
            (
              x1,
              x2,
        ...
        val length & retVal =
          (
            GLibKeyFileRecord.FFI.withPtr false
             ...
             &&&> GLibErrorRecord.handleError
             ---> GSize.FFI.fromVal && GBoolCArrayN.FFI.fromPtr ~1
          )
            getBooleanList_
            (
              self
        ...
        val length & retVal =
          (
            GLibKeyFileRecord.FFI.withPtr false
             ...
             &&&> GSize.FFI.withRefVal
             &&&> GLibErrorRecord.handleError
             ---> GSize.FFI.fromVal && GDoubleCArrayN.FFI.fromPtr ~1
          )
            getDoubleList_
            (
              self
    ...
    fun getGroups self =
      let
        val length & retVal = (GLibKeyFileRecord.FFI.withPtr false &&&> GSize.FFI.withRefVal ---> GSize.FFI.fromVal && Utf8CPtrArray.FFI.fromPtr ~1) getGroups_ (self & GSize.null)
      in
        (retVal, length)
      end
        ...
        val length & retVal =
          (
            GLibKeyFileRecord.FFI.withPtr false
             ...
             &&&> GSize.FFI.withRefVal
             &&&> GLibErrorRecord.handleError
             ---> GSize.FFI.fromVal && GIntCArrayN.FFI.fromPtr ~1
          )
            getIntegerList_
            (
              self
        ...
        val length & retVal =
          (
            GLibKeyFileRecord.FFI.withPtr false
             ...
             &&&> GSize.FFI.withRefVal
             &&&> GLibErrorRecord.handleError
             ---> GSize.FFI.fromVal && Utf8CPtrArray.FFI.fromPtr ~1
          )
            getKeys_
            (
              self
