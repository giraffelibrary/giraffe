structure GLibChecksumRecord :> G_LIB_CHECKSUM_RECORD =
  struct
    structure Pointer = CPointerInternal
    type opt = Pointer.opt
    type non_opt = Pointer.non_opt
    type 'a p = 'a Pointer.p
    val dup_ = _import "g_checksum_copy" : non_opt p -> non_opt p;
    val free_ = _import "g_checksum_free" : non_opt p -> unit;
    structure Record =
      BoxedRecord(
