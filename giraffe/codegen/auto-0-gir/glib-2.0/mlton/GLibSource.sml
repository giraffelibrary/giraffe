structure GLibSource :>
  ...
  struct
    ...
    val getId_ = _import "g_source_get_id" : GLibSourceRecord.C.notnull GLibSourceRecord.C.p -> FFI.UInt.C.val_;
    val getName_ = _import "g_source_get_name" : GLibSourceRecord.C.notnull GLibSourceRecord.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getPriority_ = _import "g_source_get_priority" : GLibSourceRecord.C.notnull GLibSourceRecord.C.p -> FFI.Int.C.val_;
    ...
    val setPriority_ = fn x1 & x2 => (_import "g_source_set_priority" : GLibSourceRecord.C.notnull GLibSourceRecord.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
    val remove_ = _import "g_source_remove" : FFI.UInt.C.val_ -> FFI.Bool.C.val_;
    val setNameById_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    fun setNameById tag name = (FFI.UInt.C.withVal &&&> Utf8.C.withConstPtr ---> I) setNameById_ (tag & name)
  end
