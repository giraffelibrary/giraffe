structure GLibSource :>
  ...
  struct
    ...
    val attach_ = fn x1 & x2 => (_import "g_source_attach" : GLibSourceRecord.FFI.non_opt GLibSourceRecord.FFI.p * GLibMainContextRecord.FFI.opt GLibMainContextRecord.FFI.p -> GUInt.FFI.val_;) (x1, x2)
    ...
    val getId_ = _import "g_source_get_id" : GLibSourceRecord.FFI.non_opt GLibSourceRecord.FFI.p -> GUInt.FFI.val_;
    ...
    val getPriority_ = _import "g_source_get_priority" : GLibSourceRecord.FFI.non_opt GLibSourceRecord.FFI.p -> GInt.FFI.val_;
    ...
    val setPriority_ = fn x1 & x2 => (_import "g_source_set_priority" : GLibSourceRecord.FFI.non_opt GLibSourceRecord.FFI.p * GInt.FFI.val_ -> unit;) (x1, x2)
    ...
    fun setPriority self priority = (GLibSourceRecord.FFI.withPtr false &&&> GInt.FFI.withVal ---> I) setPriority_ (self & priority)
    ...
    fun setNameById (tag, name) = (GUInt.FFI.withVal &&&> Utf8.FFI.withPtr 0 ---> I) setNameById_ (tag & name)
  end
