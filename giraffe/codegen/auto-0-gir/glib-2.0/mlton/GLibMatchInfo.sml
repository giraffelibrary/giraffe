structure GLibMatchInfo :>
  ...
  struct
    ...
    val fetch_ = fn x1 & x2 => (_import "g_match_info_fetch" : GLibMatchInfoRecord.FFI.non_opt GLibMatchInfoRecord.FFI.p * GInt.FFI.val_ -> Utf8.FFI.opt Utf8.FFI.out_p;) (x1, x2)
    ...
    val getMatchCount_ = _import "g_match_info_get_match_count" : GLibMatchInfoRecord.FFI.non_opt GLibMatchInfoRecord.FFI.p -> GInt.FFI.val_;
