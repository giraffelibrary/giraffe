structure GLibIOChannel :>
  ...
  struct
    ...
    val unixNew_ = _import "g_io_channel_unix_new" : GInt.FFI.val_ -> GLibIOChannelRecord.FFI.notnull GLibIOChannelRecord.FFI.p;
    ...
    val unixGetFd_ = _import "g_io_channel_unix_get_fd" : GLibIOChannelRecord.FFI.notnull GLibIOChannelRecord.FFI.p -> GInt.FFI.val_;
    val writeUnichar_ =
      fn
        x1
         & x2
