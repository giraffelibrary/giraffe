structure GLibIOChannel :>
  ...
  struct
    ...
    val unixNew_ = _import "g_io_channel_unix_new" : GInt.FFI.val_ -> GLibIOChannelRecord.FFI.non_opt GLibIOChannelRecord.FFI.p;
    ...
    val unixGetFd_ = _import "g_io_channel_unix_get_fd" : GLibIOChannelRecord.FFI.non_opt GLibIOChannelRecord.FFI.p -> GInt.FFI.val_;
    val writeUnichar_ =
      fn
        x1
         & x2
    ...
    fun unixGetFd self = (GLibIOChannelRecord.FFI.withPtr false ---> GInt.FFI.fromVal) unixGetFd_ self
