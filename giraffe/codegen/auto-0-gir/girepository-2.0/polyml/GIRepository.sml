structure GIRepository : G_I_REPOSITORY =
  struct
    local
      open PolyMLFFI
    in
      val argInfoGetClosure_ = call (load_sym libgirepository "g_arg_info_get_closure") (GIRepositoryArgInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val argInfoGetDestroy_ = call (load_sym libgirepository "g_arg_info_get_destroy") (GIRepositoryArgInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val argInfoIsCallerAllocates_ = call (load_sym libgirepository "g_arg_info_is_caller_allocates") (GIRepositoryArgInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val argInfoIsOptional_ = call (load_sym libgirepository "g_arg_info_is_optional") (GIRepositoryArgInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val argInfoIsReturnValue_ = call (load_sym libgirepository "g_arg_info_is_return_value") (GIRepositoryArgInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val argInfoIsSkip_ = call (load_sym libgirepository "g_arg_info_is_skip") (GIRepositoryArgInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val argInfoMayBeNull_ = call (load_sym libgirepository "g_arg_info_may_be_null") (GIRepositoryArgInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val callableInfoGetArg_ = call (load_sym libgirepository "g_callable_info_get_arg") (GIRepositoryCallableInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryArgInfoRecord.PolyML.cPtr)
      ...
      val callableInfoGetNArgs_ = call (load_sym libgirepository "g_callable_info_get_n_args") (GIRepositoryCallableInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val callableInfoMayReturnNull_ = call (load_sym libgirepository "g_callable_info_may_return_null") (GIRepositoryCallableInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val callableInfoSkipReturn_ = call (load_sym libgirepository "g_callable_info_skip_return") (GIRepositoryCallableInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val enumInfoGetMethod_ = call (load_sym libgirepository "g_enum_info_get_method") (GIRepositoryEnumInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryFunctionInfoRecord.PolyML.cPtr)
      val enumInfoGetNMethods_ = call (load_sym libgirepository "g_enum_info_get_n_methods") (GIRepositoryEnumInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val enumInfoGetNValues_ = call (load_sym libgirepository "g_enum_info_get_n_values") (GIRepositoryEnumInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val enumInfoGetValue_ = call (load_sym libgirepository "g_enum_info_get_value") (GIRepositoryEnumInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryValueInfoRecord.PolyML.cPtr)
      ...
      val fieldInfoGetOffset_ = call (load_sym libgirepository "g_field_info_get_offset") (GIRepositoryFieldInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val fieldInfoGetSize_ = call (load_sym libgirepository "g_field_info_get_size") (GIRepositoryFieldInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val interfaceInfoGetConstant_ = call (load_sym libgirepository "g_interface_info_get_constant") (GIRepositoryInterfaceInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryConstantInfoRecord.PolyML.cPtr)
      ...
      val interfaceInfoGetMethod_ = call (load_sym libgirepository "g_interface_info_get_method") (GIRepositoryInterfaceInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryFunctionInfoRecord.PolyML.cPtr)
      val interfaceInfoGetNConstants_ = call (load_sym libgirepository "g_interface_info_get_n_constants") (GIRepositoryInterfaceInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val interfaceInfoGetNMethods_ = call (load_sym libgirepository "g_interface_info_get_n_methods") (GIRepositoryInterfaceInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val interfaceInfoGetNPrerequisites_ = call (load_sym libgirepository "g_interface_info_get_n_prerequisites") (GIRepositoryInterfaceInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val interfaceInfoGetNProperties_ = call (load_sym libgirepository "g_interface_info_get_n_properties") (GIRepositoryInterfaceInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val interfaceInfoGetNSignals_ = call (load_sym libgirepository "g_interface_info_get_n_signals") (GIRepositoryInterfaceInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val interfaceInfoGetNVfuncs_ = call (load_sym libgirepository "g_interface_info_get_n_vfuncs") (GIRepositoryInterfaceInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val interfaceInfoGetPrerequisite_ = call (load_sym libgirepository "g_interface_info_get_prerequisite") (GIRepositoryInterfaceInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val interfaceInfoGetProperty_ = call (load_sym libgirepository "g_interface_info_get_property") (GIRepositoryInterfaceInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryPropertyInfoRecord.PolyML.cPtr)
      val interfaceInfoGetSignal_ = call (load_sym libgirepository "g_interface_info_get_signal") (GIRepositoryInterfaceInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositorySignalInfoRecord.PolyML.cPtr)
      val interfaceInfoGetVfunc_ = call (load_sym libgirepository "g_interface_info_get_vfunc") (GIRepositoryInterfaceInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryVFuncInfoRecord.PolyML.cPtr)
      ...
      val objectInfoGetAbstract_ = call (load_sym libgirepository "g_object_info_get_abstract") (GIRepositoryObjectInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val objectInfoGetConstant_ = call (load_sym libgirepository "g_object_info_get_constant") (GIRepositoryObjectInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryConstantInfoRecord.PolyML.cPtr)
      val objectInfoGetField_ = call (load_sym libgirepository "g_object_info_get_field") (GIRepositoryObjectInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryFieldInfoRecord.PolyML.cPtr)
      val objectInfoGetFundamental_ = call (load_sym libgirepository "g_object_info_get_fundamental") (GIRepositoryObjectInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val objectInfoGetInterface_ = call (load_sym libgirepository "g_object_info_get_interface") (GIRepositoryObjectInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryInterfaceInfoRecord.PolyML.cPtr)
      val objectInfoGetMethod_ = call (load_sym libgirepository "g_object_info_get_method") (GIRepositoryObjectInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryFunctionInfoRecord.PolyML.cPtr)
      val objectInfoGetNConstants_ = call (load_sym libgirepository "g_object_info_get_n_constants") (GIRepositoryObjectInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val objectInfoGetNFields_ = call (load_sym libgirepository "g_object_info_get_n_fields") (GIRepositoryObjectInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val objectInfoGetNInterfaces_ = call (load_sym libgirepository "g_object_info_get_n_interfaces") (GIRepositoryObjectInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val objectInfoGetNMethods_ = call (load_sym libgirepository "g_object_info_get_n_methods") (GIRepositoryObjectInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val objectInfoGetNProperties_ = call (load_sym libgirepository "g_object_info_get_n_properties") (GIRepositoryObjectInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val objectInfoGetNSignals_ = call (load_sym libgirepository "g_object_info_get_n_signals") (GIRepositoryObjectInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val objectInfoGetNVfuncs_ = call (load_sym libgirepository "g_object_info_get_n_vfuncs") (GIRepositoryObjectInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val objectInfoGetProperty_ = call (load_sym libgirepository "g_object_info_get_property") (GIRepositoryObjectInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryPropertyInfoRecord.PolyML.cPtr)
      ...
      val objectInfoGetSignal_ = call (load_sym libgirepository "g_object_info_get_signal") (GIRepositoryObjectInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositorySignalInfoRecord.PolyML.cPtr)
      ...
      val objectInfoGetVfunc_ = call (load_sym libgirepository "g_object_info_get_vfunc") (GIRepositoryObjectInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryVFuncInfoRecord.PolyML.cPtr)
      ...
      val signalInfoTrueStopsEmit_ = call (load_sym libgirepository "g_signal_info_true_stops_emit") (GIRepositorySignalInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val structInfoGetAlignment_ = call (load_sym libgirepository "g_struct_info_get_alignment") (GIRepositoryStructInfoRecord.PolyML.cPtr --> GSize.PolyML.cVal)
      val structInfoGetField_ = call (load_sym libgirepository "g_struct_info_get_field") (GIRepositoryStructInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryFieldInfoRecord.PolyML.cPtr)
      val structInfoGetMethod_ = call (load_sym libgirepository "g_struct_info_get_method") (GIRepositoryStructInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryFunctionInfoRecord.PolyML.cPtr)
      val structInfoGetNFields_ = call (load_sym libgirepository "g_struct_info_get_n_fields") (GIRepositoryStructInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val structInfoGetNMethods_ = call (load_sym libgirepository "g_struct_info_get_n_methods") (GIRepositoryStructInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val structInfoGetSize_ = call (load_sym libgirepository "g_struct_info_get_size") (GIRepositoryStructInfoRecord.PolyML.cPtr --> GSize.PolyML.cVal)
      val structInfoIsForeign_ = call (load_sym libgirepository "g_struct_info_is_foreign") (GIRepositoryStructInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val structInfoIsGtypeStruct_ = call (load_sym libgirepository "g_struct_info_is_gtype_struct") (GIRepositoryStructInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val typeInfoGetArrayFixedSize_ = call (load_sym libgirepository "g_type_info_get_array_fixed_size") (GIRepositoryTypeInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val typeInfoGetArrayLength_ = call (load_sym libgirepository "g_type_info_get_array_length") (GIRepositoryTypeInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val typeInfoGetParamType_ = call (load_sym libgirepository "g_type_info_get_param_type") (GIRepositoryTypeInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryTypeInfoRecord.PolyML.cPtr)
      ...
      val typeInfoIsPointer_ = call (load_sym libgirepository "g_type_info_is_pointer") (GIRepositoryTypeInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val typeInfoIsZeroTerminated_ = call (load_sym libgirepository "g_type_info_is_zero_terminated") (GIRepositoryTypeInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val unionInfoGetAlignment_ = call (load_sym libgirepository "g_union_info_get_alignment") (GIRepositoryUnionInfoRecord.PolyML.cPtr --> GSize.PolyML.cVal)
      val unionInfoGetDiscriminator_ = call (load_sym libgirepository "g_union_info_get_discriminator") (GIRepositoryUnionInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryConstantInfoRecord.PolyML.cPtr)
      val unionInfoGetDiscriminatorOffset_ = call (load_sym libgirepository "g_union_info_get_discriminator_offset") (GIRepositoryUnionInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val unionInfoGetField_ = call (load_sym libgirepository "g_union_info_get_field") (GIRepositoryUnionInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryFieldInfoRecord.PolyML.cPtr)
      val unionInfoGetMethod_ = call (load_sym libgirepository "g_union_info_get_method") (GIRepositoryUnionInfoRecord.PolyML.cPtr &&> GInt.PolyML.cVal --> GIRepositoryFunctionInfoRecord.PolyML.cPtr)
      val unionInfoGetNFields_ = call (load_sym libgirepository "g_union_info_get_n_fields") (GIRepositoryUnionInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val unionInfoGetNMethods_ = call (load_sym libgirepository "g_union_info_get_n_methods") (GIRepositoryUnionInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
      val unionInfoGetSize_ = call (load_sym libgirepository "g_union_info_get_size") (GIRepositoryUnionInfoRecord.PolyML.cPtr --> GSize.PolyML.cVal)
      val unionInfoIsDiscriminated_ = call (load_sym libgirepository "g_union_info_is_discriminated") (GIRepositoryUnionInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val valueInfoGetValue_ = call (load_sym libgirepository "g_value_info_get_value") (GIRepositoryValueInfoRecord.PolyML.cPtr --> GInt64.PolyML.cVal)
      ...
      val vfuncInfoGetOffset_ = call (load_sym libgirepository "g_vfunc_info_get_offset") (GIRepositoryVFuncInfoRecord.PolyML.cPtr --> GInt.PolyML.cVal)
