structure GioApplicationCommandLine :>
  ...
  struct
    ...
    in
      ...
      val getArguments_ = call (load_sym libgio "g_application_command_line_get_arguments") (GioApplicationCommandLineClass.PolyML.cPtr &&> GInt.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      ...
      val getExitStatus_ = call (load_sym libgio "g_application_command_line_get_exit_status") (GioApplicationCommandLineClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val setExitStatus_ = call (load_sym libgio "g_application_command_line_set_exit_status") (GioApplicationCommandLineClass.PolyML.cPtr &&> GInt.PolyML.cVal --> PolyMLFFI.cVoid)
    end
