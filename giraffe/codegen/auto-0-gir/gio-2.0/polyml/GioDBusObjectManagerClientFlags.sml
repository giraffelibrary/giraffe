structure GioDBusObjectManagerClientFlags :>
  sig
    include GIO_D_BUS_OBJECT_MANAGER_CLIENT_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_dbus_object_manager_client_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
