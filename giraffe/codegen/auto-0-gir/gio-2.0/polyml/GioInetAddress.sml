structure GioInetAddress :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "g_inet_address_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      ...
      val getNativeSize_ = call (getSymbol "g_inet_address_get_native_size") (GioInetAddressClass.PolyML.cPtr --> GSize.PolyML.cVal)
