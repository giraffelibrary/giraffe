structure GioInetAddress :>
  ...
  struct
    ...
    in
      ...
      val equal_ = call (load_sym libgio "g_inet_address_equal") (GioInetAddressClass.PolyML.cPtr &&> GioInetAddressClass.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val getIsAny_ = call (load_sym libgio "g_inet_address_get_is_any") (GioInetAddressClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getIsLinkLocal_ = call (load_sym libgio "g_inet_address_get_is_link_local") (GioInetAddressClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getIsLoopback_ = call (load_sym libgio "g_inet_address_get_is_loopback") (GioInetAddressClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getIsMcGlobal_ = call (load_sym libgio "g_inet_address_get_is_mc_global") (GioInetAddressClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getIsMcLinkLocal_ = call (load_sym libgio "g_inet_address_get_is_mc_link_local") (GioInetAddressClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getIsMcNodeLocal_ = call (load_sym libgio "g_inet_address_get_is_mc_node_local") (GioInetAddressClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getIsMcOrgLocal_ = call (load_sym libgio "g_inet_address_get_is_mc_org_local") (GioInetAddressClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getIsMcSiteLocal_ = call (load_sym libgio "g_inet_address_get_is_mc_site_local") (GioInetAddressClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getIsMulticast_ = call (load_sym libgio "g_inet_address_get_is_multicast") (GioInetAddressClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getIsSiteLocal_ = call (load_sym libgio "g_inet_address_get_is_site_local") (GioInetAddressClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getNativeSize_ = call (load_sym libgio "g_inet_address_get_native_size") (GioInetAddressClass.PolyML.cPtr --> GSize.PolyML.cVal)
