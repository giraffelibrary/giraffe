structure GioDBusCallFlags :>
  sig
    include GIO_D_BUS_CALL_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_dbus_call_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
