structure GioDBusInterfaceSkeletonFlags :>
  sig
    include GIO_D_BUS_INTERFACE_SKELETON_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_dbus_interface_skeleton_flags_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
