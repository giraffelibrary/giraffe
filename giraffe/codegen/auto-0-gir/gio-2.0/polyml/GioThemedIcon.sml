structure GioThemedIcon :>
  ...
  struct
    ...
    in
      ...
      val newFromNames_ = call (getSymbol "g_themed_icon_new_from_names") (Utf8CArrayN.PolyML.cInPtr &&> GInt.PolyML.cVal --> GioThemedIconClass.PolyML.cPtr)
    ...
    fun newFromNames iconnames =
      let
        ...
        val retVal = (Utf8CArrayN.FFI.withPtr &&&> GInt.FFI.withVal ---> GioThemedIconClass.FFI.fromPtr true) newFromNames_ (iconnames & len)
      in
        retVal
      end
