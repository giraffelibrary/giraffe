structure GioBufferedOutputStream :>
  ...
  struct
    ...
    in
      ...
      val newSized_ = call (load_sym libgio "g_buffered_output_stream_new_sized") (GObjectObjectClass.PolyML.PTR &&> FFI.Size.PolyML.VAL --> GObjectObjectClass.PolyML.PTR)
      ...
      val getBufferSize_ = call (load_sym libgio "g_buffered_output_stream_get_buffer_size") (GObjectObjectClass.PolyML.PTR --> FFI.Size.PolyML.VAL)
