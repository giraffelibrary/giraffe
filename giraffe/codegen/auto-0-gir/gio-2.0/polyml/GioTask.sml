structure GioTask :>
  ...
  struct
    ...
    in
      ...
      val getPriority_ = call (getSymbol "g_task_get_priority") (GioTaskClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val propagateInt_ = call (getSymbol "g_task_propagate_int") (GioTaskClass.PolyML.cPtr &&> GLibErrorRecord.PolyML.cOutOptRef --> GSSize.PolyML.cVal)
      ...
      val returnInt_ = call (getSymbol "g_task_return_int") (GioTaskClass.PolyML.cPtr &&> GSSize.PolyML.cVal --> cVoid)
      val setCheckCancellable_ = call (getSymbol "g_task_set_check_cancellable") (GioTaskClass.PolyML.cPtr &&> GBool.PolyML.cVal --> cVoid)
      val setPriority_ = call (getSymbol "g_task_set_priority") (GioTaskClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
