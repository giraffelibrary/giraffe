structure GioDBusArgInfoRecord :> GIO_D_BUS_ARG_INFO_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "g_dbus_arg_info_ref") (cPtr --> cPtr)
      val free_ = call (getSymbol "g_dbus_arg_info_unref") (cPtr --> cVoid)
    end
    structure Record =
      BoxedRecord(
