structure GioFilterOutputStream :>
  ...
  struct
    ...
    in
      ...
      val setCloseBaseStream_ = call (load_sym libgio "g_filter_output_stream_set_close_base_stream") (GioFilterOutputStreamClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> FFI.PolyML.cVoid)
    end
