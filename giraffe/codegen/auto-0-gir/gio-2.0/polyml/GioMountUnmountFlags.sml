structure GioMountUnmountFlags :>
  sig
    include GIO_MOUNT_UNMOUNT_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_mount_unmount_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
