structure GioSubprocess :>
  ...
  struct
    ...
    in
      ...
      val getExitStatus_ = call (getSymbol "g_subprocess_get_exit_status") (GioSubprocessClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getStatus_ = call (getSymbol "g_subprocess_get_status") (GioSubprocessClass.PolyML.cPtr --> GInt.PolyML.cVal)
      ...
      val getTermSig_ = call (getSymbol "g_subprocess_get_term_sig") (GioSubprocessClass.PolyML.cPtr --> GInt.PolyML.cVal)
      val sendSignal_ = call (getSymbol "g_subprocess_send_signal") (GioSubprocessClass.PolyML.cPtr &&> GInt.PolyML.cVal --> cVoid)
      val wait_ =
    ...
    fun getExitStatus self = (GioSubprocessClass.FFI.withPtr false ---> GInt.FFI.fromVal) getExitStatus_ self
    ...
    fun getStatus self = (GioSubprocessClass.FFI.withPtr false ---> GInt.FFI.fromVal) getStatus_ self
    ...
    fun getTermSig self = (GioSubprocessClass.FFI.withPtr false ---> GInt.FFI.fromVal) getTermSig_ self
    fun sendSignal self signalNum = (GioSubprocessClass.FFI.withPtr false &&&> GInt.FFI.withVal ---> I) sendSignal_ (self & signalNum)
