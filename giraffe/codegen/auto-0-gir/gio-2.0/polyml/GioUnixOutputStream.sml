structure GioUnixOutputStream :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgio "g_unix_output_stream_new") (FFI.Int.PolyML.cVal &&> FFI.Bool.PolyML.cVal --> GioOutputStreamClass.PolyML.cPtr)
      ...
      val getFd_ = call (load_sym libgio "g_unix_output_stream_get_fd") (GioUnixOutputStreamClass.PolyML.cPtr --> FFI.Int.PolyML.cVal)
      val setCloseFd_ = call (load_sym libgio "g_unix_output_stream_set_close_fd") (GioUnixOutputStreamClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> PolyMLFFI.cVoid)
    end
    ...
    fun getFd self = (GioUnixOutputStreamClass.C.withPtr ---> FFI.Int.C.fromVal) getFd_ self
