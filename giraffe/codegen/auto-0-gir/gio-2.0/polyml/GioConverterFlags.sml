structure GioConverterFlags :>
  sig
    include GIO_CONVERTER_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_converter_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
