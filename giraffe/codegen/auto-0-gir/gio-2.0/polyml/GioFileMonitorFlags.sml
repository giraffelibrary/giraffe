structure GioFileMonitorFlags :>
  sig
    include GIO_FILE_MONITOR_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_file_monitor_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
