structure GioDBusAnnotationInfoRecord :> GIO_D_BUS_ANNOTATION_INFO_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "g_dbus_annotation_info_ref") (cPtr --> cPtr)
      val free_ = call (getSymbol "g_dbus_annotation_info_unref") (cPtr --> PolyMLFFI.cVoid)
    end
    structure Record =
      BoxedRecord(
