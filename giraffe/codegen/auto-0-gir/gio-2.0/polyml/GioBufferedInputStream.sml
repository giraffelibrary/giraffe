structure GioBufferedInputStream :>
  ...
  struct
    ...
    in
      ...
      val newSized_ = call (load_sym libgio "g_buffered_input_stream_new_sized") (GioInputStreamClass.PolyML.cPtr &&> GSize.PolyML.cVal --> GioInputStreamClass.PolyML.cPtr)
      val fill_ =
      ...
      val getAvailable_ = call (load_sym libgio "g_buffered_input_stream_get_available") (GioBufferedInputStreamClass.PolyML.cPtr --> GSize.PolyML.cVal)
      val getBufferSize_ = call (load_sym libgio "g_buffered_input_stream_get_buffer_size") (GioBufferedInputStreamClass.PolyML.cPtr --> GSize.PolyML.cVal)
      val peekBuffer_ = call (load_sym libgio "g_buffered_input_stream_peek_buffer") (GioBufferedInputStreamClass.PolyML.cPtr &&> GSize.PolyML.cRef --> GUInt8CVectorN.PolyML.cOutPtr)
      val readByte_ =
      ...
      val setBufferSize_ = call (load_sym libgio "g_buffered_input_stream_set_buffer_size") (GioBufferedInputStreamClass.PolyML.cPtr &&> GSize.PolyML.cVal --> PolyMLFFI.cVoid)
    end
