structure Gio : GIO =
  struct
    ...
    in
      ...
      val busUnownName_ = call (load_sym libgio "g_bus_unown_name") (FFI.UInt.PolyML.cVal --> PolyMLFFI.cVoid)
      val busUnwatchName_ = call (load_sym libgio "g_bus_unwatch_name") (FFI.UInt.PolyML.cVal --> PolyMLFFI.cVoid)
