structure GioSimpleAsyncResult :>
  ...
  struct
    ...
    in
      ...
      val setOpResGssize_ = call (load_sym libgio "g_simple_async_result_set_op_res_gssize") (GioSimpleAsyncResultClass.PolyML.cPtr &&> FFI.SSize.PolyML.cVal --> PolyMLFFI.cVoid)
    end
