structure GioUnixInputStream :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgio "g_unix_input_stream_new") (FFI.Int.PolyML.VAL &&> FFI.Bool.PolyML.VAL --> GObjectObjectClass.PolyML.PTR)
      val getCloseFd_ = call (load_sym libgio "g_unix_input_stream_get_close_fd") (GObjectObjectClass.PolyML.PTR --> FFI.Bool.PolyML.VAL)
      val getFd_ = call (load_sym libgio "g_unix_input_stream_get_fd") (GObjectObjectClass.PolyML.PTR --> FFI.Int.PolyML.VAL)
