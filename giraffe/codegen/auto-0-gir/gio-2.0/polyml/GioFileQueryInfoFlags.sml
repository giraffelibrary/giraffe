structure GioFileQueryInfoFlags :>
  sig
    include GIO_FILE_QUERY_INFO_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_file_query_info_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
