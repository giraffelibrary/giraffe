structure GioIcon :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "g_icon_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      ...
      val equal_ = call (getSymbol "g_icon_equal") (GioIconClass.PolyML.cPtr &&> GioIconClass.PolyML.cPtr --> GBool.PolyML.cVal)
