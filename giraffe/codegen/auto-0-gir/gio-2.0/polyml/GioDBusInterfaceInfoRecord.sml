structure GioDBusInterfaceInfoRecord :> GIO_D_BUS_INTERFACE_INFO_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "g_dbus_interface_info_ref") (cPtr --> cPtr)
      val free_ = call (getSymbol "g_dbus_interface_info_unref") (cPtr --> PolyMLFFI.cVoid)
    end
    structure Record =
      BoxedRecord(
