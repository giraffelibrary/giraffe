structure GioFileCreateFlags :> GIO_FILE_CREATE_FLAGS =
  struct
    local
      fun NONE () = 0w0
    in
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_file_create_flags_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
