structure GioDBusPropertyInfoRecord :> GIO_D_BUS_PROPERTY_INFO_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "g_dbus_property_info_ref") (cPtr --> cPtr)
      val free_ = call (getSymbol "g_dbus_property_info_unref") (cPtr --> PolyMLFFI.cVoid)
    end
    structure Record =
      BoxedRecord(
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "g_dbus_property_info_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
