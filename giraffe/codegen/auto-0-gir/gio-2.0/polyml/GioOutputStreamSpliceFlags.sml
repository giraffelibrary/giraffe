structure GioOutputStreamSpliceFlags :>
  sig
    include GIO_OUTPUT_STREAM_SPLICE_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_output_stream_splice_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
