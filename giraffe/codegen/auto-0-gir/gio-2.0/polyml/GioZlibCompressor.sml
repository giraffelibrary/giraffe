structure GioZlibCompressor :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgio "g_zlib_compressor_new") (GioZlibCompressorFormat.PolyML.cVal &&> FFI.Int.PolyML.cVal --> GioZlibCompressorClass.PolyML.cPtr)
      ...
      val setFileInfo_ = call (load_sym libgio "g_zlib_compressor_set_file_info") (GioZlibCompressorClass.PolyML.cPtr &&> GioFileInfoClass.PolyML.cOptPtr --> FFI.PolyML.cVoid)
    end
