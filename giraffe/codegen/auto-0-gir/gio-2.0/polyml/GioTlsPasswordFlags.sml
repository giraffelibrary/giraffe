structure GioTlsPasswordFlags :>
  sig
    include GIO_TLS_PASSWORD_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_tls_password_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
