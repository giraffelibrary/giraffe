structure GioCredentials :>
  ...
  struct
    ...
    val getUnixUser_ = fn x1 & x2 => (_import "g_credentials_get_unix_user" : GioCredentialsClass.C.notnull GioCredentialsClass.C.p * (unit, unit) GLibErrorRecord.C.r -> FFI.UInt.C.val_;) (x1, x2)
    val isSameUser_ =
      fn
        x1
         & x2
