structure GioEmblemedIcon :>
  ...
  struct
    ...
    val new_ = fn x1 & x2 => (_import "g_emblemed_icon_new" : GioIconClass.FFI.notnull GioIconClass.FFI.p * unit GioEmblemClass.FFI.p -> GioEmblemedIconClass.FFI.notnull GioEmblemedIconClass.FFI.p;) (x1, x2)
