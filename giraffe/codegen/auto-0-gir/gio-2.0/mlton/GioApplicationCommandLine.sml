structure GioApplicationCommandLine :>
  ...
  struct
    ...
    val getArguments_ = fn x1 & x2 => (_import "g_application_command_line_get_arguments" : GioApplicationCommandLineClass.FFI.notnull GioApplicationCommandLineClass.FFI.p * GInt.FFI.ref_ -> Utf8CPtrArrayN.FFI.notnull Utf8CPtrArrayN.FFI.out_p;) (x1, x2)
