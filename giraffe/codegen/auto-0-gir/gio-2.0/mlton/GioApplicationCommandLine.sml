structure GioApplicationCommandLine :>
  ...
  struct
    ...
    val setExitStatus_ = fn x1 & x2 => (_import "g_application_command_line_set_exit_status" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
