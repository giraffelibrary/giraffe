structure GioInetAddress :>
  ...
  struct
    ...
    val newAny_ = _import "g_inet_address_new_any" : GioSocketFamily.FFI.val_ -> GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p;
    val newFromString_ = _import "mlton_g_inet_address_new_from_string" : Utf8.MLton.p1 * Utf8.FFI.notnull Utf8.MLton.p2 -> GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p;
    val newLoopback_ = _import "g_inet_address_new_loopback" : GioSocketFamily.FFI.val_ -> GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p;
    val equal_ = fn x1 & x2 => (_import "g_inet_address_equal" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p * GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GBool.FFI.val_;) (x1, x2)
    val getFamily_ = _import "g_inet_address_get_family" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GioSocketFamily.FFI.val_;
    val getIsAny_ = _import "g_inet_address_get_is_any" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GBool.FFI.val_;
    val getIsLinkLocal_ = _import "g_inet_address_get_is_link_local" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GBool.FFI.val_;
    val getIsLoopback_ = _import "g_inet_address_get_is_loopback" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GBool.FFI.val_;
    val getIsMcGlobal_ = _import "g_inet_address_get_is_mc_global" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GBool.FFI.val_;
    val getIsMcLinkLocal_ = _import "g_inet_address_get_is_mc_link_local" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GBool.FFI.val_;
    val getIsMcNodeLocal_ = _import "g_inet_address_get_is_mc_node_local" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GBool.FFI.val_;
    val getIsMcOrgLocal_ = _import "g_inet_address_get_is_mc_org_local" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GBool.FFI.val_;
    val getIsMcSiteLocal_ = _import "g_inet_address_get_is_mc_site_local" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GBool.FFI.val_;
    val getIsMulticast_ = _import "g_inet_address_get_is_multicast" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GBool.FFI.val_;
    val getIsSiteLocal_ = _import "g_inet_address_get_is_site_local" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GBool.FFI.val_;
    val getNativeSize_ = _import "g_inet_address_get_native_size" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> GSize.FFI.val_;
    val toString_ = _import "g_inet_address_to_string" : GioInetAddressClass.FFI.notnull GioInetAddressClass.FFI.p -> Utf8.FFI.notnull Utf8.FFI.out_p;
    ...
    fun getNativeSize self = (GioInetAddressClass.FFI.withPtr ---> GSize.FFI.fromVal) getNativeSize_ self
