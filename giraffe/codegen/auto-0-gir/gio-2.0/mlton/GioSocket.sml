structure GioSocket :>
  ...
  struct
    ...
    val newFromFd_ = fn x1 & x2 => (_import "g_socket_new_from_fd" : FFI.Int.C.val_ * (unit, unit) GLibErrorRecord.C.r -> GioSocketClass.C.notnull GioSocketClass.C.p;) (x1, x2)
    val accept_ =
      fn
        x1
         & x2
    ...
    val getFd_ = _import "g_socket_get_fd" : GioSocketClass.C.notnull GioSocketClass.C.p -> FFI.Int.C.val_;
    val getKeepalive_ = _import "g_socket_get_keepalive" : GioSocketClass.C.notnull GioSocketClass.C.p -> FFI.Bool.C.val_;
    val getListenBacklog_ = _import "g_socket_get_listen_backlog" : GioSocketClass.C.notnull GioSocketClass.C.p -> FFI.Int.C.val_;
    ...
    val getTimeout_ = _import "g_socket_get_timeout" : GioSocketClass.C.notnull GioSocketClass.C.p -> FFI.UInt.C.val_;
    ...
    val setListenBacklog_ = fn x1 & x2 => (_import "g_socket_set_listen_backlog" : GioSocketClass.C.notnull GioSocketClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
    val setTimeout_ = fn x1 & x2 => (_import "g_socket_set_timeout" : GioSocketClass.C.notnull GioSocketClass.C.p * FFI.UInt.C.val_ -> unit;) (x1, x2)
    val shutdown_ =
      fn
        x1
         & x2
