structure GioDBusMessage :>
  ...
  struct
    ...
    val print_ = fn x1 & x2 => (_import "g_dbus_message_print" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.UInt.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
