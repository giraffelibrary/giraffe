structure GioPollableOutputStream :>
  ...
  struct
    ...
    val canPoll_ = _import "g_pollable_output_stream_can_poll" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.C.val_;
    val isWritable_ = _import "g_pollable_output_stream_is_writable" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.C.val_;
