structure GioBufferedOutputStream :>
  ...
  struct
    ...
    val newSized_ = fn x1 & x2 => (_import "g_buffered_output_stream_new_sized" : GioOutputStreamClass.C.notnull GioOutputStreamClass.C.p * FFI.Size.C.val_ -> GioOutputStreamClass.C.notnull GioOutputStreamClass.C.p;) (x1, x2)
    ...
    val getBufferSize_ = _import "g_buffered_output_stream_get_buffer_size" : GioBufferedOutputStreamClass.C.notnull GioBufferedOutputStreamClass.C.p -> FFI.Size.C.val_;
    ...
    val setBufferSize_ = fn x1 & x2 => (_import "g_buffered_output_stream_set_buffer_size" : GioBufferedOutputStreamClass.C.notnull GioBufferedOutputStreamClass.C.p * FFI.Size.C.val_ -> unit;) (x1, x2)
