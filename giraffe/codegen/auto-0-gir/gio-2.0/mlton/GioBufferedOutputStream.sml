structure GioBufferedOutputStream :>
  ...
  struct
    ...
    val newSized_ = fn x1 & x2 => (_import "g_buffered_output_stream_new_sized" : GioOutputStreamClass.FFI.notnull GioOutputStreamClass.FFI.p * GSize.FFI.val_ -> GioOutputStreamClass.FFI.notnull GioOutputStreamClass.FFI.p;) (x1, x2)
    ...
    val getBufferSize_ = _import "g_buffered_output_stream_get_buffer_size" : GioBufferedOutputStreamClass.FFI.notnull GioBufferedOutputStreamClass.FFI.p -> GSize.FFI.val_;
    ...
    val setBufferSize_ = fn x1 & x2 => (_import "g_buffered_output_stream_set_buffer_size" : GioBufferedOutputStreamClass.FFI.notnull GioBufferedOutputStreamClass.FFI.p * GSize.FFI.val_ -> unit;) (x1, x2)
