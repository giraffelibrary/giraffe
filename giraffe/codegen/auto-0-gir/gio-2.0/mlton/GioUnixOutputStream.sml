structure GioUnixOutputStream :>
  ...
  struct
    ...
    val new_ = fn x1 & x2 => (_import "g_unix_output_stream_new" : FFI.Int.C.val_ * FFI.Bool.C.val_ -> GioOutputStreamClass.C.notnull GioOutputStreamClass.C.p;) (x1, x2)
    ...
    val getFd_ = _import "g_unix_output_stream_get_fd" : GioUnixOutputStreamClass.C.notnull GioUnixOutputStreamClass.C.p -> FFI.Int.C.val_;
