structure GioSimpleAsyncResult :>
  ...
  struct
    ...
    val getOpResGssize_ = _import "g_simple_async_result_get_op_res_gssize" : GioSimpleAsyncResultClass.C.notnull GioSimpleAsyncResultClass.C.p -> FFI.SSize.C.val_;
    ...
    val setOpResGssize_ = fn x1 & x2 => (_import "g_simple_async_result_set_op_res_gssize" : GioSimpleAsyncResultClass.C.notnull GioSimpleAsyncResultClass.C.p * FFI.SSize.C.val_ -> unit;) (x1, x2)
