structure GioSimpleAsyncResult :>
  ...
  struct
    ...
    val getOpResGssize_ = _import "g_simple_async_result_get_op_res_gssize" : GioSimpleAsyncResultClass.FFI.non_opt GioSimpleAsyncResultClass.FFI.p -> GSSize.FFI.val_;
    ...
    val setOpResGssize_ = fn x1 & x2 => (_import "g_simple_async_result_set_op_res_gssize" : GioSimpleAsyncResultClass.FFI.non_opt GioSimpleAsyncResultClass.FFI.p * GSSize.FFI.val_ -> unit;) (x1, x2)
    ...
    fun getOpResGssize self = (GioSimpleAsyncResultClass.FFI.withPtr false ---> GSSize.FFI.fromVal) getOpResGssize_ self
    ...
    fun setOpResGssize self opRes = (GioSimpleAsyncResultClass.FFI.withPtr false &&&> GSSize.FFI.withVal ---> I) setOpResGssize_ (self & opRes)
  end
