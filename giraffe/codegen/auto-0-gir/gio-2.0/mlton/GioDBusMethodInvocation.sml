structure GioDBusMethodInvocation :>
  ...
  struct
    ...
    val getInterfaceName_ = _import "g_dbus_method_invocation_get_interface_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.C.notnull FFI.String.C.out_p;
    ...
    val getMethodName_ = _import "g_dbus_method_invocation_get_method_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.C.notnull FFI.String.C.out_p;
    val getObjectPath_ = _import "g_dbus_method_invocation_get_object_path" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.C.notnull FFI.String.C.out_p;
    ...
    val getSender_ = _import "g_dbus_method_invocation_get_sender" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.C.notnull FFI.String.C.out_p;
