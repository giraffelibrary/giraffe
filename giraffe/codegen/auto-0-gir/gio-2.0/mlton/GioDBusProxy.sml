structure GioDBusProxy :>
  ...
  struct
    ...
    val getDefaultTimeout_ = _import "g_dbus_proxy_get_default_timeout" : GioDBusProxyClass.C.notnull GioDBusProxyClass.C.p -> FFI.Int.C.val_;
    ...
    val setDefaultTimeout_ = fn x1 & x2 => (_import "g_dbus_proxy_set_default_timeout" : GioDBusProxyClass.C.notnull GioDBusProxyClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
