structure GioUnixMountPoint :>
  ...
  struct
    val compare_ = fn x1 & x2 => (_import "g_unix_mount_point_compare" : GioUnixMountPointRecord.FFI.notnull GioUnixMountPointRecord.FFI.p * GioUnixMountPointRecord.FFI.notnull GioUnixMountPointRecord.FFI.p -> GInt.FFI.val_;) (x1, x2)
