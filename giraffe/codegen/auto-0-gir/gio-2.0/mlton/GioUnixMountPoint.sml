structure GioUnixMountPoint :>
  ...
  struct
    val compare_ = fn x1 & x2 => (_import "g_unix_mount_point_compare" : GioUnixMountPointRecord.FFI.non_opt GioUnixMountPointRecord.FFI.p * GioUnixMountPointRecord.FFI.non_opt GioUnixMountPointRecord.FFI.p -> GInt.FFI.val_;) (x1, x2)
    ...
    fun compare self mount2 = (GioUnixMountPointRecord.FFI.withPtr &&&> GioUnixMountPointRecord.FFI.withPtr ---> GInt.FFI.fromVal) compare_ (self & mount2)
