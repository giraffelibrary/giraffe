structure GioUnixInputStream :>
  ...
  struct
    ...
    val new_ = fn x1 & x2 => (_import "g_unix_input_stream_new" : GInt.FFI.val_ * GBool.FFI.val_ -> GioInputStreamClass.FFI.non_opt GioInputStreamClass.FFI.p;) (x1, x2)
    ...
    val getFd_ = _import "g_unix_input_stream_get_fd" : GioUnixInputStreamClass.FFI.non_opt GioUnixInputStreamClass.FFI.p -> GInt.FFI.val_;
