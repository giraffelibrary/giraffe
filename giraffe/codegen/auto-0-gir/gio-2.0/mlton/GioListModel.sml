structure GioListModel :>
  ...
  struct
    ...
    val getObject_ = fn x1 & x2 => (_import "g_list_model_get_object" : GioListModelClass.FFI.notnull GioListModelClass.FFI.p * GUInt.FFI.val_ -> GObjectObjectClass.FFI.notnull GObjectObjectClass.FFI.p;) (x1, x2)
    val itemsChanged_ =
      fn
        x1
         & x2
