structure GioMemoryOutputStream :>
  ...
  struct
    ...
    val getDataSize_ = _import "g_memory_output_stream_get_data_size" : GioMemoryOutputStreamClass.C.notnull GioMemoryOutputStreamClass.C.p -> FFI.Size.C.val_;
    val getSize_ = _import "g_memory_output_stream_get_size" : GioMemoryOutputStreamClass.C.notnull GioMemoryOutputStreamClass.C.p -> FFI.Size.C.val_;
