structure GioUnixMountMonitor :>
  ...
  struct
    ...
    val setRateLimit_ = fn x1 & x2 => (_import "g_unix_mount_monitor_set_rate_limit" : GioUnixMountMonitorClass.C.notnull GioUnixMountMonitorClass.C.p * FFI.Int.C.val_ -> unit;) (x1, x2)
