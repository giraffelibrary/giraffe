structure GioDBusInterface :>
  ...
  struct
    ...
    val dupObject_ = _import "g_dbus_interface_dup_object" : GioDBusInterfaceClass.FFI.notnull GioDBusInterfaceClass.FFI.p -> GioDBusObjectClass.FFI.notnull GioDBusObjectClass.FFI.p;
