structure GioApplication :>
  ...
  struct
    ...
    val getInactivityTimeout_ = _import "g_application_get_inactivity_timeout" : GioApplicationClass.C.notnull GioApplicationClass.C.p -> FFI.UInt.C.val_;
    ...
    val setInactivityTimeout_ = fn x1 & x2 => (_import "g_application_set_inactivity_timeout" : GioApplicationClass.C.notnull GioApplicationClass.C.p * FFI.UInt.C.val_ -> unit;) (x1, x2)
