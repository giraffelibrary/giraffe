structure GioBufferedInputStream :>
  ...
  struct
    ...
    val newSized_ = fn x1 & x2 => (_import "g_buffered_input_stream_new_sized" : GioInputStreamClass.C.notnull GioInputStreamClass.C.p * FFI.Size.C.val_ -> GioInputStreamClass.C.notnull GioInputStreamClass.C.p;) (x1, x2)
    val fill_ =
      fn
        x1
         & x2
    ...
    val getAvailable_ = _import "g_buffered_input_stream_get_available" : GioBufferedInputStreamClass.C.notnull GioBufferedInputStreamClass.C.p -> FFI.Size.C.val_;
    val getBufferSize_ = _import "g_buffered_input_stream_get_buffer_size" : GioBufferedInputStreamClass.C.notnull GioBufferedInputStreamClass.C.p -> FFI.Size.C.val_;
    val readByte_ =
      fn
        x1
         & x2
    ...
    val setBufferSize_ = fn x1 & x2 => (_import "g_buffered_input_stream_set_buffer_size" : GioBufferedInputStreamClass.C.notnull GioBufferedInputStreamClass.C.p * FFI.Size.C.val_ -> unit;) (x1, x2)
