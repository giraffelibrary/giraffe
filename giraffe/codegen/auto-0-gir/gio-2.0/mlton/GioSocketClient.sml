structure GioSocketClient :>
  ...
  struct
    ...
    val getTimeout_ = _import "g_socket_client_get_timeout" : GioSocketClientClass.C.notnull GioSocketClientClass.C.p -> FFI.UInt.C.val_;
    ...
    val setTimeout_ = fn x1 & x2 => (_import "g_socket_client_set_timeout" : GioSocketClientClass.C.notnull GioSocketClientClass.C.p * FFI.UInt.C.val_ -> unit;) (x1, x2)
    ...
    fun getTimeout self = (GioSocketClientClass.C.withPtr ---> FFI.UInt.C.fromVal) getTimeout_ self
    ...
    fun setTimeout self timeout = (GioSocketClientClass.C.withPtr &&&> FFI.UInt.C.withVal ---> I) setTimeout_ (self & timeout)
