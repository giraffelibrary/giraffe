structure GioUnixSocketAddress :>
  ...
  struct
    ...
    val getPathLen_ = _import "g_unix_socket_address_get_path_len" : GioUnixSocketAddressClass.C.notnull GioUnixSocketAddressClass.C.p -> FFI.Size.C.val_;
    ...
    fun getPathLen self = (GioUnixSocketAddressClass.C.withPtr ---> FFI.Size.C.fromVal) getPathLen_ self
    local
      open Property
    in
      val addressTypeProp =
