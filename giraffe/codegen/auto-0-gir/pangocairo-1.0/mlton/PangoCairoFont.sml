structure PangoCairoFont :>
  ...
  struct
    ...
    val getScaledFont_ = _import "pango_cairo_font_get_scaled_font" : PangoCairoFontClass.FFI.notnull PangoCairoFontClass.FFI.p -> CairoScaledFontRecord.FFI.notnull CairoScaledFontRecord.FFI.p;
