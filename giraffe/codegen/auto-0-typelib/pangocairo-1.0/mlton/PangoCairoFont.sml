structure PangoCairoFont :>
  ...
  struct
    ...
    val getScaledFont_ = _import "pango_cairo_font_get_scaled_font" : PangoCairoFontClass.C.notnull PangoCairoFontClass.C.p -> CairoScaledFontRecord.C.notnull CairoScaledFontRecord.C.p;
