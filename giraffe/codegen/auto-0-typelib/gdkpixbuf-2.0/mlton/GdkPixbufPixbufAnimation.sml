structure GdkPixbufPixbufAnimation :>
  ...
  struct
    ...
    val getHeight_ = _import "gdk_pixbuf_animation_get_height" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.C.val_;
    ...
    val getWidth_ = _import "gdk_pixbuf_animation_get_width" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.C.val_;
