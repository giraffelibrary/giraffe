structure GdkPixbufPixdata :>
  ...
  struct
    ...
    val serialize_ = fn x1 & x2 => (_import "gdk_pixdata_serialize" : GdkPixbufPixdataRecord.FFI.notnull GdkPixbufPixdataRecord.FFI.p * GUInt32.FFI.ref_ -> GUInt8CVectorN.FFI.notnull GUInt8CVectorN.FFI.out_p;) (x1, x2)
    val toCsource_ =
      fn
        x1
         & (x2, x3)
