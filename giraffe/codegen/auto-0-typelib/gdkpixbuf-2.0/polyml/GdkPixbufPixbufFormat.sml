structure GdkPixbufPixbufFormat :>
  ...
  struct
    ...
    in
      ...
      val getExtensions_ = call (getSymbol "gdk_pixbuf_format_get_extensions") (GdkPixbufPixbufFormatRecord.PolyML.cPtr --> Utf8CPtrArray.PolyML.cOutPtr)
      val getLicense_ = call (getSymbol "gdk_pixbuf_format_get_license") (GdkPixbufPixbufFormatRecord.PolyML.cPtr --> Utf8.PolyML.cOutPtr)
      val getMimeTypes_ = call (getSymbol "gdk_pixbuf_format_get_mime_types") (GdkPixbufPixbufFormatRecord.PolyML.cPtr --> Utf8CPtrArray.PolyML.cOutPtr)
