structure GdkPixbufPixbufAnimation :>
  ...
  struct
    ...
    in
      ...
      val getHeight_ = call (load_sym libgdkpixbuf "gdk_pixbuf_animation_get_height") (GdkPixbufPixbufAnimationClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getWidth_ = call (load_sym libgdkpixbuf "gdk_pixbuf_animation_get_width") (GdkPixbufPixbufAnimationClass.PolyML.cPtr --> GInt32.PolyML.cVal)
