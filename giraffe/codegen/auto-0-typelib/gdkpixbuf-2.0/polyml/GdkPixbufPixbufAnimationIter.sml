structure GdkPixbufPixbufAnimationIter :>
  ...
  struct
    ...
    in
      ...
      val getDelayTime_ = call (load_sym libgdkpixbuf "gdk_pixbuf_animation_iter_get_delay_time") (GdkPixbufPixbufAnimationIterClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
