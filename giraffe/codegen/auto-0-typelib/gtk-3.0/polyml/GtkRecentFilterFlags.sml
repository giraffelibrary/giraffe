structure GtkRecentFilterFlags :>
  sig
    include GTK_RECENT_FILTER_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtk "gtk_recent_filter_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
