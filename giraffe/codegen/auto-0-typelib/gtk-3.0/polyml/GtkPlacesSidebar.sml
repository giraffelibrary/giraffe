structure GtkPlacesSidebar :>
  ...
  struct
    ...
    in
      ...
      val getNthBookmark_ = call (getSymbol "gtk_places_sidebar_get_nth_bookmark") (GtkPlacesSidebarClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> GioFileClass.PolyML.cOptPtr)
