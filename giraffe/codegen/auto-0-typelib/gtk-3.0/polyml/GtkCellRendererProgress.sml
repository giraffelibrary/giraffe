structure GtkCellRendererProgress :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_cell_renderer_progress_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      val new_ = call (getSymbol "gtk_cell_renderer_progress_new") (PolyMLFFI.cVoid --> GtkCellRendererClass.PolyML.cPtr)
    end
