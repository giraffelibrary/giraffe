structure GtkInfoBar :>
  ...
  struct
    ...
    in
      ...
      val response_ = call (load_sym libgtk "gtk_info_bar_response") (GtkInfoBarClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setDefaultResponse_ = call (load_sym libgtk "gtk_info_bar_set_default_response") (GtkInfoBarClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
