structure GtkBox :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgtk "gtk_box_new") (GtkOrientation.PolyML.cVal &&> GInt32.PolyML.cVal --> GtkWidgetClass.PolyML.cPtr)
      val getHomogeneous_ = call (load_sym libgtk "gtk_box_get_homogeneous") (GtkBoxClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getSpacing_ = call (load_sym libgtk "gtk_box_get_spacing") (GtkBoxClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val packEnd_ =
      ...
      val setHomogeneous_ = call (load_sym libgtk "gtk_box_set_homogeneous") (GtkBoxClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setSpacing_ = call (load_sym libgtk "gtk_box_set_spacing") (GtkBoxClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
    end
