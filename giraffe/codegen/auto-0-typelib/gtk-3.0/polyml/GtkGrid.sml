structure GtkGrid :>
  ...
  struct
    ...
    in
      ...
      val getBaselineRow_ = call (getSymbol "gtk_grid_get_baseline_row") (GtkGridClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getChildAt_ =
      ...
      val getRowBaselinePosition_ = call (getSymbol "gtk_grid_get_row_baseline_position") (GtkGridClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> GtkBaselinePosition.PolyML.cVal)
      ...
      val insertColumn_ = call (getSymbol "gtk_grid_insert_column") (GtkGridClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val insertNextTo_ =
      ...
      val insertRow_ = call (getSymbol "gtk_grid_insert_row") (GtkGridClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val removeColumn_ = call (getSymbol "gtk_grid_remove_column") (GtkGridClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val removeRow_ = call (getSymbol "gtk_grid_remove_row") (GtkGridClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val setBaselineRow_ = call (getSymbol "gtk_grid_set_baseline_row") (GtkGridClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      ...
      val setColumnSpacing_ = call (getSymbol "gtk_grid_set_column_spacing") (GtkGridClass.PolyML.cPtr &&> GUInt32.PolyML.cVal --> cVoid)
      ...
      val setRowSpacing_ = call (getSymbol "gtk_grid_set_row_spacing") (GtkGridClass.PolyML.cPtr &&> GUInt32.PolyML.cVal --> cVoid)
    end
    ...
    fun getBaselineRow self = (GtkGridClass.FFI.withPtr ---> GInt32.FFI.fromVal) getBaselineRow_ self
    ...
    fun getRowBaselinePosition self row = (GtkGridClass.FFI.withPtr &&&> GInt32.FFI.withVal ---> GtkBaselinePosition.FFI.fromVal) getRowBaselinePosition_ (self & row)
    ...
    fun removeColumn self position = (GtkGridClass.FFI.withPtr &&&> GInt32.FFI.withVal ---> I) removeColumn_ (self & position)
    fun removeRow self position = (GtkGridClass.FFI.withPtr &&&> GInt32.FFI.withVal ---> I) removeRow_ (self & position)
    fun setBaselineRow self row = (GtkGridClass.FFI.withPtr &&&> GInt32.FFI.withVal ---> I) setBaselineRow_ (self & row)
