structure GtkPrintSettings :>
  ...
  struct
    ...
    in
      ...
      val getInt_ = call (getSymbol "gtk_print_settings_get_int") (GtkPrintSettingsClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> GInt32.PolyML.cVal)
      ...
      val getNCopies_ = call (getSymbol "gtk_print_settings_get_n_copies") (GtkPrintSettingsClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getNumberUp_ = call (getSymbol "gtk_print_settings_get_number_up") (GtkPrintSettingsClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getPageRanges_ = call (getSymbol "gtk_print_settings_get_page_ranges") (GtkPrintSettingsClass.PolyML.cPtr &&> GInt32.PolyML.cRef --> GtkPageRangeRecordCArrayN.PolyML.cOutPtr)
      ...
      val getResolution_ = call (getSymbol "gtk_print_settings_get_resolution") (GtkPrintSettingsClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getResolutionX_ = call (getSymbol "gtk_print_settings_get_resolution_x") (GtkPrintSettingsClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getResolutionY_ = call (getSymbol "gtk_print_settings_get_resolution_y") (GtkPrintSettingsClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val setNCopies_ = call (getSymbol "gtk_print_settings_set_n_copies") (GtkPrintSettingsClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val setNumberUp_ = call (getSymbol "gtk_print_settings_set_number_up") (GtkPrintSettingsClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      ...
      val setResolution_ = call (getSymbol "gtk_print_settings_set_resolution") (GtkPrintSettingsClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
