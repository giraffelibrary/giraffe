structure GtkPrintSettings :>
  ...
  struct
    ...
    in
      ...
      val getInt_ = call (load_sym libgtk "gtk_print_settings_get_int") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INPTR --> FFI.Int32.PolyML.VAL)
    ...
    fun getInt self key = (GObjectObjectClass.C.withPtr &&&> Utf8.C.withConstPtr ---> FFI.Int32.C.fromVal) getInt_ (self & key)
