structure GtkComboBox :>
  ...
  struct
    ...
    in
      ...
      val getActive_ = call (load_sym libgtk "gtk_combo_box_get_active") (GtkComboBoxClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getActiveId_ = call (load_sym libgtk "gtk_combo_box_get_active_id") (GtkComboBoxClass.PolyML.cPtr --> Utf8.PolyML.cOutPtr)
      val getActiveIter_ = call (load_sym libgtk "gtk_combo_box_get_active_iter") (GtkComboBoxClass.PolyML.cPtr &&> GtkTreeIterRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val getAddTearoffs_ = call (load_sym libgtk "gtk_combo_box_get_add_tearoffs") (GtkComboBoxClass.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val getColumnSpanColumn_ = call (load_sym libgtk "gtk_combo_box_get_column_span_column") (GtkComboBoxClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getEntryTextColumn_ = call (load_sym libgtk "gtk_combo_box_get_entry_text_column") (GtkComboBoxClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getFocusOnClick_ = call (load_sym libgtk "gtk_combo_box_get_focus_on_click") (GtkComboBoxClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getHasEntry_ = call (load_sym libgtk "gtk_combo_box_get_has_entry") (GtkComboBoxClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getIdColumn_ = call (load_sym libgtk "gtk_combo_box_get_id_column") (GtkComboBoxClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getPopupFixedWidth_ = call (load_sym libgtk "gtk_combo_box_get_popup_fixed_width") (GtkComboBoxClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getRowSpanColumn_ = call (load_sym libgtk "gtk_combo_box_get_row_span_column") (GtkComboBoxClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getTitle_ = call (load_sym libgtk "gtk_combo_box_get_title") (GtkComboBoxClass.PolyML.cPtr --> Utf8.PolyML.cOutPtr)
      val getWrapWidth_ = call (load_sym libgtk "gtk_combo_box_get_wrap_width") (GtkComboBoxClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val setActive_ = call (load_sym libgtk "gtk_combo_box_set_active") (GtkComboBoxClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setActiveId_ = call (load_sym libgtk "gtk_combo_box_set_active_id") (GtkComboBoxClass.PolyML.cPtr &&> Utf8.PolyML.cInOptPtr --> GBool.PolyML.cVal)
      ...
      val setAddTearoffs_ = call (load_sym libgtk "gtk_combo_box_set_add_tearoffs") (GtkComboBoxClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setColumnSpanColumn_ = call (load_sym libgtk "gtk_combo_box_set_column_span_column") (GtkComboBoxClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setEntryTextColumn_ = call (load_sym libgtk "gtk_combo_box_set_entry_text_column") (GtkComboBoxClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setFocusOnClick_ = call (load_sym libgtk "gtk_combo_box_set_focus_on_click") (GtkComboBoxClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setIdColumn_ = call (load_sym libgtk "gtk_combo_box_set_id_column") (GtkComboBoxClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setPopupFixedWidth_ = call (load_sym libgtk "gtk_combo_box_set_popup_fixed_width") (GtkComboBoxClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setRowSpanColumn_ = call (load_sym libgtk "gtk_combo_box_set_row_span_column") (GtkComboBoxClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setWrapWidth_ = call (load_sym libgtk "gtk_combo_box_set_wrap_width") (GtkComboBoxClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
    end
