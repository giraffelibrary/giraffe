structure GtkComboBox :>
  ...
  struct
    ...
    in
      ...
      val setActive_ = call (load_sym libgtk "gtk_combo_box_set_active") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      ...
      val setColumnSpanColumn_ = call (load_sym libgtk "gtk_combo_box_set_column_span_column") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      val setEntryTextColumn_ = call (load_sym libgtk "gtk_combo_box_set_entry_text_column") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      ...
      val setIdColumn_ = call (load_sym libgtk "gtk_combo_box_set_id_column") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      ...
      val setRowSpanColumn_ = call (load_sym libgtk "gtk_combo_box_set_row_span_column") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      ...
      val setWrapWidth_ = call (load_sym libgtk "gtk_combo_box_set_wrap_width") (GtkComboBoxClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
    end
