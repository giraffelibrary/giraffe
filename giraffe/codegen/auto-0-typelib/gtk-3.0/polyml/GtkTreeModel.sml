structure GtkTreeModel :>
  ...
  struct
    ...
    in
      ...
      val getNColumns_ = call (load_sym libgtk "gtk_tree_model_get_n_columns") (GObjectObjectClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val iterNChildren_ = call (load_sym libgtk "gtk_tree_model_iter_n_children") (GObjectObjectClass.PolyML.cPtr &&> GtkTreeIterRecord.PolyML.cOptPtr --> FFI.Int32.PolyML.cVal)
