structure GtkAboutDialog :>
  ...
  struct
    ...
    in
      ...
      val getComments_ = call (load_sym libgtk "gtk_about_dialog_get_comments") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      val getCopyright_ = call (load_sym libgtk "gtk_about_dialog_get_copyright") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      val getLicense_ = call (load_sym libgtk "gtk_about_dialog_get_license") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      ...
      val getLogoIconName_ = call (load_sym libgtk "gtk_about_dialog_get_logo_icon_name") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      val getProgramName_ = call (load_sym libgtk "gtk_about_dialog_get_program_name") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      val getTranslatorCredits_ = call (load_sym libgtk "gtk_about_dialog_get_translator_credits") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      val getVersion_ = call (load_sym libgtk "gtk_about_dialog_get_version") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      val getWebsite_ = call (load_sym libgtk "gtk_about_dialog_get_website") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      val getWebsiteLabel_ = call (load_sym libgtk "gtk_about_dialog_get_website_label") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      ...
      val setComments_ = call (load_sym libgtk "gtk_about_dialog_set_comments") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INOPTPTR --> FFI.PolyML.VOID)
      val setCopyright_ = call (load_sym libgtk "gtk_about_dialog_set_copyright") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INPTR --> FFI.PolyML.VOID)
      val setLicense_ = call (load_sym libgtk "gtk_about_dialog_set_license") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INOPTPTR --> FFI.PolyML.VOID)
      ...
      val setLogoIconName_ = call (load_sym libgtk "gtk_about_dialog_set_logo_icon_name") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INOPTPTR --> FFI.PolyML.VOID)
      val setProgramName_ = call (load_sym libgtk "gtk_about_dialog_set_program_name") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INPTR --> FFI.PolyML.VOID)
      val setTranslatorCredits_ = call (load_sym libgtk "gtk_about_dialog_set_translator_credits") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INOPTPTR --> FFI.PolyML.VOID)
      val setVersion_ = call (load_sym libgtk "gtk_about_dialog_set_version") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INOPTPTR --> FFI.PolyML.VOID)
      val setWebsite_ = call (load_sym libgtk "gtk_about_dialog_set_website") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INOPTPTR --> FFI.PolyML.VOID)
      val setWebsiteLabel_ = call (load_sym libgtk "gtk_about_dialog_set_website_label") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INPTR --> FFI.PolyML.VOID)
