structure GtkAccelMap :>
  ...
  struct
    ...
    in
      ...
      val loadFd_ = call (getSymbol "gtk_accel_map_load_fd") (GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val saveFd_ = call (getSymbol "gtk_accel_map_save_fd") (GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
