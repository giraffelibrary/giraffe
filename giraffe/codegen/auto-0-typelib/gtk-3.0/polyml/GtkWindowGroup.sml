structure GtkWindowGroup :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_window_group_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      val new_ = call (getSymbol "gtk_window_group_new") (PolyMLFFI.cVoid --> GtkWindowGroupClass.PolyML.cPtr)
      val addWindow_ = call (getSymbol "gtk_window_group_add_window") (GtkWindowGroupClass.PolyML.cPtr &&> GtkWindowClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val getCurrentDeviceGrab_ = call (getSymbol "gtk_window_group_get_current_device_grab") (GtkWindowGroupClass.PolyML.cPtr &&> GdkDeviceClass.PolyML.cPtr --> GtkWidgetClass.PolyML.cPtr)
      ...
      val removeWindow_ = call (getSymbol "gtk_window_group_remove_window") (GtkWindowGroupClass.PolyML.cPtr &&> GtkWindowClass.PolyML.cPtr --> PolyMLFFI.cVoid)
    end
