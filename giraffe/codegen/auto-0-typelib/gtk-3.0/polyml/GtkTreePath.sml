structure GtkTreePath :>
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_tree_path_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      val new_ = call (getSymbol "gtk_tree_path_new") (PolyMLFFI.cVoid --> GtkTreePathRecord.PolyML.cPtr)
      val newFirst_ = call (getSymbol "gtk_tree_path_new_first") (PolyMLFFI.cVoid --> GtkTreePathRecord.PolyML.cPtr)
      val newFromString_ = call (getSymbol "gtk_tree_path_new_from_string") (Utf8.PolyML.cInPtr --> GtkTreePathRecord.PolyML.cPtr)
      val appendIndex_ = call (getSymbol "gtk_tree_path_append_index") (GtkTreePathRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val down_ = call (getSymbol "gtk_tree_path_down") (GtkTreePathRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      ...
      val next_ = call (getSymbol "gtk_tree_path_next") (GtkTreePathRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      val prependIndex_ = call (getSymbol "gtk_tree_path_prepend_index") (GtkTreePathRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
