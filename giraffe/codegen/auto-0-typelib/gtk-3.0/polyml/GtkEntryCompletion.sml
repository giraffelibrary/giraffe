structure GtkEntryCompletion :>
  ...
  struct
    ...
    in
      ...
      val deleteAction_ = call (getSymbol "gtk_entry_completion_delete_action") (GtkEntryCompletionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val getMinimumKeyLength_ = call (getSymbol "gtk_entry_completion_get_minimum_key_length") (GtkEntryCompletionClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getTextColumn_ = call (getSymbol "gtk_entry_completion_get_text_column") (GtkEntryCompletionClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val setMinimumKeyLength_ = call (getSymbol "gtk_entry_completion_set_minimum_key_length") (GtkEntryCompletionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setTextColumn_ = call (getSymbol "gtk_entry_completion_set_text_column") (GtkEntryCompletionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
    end
