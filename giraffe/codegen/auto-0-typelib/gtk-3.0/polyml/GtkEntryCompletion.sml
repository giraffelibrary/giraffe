structure GtkEntryCompletion :>
  ...
  struct
    ...
    in
      ...
      val deleteAction_ = call (load_sym libgtk "gtk_entry_completion_delete_action") (GtkEntryCompletionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val getMinimumKeyLength_ = call (load_sym libgtk "gtk_entry_completion_get_minimum_key_length") (GtkEntryCompletionClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getTextColumn_ = call (load_sym libgtk "gtk_entry_completion_get_text_column") (GtkEntryCompletionClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val setMinimumKeyLength_ = call (load_sym libgtk "gtk_entry_completion_set_minimum_key_length") (GtkEntryCompletionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setTextColumn_ = call (load_sym libgtk "gtk_entry_completion_set_text_column") (GtkEntryCompletionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
    end
    ...
    fun setMinimumKeyLength self length = (GtkEntryCompletionClass.FFI.withPtr &&&> GInt32.FFI.withVal ---> I) setMinimumKeyLength_ (self & length)
    ...
    fun setTextColumn self column = (GtkEntryCompletionClass.FFI.withPtr &&&> GInt32.FFI.withVal ---> I) setTextColumn_ (self & column)
    local
