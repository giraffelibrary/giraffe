structure GtkEntryCompletion :>
  ...
  struct
    ...
    in
      ...
      val deleteAction_ = call (getSymbol "gtk_entry_completion_delete_action") (GtkEntryCompletionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      ...
      val setMinimumKeyLength_ = call (getSymbol "gtk_entry_completion_set_minimum_key_length") (GtkEntryCompletionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      ...
      val setTextColumn_ = call (getSymbol "gtk_entry_completion_set_text_column") (GtkEntryCompletionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
    end
