structure GtkSpinButton :>
  ...
  struct
    ...
    in
      ...
      val getDigits_ = call (load_sym libgtk "gtk_spin_button_get_digits") (GtkSpinButtonClass.PolyML.cPtr --> GUInt32.PolyML.cVal)
      val getIncrements_ =
      ...
      val getValueAsInt_ = call (load_sym libgtk "gtk_spin_button_get_value_as_int") (GtkSpinButtonClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val setDigits_ = call (load_sym libgtk "gtk_spin_button_set_digits") (GtkSpinButtonClass.PolyML.cPtr &&> GUInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setIncrements_ =
