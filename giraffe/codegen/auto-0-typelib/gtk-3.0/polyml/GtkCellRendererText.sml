structure GtkCellRendererText :>
  ...
  struct
    ...
    in
      ...
      val setFixedHeightFromFont_ = call (getSymbol "gtk_cell_renderer_text_set_fixed_height_from_font") (GtkCellRendererTextClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
    end
