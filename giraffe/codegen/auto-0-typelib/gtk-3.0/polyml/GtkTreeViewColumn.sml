structure GtkTreeViewColumn :>
  ...
  struct
    ...
    in
      ...
      val getFixedWidth_ = call (load_sym libgtk "gtk_tree_view_column_get_fixed_width") (GtkTreeViewColumnClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getMaxWidth_ = call (load_sym libgtk "gtk_tree_view_column_get_max_width") (GtkTreeViewColumnClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getMinWidth_ = call (load_sym libgtk "gtk_tree_view_column_get_min_width") (GtkTreeViewColumnClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val getSortColumnId_ = call (load_sym libgtk "gtk_tree_view_column_get_sort_column_id") (GtkTreeViewColumnClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val getSpacing_ = call (load_sym libgtk "gtk_tree_view_column_get_spacing") (GtkTreeViewColumnClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val getWidth_ = call (load_sym libgtk "gtk_tree_view_column_get_width") (GtkTreeViewColumnClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getXOffset_ = call (load_sym libgtk "gtk_tree_view_column_get_x_offset") (GtkTreeViewColumnClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val packEnd_ =
      ...
      val setAlignment_ = call (load_sym libgtk "gtk_tree_view_column_set_alignment") (GtkTreeViewColumnClass.PolyML.cPtr &&> FFI.Float.PolyML.cVal --> PolyMLFFI.cVoid)
      val setClickable_ = call (load_sym libgtk "gtk_tree_view_column_set_clickable") (GtkTreeViewColumnClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setExpand_ = call (load_sym libgtk "gtk_tree_view_column_set_expand") (GtkTreeViewColumnClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setFixedWidth_ = call (load_sym libgtk "gtk_tree_view_column_set_fixed_width") (GtkTreeViewColumnClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setMaxWidth_ = call (load_sym libgtk "gtk_tree_view_column_set_max_width") (GtkTreeViewColumnClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setMinWidth_ = call (load_sym libgtk "gtk_tree_view_column_set_min_width") (GtkTreeViewColumnClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setReorderable_ = call (load_sym libgtk "gtk_tree_view_column_set_reorderable") (GtkTreeViewColumnClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setResizable_ = call (load_sym libgtk "gtk_tree_view_column_set_resizable") (GtkTreeViewColumnClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setSortColumnId_ = call (load_sym libgtk "gtk_tree_view_column_set_sort_column_id") (GtkTreeViewColumnClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setSortIndicator_ = call (load_sym libgtk "gtk_tree_view_column_set_sort_indicator") (GtkTreeViewColumnClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setSpacing_ = call (load_sym libgtk "gtk_tree_view_column_set_spacing") (GtkTreeViewColumnClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setVisible_ = call (load_sym libgtk "gtk_tree_view_column_set_visible") (GtkTreeViewColumnClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> PolyMLFFI.cVoid)
