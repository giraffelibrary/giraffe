structure GtkEntryBuffer :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgtk "gtk_entry_buffer_new") (Utf8.PolyML.INOPTPTR &&> FFI.Int32.PolyML.VAL --> GObjectObjectClass.PolyML.PTR)
      val deleteText_ =
      ...
      val getText_ = call (load_sym libgtk "gtk_entry_buffer_get_text") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      val insertText_ =
