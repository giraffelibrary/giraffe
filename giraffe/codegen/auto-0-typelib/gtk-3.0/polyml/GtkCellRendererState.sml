structure GtkCellRendererState :>
  sig
    include GTK_CELL_RENDERER_STATE
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtk "gtk_cell_renderer_state_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
