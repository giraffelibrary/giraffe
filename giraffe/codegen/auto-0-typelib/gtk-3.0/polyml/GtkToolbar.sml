structure GtkToolbar :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgtk "gtk_toolbar_new") (FFI.PolyML.cVoid --> GtkWidgetClass.PolyML.cPtr)
      val getDropIndex_ =
      ...
      val getIconSize_ = call (load_sym libgtk "gtk_toolbar_get_icon_size") (GtkToolbarClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getItemIndex_ = call (load_sym libgtk "gtk_toolbar_get_item_index") (GtkToolbarClass.PolyML.cPtr &&> GtkToolItemClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getNItems_ = call (load_sym libgtk "gtk_toolbar_get_n_items") (GtkToolbarClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getNthItem_ = call (load_sym libgtk "gtk_toolbar_get_nth_item") (GtkToolbarClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> GtkToolItemClass.PolyML.cPtr)
      ...
      val setIconSize_ = call (load_sym libgtk "gtk_toolbar_set_icon_size") (GtkToolbarClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      val setShowArrow_ = call (load_sym libgtk "gtk_toolbar_set_show_arrow") (GtkToolbarClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> FFI.PolyML.cVoid)
      val setStyle_ = call (load_sym libgtk "gtk_toolbar_set_style") (GtkToolbarClass.PolyML.cPtr &&> GtkToolbarStyle.PolyML.cVal --> FFI.PolyML.cVoid)
      val unsetIconSize_ = call (load_sym libgtk "gtk_toolbar_unset_icon_size") (GtkToolbarClass.PolyML.cPtr --> FFI.PolyML.cVoid)
      val unsetStyle_ = call (load_sym libgtk "gtk_toolbar_unset_style") (GtkToolbarClass.PolyML.cPtr --> FFI.PolyML.cVoid)
    end
    ...
    fun getIconSize self = (GtkToolbarClass.C.withPtr ---> FFI.Int32.C.fromVal) getIconSize_ self
    fun getItemIndex self item = (GtkToolbarClass.C.withPtr &&&> GtkToolItemClass.C.withPtr ---> FFI.Int32.C.fromVal) getItemIndex_ (self & item)
    fun getNItems self = (GtkToolbarClass.C.withPtr ---> FFI.Int32.C.fromVal) getNItems_ self
    fun getNthItem self n = (GtkToolbarClass.C.withPtr &&&> FFI.Int32.C.withVal ---> GtkToolItemClass.C.fromPtr false) getNthItem_ (self & n)
    ...
    fun setIconSize self iconSize = (GtkToolbarClass.C.withPtr &&&> FFI.Int32.C.withVal ---> I) setIconSize_ (self & iconSize)
