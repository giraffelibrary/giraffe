structure GtkWidgetPath :>
  ...
  struct
    ...
    in
      ...
      val appendType_ = call (getSymbol "gtk_widget_path_append_type") (GtkWidgetPathRecord.PolyML.cPtr &&> GObjectType.PolyML.cVal --> GInt32.PolyML.cVal)
      ...
      val iterGetName_ = call (getSymbol "gtk_widget_path_iter_get_name") (GtkWidgetPathRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> Utf8.PolyML.cOutOptPtr)
      val iterGetObjectName_ = call (getSymbol "gtk_widget_path_iter_get_object_name") (GtkWidgetPathRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> Utf8.PolyML.cOutOptPtr)
      val iterGetObjectType_ = call (getSymbol "gtk_widget_path_iter_get_object_type") (GtkWidgetPathRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GObjectType.PolyML.cVal)
      ...
      val iterGetState_ = call (getSymbol "gtk_widget_path_iter_get_state") (GtkWidgetPathRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GtkStateFlags.PolyML.cVal)
      val iterHasClass_ =
