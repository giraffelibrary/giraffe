structure GtkVSeparator :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_vseparator_get_type") (cVoid --> GObjectType.PolyML.cVal)
      val new_ = call (getSymbol "gtk_vseparator_new") (cVoid --> GtkWidgetClass.PolyML.cPtr)
    end
