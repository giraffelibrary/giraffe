structure GtkRadioAction :>
  ...
  struct
    ...
    in
      ...
      val getCurrentValue_ = call (getSymbol "gtk_radio_action_get_current_value") (GtkRadioActionClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val setCurrentValue_ = call (getSymbol "gtk_radio_action_set_current_value") (GtkRadioActionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
    end
