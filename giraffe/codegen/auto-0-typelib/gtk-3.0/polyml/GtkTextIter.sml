structure GtkTextIter :>
  ...
  struct
    ...
    in
      ...
      val setLine_ = call (getSymbol "gtk_text_iter_set_line") (GtkTextIterRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val setLineIndex_ = call (getSymbol "gtk_text_iter_set_line_index") (GtkTextIterRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val setLineOffset_ = call (getSymbol "gtk_text_iter_set_line_offset") (GtkTextIterRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val setOffset_ = call (getSymbol "gtk_text_iter_set_offset") (GtkTextIterRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val setVisibleLineIndex_ = call (getSymbol "gtk_text_iter_set_visible_line_index") (GtkTextIterRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
