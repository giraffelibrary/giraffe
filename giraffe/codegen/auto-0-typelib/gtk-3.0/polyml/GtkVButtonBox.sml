structure GtkVButtonBox :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_vbutton_box_get_type") (cVoid --> GObjectType.PolyML.cVal)
      val new_ = call (getSymbol "gtk_vbutton_box_new") (cVoid --> GtkWidgetClass.PolyML.cPtr)
    end
