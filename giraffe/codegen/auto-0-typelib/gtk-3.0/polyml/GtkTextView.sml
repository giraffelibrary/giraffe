structure GtkTextView :>
  ...
  struct
    ...
    in
      ...
      val getBorderWindowSize_ = call (getSymbol "gtk_text_view_get_border_window_size") (GtkTextViewClass.PolyML.cPtr &&> GtkTextWindowType.PolyML.cVal --> GInt32.PolyML.cVal)
      val getBottomMargin_ = call (getSymbol "gtk_text_view_get_bottom_margin") (GtkTextViewClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getInputHints_ = call (getSymbol "gtk_text_view_get_input_hints") (GtkTextViewClass.PolyML.cPtr --> GtkInputHints.PolyML.cVal)
      val getInputPurpose_ = call (getSymbol "gtk_text_view_get_input_purpose") (GtkTextViewClass.PolyML.cPtr --> GtkInputPurpose.PolyML.cVal)
      ...
      val getLeftMargin_ = call (getSymbol "gtk_text_view_get_left_margin") (GtkTextViewClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getLineAtY_ =
      ...
      val getMonospace_ = call (getSymbol "gtk_text_view_get_monospace") (GtkTextViewClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getOverwrite_ = call (getSymbol "gtk_text_view_get_overwrite") (GtkTextViewClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getPixelsAboveLines_ = call (getSymbol "gtk_text_view_get_pixels_above_lines") (GtkTextViewClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getPixelsBelowLines_ = call (getSymbol "gtk_text_view_get_pixels_below_lines") (GtkTextViewClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getTabs_ = call (getSymbol "gtk_text_view_get_tabs") (GtkTextViewClass.PolyML.cPtr --> PangoTabArrayRecord.PolyML.cOptPtr)
      val getTopMargin_ = call (getSymbol "gtk_text_view_get_top_margin") (GtkTextViewClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getWindow_ = call (getSymbol "gtk_text_view_get_window") (GtkTextViewClass.PolyML.cPtr &&> GtkTextWindowType.PolyML.cVal --> GdkWindowClass.PolyML.cOptPtr)
      ...
      val resetCursorBlink_ = call (getSymbol "gtk_text_view_reset_cursor_blink") (GtkTextViewClass.PolyML.cPtr --> cVoid)
      ...
      val setBottomMargin_ = call (getSymbol "gtk_text_view_set_bottom_margin") (GtkTextViewClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      ...
      val setIndent_ = call (getSymbol "gtk_text_view_set_indent") (GtkTextViewClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val setInputHints_ = call (getSymbol "gtk_text_view_set_input_hints") (GtkTextViewClass.PolyML.cPtr &&> GtkInputHints.PolyML.cVal --> cVoid)
      val setInputPurpose_ = call (getSymbol "gtk_text_view_set_input_purpose") (GtkTextViewClass.PolyML.cPtr &&> GtkInputPurpose.PolyML.cVal --> cVoid)
      ...
      val setLeftMargin_ = call (getSymbol "gtk_text_view_set_left_margin") (GtkTextViewClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val setMonospace_ = call (getSymbol "gtk_text_view_set_monospace") (GtkTextViewClass.PolyML.cPtr &&> GBool.PolyML.cVal --> cVoid)
      val setOverwrite_ = call (getSymbol "gtk_text_view_set_overwrite") (GtkTextViewClass.PolyML.cPtr &&> GBool.PolyML.cVal --> cVoid)
      val setPixelsAboveLines_ = call (getSymbol "gtk_text_view_set_pixels_above_lines") (GtkTextViewClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val setPixelsBelowLines_ = call (getSymbol "gtk_text_view_set_pixels_below_lines") (GtkTextViewClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val setPixelsInsideWrap_ = call (getSymbol "gtk_text_view_set_pixels_inside_wrap") (GtkTextViewClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val setRightMargin_ = call (getSymbol "gtk_text_view_set_right_margin") (GtkTextViewClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val setTabs_ = call (getSymbol "gtk_text_view_set_tabs") (GtkTextViewClass.PolyML.cPtr &&> PangoTabArrayRecord.PolyML.cPtr --> cVoid)
      val setTopMargin_ = call (getSymbol "gtk_text_view_set_top_margin") (GtkTextViewClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
    ...
    fun getBorderWindowSize self type' = (GtkTextViewClass.FFI.withPtr false &&&> GtkTextWindowType.FFI.withVal ---> GInt32.FFI.fromVal) getBorderWindowSize_ (self & type')
    fun getBottomMargin self = (GtkTextViewClass.FFI.withPtr false ---> GInt32.FFI.fromVal) getBottomMargin_ self
    ...
    fun getIndent self = (GtkTextViewClass.FFI.withPtr false ---> GInt32.FFI.fromVal) getIndent_ self
    ...
    fun getLeftMargin self = (GtkTextViewClass.FFI.withPtr false ---> GInt32.FFI.fromVal) getLeftMargin_ self
    ...
    fun getPixelsAboveLines self = (GtkTextViewClass.FFI.withPtr false ---> GInt32.FFI.fromVal) getPixelsAboveLines_ self
    fun getPixelsBelowLines self = (GtkTextViewClass.FFI.withPtr false ---> GInt32.FFI.fromVal) getPixelsBelowLines_ self
    fun getPixelsInsideWrap self = (GtkTextViewClass.FFI.withPtr false ---> GInt32.FFI.fromVal) getPixelsInsideWrap_ self
    fun getRightMargin self = (GtkTextViewClass.FFI.withPtr false ---> GInt32.FFI.fromVal) getRightMargin_ self
    fun getTabs self = (GtkTextViewClass.FFI.withPtr false ---> PangoTabArrayRecord.FFI.fromOptPtr true) getTabs_ self
    fun getTopMargin self = (GtkTextViewClass.FFI.withPtr false ---> GInt32.FFI.fromVal) getTopMargin_ self
    ...
    fun setBottomMargin self bottomMargin = (GtkTextViewClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) setBottomMargin_ (self & bottomMargin)
    ...
    fun setIndent self indent = (GtkTextViewClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) setIndent_ (self & indent)
    ...
    fun setLeftMargin self leftMargin = (GtkTextViewClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) setLeftMargin_ (self & leftMargin)
    ...
    fun setPixelsAboveLines self pixelsAboveLines = (GtkTextViewClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) setPixelsAboveLines_ (self & pixelsAboveLines)
    fun setPixelsBelowLines self pixelsBelowLines = (GtkTextViewClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) setPixelsBelowLines_ (self & pixelsBelowLines)
    fun setPixelsInsideWrap self pixelsInsideWrap = (GtkTextViewClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) setPixelsInsideWrap_ (self & pixelsInsideWrap)
    fun setRightMargin self rightMargin = (GtkTextViewClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) setRightMargin_ (self & rightMargin)
    fun setTabs self tabs = (GtkTextViewClass.FFI.withPtr false &&&> PangoTabArrayRecord.FFI.withPtr false ---> I) setTabs_ (self & tabs)
    fun setTopMargin self topMargin = (GtkTextViewClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) setTopMargin_ (self & topMargin)
