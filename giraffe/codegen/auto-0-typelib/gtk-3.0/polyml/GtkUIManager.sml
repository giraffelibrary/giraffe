structure GtkUIManager :>
  ...
  struct
    ...
    in
      ...
      val newMergeId_ = call (load_sym libgtk "gtk_ui_manager_new_merge_id") (GtkUIManagerClass.PolyML.cPtr --> GUInt32.PolyML.cVal)
      ...
      val removeUi_ = call (load_sym libgtk "gtk_ui_manager_remove_ui") (GtkUIManagerClass.PolyML.cPtr &&> GUInt32.PolyML.cVal --> PolyMLFFI.cVoid)
