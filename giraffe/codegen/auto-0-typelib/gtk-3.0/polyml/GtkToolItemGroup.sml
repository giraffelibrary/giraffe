structure GtkToolItemGroup :>
  ...
  struct
    ...
    in
      ...
      val getCollapsed_ = call (load_sym libgtk "gtk_tool_item_group_get_collapsed") (GtkToolItemGroupClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getDropItem_ =
      ...
      val getItemPosition_ = call (load_sym libgtk "gtk_tool_item_group_get_item_position") (GtkToolItemGroupClass.PolyML.cPtr &&> GtkToolItemClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getNItems_ = call (load_sym libgtk "gtk_tool_item_group_get_n_items") (GtkToolItemGroupClass.PolyML.cPtr --> GUInt32.PolyML.cVal)
      val getNthItem_ = call (load_sym libgtk "gtk_tool_item_group_get_nth_item") (GtkToolItemGroupClass.PolyML.cPtr &&> GUInt32.PolyML.cVal --> GtkToolItemClass.PolyML.cPtr)
      val insert_ =
      ...
      val setCollapsed_ = call (load_sym libgtk "gtk_tool_item_group_set_collapsed") (GtkToolItemGroupClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
