structure GtkListBox :>
  ...
  struct
    ...
    in
      ...
      val getRowAtIndex_ = call (getSymbol "gtk_list_box_get_row_at_index") (GtkListBoxClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> GtkListBoxRowClass.PolyML.cOptPtr)
      val getRowAtY_ = call (getSymbol "gtk_list_box_get_row_at_y") (GtkListBoxClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> GtkListBoxRowClass.PolyML.cOptPtr)
