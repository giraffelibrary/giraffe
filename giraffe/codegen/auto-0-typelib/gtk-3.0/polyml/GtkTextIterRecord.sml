structure GtkTextIterRecord :> GTK_TEXT_ITER_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val new_ = call (getSymbol "giraffe_gtk_text_iter_new") (PolyMLFFI.cVoid --> cPtr)
      val copy_ = call (getSymbol "giraffe_gtk_text_iter_copy") (cPtr &&> cPtr --> PolyMLFFI.cVoid)
      val free_ = call (getSymbol "giraffe_gtk_text_iter_free") (cPtr --> PolyMLFFI.cVoid)
      val size_ = call (getSymbol "giraffe_gtk_text_iter_size") (PolyMLFFI.cVoid --> GUInt.PolyML.cVal)
    end
    structure Record =
      BoxedValueRecord(
