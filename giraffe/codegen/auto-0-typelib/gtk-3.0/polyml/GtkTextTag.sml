structure GtkTextTag :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtk "gtk_text_tag_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      val new_ = call (load_sym libgtk "gtk_text_tag_new") (Utf8.PolyML.cInOptPtr --> GtkTextTagClass.PolyML.cPtr)
      val event_ =
      ...
      val getPriority_ = call (load_sym libgtk "gtk_text_tag_get_priority") (GtkTextTagClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val setPriority_ = call (load_sym libgtk "gtk_text_tag_set_priority") (GtkTextTagClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> PolyMLFFI.cVoid)
    end
    ...
    fun getPriority self = (GtkTextTagClass.C.withPtr ---> FFI.Int32.C.fromVal) getPriority_ self
    fun setPriority self priority = (GtkTextTagClass.C.withPtr &&&> FFI.Int32.C.withVal ---> I) setPriority_ (self & priority)
    local
