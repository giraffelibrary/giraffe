structure GtkCellAccessibleParent :>
  ...
  struct
    ...
    in
      ...
      val getChildIndex_ = call (getSymbol "gtk_cell_accessible_parent_get_child_index") (GtkCellAccessibleParentClass.PolyML.cPtr &&> GtkCellAccessibleClass.PolyML.cPtr --> GInt32.PolyML.cVal)
