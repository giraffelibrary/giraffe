structure GtkButtonAccessibleClass :>
  ...
  struct
    ...
    type 'a button_accessible = unit
    type 'a class = 'a button_accessible class
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_button_accessible_get_type") (cVoid --> GObjectType.PolyML.cVal)
