structure GtkStack :>
  ...
  struct
    ...
    in
      ...
      val getTransitionDuration_ = call (getSymbol "gtk_stack_get_transition_duration") (GtkStackClass.PolyML.cPtr --> GUInt32.PolyML.cVal)
      ...
      val setTransitionDuration_ = call (getSymbol "gtk_stack_set_transition_duration") (GtkStackClass.PolyML.cPtr &&> GUInt32.PolyML.cVal --> cVoid)
