structure GtkAccessible :>
  ...
  struct
    ...
    in
      ...
      val connectWidgetDestroyed_ = call (load_sym libgtk "gtk_accessible_connect_widget_destroyed") (GtkAccessibleClass.PolyML.cPtr --> FFI.PolyML.cVoid)
      val getWidget_ = call (load_sym libgtk "gtk_accessible_get_widget") (GtkAccessibleClass.PolyML.cPtr --> GtkWidgetClass.PolyML.cPtr)
      val setWidget_ = call (load_sym libgtk "gtk_accessible_set_widget") (GtkAccessibleClass.PolyML.cPtr &&> GtkWidgetClass.PolyML.cPtr --> FFI.PolyML.cVoid)
    end
