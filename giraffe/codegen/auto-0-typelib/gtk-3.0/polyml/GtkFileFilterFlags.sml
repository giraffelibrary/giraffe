structure GtkFileFilterFlags :>
  sig
    include GTK_FILE_FILTER_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtk "gtk_file_filter_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
