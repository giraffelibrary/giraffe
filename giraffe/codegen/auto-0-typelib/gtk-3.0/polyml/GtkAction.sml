structure GtkAction :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_action_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      val new_ =
      ...
      val activate_ = call (getSymbol "gtk_action_activate") (GtkActionClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val blockActivate_ = call (getSymbol "gtk_action_block_activate") (GtkActionClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val connectAccelerator_ = call (getSymbol "gtk_action_connect_accelerator") (GtkActionClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val createIcon_ = call (getSymbol "gtk_action_create_icon") (GtkActionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> GtkWidgetClass.PolyML.cPtr)
      ...
      val disconnectAccelerator_ = call (getSymbol "gtk_action_disconnect_accelerator") (GtkActionClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      ...
      val setAccelGroup_ = call (getSymbol "gtk_action_set_accel_group") (GtkActionClass.PolyML.cPtr &&> GtkAccelGroupClass.PolyML.cOptPtr --> PolyMLFFI.cVoid)
      val setAccelPath_ = call (getSymbol "gtk_action_set_accel_path") (GtkActionClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
      val setAlwaysShowImage_ = call (getSymbol "gtk_action_set_always_show_image") (GtkActionClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setGicon_ = call (getSymbol "gtk_action_set_gicon") (GtkActionClass.PolyML.cPtr &&> GioIconClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val setIconName_ = call (getSymbol "gtk_action_set_icon_name") (GtkActionClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
      val setIsImportant_ = call (getSymbol "gtk_action_set_is_important") (GtkActionClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setLabel_ = call (getSymbol "gtk_action_set_label") (GtkActionClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
      val setSensitive_ = call (getSymbol "gtk_action_set_sensitive") (GtkActionClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setShortLabel_ = call (getSymbol "gtk_action_set_short_label") (GtkActionClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
      val setStockId_ = call (getSymbol "gtk_action_set_stock_id") (GtkActionClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
      val setTooltip_ = call (getSymbol "gtk_action_set_tooltip") (GtkActionClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
      val setVisible_ = call (getSymbol "gtk_action_set_visible") (GtkActionClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setVisibleHorizontal_ = call (getSymbol "gtk_action_set_visible_horizontal") (GtkActionClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setVisibleVertical_ = call (getSymbol "gtk_action_set_visible_vertical") (GtkActionClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val unblockActivate_ = call (getSymbol "gtk_action_unblock_activate") (GtkActionClass.PolyML.cPtr --> PolyMLFFI.cVoid)
    end
