structure GtkIconInfo :>
  ...
  struct
    ...
    in
      ...
      val getBaseSize_ = call (load_sym libgtk "gtk_icon_info_get_base_size") (GtkIconInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getEmbeddedRect_ = call (load_sym libgtk "gtk_icon_info_get_embedded_rect") (GtkIconInfoRecord.PolyML.cPtr &&> CairoRectangleIntRecord.PolyML.cPtr --> GBool.PolyML.cVal)
