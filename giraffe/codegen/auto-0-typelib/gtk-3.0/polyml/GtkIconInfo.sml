structure GtkIconInfo :>
  ...
  struct
    ...
    in
      ...
      val getBaseSize_ = call (getSymbol "gtk_icon_info_get_base_size") (GtkIconInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getEmbeddedRect_ = call (getSymbol "gtk_icon_info_get_embedded_rect") (GtkIconInfoRecord.PolyML.cPtr &&> CairoRectangleIntRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val setRawCoordinates_ = call (getSymbol "gtk_icon_info_set_raw_coordinates") (GtkIconInfoRecord.PolyML.cPtr &&> GBool.PolyML.cVal --> cVoid)
    end
