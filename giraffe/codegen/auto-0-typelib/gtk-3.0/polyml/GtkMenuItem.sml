structure GtkMenuItem :>
  ...
  struct
    ...
    in
      ...
      val newWithLabel_ = call (load_sym libgtk "gtk_menu_item_new_with_label") (Utf8.PolyML.INPTR --> GObjectObjectClass.PolyML.PTR)
      val newWithMnemonic_ = call (load_sym libgtk "gtk_menu_item_new_with_mnemonic") (Utf8.PolyML.INPTR --> GObjectObjectClass.PolyML.PTR)
      ...
      val getAccelPath_ = call (load_sym libgtk "gtk_menu_item_get_accel_path") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      val getLabel_ = call (load_sym libgtk "gtk_menu_item_get_label") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      ...
      val setAccelPath_ = call (load_sym libgtk "gtk_menu_item_set_accel_path") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INOPTPTR --> FFI.PolyML.VOID)
      val setLabel_ = call (load_sym libgtk "gtk_menu_item_set_label") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INPTR --> FFI.PolyML.VOID)
      ...
      val toggleSizeAllocate_ = call (load_sym libgtk "gtk_menu_item_toggle_size_allocate") (GObjectObjectClass.PolyML.PTR &&> FFI.Int32.PolyML.VAL --> FFI.PolyML.VOID)
    end
