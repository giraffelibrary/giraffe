structure GtkMenuItem :>
  ...
  struct
    ...
    in
      ...
      val toggleSizeAllocate_ = call (getSymbol "gtk_menu_item_toggle_size_allocate") (GtkMenuItemClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val toggleSizeRequest_ = call (getSymbol "gtk_menu_item_toggle_size_request") (GtkMenuItemClass.PolyML.cPtr &&> GInt32.PolyML.cRef --> cVoid)
    end
