structure GtkTextMark :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgtk "gtk_text_mark_new") (Utf8.PolyML.cInOptPtr &&> GBool.PolyML.cVal --> GtkTextMarkClass.PolyML.cPtr)
      val getBuffer_ = call (load_sym libgtk "gtk_text_mark_get_buffer") (GtkTextMarkClass.PolyML.cPtr --> GtkTextBufferClass.PolyML.cPtr)
      val getDeleted_ = call (load_sym libgtk "gtk_text_mark_get_deleted") (GtkTextMarkClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getLeftGravity_ = call (load_sym libgtk "gtk_text_mark_get_left_gravity") (GtkTextMarkClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val getName_ = call (load_sym libgtk "gtk_text_mark_get_name") (GtkTextMarkClass.PolyML.cPtr --> Utf8.PolyML.cOutPtr)
      val getVisible_ = call (load_sym libgtk "gtk_text_mark_get_visible") (GtkTextMarkClass.PolyML.cPtr --> GBool.PolyML.cVal)
      val setVisible_ = call (load_sym libgtk "gtk_text_mark_set_visible") (GtkTextMarkClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
    end
