structure GtkTextMark :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_text_mark_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      ...
      val setVisible_ = call (getSymbol "gtk_text_mark_set_visible") (GtkTextMarkClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
    end
