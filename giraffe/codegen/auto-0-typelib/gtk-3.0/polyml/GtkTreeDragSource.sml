structure GtkTreeDragSource :>
  ...
  struct
    ...
    in
      ...
      val dragDataDelete_ = call (load_sym libgtk "gtk_tree_drag_source_drag_data_delete") (GtkTreeDragSourceClass.PolyML.cPtr &&> GtkTreePathRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val rowDraggable_ = call (load_sym libgtk "gtk_tree_drag_source_row_draggable") (GtkTreeDragSourceClass.PolyML.cPtr &&> GtkTreePathRecord.PolyML.cPtr --> GBool.PolyML.cVal)
    end
