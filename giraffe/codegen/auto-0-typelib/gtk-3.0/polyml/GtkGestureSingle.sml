structure GtkGestureSingle :>
  ...
  struct
    ...
    fun getButton self = (GtkGestureSingleClass.FFI.withPtr ---> GUInt32.FFI.fromVal) getButton_ self
    fun getCurrentButton self = (GtkGestureSingleClass.FFI.withPtr ---> GUInt32.FFI.fromVal) getCurrentButton_ self
    ...
    fun setButton self button = (GtkGestureSingleClass.FFI.withPtr &&&> GUInt32.FFI.withVal ---> I) setButton_ (self & button)
