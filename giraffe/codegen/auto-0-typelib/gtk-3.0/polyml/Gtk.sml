structure Gtk : GTK =
  struct
    ...
    in
      ...
      val acceleratorGetLabel_ = call (load_sym libgtk "gtk_accelerator_get_label") (GUInt32.PolyML.cVal &&> GdkModifierType.PolyML.cVal --> Utf8.PolyML.cOutPtr)
      val acceleratorName_ = call (load_sym libgtk "gtk_accelerator_name") (GUInt32.PolyML.cVal &&> GdkModifierType.PolyML.cVal --> Utf8.PolyML.cOutPtr)
      ...
      val acceleratorValid_ = call (load_sym libgtk "gtk_accelerator_valid") (GUInt32.PolyML.cVal &&> GdkModifierType.PolyML.cVal --> GBool.PolyML.cVal)
      ...
      val builderErrorQuark_ = call (load_sym libgtk "gtk_builder_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      ...
      val cssProviderErrorQuark_ = call (load_sym libgtk "gtk_css_provider_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val deviceGrabAdd_ =
      ...
      val fileChooserErrorQuark_ = call (load_sym libgtk "gtk_file_chooser_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val getBinaryAge_ = call (load_sym libgtk "gtk_get_binary_age") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      ...
      val getDebugFlags_ = call (load_sym libgtk "gtk_get_debug_flags") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      ...
      val getInterfaceAge_ = call (load_sym libgtk "gtk_get_interface_age") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val getMajorVersion_ = call (load_sym libgtk "gtk_get_major_version") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val getMicroVersion_ = call (load_sym libgtk "gtk_get_micro_version") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val getMinorVersion_ = call (load_sym libgtk "gtk_get_minor_version") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val grabGetCurrent_ = call (load_sym libgtk "gtk_grab_get_current") (PolyMLFFI.cVoid --> GtkWidgetClass.PolyML.cPtr)
      val iconSizeFromName_ = call (load_sym libgtk "gtk_icon_size_from_name") (Utf8.PolyML.cInPtr --> GInt32.PolyML.cVal)
      val iconSizeGetName_ = call (load_sym libgtk "gtk_icon_size_get_name") (GInt32.PolyML.cVal --> Utf8.PolyML.cOutPtr)
      val iconSizeLookup_ =
      ...
      val iconSizeRegisterAlias_ = call (load_sym libgtk "gtk_icon_size_register_alias") (Utf8.PolyML.cInPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val iconThemeErrorQuark_ = call (load_sym libgtk "gtk_icon_theme_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val init_ = call (load_sym libgtk "gtk_init") (GInt32.PolyML.cRef &&> Utf8CVectorN.PolyML.cInOutRef --> PolyMLFFI.cVoid)
      val initCheck_ = call (load_sym libgtk "gtk_init_check") (GInt32.PolyML.cRef &&> Utf8CVectorN.PolyML.cInOutRef --> GBool.PolyML.cVal)
      val keySnooperRemove_ = call (load_sym libgtk "gtk_key_snooper_remove") (GUInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val mainLevel_ = call (load_sym libgtk "gtk_main_level") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      ...
      val parseArgs_ = call (load_sym libgtk "gtk_parse_args") (GInt32.PolyML.cRef &&> Utf8CVectorN.PolyML.cInOutRef --> GBool.PolyML.cVal)
      val printErrorQuark_ = call (load_sym libgtk "gtk_print_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      ...
      val recentChooserErrorQuark_ = call (load_sym libgtk "gtk_recent_chooser_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val recentManagerErrorQuark_ = call (load_sym libgtk "gtk_recent_manager_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val renderActivity_ =
      ...
      val setDebugFlags_ = call (load_sym libgtk "gtk_set_debug_flags") (GUInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val showUri_ =
      ...
      val targetsIncludeText_ = call (load_sym libgtk "gtk_targets_include_text") (GdkAtomRecordCVectorN.PolyML.cInPtr &&> GInt32.PolyML.cVal --> GBool.PolyML.cVal)
      val targetsIncludeUri_ = call (load_sym libgtk "gtk_targets_include_uri") (GdkAtomRecordCVectorN.PolyML.cInPtr &&> GInt32.PolyML.cVal --> GBool.PolyML.cVal)
