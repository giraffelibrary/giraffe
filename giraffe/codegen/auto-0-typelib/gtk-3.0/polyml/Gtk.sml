structure Gtk : GTK =
  struct
    ...
    in
      ...
      val builderErrorQuark_ = call (load_sym libgtk "gtk_builder_error_quark") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      ...
      val cssProviderErrorQuark_ = call (load_sym libgtk "gtk_css_provider_error_quark") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      val deviceGrabAdd_ =
      ...
      val disableSetlocale_ = call (load_sym libgtk "gtk_disable_setlocale") (PolyMLFFI.cVoid --> PolyMLFFI.cVoid)
      val dragFinish_ =
      ...
      val dragSetIconDefault_ = call (load_sym libgtk "gtk_drag_set_icon_default") (GdkDragContextClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      ...
      val fileChooserErrorQuark_ = call (load_sym libgtk "gtk_file_chooser_error_quark") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      val getBinaryAge_ = call (load_sym libgtk "gtk_get_binary_age") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      ...
      val getDebugFlags_ = call (load_sym libgtk "gtk_get_debug_flags") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      ...
      val getInterfaceAge_ = call (load_sym libgtk "gtk_get_interface_age") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      val getMajorVersion_ = call (load_sym libgtk "gtk_get_major_version") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      val getMicroVersion_ = call (load_sym libgtk "gtk_get_micro_version") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      val getMinorVersion_ = call (load_sym libgtk "gtk_get_minor_version") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      ...
      val iconSizeRegisterAlias_ = call (load_sym libgtk "gtk_icon_size_register_alias") (Utf8.PolyML.cInPtr &&> FFI.Int32.PolyML.cVal --> PolyMLFFI.cVoid)
      val iconThemeErrorQuark_ = call (load_sym libgtk "gtk_icon_theme_error_quark") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      val keySnooperRemove_ = call (load_sym libgtk "gtk_key_snooper_remove") (FFI.UInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val mainLevel_ = call (load_sym libgtk "gtk_main_level") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      ...
      val printErrorQuark_ = call (load_sym libgtk "gtk_print_error_quark") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      ...
      val recentChooserErrorQuark_ = call (load_sym libgtk "gtk_recent_chooser_error_quark") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      val recentManagerErrorQuark_ = call (load_sym libgtk "gtk_recent_manager_error_quark") (PolyMLFFI.cVoid --> FFI.UInt32.PolyML.cVal)
      val renderActivity_ =
      ...
      val setDebugFlags_ = call (load_sym libgtk "gtk_set_debug_flags") (FFI.UInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val showUri_ =
