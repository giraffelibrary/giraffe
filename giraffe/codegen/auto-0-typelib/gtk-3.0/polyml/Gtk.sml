structure Gtk : GTK =
  struct
    ...
    in
      ...
      val builderErrorQuark_ = call (getSymbol "gtk_builder_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      ...
      val cssProviderErrorQuark_ = call (getSymbol "gtk_css_provider_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val deviceGrabAdd_ =
      ...
      val fileChooserErrorQuark_ = call (getSymbol "gtk_file_chooser_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val getBinaryAge_ = call (getSymbol "gtk_get_binary_age") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      ...
      val getDebugFlags_ = call (getSymbol "gtk_get_debug_flags") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      ...
      val getInterfaceAge_ = call (getSymbol "gtk_get_interface_age") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val getMajorVersion_ = call (getSymbol "gtk_get_major_version") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val getMicroVersion_ = call (getSymbol "gtk_get_micro_version") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val getMinorVersion_ = call (getSymbol "gtk_get_minor_version") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      ...
      val iconSizeRegisterAlias_ = call (getSymbol "gtk_icon_size_register_alias") (Utf8.PolyML.cInPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val iconThemeErrorQuark_ = call (getSymbol "gtk_icon_theme_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val init_ = call (getSymbol "gtk_init") (GInt32.PolyML.cRef &&> Utf8CVectorN.PolyML.cInOutRef --> PolyMLFFI.cVoid)
      val initCheck_ = call (getSymbol "gtk_init_check") (GInt32.PolyML.cRef &&> Utf8CVectorN.PolyML.cInOutRef --> GBool.PolyML.cVal)
      val keySnooperRemove_ = call (getSymbol "gtk_key_snooper_remove") (GUInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val mainLevel_ = call (getSymbol "gtk_main_level") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      ...
      val printErrorQuark_ = call (getSymbol "gtk_print_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      ...
      val recentChooserErrorQuark_ = call (getSymbol "gtk_recent_chooser_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val recentManagerErrorQuark_ = call (getSymbol "gtk_recent_manager_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      val renderActivity_ =
      ...
      val setDebugFlags_ = call (getSymbol "gtk_set_debug_flags") (GUInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val showUri_ =
