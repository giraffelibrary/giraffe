  ...
  struct
    ...
    fun new types =
      let
        ...
        val retVal = (GInt32.FFI.withVal &&&> GObjectTypeCArrayN.FFI.withPtr 0 ---> GtkListStoreClass.FFI.fromPtr true) new_ (nColumns & types)
      in
        retVal
      end
    fun append self =
    ...
    fun reorder self newOrder = (GtkListStoreClass.FFI.withPtr false &&&> GInt32CArray.FFI.withPtr 0 ---> I) reorder_ (self & newOrder)
