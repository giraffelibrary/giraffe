structure GtkColorSelection :>
  ...
  struct
    ...
    in
      ...
      val paletteToString_ = call (getSymbol "gtk_color_selection_palette_to_string") (GdkColorRecordCArrayN.PolyML.cInPtr &&> GInt32.PolyML.cVal --> Utf8.PolyML.cOutPtr)
    ...
    fun paletteToString colors =
      let
        ...
        val retVal = (GdkColorRecordCArrayN.FFI.withPtr 0 &&&> GInt32.FFI.withVal ---> Utf8.FFI.fromPtr ~1) paletteToString_ (colors & nColors)
      in
        retVal
      end
