    ...
    in
      ...
      val paletteFromString_ =
        call (getSymbol "gtk_color_selection_palette_from_string")
          (
            Utf8.PolyML.cInPtr
             &&> GdkColorRecordCVectorN.PolyML.cOutRef
             &&> GInt32.PolyML.cRef
             --> GBool.PolyML.cVal
          )
      val paletteToString_ = call (getSymbol "gtk_color_selection_palette_to_string") (GdkColorRecordCVectorN.PolyML.cInPtr &&> GInt32.PolyML.cVal --> Utf8.PolyML.cOutPtr)
