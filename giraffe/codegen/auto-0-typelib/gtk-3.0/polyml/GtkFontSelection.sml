structure GtkFontSelection :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtk "gtk_font_selection_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      val new_ = call (load_sym libgtk "gtk_font_selection_new") (PolyMLFFI.cVoid --> GtkWidgetClass.PolyML.cPtr)
    end
