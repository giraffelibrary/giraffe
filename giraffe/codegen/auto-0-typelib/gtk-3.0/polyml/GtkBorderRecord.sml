structure GtkBorderRecord :> GTK_BORDER_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val new_ = call (getSymbol "giraffe_gtk_border_new") (PolyMLFFI.cVoid --> cPtr)
      val copy_ = call (getSymbol "giraffe_gtk_border_copy") (cPtr &&> cPtr --> PolyMLFFI.cVoid)
      val free_ = call (getSymbol "giraffe_gtk_border_free") (cPtr --> PolyMLFFI.cVoid)
      val size_ = call (getSymbol "giraffe_gtk_border_size") (PolyMLFFI.cVoid --> GUInt.PolyML.cVal)
    end
    structure Record =
      BoxedValueRecord(
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_border_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
