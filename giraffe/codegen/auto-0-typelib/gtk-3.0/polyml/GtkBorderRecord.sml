structure GtkBorderRecord :> GTK_BORDER_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val new_ = call (getSymbol "giraffe_gtk_border_new") (cVoid --> cPtr)
      val copy_ = call (getSymbol "giraffe_gtk_border_copy") (cPtr &&> cPtr --> cVoid)
      val free_ = call (getSymbol "giraffe_gtk_border_free") (cPtr --> cVoid)
      val size_ = call (getSymbol "giraffe_gtk_border_size") (cVoid --> GUInt.PolyML.cVal)
    end
    structure Record =
      BoxedValueRecord(
