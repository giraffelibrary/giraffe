structure GtkContainer :>
  ...
  struct
    ...
    in
      ...
      val getBorderWidth_ = call (load_sym libgtk "gtk_container_get_border_width") (GtkContainerClass.PolyML.cPtr --> FFI.UInt32.PolyML.cVal)
      ...
      val setBorderWidth_ = call (load_sym libgtk "gtk_container_set_border_width") (GtkContainerClass.PolyML.cPtr &&> FFI.UInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setReallocateRedraws_ = call (load_sym libgtk "gtk_container_set_reallocate_redraws") (GtkContainerClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> PolyMLFFI.cVoid)
