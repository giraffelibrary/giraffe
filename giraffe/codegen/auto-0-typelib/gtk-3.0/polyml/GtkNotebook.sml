structure GtkNotebook :>
  ...
  struct
    ...
    in
      ...
      val getCurrentPage_ = call (load_sym libgtk "gtk_notebook_get_current_page") (GtkNotebookClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val getNPages_ = call (load_sym libgtk "gtk_notebook_get_n_pages") (GtkNotebookClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getNthPage_ = call (load_sym libgtk "gtk_notebook_get_nth_page") (GtkNotebookClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> GtkWidgetClass.PolyML.cPtr)
      ...
      val pageNum_ = call (load_sym libgtk "gtk_notebook_page_num") (GtkNotebookClass.PolyML.cPtr &&> GtkWidgetClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val removePage_ = call (load_sym libgtk "gtk_notebook_remove_page") (GtkNotebookClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      val reorderChild_ =
      ...
      val setCurrentPage_ = call (load_sym libgtk "gtk_notebook_set_current_page") (GtkNotebookClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
