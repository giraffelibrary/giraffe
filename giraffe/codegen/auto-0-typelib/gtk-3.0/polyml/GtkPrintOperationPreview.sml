structure GtkPrintOperationPreview :>
  ...
  struct
    ...
    in
      ...
      val renderPage_ = call (load_sym libgtk "gtk_print_operation_preview_render_page") (GtkPrintOperationPreviewClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> PolyMLFFI.cVoid)
    end
