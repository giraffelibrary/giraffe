structure GtkSelectionData :>
  ...
  struct
    ...
    in
      ...
      val getFormat_ = call (load_sym libgtk "gtk_selection_data_get_format") (GtkSelectionDataRecord.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getLength_ = call (load_sym libgtk "gtk_selection_data_get_length") (GtkSelectionDataRecord.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val setPixbuf_ = call (load_sym libgtk "gtk_selection_data_set_pixbuf") (GtkSelectionDataRecord.PolyML.cPtr &&> GdkPixbufPixbufClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val setText_ =
      ...
      val targetsIncludeRichText_ = call (load_sym libgtk "gtk_selection_data_targets_include_rich_text") (GtkSelectionDataRecord.PolyML.cPtr &&> GtkTextBufferClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
