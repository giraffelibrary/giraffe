structure GtkSelectionData :>
  ...
  struct
    ...
    in
      ...
      val getData_ = call (load_sym libgtk "gtk_selection_data_get_data_with_length") (GtkSelectionDataRecord.PolyML.cPtr &&> GInt32.PolyML.cRef --> GUInt8CVectorN.PolyML.cOutPtr)
      ...
      val getFormat_ = call (load_sym libgtk "gtk_selection_data_get_format") (GtkSelectionDataRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getLength_ = call (load_sym libgtk "gtk_selection_data_get_length") (GtkSelectionDataRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
