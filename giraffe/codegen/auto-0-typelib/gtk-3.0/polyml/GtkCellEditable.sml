structure GtkCellEditable :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtk "gtk_cell_editable_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      val editingDone_ = call (load_sym libgtk "gtk_cell_editable_editing_done") (GtkCellEditableClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val removeWidget_ = call (load_sym libgtk "gtk_cell_editable_remove_widget") (GtkCellEditableClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val startEditing_ = call (load_sym libgtk "gtk_cell_editable_start_editing") (GtkCellEditableClass.PolyML.cPtr &&> GdkEvent.PolyML.cOptPtr --> PolyMLFFI.cVoid)
    end
