structure GtkIconFactory :>
  ...
  struct
    ...
    in
      ...
      val lookupDefault_ = call (load_sym libgtk "gtk_icon_factory_lookup_default") (FFI.String.PolyML.INPTR --> GtkIconSetRecord.PolyML.PTR)
      val add_ =
      ...
      val lookup_ = call (load_sym libgtk "gtk_icon_factory_lookup") (GObjectObjectClass.PolyML.PTR &&> FFI.String.PolyML.INPTR --> GtkIconSetRecord.PolyML.PTR)
