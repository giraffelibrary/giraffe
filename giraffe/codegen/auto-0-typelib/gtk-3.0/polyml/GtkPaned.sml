structure GtkPaned :>
  ...
  struct
    ...
    in
      ...
      val getPosition_ = call (load_sym libgtk "gtk_paned_get_position") (GtkPanedClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val pack1_ =
      ...
      val setPosition_ = call (load_sym libgtk "gtk_paned_set_position") (GtkPanedClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
    end
