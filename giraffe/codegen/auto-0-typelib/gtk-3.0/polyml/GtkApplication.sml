structure GtkApplication :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgtk "gtk_application_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      ...
      val addWindow_ = call (load_sym libgtk "gtk_application_add_window") (GtkApplicationClass.PolyML.cPtr &&> GtkWindowClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val removeWindow_ = call (load_sym libgtk "gtk_application_remove_window") (GtkApplicationClass.PolyML.cPtr &&> GtkWindowClass.PolyML.cPtr --> PolyMLFFI.cVoid)
    end
