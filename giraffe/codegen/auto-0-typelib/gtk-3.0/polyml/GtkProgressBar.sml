structure GtkProgressBar :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgtk "gtk_progress_bar_new") (FFI.PolyML.cVoid --> GtkWidgetClass.PolyML.cPtr)
      ...
      val pulse_ = call (load_sym libgtk "gtk_progress_bar_pulse") (GtkProgressBarClass.PolyML.cPtr --> FFI.PolyML.cVoid)
      val setEllipsize_ = call (load_sym libgtk "gtk_progress_bar_set_ellipsize") (GtkProgressBarClass.PolyML.cPtr &&> PangoEllipsizeMode.PolyML.cVal --> FFI.PolyML.cVoid)
      val setFraction_ = call (load_sym libgtk "gtk_progress_bar_set_fraction") (GtkProgressBarClass.PolyML.cPtr &&> FFI.Double.PolyML.cVal --> FFI.PolyML.cVoid)
      val setInverted_ = call (load_sym libgtk "gtk_progress_bar_set_inverted") (GtkProgressBarClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> FFI.PolyML.cVoid)
      val setPulseStep_ = call (load_sym libgtk "gtk_progress_bar_set_pulse_step") (GtkProgressBarClass.PolyML.cPtr &&> FFI.Double.PolyML.cVal --> FFI.PolyML.cVoid)
      val setShowText_ = call (load_sym libgtk "gtk_progress_bar_set_show_text") (GtkProgressBarClass.PolyML.cPtr &&> FFI.Bool.PolyML.cVal --> FFI.PolyML.cVoid)
      val setText_ = call (load_sym libgtk "gtk_progress_bar_set_text") (GtkProgressBarClass.PolyML.cPtr &&> Utf8.PolyML.cInOptPtr --> FFI.PolyML.cVoid)
    end
