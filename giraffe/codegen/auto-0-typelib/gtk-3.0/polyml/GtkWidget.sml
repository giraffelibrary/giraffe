structure GtkWidget :>
  ...
  struct
    ...
    in
      ...
      val addEvents_ = call (load_sym libgtk "gtk_widget_add_events") (GtkWidgetClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      ...
      val canActivateAccel_ = call (load_sym libgtk "gtk_widget_can_activate_accel") (GtkWidgetClass.PolyML.cPtr &&> FFI.UInt32.PolyML.cVal --> FFI.Bool.PolyML.cVal)
      ...
      val dragDestGetTrackMotion_ = call (load_sym libgtk "gtk_drag_dest_get_track_motion") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      ...
      val getAllocatedHeight_ = call (load_sym libgtk "gtk_widget_get_allocated_height") (GtkWidgetClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getAllocatedWidth_ = call (load_sym libgtk "gtk_widget_get_allocated_width") (GtkWidgetClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getAllocation_ = call (load_sym libgtk "gtk_widget_get_allocation") (GtkWidgetClass.PolyML.cPtr &&> CairoRectangleIntRecord.PolyML.cPtr --> FFI.PolyML.cVoid)
      ...
      val getChildVisible_ = call (load_sym libgtk "gtk_widget_get_child_visible") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      ...
      val getDeviceEnabled_ = call (load_sym libgtk "gtk_widget_get_device_enabled") (GtkWidgetClass.PolyML.cPtr &&> GdkDeviceClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      ...
      val getDoubleBuffered_ = call (load_sym libgtk "gtk_widget_get_double_buffered") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val getEvents_ = call (load_sym libgtk "gtk_widget_get_events") (GtkWidgetClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getHalign_ = call (load_sym libgtk "gtk_widget_get_halign") (GtkWidgetClass.PolyML.cPtr --> GtkAlign.PolyML.cVal)
      val getHasTooltip_ = call (load_sym libgtk "gtk_widget_get_has_tooltip") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val getHasWindow_ = call (load_sym libgtk "gtk_widget_get_has_window") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val getHexpand_ = call (load_sym libgtk "gtk_widget_get_hexpand") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val getHexpandSet_ = call (load_sym libgtk "gtk_widget_get_hexpand_set") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val getMapped_ = call (load_sym libgtk "gtk_widget_get_mapped") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val getMarginBottom_ = call (load_sym libgtk "gtk_widget_get_margin_bottom") (GtkWidgetClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getMarginLeft_ = call (load_sym libgtk "gtk_widget_get_margin_left") (GtkWidgetClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getMarginRight_ = call (load_sym libgtk "gtk_widget_get_margin_right") (GtkWidgetClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getMarginTop_ = call (load_sym libgtk "gtk_widget_get_margin_top") (GtkWidgetClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val getNoShowAll_ = call (load_sym libgtk "gtk_widget_get_no_show_all") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      ...
      val getSensitive_ = call (load_sym libgtk "gtk_widget_get_sensitive") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      ...
      val getSupportMultidevice_ = call (load_sym libgtk "gtk_widget_get_support_multidevice") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      ...
      val getVexpand_ = call (load_sym libgtk "gtk_widget_get_vexpand") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val getVexpandSet_ = call (load_sym libgtk "gtk_widget_get_vexpand_set") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      ...
      val isAncestor_ = call (load_sym libgtk "gtk_widget_is_ancestor") (GtkWidgetClass.PolyML.cPtr &&> GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val isComposited_ = call (load_sym libgtk "gtk_widget_is_composited") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val isDrawable_ = call (load_sym libgtk "gtk_widget_is_drawable") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val isFocus_ = call (load_sym libgtk "gtk_widget_is_focus") (GtkWidgetClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      ...
      val sendExpose_ = call (load_sym libgtk "gtk_widget_send_expose") (GtkWidgetClass.PolyML.cPtr &&> GdkEvent.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val setAllocation_ = call (load_sym libgtk "gtk_widget_set_allocation") (GtkWidgetClass.PolyML.cPtr &&> CairoRectangleIntRecord.PolyML.cPtr --> FFI.PolyML.cVoid)
      ...
      val setEvents_ = call (load_sym libgtk "gtk_widget_set_events") (GtkWidgetClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      ...
      val setMarginBottom_ = call (load_sym libgtk "gtk_widget_set_margin_bottom") (GtkWidgetClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      val setMarginLeft_ = call (load_sym libgtk "gtk_widget_set_margin_left") (GtkWidgetClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      val setMarginRight_ = call (load_sym libgtk "gtk_widget_set_margin_right") (GtkWidgetClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      val setMarginTop_ = call (load_sym libgtk "gtk_widget_set_margin_top") (GtkWidgetClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      ...
      val sizeAllocate_ = call (load_sym libgtk "gtk_widget_size_allocate") (GtkWidgetClass.PolyML.cPtr &&> CairoRectangleIntRecord.PolyML.cPtr --> FFI.PolyML.cVoid)
