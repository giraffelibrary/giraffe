structure GtkWidget :>
  ...
  struct
    ...
    in
      ...
      val addEvents_ = call (load_sym libgtk "gtk_widget_add_events") (GtkWidgetClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val canActivateAccel_ = call (load_sym libgtk "gtk_widget_can_activate_accel") (GtkWidgetClass.PolyML.cPtr &&> GUInt32.PolyML.cVal --> GBool.PolyML.cVal)
      ...
      val getAllocatedHeight_ = call (load_sym libgtk "gtk_widget_get_allocated_height") (GtkWidgetClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getAllocatedWidth_ = call (load_sym libgtk "gtk_widget_get_allocated_width") (GtkWidgetClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getAllocation_ = call (load_sym libgtk "gtk_widget_get_allocation") (GtkWidgetClass.PolyML.cPtr &&> CairoRectangleIntRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      ...
      val getEvents_ = call (load_sym libgtk "gtk_widget_get_events") (GtkWidgetClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getMarginBottom_ = call (load_sym libgtk "gtk_widget_get_margin_bottom") (GtkWidgetClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getMarginLeft_ = call (load_sym libgtk "gtk_widget_get_margin_left") (GtkWidgetClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getMarginRight_ = call (load_sym libgtk "gtk_widget_get_margin_right") (GtkWidgetClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getMarginTop_ = call (load_sym libgtk "gtk_widget_get_margin_top") (GtkWidgetClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val sendExpose_ = call (load_sym libgtk "gtk_widget_send_expose") (GtkWidgetClass.PolyML.cPtr &&> GdkEvent.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val setAllocation_ = call (load_sym libgtk "gtk_widget_set_allocation") (GtkWidgetClass.PolyML.cPtr &&> CairoRectangleIntRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      ...
      val setEvents_ = call (load_sym libgtk "gtk_widget_set_events") (GtkWidgetClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setMarginBottom_ = call (load_sym libgtk "gtk_widget_set_margin_bottom") (GtkWidgetClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setMarginLeft_ = call (load_sym libgtk "gtk_widget_set_margin_left") (GtkWidgetClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setMarginRight_ = call (load_sym libgtk "gtk_widget_set_margin_right") (GtkWidgetClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setMarginTop_ = call (load_sym libgtk "gtk_widget_set_margin_top") (GtkWidgetClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val sizeAllocate_ = call (load_sym libgtk "gtk_widget_size_allocate") (GtkWidgetClass.PolyML.cPtr &&> CairoRectangleIntRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
    ...
    fun getAllocation self =
      let
        val allocation & () = (GtkWidgetClass.FFI.withPtr &&&> CairoRectangleIntRecord.FFI.withNewPtr ---> CairoRectangleIntRecord.FFI.fromPtr true && I) getAllocation_ (self & ())
      in
        allocation
      end
    ...
    fun setAllocation self allocation = (GtkWidgetClass.FFI.withPtr &&&> CairoRectangleIntRecord.FFI.withPtr ---> I) setAllocation_ (self & allocation)
