structure GtkPrintOperation :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_print_operation_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      val new_ = call (getSymbol "gtk_print_operation_new") (PolyMLFFI.cVoid --> GtkPrintOperationClass.PolyML.cPtr)
      val cancel_ = call (getSymbol "gtk_print_operation_cancel") (GtkPrintOperationClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val drawPageFinish_ = call (getSymbol "gtk_print_operation_draw_page_finish") (GtkPrintOperationClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      ...
      val getError_ = call (getSymbol "gtk_print_operation_get_error") (GtkPrintOperationClass.PolyML.cPtr &&> GLibErrorRecord.PolyML.cOutOptRef --> PolyMLFFI.cVoid)
      ...
      val setAllowAsync_ = call (getSymbol "gtk_print_operation_set_allow_async") (GtkPrintOperationClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setCurrentPage_ = call (getSymbol "gtk_print_operation_set_current_page") (GtkPrintOperationClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setCustomTabLabel_ = call (getSymbol "gtk_print_operation_set_custom_tab_label") (GtkPrintOperationClass.PolyML.cPtr &&> Utf8.PolyML.cInOptPtr --> PolyMLFFI.cVoid)
      val setDefaultPageSetup_ = call (getSymbol "gtk_print_operation_set_default_page_setup") (GtkPrintOperationClass.PolyML.cPtr &&> GtkPageSetupClass.PolyML.cOptPtr --> PolyMLFFI.cVoid)
      val setDeferDrawing_ = call (getSymbol "gtk_print_operation_set_defer_drawing") (GtkPrintOperationClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val setEmbedPageSetup_ = call (getSymbol "gtk_print_operation_set_embed_page_setup") (GtkPrintOperationClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setExportFilename_ = call (getSymbol "gtk_print_operation_set_export_filename") (GtkPrintOperationClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
      val setHasSelection_ = call (getSymbol "gtk_print_operation_set_has_selection") (GtkPrintOperationClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setJobName_ = call (getSymbol "gtk_print_operation_set_job_name") (GtkPrintOperationClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
      val setNPages_ = call (getSymbol "gtk_print_operation_set_n_pages") (GtkPrintOperationClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setPrintSettings_ = call (getSymbol "gtk_print_operation_set_print_settings") (GtkPrintOperationClass.PolyML.cPtr &&> GtkPrintSettingsClass.PolyML.cOptPtr --> PolyMLFFI.cVoid)
      val setShowProgress_ = call (getSymbol "gtk_print_operation_set_show_progress") (GtkPrintOperationClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setSupportSelection_ = call (getSymbol "gtk_print_operation_set_support_selection") (GtkPrintOperationClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setTrackPrintStatus_ = call (getSymbol "gtk_print_operation_set_track_print_status") (GtkPrintOperationClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setUnit_ = call (getSymbol "gtk_print_operation_set_unit") (GtkPrintOperationClass.PolyML.cPtr &&> GtkUnit.PolyML.cVal --> PolyMLFFI.cVoid)
      val setUseFullPage_ = call (getSymbol "gtk_print_operation_set_use_full_page") (GtkPrintOperationClass.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
    end
