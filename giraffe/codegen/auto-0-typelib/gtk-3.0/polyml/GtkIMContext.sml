structure GtkIMContext :>
  ...
  struct
    ...
    in
      ...
      val setCursorLocation_ = call (getSymbol "gtk_im_context_set_cursor_location") (GtkIMContextClass.PolyML.cPtr &&> CairoRectangleIntRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      val setSurrounding_ =
