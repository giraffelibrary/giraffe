structure GtkIconSize :>
  ...
  struct
    ...
    fun fromName name = (Utf8.FFI.withPtr 0 ---> GInt32.FFI.fromVal) fromName_ name
    ...
    fun registerAlias (alias, target) = (Utf8.FFI.withPtr 0 &&&> GInt32.FFI.withVal ---> I) registerAlias_ (alias & target)
  end
