structure GtkExpander :>
  ...
  struct
    ...
    in
      ...
      val getSpacing_ = call (load_sym libgtk "gtk_expander_get_spacing") (GtkExpanderClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val setSpacing_ = call (load_sym libgtk "gtk_expander_set_spacing") (GtkExpanderClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
