structure GtkExpander :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgtk "gtk_expander_new") (Utf8.PolyML.INPTR --> GObjectObjectClass.PolyML.PTR)
      val newWithMnemonic_ = call (load_sym libgtk "gtk_expander_new_with_mnemonic") (Utf8.PolyML.INOPTPTR --> GObjectObjectClass.PolyML.PTR)
      val getExpanded_ = call (load_sym libgtk "gtk_expander_get_expanded") (GObjectObjectClass.PolyML.PTR --> FFI.Bool.PolyML.VAL)
      val getLabel_ = call (load_sym libgtk "gtk_expander_get_label") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      ...
      val getSpacing_ = call (load_sym libgtk "gtk_expander_get_spacing") (GObjectObjectClass.PolyML.PTR --> FFI.Int32.PolyML.VAL)
      ...
      val setLabel_ = call (load_sym libgtk "gtk_expander_set_label") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INOPTPTR --> FFI.PolyML.VOID)
      ...
      val setSpacing_ = call (load_sym libgtk "gtk_expander_set_spacing") (GObjectObjectClass.PolyML.PTR &&> FFI.Int32.PolyML.VAL --> FFI.PolyML.VOID)
