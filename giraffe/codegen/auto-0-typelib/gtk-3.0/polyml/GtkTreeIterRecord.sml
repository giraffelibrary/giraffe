structure GtkTreeIterRecord :> GTK_TREE_ITER_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val new_ = call (getSymbol "giraffe_gtk_tree_iter_new") (PolyMLFFI.cVoid --> cPtr)
      val copy_ = call (getSymbol "giraffe_gtk_tree_iter_copy") (cPtr &&> cPtr --> PolyMLFFI.cVoid)
      val free_ = call (getSymbol "giraffe_gtk_tree_iter_free") (cPtr --> PolyMLFFI.cVoid)
      val size_ = call (getSymbol "giraffe_gtk_tree_iter_size") (PolyMLFFI.cVoid --> GUInt.PolyML.cVal)
    end
    structure Record =
      BoxedValueRecord(
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "gtk_tree_iter_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
