structure GtkTreeIterRecord :> GTK_TREE_ITER_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val new_ = call (getSymbol "giraffe_gtk_tree_iter_new") (cVoid --> cPtr)
      val copy_ = call (getSymbol "giraffe_gtk_tree_iter_copy") (cPtr &&> cPtr --> cVoid)
      val free_ = call (getSymbol "giraffe_gtk_tree_iter_free") (cPtr --> cVoid)
      val size_ = call (getSymbol "giraffe_gtk_tree_iter_size") (cVoid --> GUInt.PolyML.cVal)
    end
    structure Record =
      BoxedValueRecord(
