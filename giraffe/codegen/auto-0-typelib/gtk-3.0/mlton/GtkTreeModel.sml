structure GtkTreeModel :>
  ...
  struct
    ...
    val getNColumns_ = _import "gtk_tree_model_get_n_columns" : GtkTreeModelClass.FFI.notnull GtkTreeModelClass.FFI.p -> GInt32.FFI.val_;
    ...
    val iterNChildren_ = fn x1 & x2 => (_import "gtk_tree_model_iter_n_children" : GtkTreeModelClass.FFI.notnull GtkTreeModelClass.FFI.p * unit GtkTreeIterRecord.FFI.p -> GInt32.FFI.val_;) (x1, x2)
