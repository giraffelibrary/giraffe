structure GtkPrintSettings :>
  ...
  struct
    ...
    val getNCopies_ = _import "gtk_print_settings_get_n_copies" : GtkPrintSettingsClass.C.notnull GtkPrintSettingsClass.C.p -> FFI.Int32.C.val_;
    val getNumberUp_ = _import "gtk_print_settings_get_number_up" : GtkPrintSettingsClass.C.notnull GtkPrintSettingsClass.C.p -> FFI.Int32.C.val_;
    ...
    val getResolution_ = _import "gtk_print_settings_get_resolution" : GtkPrintSettingsClass.C.notnull GtkPrintSettingsClass.C.p -> FFI.Int32.C.val_;
    val getResolutionX_ = _import "gtk_print_settings_get_resolution_x" : GtkPrintSettingsClass.C.notnull GtkPrintSettingsClass.C.p -> FFI.Int32.C.val_;
    val getResolutionY_ = _import "gtk_print_settings_get_resolution_y" : GtkPrintSettingsClass.C.notnull GtkPrintSettingsClass.C.p -> FFI.Int32.C.val_;
    ...
    val setNCopies_ = fn x1 & x2 => (_import "gtk_print_settings_set_n_copies" : GtkPrintSettingsClass.C.notnull GtkPrintSettingsClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    val setNumberUp_ = fn x1 & x2 => (_import "gtk_print_settings_set_number_up" : GtkPrintSettingsClass.C.notnull GtkPrintSettingsClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    ...
    val setResolution_ = fn x1 & x2 => (_import "gtk_print_settings_set_resolution" : GtkPrintSettingsClass.C.notnull GtkPrintSettingsClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
