structure GtkToolItemGroup :>
  ...
  struct
    ...
    fun getNthItem self index = (GtkToolItemGroupClass.FFI.withPtr false &&&> GUInt32.FFI.withVal ---> GtkToolItemClass.FFI.fromPtr false) getNthItem_ (self & index) before GtkToolItemGroupClass.FFI.touchPtr self
