structure GtkWidgetPath :>
  ...
  struct
    ...
    val appendForWidget_ = fn x1 & x2 => (_import "gtk_widget_path_append_for_widget" : GtkWidgetPathRecord.FFI.non_opt GtkWidgetPathRecord.FFI.p * GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p -> GInt32.FFI.val_;) (x1, x2)
    val appendType_ = fn x1 & x2 => (_import "gtk_widget_path_append_type" : GtkWidgetPathRecord.FFI.non_opt GtkWidgetPathRecord.FFI.p * GObjectType.FFI.val_ -> GInt32.FFI.val_;) (x1, x2)
    ...
    val iterClearClasses_ = fn x1 & x2 => (_import "gtk_widget_path_iter_clear_classes" : GtkWidgetPathRecord.FFI.non_opt GtkWidgetPathRecord.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val iterClearRegions_ = fn x1 & x2 => (_import "gtk_widget_path_iter_clear_regions" : GtkWidgetPathRecord.FFI.non_opt GtkWidgetPathRecord.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val iterGetName_ = fn x1 & x2 => (_import "gtk_widget_path_iter_get_name" : GtkWidgetPathRecord.FFI.non_opt GtkWidgetPathRecord.FFI.p * GInt32.FFI.val_ -> Utf8.FFI.opt Utf8.FFI.out_p;) (x1, x2)
    val iterGetObjectName_ = fn x1 & x2 => (_import "gtk_widget_path_iter_get_object_name" : GtkWidgetPathRecord.FFI.non_opt GtkWidgetPathRecord.FFI.p * GInt32.FFI.val_ -> Utf8.FFI.opt Utf8.FFI.out_p;) (x1, x2)
    val iterGetObjectType_ = fn x1 & x2 => (_import "gtk_widget_path_iter_get_object_type" : GtkWidgetPathRecord.FFI.non_opt GtkWidgetPathRecord.FFI.p * GInt32.FFI.val_ -> GObjectType.FFI.val_;) (x1, x2)
    val iterGetSiblingIndex_ = fn x1 & x2 => (_import "gtk_widget_path_iter_get_sibling_index" : GtkWidgetPathRecord.FFI.non_opt GtkWidgetPathRecord.FFI.p * GInt32.FFI.val_ -> GUInt32.FFI.val_;) (x1, x2)
    val iterGetSiblings_ = fn x1 & x2 => (_import "gtk_widget_path_iter_get_siblings" : GtkWidgetPathRecord.FFI.non_opt GtkWidgetPathRecord.FFI.p * GInt32.FFI.val_ -> GtkWidgetPathRecord.FFI.non_opt GtkWidgetPathRecord.FFI.p;) (x1, x2)
    val iterGetState_ = fn x1 & x2 => (_import "gtk_widget_path_iter_get_state" : GtkWidgetPathRecord.FFI.non_opt GtkWidgetPathRecord.FFI.p * GInt32.FFI.val_ -> GtkStateFlags.FFI.val_;) (x1, x2)
    val iterHasClass_ =
      fn
        x1
         & x2
    ...
    val length_ = _import "gtk_widget_path_length" : GtkWidgetPathRecord.FFI.non_opt GtkWidgetPathRecord.FFI.p -> GInt32.FFI.val_;
    ...
    fun appendForWidget self widget = (GtkWidgetPathRecord.FFI.withPtr false &&&> GtkWidgetClass.FFI.withPtr false ---> GInt32.FFI.fromVal) appendForWidget_ (self & widget)
    fun appendType self type' = (GtkWidgetPathRecord.FFI.withPtr false &&&> GObjectType.FFI.withVal ---> GInt32.FFI.fromVal) appendType_ (self & type')
    ...
    fun iterClearClasses self pos = (GtkWidgetPathRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) iterClearClasses_ (self & pos)
    fun iterClearRegions self pos = (GtkWidgetPathRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) iterClearRegions_ (self & pos)
    fun iterGetName self pos = (GtkWidgetPathRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> Utf8.FFI.fromOptPtr 0) iterGetName_ (self & pos) before GtkWidgetPathRecord.FFI.touchPtr self
    fun iterGetObjectName self pos = (GtkWidgetPathRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> Utf8.FFI.fromOptPtr 0) iterGetObjectName_ (self & pos) before GtkWidgetPathRecord.FFI.touchPtr self
    fun iterGetObjectType self pos = (GtkWidgetPathRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GObjectType.FFI.fromVal) iterGetObjectType_ (self & pos)
    fun iterGetSiblingIndex self pos = (GtkWidgetPathRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GUInt32.FFI.fromVal) iterGetSiblingIndex_ (self & pos)
    fun iterGetSiblings self pos = (GtkWidgetPathRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GtkWidgetPathRecord.FFI.fromPtr false) iterGetSiblings_ (self & pos) before GtkWidgetPathRecord.FFI.touchPtr self
    fun iterGetState self pos = (GtkWidgetPathRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GtkStateFlags.FFI.fromVal) iterGetState_ (self & pos)
    ...
    fun length self = (GtkWidgetPathRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) length_ self
