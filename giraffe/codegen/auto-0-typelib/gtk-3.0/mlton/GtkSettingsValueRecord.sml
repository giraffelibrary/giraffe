structure GtkSettingsValueRecord :> GTK_SETTINGS_VALUE_RECORD =
  struct
    ...
    val copy_ = fn x1 & x2 => (_import "giraffe_gtk_settings_value_copy" : notnull p * notnull p -> unit;) (x1, x2)
    val free_ = _import "giraffe_gtk_settings_value_free" : notnull p -> unit;
    val size_ = _import "giraffe_gtk_settings_value_size" : unit -> GUInt.FFI.val_;
    structure Record =
      BoxedValueRecord(
