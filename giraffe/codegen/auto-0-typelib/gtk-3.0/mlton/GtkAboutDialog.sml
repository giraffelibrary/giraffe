structure GtkAboutDialog :>
  ...
  struct
    ...
    val getComments_ = _import "gtk_about_dialog_get_comments" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getCopyright_ = _import "gtk_about_dialog_get_copyright" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getLicense_ = _import "gtk_about_dialog_get_license" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val getLogoIconName_ = _import "gtk_about_dialog_get_logo_icon_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getProgramName_ = _import "gtk_about_dialog_get_program_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getTranslatorCredits_ = _import "gtk_about_dialog_get_translator_credits" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getVersion_ = _import "gtk_about_dialog_get_version" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getWebsite_ = _import "gtk_about_dialog_get_website" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getWebsiteLabel_ = _import "gtk_about_dialog_get_website_label" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
