structure GtkAboutDialog :>
  ...
  struct
    ...
    val getArtists_ = _import "gtk_about_dialog_get_artists" : GtkAboutDialogClass.FFI.notnull GtkAboutDialogClass.FFI.p -> Utf8CArray.FFI.notnull Utf8CArray.FFI.out_p;
    val getAuthors_ = _import "gtk_about_dialog_get_authors" : GtkAboutDialogClass.FFI.notnull GtkAboutDialogClass.FFI.p -> Utf8CArray.FFI.notnull Utf8CArray.FFI.out_p;
    ...
    val getDocumenters_ = _import "gtk_about_dialog_get_documenters" : GtkAboutDialogClass.FFI.notnull GtkAboutDialogClass.FFI.p -> Utf8CArray.FFI.notnull Utf8CArray.FFI.out_p;
