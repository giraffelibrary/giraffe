structure GtkWindowGroup :>
  ...
  struct
    ...
    val getCurrentDeviceGrab_ = fn x1 & x2 => (_import "gtk_window_group_get_current_device_grab" : GtkWindowGroupClass.FFI.notnull GtkWindowGroupClass.FFI.p * GdkDeviceClass.FFI.notnull GdkDeviceClass.FFI.p -> GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p;) (x1, x2)
