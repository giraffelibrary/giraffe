structure GtkWidget :>
  ...
  struct
    ...
    val addEvents_ = fn x1 & x2 => (_import "gtk_widget_add_events" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val canActivateAccel_ = fn x1 & x2 => (_import "gtk_widget_can_activate_accel" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GUInt32.FFI.val_ -> GBool.FFI.val_;) (x1, x2)
    ...
    val getAllocatedBaseline_ = _import "gtk_widget_get_allocated_baseline" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p -> GInt32.FFI.val_;
    val getAllocatedHeight_ = _import "gtk_widget_get_allocated_height" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getAllocatedWidth_ = _import "gtk_widget_get_allocated_width" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p -> GInt32.FFI.val_;
    val getAllocation_ = fn x1 & x2 => (_import "gtk_widget_get_allocation" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GdkRectangleRecord.FFI.non_opt GdkRectangleRecord.FFI.p -> unit;) (x1, x2)
    ...
    val getClip_ = fn x1 & x2 => (_import "gtk_widget_get_clip" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GdkRectangleRecord.FFI.non_opt GdkRectangleRecord.FFI.p -> unit;) (x1, x2)
    ...
    val getEvents_ = _import "gtk_widget_get_events" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getMarginBottom_ = _import "gtk_widget_get_margin_bottom" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p -> GInt32.FFI.val_;
    val getMarginEnd_ = _import "gtk_widget_get_margin_end" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p -> GInt32.FFI.val_;
    val getMarginLeft_ = _import "gtk_widget_get_margin_left" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p -> GInt32.FFI.val_;
    val getMarginRight_ = _import "gtk_widget_get_margin_right" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p -> GInt32.FFI.val_;
    val getMarginStart_ = _import "gtk_widget_get_margin_start" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p -> GInt32.FFI.val_;
    val getMarginTop_ = _import "gtk_widget_get_margin_top" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getScaleFactor_ = _import "gtk_widget_get_scale_factor" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p -> GInt32.FFI.val_;
    ...
    val removeTickCallback_ = fn x1 & x2 => (_import "gtk_widget_remove_tick_callback" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val renderIcon_ =
      fn
        x1
         & (x2, x3)
    ...
    val sendExpose_ = fn x1 & x2 => (_import "gtk_widget_send_expose" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GdkEvent.FFI.non_opt GdkEvent.FFI.p -> GInt32.FFI.val_;) (x1, x2)
    ...
    val setAllocation_ = fn x1 & x2 => (_import "gtk_widget_set_allocation" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GdkRectangleRecord.FFI.non_opt GdkRectangleRecord.FFI.p -> unit;) (x1, x2)
    ...
    val setClip_ = fn x1 & x2 => (_import "gtk_widget_set_clip" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GdkRectangleRecord.FFI.non_opt GdkRectangleRecord.FFI.p -> unit;) (x1, x2)
    ...
    val setEvents_ = fn x1 & x2 => (_import "gtk_widget_set_events" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val setMarginBottom_ = fn x1 & x2 => (_import "gtk_widget_set_margin_bottom" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setMarginEnd_ = fn x1 & x2 => (_import "gtk_widget_set_margin_end" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setMarginLeft_ = fn x1 & x2 => (_import "gtk_widget_set_margin_left" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setMarginRight_ = fn x1 & x2 => (_import "gtk_widget_set_margin_right" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setMarginStart_ = fn x1 & x2 => (_import "gtk_widget_set_margin_start" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setMarginTop_ = fn x1 & x2 => (_import "gtk_widget_set_margin_top" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setName_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val sizeAllocate_ = fn x1 & x2 => (_import "gtk_widget_size_allocate" : GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p * GdkRectangleRecord.FFI.non_opt GdkRectangleRecord.FFI.p -> unit;) (x1, x2)
