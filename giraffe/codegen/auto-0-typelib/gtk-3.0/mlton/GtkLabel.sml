structure GtkLabel :>
  ...
  struct
    ...
    val getMaxWidthChars_ = _import "gtk_label_get_max_width_chars" : GtkLabelClass.C.notnull GtkLabelClass.C.p -> FFI.Int32.C.val_;
    val getMnemonicKeyval_ = _import "gtk_label_get_mnemonic_keyval" : GtkLabelClass.C.notnull GtkLabelClass.C.p -> FFI.UInt32.C.val_;
    ...
    val getWidthChars_ = _import "gtk_label_get_width_chars" : GtkLabelClass.C.notnull GtkLabelClass.C.p -> FFI.Int32.C.val_;
    val selectRegion_ =
      fn
        x1
         & x2
    ...
    val setMaxWidthChars_ = fn x1 & x2 => (_import "gtk_label_set_max_width_chars" : GtkLabelClass.C.notnull GtkLabelClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    ...
    val setWidthChars_ = fn x1 & x2 => (_import "gtk_label_set_width_chars" : GtkLabelClass.C.notnull GtkLabelClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
