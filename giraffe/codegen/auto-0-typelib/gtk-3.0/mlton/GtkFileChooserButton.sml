structure GtkFileChooserButton :>
  ...
  struct
    ...
    val getWidthChars_ = _import "gtk_file_chooser_button_get_width_chars" : GtkFileChooserButtonClass.C.notnull GtkFileChooserButtonClass.C.p -> FFI.Int32.C.val_;
    ...
    val setWidthChars_ = fn x1 & x2 => (_import "gtk_file_chooser_button_set_width_chars" : GtkFileChooserButtonClass.C.notnull GtkFileChooserButtonClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
