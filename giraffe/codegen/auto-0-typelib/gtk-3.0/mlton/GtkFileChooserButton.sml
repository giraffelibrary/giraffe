structure GtkFileChooserButton :>
  ...
  struct
    ...
    fun getWidthChars self = (GtkFileChooserButtonClass.FFI.withPtr false ---> GInt32.FFI.fromVal) getWidthChars_ self
    ...
    fun setWidthChars self nChars = (GtkFileChooserButtonClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) setWidthChars_ (self & nChars)
    local
