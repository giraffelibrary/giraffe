structure GtkNumerableIcon :>
  ...
  struct
    ...
    val getBackgroundIconName_ = _import "gtk_numerable_icon_get_background_icon_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getCount_ = _import "gtk_numerable_icon_get_count" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.C.val_;
    val getLabel_ = _import "gtk_numerable_icon_get_label" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val setCount_ = fn x1 & x2 => (_import "gtk_numerable_icon_set_count" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    val setLabel_ =
      fn
        x1 & (x2, x3) =>
          (
