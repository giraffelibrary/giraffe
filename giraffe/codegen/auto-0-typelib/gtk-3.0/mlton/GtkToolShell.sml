structure GtkToolShell :>
  ...
  struct
    ...
    val getIconSize_ = _import "gtk_tool_shell_get_icon_size" : GtkToolShellClass.C.notnull GtkToolShellClass.C.p -> FFI.Int32.C.val_;
    ...
    fun getIconSize self = (GtkToolShellClass.C.withPtr ---> FFI.Int32.C.fromVal) getIconSize_ self
