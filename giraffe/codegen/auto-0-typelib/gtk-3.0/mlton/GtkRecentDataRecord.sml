structure GtkRecentDataRecord :> GTK_RECENT_DATA_RECORD =
  struct
    ...
    val copy_ = fn x1 & x2 => (_import "giraffe_gtk_recent_data_copy" : notnull p * notnull p -> unit;) (x1, x2)
    val free_ = _import "giraffe_gtk_recent_data_free" : notnull p -> unit;
    val size_ = _import "giraffe_gtk_recent_data_size" : unit -> GUInt.FFI.val_;
    structure Record =
      BoxedValueRecord(
