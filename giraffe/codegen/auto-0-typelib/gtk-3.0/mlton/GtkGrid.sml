structure GtkGrid :>
  ...
  struct
    ...
    val getBaselineRow_ = _import "gtk_grid_get_baseline_row" : GtkGridClass.FFI.notnull GtkGridClass.FFI.p -> GInt32.FFI.val_;
    val getChildAt_ =
      fn
        x1
         & x2
    ...
    val getRowBaselinePosition_ = fn x1 & x2 => (_import "gtk_grid_get_row_baseline_position" : GtkGridClass.FFI.notnull GtkGridClass.FFI.p * GInt32.FFI.val_ -> GtkBaselinePosition.FFI.val_;) (x1, x2)
    ...
    val removeColumn_ = fn x1 & x2 => (_import "gtk_grid_remove_column" : GtkGridClass.FFI.notnull GtkGridClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val removeRow_ = fn x1 & x2 => (_import "gtk_grid_remove_row" : GtkGridClass.FFI.notnull GtkGridClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setBaselineRow_ = fn x1 & x2 => (_import "gtk_grid_set_baseline_row" : GtkGridClass.FFI.notnull GtkGridClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
