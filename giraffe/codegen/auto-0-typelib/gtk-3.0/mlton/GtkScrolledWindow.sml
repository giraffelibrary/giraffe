structure GtkScrolledWindow :>
  ...
  struct
    ...
    val getMaxContentHeight_ = _import "gtk_scrolled_window_get_max_content_height" : GtkScrolledWindowClass.FFI.notnull GtkScrolledWindowClass.FFI.p -> GInt32.FFI.val_;
    val getMaxContentWidth_ = _import "gtk_scrolled_window_get_max_content_width" : GtkScrolledWindowClass.FFI.notnull GtkScrolledWindowClass.FFI.p -> GInt32.FFI.val_;
    val getMinContentHeight_ = _import "gtk_scrolled_window_get_min_content_height" : GtkScrolledWindowClass.FFI.notnull GtkScrolledWindowClass.FFI.p -> GInt32.FFI.val_;
    val getMinContentWidth_ = _import "gtk_scrolled_window_get_min_content_width" : GtkScrolledWindowClass.FFI.notnull GtkScrolledWindowClass.FFI.p -> GInt32.FFI.val_;
    ...
    val setMaxContentHeight_ = fn x1 & x2 => (_import "gtk_scrolled_window_set_max_content_height" : GtkScrolledWindowClass.FFI.notnull GtkScrolledWindowClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setMaxContentWidth_ = fn x1 & x2 => (_import "gtk_scrolled_window_set_max_content_width" : GtkScrolledWindowClass.FFI.notnull GtkScrolledWindowClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setMinContentHeight_ = fn x1 & x2 => (_import "gtk_scrolled_window_set_min_content_height" : GtkScrolledWindowClass.FFI.notnull GtkScrolledWindowClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setMinContentWidth_ = fn x1 & x2 => (_import "gtk_scrolled_window_set_min_content_width" : GtkScrolledWindowClass.FFI.notnull GtkScrolledWindowClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
