structure GtkStack :>
  ...
  struct
    ...
    val getTransitionDuration_ = _import "gtk_stack_get_transition_duration" : GtkStackClass.FFI.notnull GtkStackClass.FFI.p -> GUInt32.FFI.val_;
    ...
    val setTransitionDuration_ = fn x1 & x2 => (_import "gtk_stack_set_transition_duration" : GtkStackClass.FFI.notnull GtkStackClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    fun getTransitionDuration self = (GtkStackClass.FFI.withPtr ---> GUInt32.FFI.fromVal) getTransitionDuration_ self
    ...
    fun setTransitionDuration self duration = (GtkStackClass.FFI.withPtr &&&> GUInt32.FFI.withVal ---> I) setTransitionDuration_ (self & duration)
