structure GtkRecentFilter :>
  ...
  struct
    ...
    val addAge_ = fn x1 & x2 => (_import "gtk_recent_filter_add_age" : GtkRecentFilterClass.FFI.non_opt GtkRecentFilterClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val addApplication_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    fun addAge self days = (GtkRecentFilterClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) addAge_ (self & days)
