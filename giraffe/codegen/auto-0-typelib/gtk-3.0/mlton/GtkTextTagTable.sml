structure GtkTextTagTable :>
  ...
  struct
    ...
    val getSize_ = _import "gtk_text_tag_table_get_size" : GtkTextTagTableClass.C.notnull GtkTextTagTableClass.C.p -> FFI.Int32.C.val_;
    val lookup_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    fun getSize self = (GtkTextTagTableClass.C.withPtr ---> FFI.Int32.C.fromVal) getSize_ self
