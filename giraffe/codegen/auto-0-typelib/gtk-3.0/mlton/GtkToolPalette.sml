structure GtkToolPalette :>
  ...
  struct
    ...
    val getGroupPosition_ = fn x1 & x2 => (_import "gtk_tool_palette_get_group_position" : GtkToolPaletteClass.FFI.notnull GtkToolPaletteClass.FFI.p * GtkToolItemGroupClass.FFI.notnull GtkToolItemGroupClass.FFI.p -> GInt32.FFI.val_;) (x1, x2)
    val getIconSize_ = _import "gtk_tool_palette_get_icon_size" : GtkToolPaletteClass.FFI.notnull GtkToolPaletteClass.FFI.p -> GInt32.FFI.val_;
    ...
    val setIconSize_ = fn x1 & x2 => (_import "gtk_tool_palette_set_icon_size" : GtkToolPaletteClass.FFI.notnull GtkToolPaletteClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
