structure GtkToolPalette :>
  ...
  struct
    ...
    val getGroupPosition_ = fn x1 & x2 => (_import "gtk_tool_palette_get_group_position" : GtkToolPaletteClass.C.notnull GtkToolPaletteClass.C.p * GtkToolItemGroupClass.C.notnull GtkToolItemGroupClass.C.p -> FFI.Int32.C.val_;) (x1, x2)
    val getIconSize_ = _import "gtk_tool_palette_get_icon_size" : GtkToolPaletteClass.C.notnull GtkToolPaletteClass.C.p -> FFI.Int32.C.val_;
    ...
    val setIconSize_ = fn x1 & x2 => (_import "gtk_tool_palette_set_icon_size" : GtkToolPaletteClass.C.notnull GtkToolPaletteClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    ...
    fun getGroupPosition self group = (GtkToolPaletteClass.C.withPtr &&&> GtkToolItemGroupClass.C.withPtr ---> FFI.Int32.C.fromVal) getGroupPosition_ (self & group)
    fun getIconSize self = (GtkToolPaletteClass.C.withPtr ---> FFI.Int32.C.fromVal) getIconSize_ self
    ...
    fun setIconSize self iconSize = (GtkToolPaletteClass.C.withPtr &&&> FFI.Int32.C.withVal ---> I) setIconSize_ (self & iconSize)
