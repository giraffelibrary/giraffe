structure GtkStatusbar :>
  ...
  struct
    ...
    val removeAll_ = fn x1 & x2 => (_import "gtk_statusbar_remove_all" : GtkStatusbarClass.FFI.notnull GtkStatusbarClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    fun removeAll self contextId = (GtkStatusbarClass.FFI.withPtr &&&> GUInt32.FFI.withVal ---> I) removeAll_ (self & contextId)
    local
