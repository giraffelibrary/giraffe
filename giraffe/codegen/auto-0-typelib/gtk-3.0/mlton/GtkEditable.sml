structure GtkEditable :>
  ...
  struct
    ...
    val getPosition_ = _import "gtk_editable_get_position" : GtkEditableClass.FFI.non_opt GtkEditableClass.FFI.p -> GInt32.FFI.val_;
    ...
    val setPosition_ = fn x1 & x2 => (_import "gtk_editable_set_position" : GtkEditableClass.FFI.non_opt GtkEditableClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
