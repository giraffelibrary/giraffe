structure GtkPrintOperationPreview :>
  ...
  struct
    ...
    val isSelected_ = fn x1 & x2 => (_import "gtk_print_operation_preview_is_selected" : GtkPrintOperationPreviewClass.C.notnull GtkPrintOperationPreviewClass.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    val renderPage_ = fn x1 & x2 => (_import "gtk_print_operation_preview_render_page" : GtkPrintOperationPreviewClass.C.notnull GtkPrintOperationPreviewClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
