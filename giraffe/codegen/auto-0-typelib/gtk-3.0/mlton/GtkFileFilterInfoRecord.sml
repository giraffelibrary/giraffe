structure GtkFileFilterInfoRecord :> GTK_FILE_FILTER_INFO_RECORD =
  struct
    ...
    val copy_ = fn x1 & x2 => (_import "giraffe_gtk_file_filter_info_copy" : notnull p * notnull p -> unit;) (x1, x2)
    val free_ = _import "giraffe_gtk_file_filter_info_free" : notnull p -> unit;
    val size_ = _import "giraffe_gtk_file_filter_info_size" : unit -> GUInt.FFI.val_;
    structure Record =
      BoxedValueRecord(
