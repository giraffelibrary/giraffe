structure GtkTextBuffer :>
  ...
  struct
    ...
    val getCharCount_ = _import "gtk_text_buffer_get_char_count" : GtkTextBufferClass.C.notnull GtkTextBufferClass.C.p -> FFI.Int32.C.val_;
    ...
    val getLineCount_ = _import "gtk_text_buffer_get_line_count" : GtkTextBufferClass.C.notnull GtkTextBufferClass.C.p -> FFI.Int32.C.val_;
    val getMark_ =
      fn
        x1 & (x2, x3) =>
          (
