structure GtkTextBuffer :>
  ...
  struct
    ...
    val getCharCount_ = _import "gtk_text_buffer_get_char_count" : GtkTextBufferClass.FFI.non_opt GtkTextBufferClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getDeserializeFormats_ = fn x1 & x2 => (_import "gtk_text_buffer_get_deserialize_formats" : GtkTextBufferClass.FFI.non_opt GtkTextBufferClass.FFI.p * GInt32.FFI.ref_ -> GdkAtomRecordCPtrArrayN.FFI.non_opt GdkAtomRecordCPtrArrayN.FFI.out_p;) (x1, x2)
    ...
    val getLineCount_ = _import "gtk_text_buffer_get_line_count" : GtkTextBufferClass.FFI.non_opt GtkTextBufferClass.FFI.p -> GInt32.FFI.val_;
    val getMark_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val getSerializeFormats_ = fn x1 & x2 => (_import "gtk_text_buffer_get_serialize_formats" : GtkTextBufferClass.FFI.non_opt GtkTextBufferClass.FFI.p * GInt32.FFI.ref_ -> GdkAtomRecordCPtrArrayN.FFI.non_opt GdkAtomRecordCPtrArrayN.FFI.out_p;) (x1, x2)
    val getSlice_ =
      fn
        x1
         & x2
