structure GtkTextView :>
  ...
  struct
    ...
    val getBorderWindowSize_ = fn x1 & x2 => (_import "gtk_text_view_get_border_window_size" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p * GtkTextWindowType.FFI.val_ -> GInt32.FFI.val_;) (x1, x2)
    val getBottomMargin_ = _import "gtk_text_view_get_bottom_margin" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getIndent_ = _import "gtk_text_view_get_indent" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getLeftMargin_ = _import "gtk_text_view_get_left_margin" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p -> GInt32.FFI.val_;
    val getLineAtY_ =
      fn
        x1
         & x2
    ...
    val getPixelsAboveLines_ = _import "gtk_text_view_get_pixels_above_lines" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p -> GInt32.FFI.val_;
    val getPixelsBelowLines_ = _import "gtk_text_view_get_pixels_below_lines" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p -> GInt32.FFI.val_;
    val getPixelsInsideWrap_ = _import "gtk_text_view_get_pixels_inside_wrap" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p -> GInt32.FFI.val_;
    val getRightMargin_ = _import "gtk_text_view_get_right_margin" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getTopMargin_ = _import "gtk_text_view_get_top_margin" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p -> GInt32.FFI.val_;
    ...
    val setBottomMargin_ = fn x1 & x2 => (_import "gtk_text_view_set_bottom_margin" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val setIndent_ = fn x1 & x2 => (_import "gtk_text_view_set_indent" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val setLeftMargin_ = fn x1 & x2 => (_import "gtk_text_view_set_left_margin" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val setPixelsAboveLines_ = fn x1 & x2 => (_import "gtk_text_view_set_pixels_above_lines" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setPixelsBelowLines_ = fn x1 & x2 => (_import "gtk_text_view_set_pixels_below_lines" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setPixelsInsideWrap_ = fn x1 & x2 => (_import "gtk_text_view_set_pixels_inside_wrap" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setRightMargin_ = fn x1 & x2 => (_import "gtk_text_view_set_right_margin" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val setTopMargin_ = fn x1 & x2 => (_import "gtk_text_view_set_top_margin" : GtkTextViewClass.FFI.non_opt GtkTextViewClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
