structure GtkUIManager :>
  ...
  struct
    ...
    val newMergeId_ = _import "gtk_ui_manager_new_merge_id" : GtkUIManagerClass.FFI.non_opt GtkUIManagerClass.FFI.p -> GUInt32.FFI.val_;
    ...
    val removeUi_ = fn x1 & x2 => (_import "gtk_ui_manager_remove_ui" : GtkUIManagerClass.FFI.non_opt GtkUIManagerClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
