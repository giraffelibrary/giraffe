structure GtkIMMulticontext :>
  ...
  struct
    ...
    val new_ = _import "gtk_im_multicontext_new" : unit -> GtkIMContextClass.FFI.notnull GtkIMContextClass.FFI.p;
    val appendMenuitems_ = fn x1 & x2 => (_import "gtk_im_multicontext_append_menuitems" : GtkIMMulticontextClass.FFI.notnull GtkIMMulticontextClass.FFI.p * GtkMenuShellClass.FFI.notnull GtkMenuShellClass.FFI.p -> unit;) (x1, x2)
    val getContextId_ = _import "gtk_im_multicontext_get_context_id" : GtkIMMulticontextClass.FFI.notnull GtkIMMulticontextClass.FFI.p -> Utf8.FFI.notnull Utf8.FFI.out_p;
    val setContextId_ =
      fn
        x1 & (x2, x3) =>
          (
            _import "mlton_gtk_im_multicontext_set_context_id" :
              GtkIMMulticontextClass.FFI.notnull GtkIMMulticontextClass.FFI.p
               * Utf8.MLton.p1
