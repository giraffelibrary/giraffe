structure GtkComboBox :>
  ...
  struct
    ...
    val getColumnSpanColumn_ = _import "gtk_combo_box_get_column_span_column" : GtkComboBoxClass.FFI.notnull GtkComboBoxClass.FFI.p -> GInt32.FFI.val_;
    val getEntryTextColumn_ = _import "gtk_combo_box_get_entry_text_column" : GtkComboBoxClass.FFI.notnull GtkComboBoxClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getIdColumn_ = _import "gtk_combo_box_get_id_column" : GtkComboBoxClass.FFI.notnull GtkComboBoxClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getRowSpanColumn_ = _import "gtk_combo_box_get_row_span_column" : GtkComboBoxClass.FFI.notnull GtkComboBoxClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getWrapWidth_ = _import "gtk_combo_box_get_wrap_width" : GtkComboBoxClass.FFI.notnull GtkComboBoxClass.FFI.p -> GInt32.FFI.val_;
    ...
    val setActive_ = fn x1 & x2 => (_import "gtk_combo_box_set_active" : GtkComboBoxClass.FFI.notnull GtkComboBoxClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setActiveId_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val setColumnSpanColumn_ = fn x1 & x2 => (_import "gtk_combo_box_set_column_span_column" : GtkComboBoxClass.FFI.notnull GtkComboBoxClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setEntryTextColumn_ = fn x1 & x2 => (_import "gtk_combo_box_set_entry_text_column" : GtkComboBoxClass.FFI.notnull GtkComboBoxClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val setIdColumn_ = fn x1 & x2 => (_import "gtk_combo_box_set_id_column" : GtkComboBoxClass.FFI.notnull GtkComboBoxClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val setRowSpanColumn_ = fn x1 & x2 => (_import "gtk_combo_box_set_row_span_column" : GtkComboBoxClass.FFI.notnull GtkComboBoxClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setTitle_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val setWrapWidth_ = fn x1 & x2 => (_import "gtk_combo_box_set_wrap_width" : GtkComboBoxClass.FFI.notnull GtkComboBoxClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
