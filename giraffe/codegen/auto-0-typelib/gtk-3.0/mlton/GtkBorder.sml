structure GtkBorder :>
  ...
  struct
    ...
    val new_ = _import "gtk_border_new" : unit -> GtkBorderRecord.FFI.non_opt GtkBorderRecord.FFI.p;
    val copy_ = _import "gtk_border_copy" : GtkBorderRecord.FFI.non_opt GtkBorderRecord.FFI.p -> GtkBorderRecord.FFI.non_opt GtkBorderRecord.FFI.p;
