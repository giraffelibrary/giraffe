structure GtkEntryCompletion :>
  ...
  struct
    ...
    val new_ = _import "gtk_entry_completion_new" : unit -> GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p;
    val newWithArea_ = _import "gtk_entry_completion_new_with_area" : GtkCellAreaClass.C.notnull GtkCellAreaClass.C.p -> GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p;
    val complete_ = _import "gtk_entry_completion_complete" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> unit;
    val deleteAction_ = fn x1 & x2 => (_import "gtk_entry_completion_delete_action" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    val getCompletionPrefix_ = _import "gtk_entry_completion_get_completion_prefix" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getEntry_ = _import "gtk_entry_completion_get_entry" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> GtkWidgetClass.C.notnull GtkWidgetClass.C.p;
    val getInlineCompletion_ = _import "gtk_entry_completion_get_inline_completion" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> FFI.Bool.C.val_;
    val getInlineSelection_ = _import "gtk_entry_completion_get_inline_selection" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> FFI.Bool.C.val_;
    val getMinimumKeyLength_ = _import "gtk_entry_completion_get_minimum_key_length" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> FFI.Int32.C.val_;
    val getModel_ = _import "gtk_entry_completion_get_model" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> GtkTreeModelClass.C.notnull GtkTreeModelClass.C.p;
    val getPopupCompletion_ = _import "gtk_entry_completion_get_popup_completion" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> FFI.Bool.C.val_;
    val getPopupSetWidth_ = _import "gtk_entry_completion_get_popup_set_width" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> FFI.Bool.C.val_;
    val getPopupSingleMatch_ = _import "gtk_entry_completion_get_popup_single_match" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> FFI.Bool.C.val_;
    val getTextColumn_ = _import "gtk_entry_completion_get_text_column" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> FFI.Int32.C.val_;
         ...
         & (x3, x4) =>
          (
            _import "mlton_gtk_entry_completion_insert_action_markup" :
              GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p
               * FFI.Int32.C.val_
               * Utf8.MLton.p1
    ...
    val insertPrefix_ = _import "gtk_entry_completion_insert_prefix" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p -> unit;
    val setInlineCompletion_ = fn x1 & x2 => (_import "gtk_entry_completion_set_inline_completion" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p * FFI.Bool.C.val_ -> unit;) (x1, x2)
    val setInlineSelection_ = fn x1 & x2 => (_import "gtk_entry_completion_set_inline_selection" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p * FFI.Bool.C.val_ -> unit;) (x1, x2)
    val setMinimumKeyLength_ = fn x1 & x2 => (_import "gtk_entry_completion_set_minimum_key_length" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    val setModel_ = fn x1 & x2 => (_import "gtk_entry_completion_set_model" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p * unit GtkTreeModelClass.C.p -> unit;) (x1, x2)
    val setPopupCompletion_ = fn x1 & x2 => (_import "gtk_entry_completion_set_popup_completion" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p * FFI.Bool.C.val_ -> unit;) (x1, x2)
    val setPopupSetWidth_ = fn x1 & x2 => (_import "gtk_entry_completion_set_popup_set_width" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p * FFI.Bool.C.val_ -> unit;) (x1, x2)
    val setPopupSingleMatch_ = fn x1 & x2 => (_import "gtk_entry_completion_set_popup_single_match" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p * FFI.Bool.C.val_ -> unit;) (x1, x2)
    val setTextColumn_ = fn x1 & x2 => (_import "gtk_entry_completion_set_text_column" : GtkEntryCompletionClass.C.notnull GtkEntryCompletionClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
