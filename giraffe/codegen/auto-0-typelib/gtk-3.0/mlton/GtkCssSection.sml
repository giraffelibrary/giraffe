structure GtkCssSection :>
  ...
  struct
    ...
    val getEndLine_ = _import "gtk_css_section_get_end_line" : GtkCssSectionRecord.FFI.notnull GtkCssSectionRecord.FFI.p -> GUInt32.FFI.val_;
    val getEndPosition_ = _import "gtk_css_section_get_end_position" : GtkCssSectionRecord.FFI.notnull GtkCssSectionRecord.FFI.p -> GUInt32.FFI.val_;
    ...
    val getStartLine_ = _import "gtk_css_section_get_start_line" : GtkCssSectionRecord.FFI.notnull GtkCssSectionRecord.FFI.p -> GUInt32.FFI.val_;
    val getStartPosition_ = _import "gtk_css_section_get_start_position" : GtkCssSectionRecord.FFI.notnull GtkCssSectionRecord.FFI.p -> GUInt32.FFI.val_;
    type t = GtkCssSectionRecord.t
    type css_section_type_t = GtkCssSectionType.t
    val getType = (I ---> GObjectType.FFI.fromVal) getType_
    fun getEndLine self = (GtkCssSectionRecord.FFI.withPtr ---> GUInt32.FFI.fromVal) getEndLine_ self
    fun getEndPosition self = (GtkCssSectionRecord.FFI.withPtr ---> GUInt32.FFI.fromVal) getEndPosition_ self
    ...
    fun getStartLine self = (GtkCssSectionRecord.FFI.withPtr ---> GUInt32.FFI.fromVal) getStartLine_ self
    fun getStartPosition self = (GtkCssSectionRecord.FFI.withPtr ---> GUInt32.FFI.fromVal) getStartPosition_ self
  end
