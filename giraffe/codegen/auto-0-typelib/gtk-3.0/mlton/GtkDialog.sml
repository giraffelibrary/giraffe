structure GtkDialog :>
  ...
  struct
    ...
    val getResponseForWidget_ = fn x1 & x2 => (_import "gtk_dialog_get_response_for_widget" : GtkDialogClass.C.notnull GtkDialogClass.C.p * GtkWidgetClass.C.notnull GtkWidgetClass.C.p -> FFI.Int32.C.val_;) (x1, x2)
    val getWidgetForResponse_ = fn x1 & x2 => (_import "gtk_dialog_get_widget_for_response" : GtkDialogClass.C.notnull GtkDialogClass.C.p * FFI.Int32.C.val_ -> GtkWidgetClass.C.notnull GtkWidgetClass.C.p;) (x1, x2)
    val response_ = fn x1 & x2 => (_import "gtk_dialog_response" : GtkDialogClass.C.notnull GtkDialogClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    val run_ = _import "gtk_dialog_run" : GtkDialogClass.C.notnull GtkDialogClass.C.p -> FFI.Int32.C.val_;
    val setDefaultResponse_ = fn x1 & x2 => (_import "gtk_dialog_set_default_response" : GtkDialogClass.C.notnull GtkDialogClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    ...
    fun getResponseForWidget self widget = (GtkDialogClass.C.withPtr &&&> GtkWidgetClass.C.withPtr ---> FFI.Int32.C.fromVal) getResponseForWidget_ (self & widget)
    fun getWidgetForResponse self responseId = (GtkDialogClass.C.withPtr &&&> FFI.Int32.C.withVal ---> GtkWidgetClass.C.fromPtr false) getWidgetForResponse_ (self & responseId)
    fun response self responseId = (GtkDialogClass.C.withPtr &&&> FFI.Int32.C.withVal ---> I) response_ (self & responseId)
    fun run self = (GtkDialogClass.C.withPtr ---> FFI.Int32.C.fromVal) run_ self
    fun setDefaultResponse self responseId = (GtkDialogClass.C.withPtr &&&> FFI.Int32.C.withVal ---> I) setDefaultResponse_ (self & responseId)
