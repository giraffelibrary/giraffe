structure GtkDialog :>
  ...
  struct
    ...
    val getWidgetForResponse_ = fn x1 & x2 => (_import "gtk_dialog_get_widget_for_response" : GtkDialogClass.FFI.notnull GtkDialogClass.FFI.p * GInt32.FFI.val_ -> unit GtkWidgetClass.FFI.p;) (x1, x2)
