structure GtkDialog :>
  ...
  struct
    ...
    val getResponseForWidget_ = fn x1 & x2 => (_import "gtk_dialog_get_response_for_widget" : GtkDialogClass.FFI.notnull GtkDialogClass.FFI.p * GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GInt32.FFI.val_;) (x1, x2)
    val getWidgetForResponse_ = fn x1 & x2 => (_import "gtk_dialog_get_widget_for_response" : GtkDialogClass.FFI.notnull GtkDialogClass.FFI.p * GInt32.FFI.val_ -> GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p;) (x1, x2)
    val response_ = fn x1 & x2 => (_import "gtk_dialog_response" : GtkDialogClass.FFI.notnull GtkDialogClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val run_ = _import "gtk_dialog_run" : GtkDialogClass.FFI.notnull GtkDialogClass.FFI.p -> GInt32.FFI.val_;
    ...
    val setDefaultResponse_ = fn x1 & x2 => (_import "gtk_dialog_set_default_response" : GtkDialogClass.FFI.notnull GtkDialogClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
