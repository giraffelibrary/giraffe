structure GtkComboBoxText :>
  ...
  struct
    ...
    val remove_ = fn x1 & x2 => (_import "gtk_combo_box_text_remove" : GtkComboBoxTextClass.C.notnull GtkComboBoxTextClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    ...
    fun remove self position = (GtkComboBoxTextClass.C.withPtr &&&> FFI.Int32.C.withVal ---> I) remove_ (self & position)
