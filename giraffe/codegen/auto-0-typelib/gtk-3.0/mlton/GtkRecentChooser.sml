structure GtkRecentChooser :>
  ...
  struct
    ...
    val getLimit_ = _import "gtk_recent_chooser_get_limit" : GtkRecentChooserClass.FFI.non_opt GtkRecentChooserClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getUris_ = fn x1 & x2 => (_import "gtk_recent_chooser_get_uris" : GtkRecentChooserClass.FFI.non_opt GtkRecentChooserClass.FFI.p * GUInt64.FFI.ref_ -> Utf8CPtrArray.FFI.non_opt Utf8CPtrArray.FFI.out_p;) (x1, x2)
    ...
    val setLimit_ = fn x1 & x2 => (_import "gtk_recent_chooser_set_limit" : GtkRecentChooserClass.FFI.non_opt GtkRecentChooserClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    fun getUris self =
      let
        val _ & retVal = (GtkRecentChooserClass.FFI.withPtr &&&> GUInt64.FFI.withRefVal ---> GUInt64.FFI.fromVal && Utf8CPtrArray.FFI.fromPtr 2) getUris_ (self & GUInt64.null)
      in
        retVal
      end
