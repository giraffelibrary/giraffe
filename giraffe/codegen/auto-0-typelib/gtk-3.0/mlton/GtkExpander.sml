structure GtkExpander :>
  ...
  struct
    ...
    val getSpacing_ = _import "gtk_expander_get_spacing" : GtkExpanderClass.C.notnull GtkExpanderClass.C.p -> FFI.Int32.C.val_;
    ...
    val setSpacing_ = fn x1 & x2 => (_import "gtk_expander_set_spacing" : GtkExpanderClass.C.notnull GtkExpanderClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    ...
    fun getSpacing self = (GtkExpanderClass.C.withPtr ---> FFI.Int32.C.fromVal) getSpacing_ self
    ...
    fun setSpacing self spacing = (GtkExpanderClass.C.withPtr &&&> FFI.Int32.C.withVal ---> I) setSpacing_ (self & spacing)
