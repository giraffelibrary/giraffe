structure GtkExpander :>
  ...
  struct
    ...
    val new_ = _import "mlton_gtk_expander_new" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> GObjectObjectClass.C.notnull GObjectObjectClass.C.p;
    val newWithMnemonic_ = _import "mlton_gtk_expander_new_with_mnemonic" : Utf8.MLton.p1 * unit Utf8.MLton.p2 -> GObjectObjectClass.C.notnull GObjectObjectClass.C.p;
