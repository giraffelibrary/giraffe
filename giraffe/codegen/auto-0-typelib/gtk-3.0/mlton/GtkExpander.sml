structure GtkExpander :>
  ...
  struct
    ...
    val getSpacing_ = _import "gtk_expander_get_spacing" : GtkExpanderClass.FFI.non_opt GtkExpanderClass.FFI.p -> GInt32.FFI.val_;
    ...
    val setSpacing_ = fn x1 & x2 => (_import "gtk_expander_set_spacing" : GtkExpanderClass.FFI.non_opt GtkExpanderClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
