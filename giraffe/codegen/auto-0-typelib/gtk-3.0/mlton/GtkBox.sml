structure GtkBox :>
  ...
  struct
    ...
    val new_ = fn x1 & x2 => (_import "gtk_box_new" : GtkOrientation.C.val_ * FFI.Int32.C.val_ -> GtkWidgetClass.C.notnull GtkWidgetClass.C.p;) (x1, x2)
    val getHomogeneous_ = _import "gtk_box_get_homogeneous" : GtkBoxClass.C.notnull GtkBoxClass.C.p -> FFI.Bool.C.val_;
    val getSpacing_ = _import "gtk_box_get_spacing" : GtkBoxClass.C.notnull GtkBoxClass.C.p -> FFI.Int32.C.val_;
    val packEnd_ =
      fn
        x1
         & x2
    ...
    val setSpacing_ = fn x1 & x2 => (_import "gtk_box_set_spacing" : GtkBoxClass.C.notnull GtkBoxClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
