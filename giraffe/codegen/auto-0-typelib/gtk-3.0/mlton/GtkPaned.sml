structure GtkPaned :>
  ...
  struct
    ...
    val getPosition_ = _import "gtk_paned_get_position" : GtkPanedClass.FFI.notnull GtkPanedClass.FFI.p -> GInt32.FFI.val_;
    val pack1_ =
      fn
        x1
         & x2
    ...
    val setPosition_ = fn x1 & x2 => (_import "gtk_paned_set_position" : GtkPanedClass.FFI.notnull GtkPanedClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    fun getPosition self = (GtkPanedClass.FFI.withPtr ---> GInt32.FFI.fromVal) getPosition_ self
    ...
    fun setPosition self position = (GtkPanedClass.FFI.withPtr &&&> GInt32.FFI.withVal ---> I) setPosition_ (self & position)
    local
