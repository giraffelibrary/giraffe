structure GtkToolItem :>
  ...
  struct
    ...
    val getIconSize_ = _import "gtk_tool_item_get_icon_size" : GtkToolItemClass.FFI.non_opt GtkToolItemClass.FFI.p -> GInt32.FFI.val_;
    ...
    fun getIconSize self = (GtkToolItemClass.FFI.withPtr false ---> GInt32.FFI.fromVal) getIconSize_ self
