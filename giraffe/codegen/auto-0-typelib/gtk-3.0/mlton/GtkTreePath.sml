structure GtkTreePath :>
  ...
  struct
    ...
    val appendIndex_ = fn x1 & x2 => (_import "gtk_tree_path_append_index" : GtkTreePathRecord.FFI.non_opt GtkTreePathRecord.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val compare_ = fn x1 & x2 => (_import "gtk_tree_path_compare" : GtkTreePathRecord.FFI.non_opt GtkTreePathRecord.FFI.p * GtkTreePathRecord.FFI.non_opt GtkTreePathRecord.FFI.p -> GInt32.FFI.val_;) (x1, x2)
    ...
    val getDepth_ = _import "gtk_tree_path_get_depth" : GtkTreePathRecord.FFI.non_opt GtkTreePathRecord.FFI.p -> GInt32.FFI.val_;
    val getIndices_ = fn x1 & x2 => (_import "gtk_tree_path_get_indices_with_depth" : GtkTreePathRecord.FFI.non_opt GtkTreePathRecord.FFI.p * GInt32.FFI.ref_ -> GInt32CArrayN.FFI.non_opt GInt32CArrayN.FFI.out_p;) (x1, x2)
    ...
    val prependIndex_ = fn x1 & x2 => (_import "gtk_tree_path_prepend_index" : GtkTreePathRecord.FFI.non_opt GtkTreePathRecord.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
