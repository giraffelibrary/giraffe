structure GtkApplication :>
  ...
  struct
    ...
    val getWindowById_ = fn x1 & x2 => (_import "gtk_application_get_window_by_id" : GtkApplicationClass.FFI.notnull GtkApplicationClass.FFI.p * GUInt32.FFI.val_ -> unit GtkWindowClass.FFI.p;) (x1, x2)
    val inhibit_ =
      fn
        x1
         & x2
    ...
    val uninhibit_ = fn x1 & x2 => (_import "gtk_application_uninhibit" : GtkApplicationClass.FFI.notnull GtkApplicationClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
