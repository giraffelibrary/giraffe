structure GtkSelectionData :>
  ...
  struct
    ...
    val getData_ = fn x1 & x2 => (_import "gtk_selection_data_get_data_with_length" : GtkSelectionDataRecord.FFI.non_opt GtkSelectionDataRecord.FFI.p * GInt32.FFI.ref_ -> GUInt8CArrayN.FFI.non_opt GUInt8CArrayN.FFI.out_p;) (x1, x2)
    ...
    val getFormat_ = _import "gtk_selection_data_get_format" : GtkSelectionDataRecord.FFI.non_opt GtkSelectionDataRecord.FFI.p -> GInt32.FFI.val_;
    val getLength_ = _import "gtk_selection_data_get_length" : GtkSelectionDataRecord.FFI.non_opt GtkSelectionDataRecord.FFI.p -> GInt32.FFI.val_;
