structure GtkTextIter :>
  ...
  struct
    ...
    val backwardChars_ = fn x1 & x2 => (_import "gtk_text_iter_backward_chars" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val backwardCursorPositions_ = fn x1 & x2 => (_import "gtk_text_iter_backward_cursor_positions" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    val backwardLine_ = _import "gtk_text_iter_backward_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.C.val_;
    val backwardLines_ = fn x1 & x2 => (_import "gtk_text_iter_backward_lines" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    val backwardSearch_ =
      fn
        x1
         & (x2, x3)
    ...
    val backwardSentenceStarts_ = fn x1 & x2 => (_import "gtk_text_iter_backward_sentence_starts" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val backwardVisibleCursorPositions_ = fn x1 & x2 => (_import "gtk_text_iter_backward_visible_cursor_positions" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val backwardVisibleLines_ = fn x1 & x2 => (_import "gtk_text_iter_backward_visible_lines" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val backwardVisibleWordStarts_ = fn x1 & x2 => (_import "gtk_text_iter_backward_visible_word_starts" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val backwardWordStarts_ = fn x1 & x2 => (_import "gtk_text_iter_backward_word_starts" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val compare_ = fn x1 & x2 => (_import "gtk_text_iter_compare" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.C.val_;) (x1, x2)
    ...
    val forwardChars_ = fn x1 & x2 => (_import "gtk_text_iter_forward_chars" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val forwardCursorPositions_ = fn x1 & x2 => (_import "gtk_text_iter_forward_cursor_positions" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    val forwardLine_ = _import "gtk_text_iter_forward_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.C.val_;
    val forwardLines_ = fn x1 & x2 => (_import "gtk_text_iter_forward_lines" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    val forwardSearch_ =
      fn
        x1
         & (x2, x3)
    ...
    val forwardSentenceEnds_ = fn x1 & x2 => (_import "gtk_text_iter_forward_sentence_ends" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val forwardVisibleCursorPositions_ = fn x1 & x2 => (_import "gtk_text_iter_forward_visible_cursor_positions" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val forwardVisibleLines_ = fn x1 & x2 => (_import "gtk_text_iter_forward_visible_lines" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val forwardVisibleWordEnds_ = fn x1 & x2 => (_import "gtk_text_iter_forward_visible_word_ends" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val forwardWordEnds_ = fn x1 & x2 => (_import "gtk_text_iter_forward_word_ends" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val getBytesInLine_ = _import "gtk_text_iter_get_bytes_in_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.C.val_;
    val getChar_ = _import "gtk_text_iter_get_char" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Char.C.val_;
    val getCharsInLine_ = _import "gtk_text_iter_get_chars_in_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.C.val_;
    ...
    val getLine_ = _import "gtk_text_iter_get_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.C.val_;
    val getLineIndex_ = _import "gtk_text_iter_get_line_index" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.C.val_;
    val getLineOffset_ = _import "gtk_text_iter_get_line_offset" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.C.val_;
    val getOffset_ = _import "gtk_text_iter_get_offset" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.C.val_;
    ...
    val getSlice_ = fn x1 & x2 => (_import "gtk_text_iter_get_slice" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.String.C.notnull FFI.String.C.out_p;) (x1, x2)
    val getText_ = fn x1 & x2 => (_import "gtk_text_iter_get_text" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.String.C.notnull FFI.String.C.out_p;) (x1, x2)
    val getVisibleLineIndex_ = _import "gtk_text_iter_get_visible_line_index" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.C.val_;
    val getVisibleLineOffset_ = _import "gtk_text_iter_get_visible_line_offset" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.C.val_;
    val getVisibleSlice_ = fn x1 & x2 => (_import "gtk_text_iter_get_visible_slice" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.String.C.notnull FFI.String.C.out_p;) (x1, x2)
    val getVisibleText_ = fn x1 & x2 => (_import "gtk_text_iter_get_visible_text" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.String.C.notnull FFI.String.C.out_p;) (x1, x2)
    ...
    val setLine_ = fn x1 & x2 => (_import "gtk_text_iter_set_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    val setLineIndex_ = fn x1 & x2 => (_import "gtk_text_iter_set_line_index" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    val setLineOffset_ = fn x1 & x2 => (_import "gtk_text_iter_set_line_offset" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    val setOffset_ = fn x1 & x2 => (_import "gtk_text_iter_set_offset" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    val setVisibleLineIndex_ = fn x1 & x2 => (_import "gtk_text_iter_set_visible_line_index" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    val setVisibleLineOffset_ = fn x1 & x2 => (_import "gtk_text_iter_set_visible_line_offset" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
