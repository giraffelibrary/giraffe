structure GtkRange :>
  ...
  struct
    ...
    val getMinSliderSize_ = _import "gtk_range_get_min_slider_size" : GtkRangeClass.FFI.non_opt GtkRangeClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getRoundDigits_ = _import "gtk_range_get_round_digits" : GtkRangeClass.FFI.non_opt GtkRangeClass.FFI.p -> GInt32.FFI.val_;
    ...
    val setMinSliderSize_ = fn x1 & x2 => (_import "gtk_range_set_min_slider_size" : GtkRangeClass.FFI.non_opt GtkRangeClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val setRange_ =
      fn
        x1
         & x2
    ...
    val setRoundDigits_ = fn x1 & x2 => (_import "gtk_range_set_round_digits" : GtkRangeClass.FFI.non_opt GtkRangeClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
