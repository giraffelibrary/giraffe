structure GtkSocket :>
  ...
  struct
    ...
    val addId_ = fn x1 & x2 => (_import "gtk_socket_add_id" : GtkSocketClass.C.notnull GtkSocketClass.C.p * FFI.UInt64.C.val_ -> unit;) (x1, x2)
    val getId_ = _import "gtk_socket_get_id" : GtkSocketClass.C.notnull GtkSocketClass.C.p -> FFI.UInt64.C.val_;
