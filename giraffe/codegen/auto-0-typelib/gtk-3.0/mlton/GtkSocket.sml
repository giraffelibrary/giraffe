structure GtkSocket :>
  ...
  struct
    ...
    val addId_ = fn x1 & x2 => (_import "gtk_socket_add_id" : GtkSocketClass.FFI.non_opt GtkSocketClass.FFI.p * GUInt64.FFI.val_ -> unit;) (x1, x2)
    val getId_ = _import "gtk_socket_get_id" : GtkSocketClass.FFI.non_opt GtkSocketClass.FFI.p -> GUInt64.FFI.val_;
