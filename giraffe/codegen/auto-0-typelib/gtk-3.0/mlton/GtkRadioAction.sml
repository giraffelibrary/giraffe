structure GtkRadioAction :>
  ...
  struct
    ...
    val getCurrentValue_ = _import "gtk_radio_action_get_current_value" : GtkRadioActionClass.FFI.non_opt GtkRadioActionClass.FFI.p -> GInt32.FFI.val_;
    ...
    val setCurrentValue_ = fn x1 & x2 => (_import "gtk_radio_action_set_current_value" : GtkRadioActionClass.FFI.non_opt GtkRadioActionClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    fun getCurrentValue self = (GtkRadioActionClass.FFI.withPtr false ---> GInt32.FFI.fromVal) getCurrentValue_ self
    ...
    fun setCurrentValue self currentValue = (GtkRadioActionClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) setCurrentValue_ (self & currentValue)
    local
