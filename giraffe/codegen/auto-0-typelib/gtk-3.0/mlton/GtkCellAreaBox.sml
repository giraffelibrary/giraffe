structure GtkCellAreaBox :>
  ...
  struct
    ...
    val getSpacing_ = _import "gtk_cell_area_box_get_spacing" : GtkCellAreaBoxClass.FFI.non_opt GtkCellAreaBoxClass.FFI.p -> GInt32.FFI.val_;
    val packEnd_ =
      fn
        x1
         & x2
    ...
    val setSpacing_ = fn x1 & x2 => (_import "gtk_cell_area_box_set_spacing" : GtkCellAreaBoxClass.FFI.non_opt GtkCellAreaBoxClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    fun getSpacing self = (GtkCellAreaBoxClass.FFI.withPtr false ---> GInt32.FFI.fromVal) getSpacing_ self
    fun packEnd
      self
      (
        renderer,
