structure GtkToolbar :>
  ...
  struct
    ...
    val getNthItem_ = fn x1 & x2 => (_import "gtk_toolbar_get_nth_item" : GtkToolbarClass.FFI.notnull GtkToolbarClass.FFI.p * GInt32.FFI.val_ -> unit GtkToolItemClass.FFI.p;) (x1, x2)
