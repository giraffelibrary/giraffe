structure GtkToolbar :>
  ...
  struct
    ...
    val getItemIndex_ = fn x1 & x2 => (_import "gtk_toolbar_get_item_index" : GtkToolbarClass.FFI.non_opt GtkToolbarClass.FFI.p * GtkToolItemClass.FFI.non_opt GtkToolItemClass.FFI.p -> GInt32.FFI.val_;) (x1, x2)
    val getNItems_ = _import "gtk_toolbar_get_n_items" : GtkToolbarClass.FFI.non_opt GtkToolbarClass.FFI.p -> GInt32.FFI.val_;
    val getNthItem_ = fn x1 & x2 => (_import "gtk_toolbar_get_nth_item" : GtkToolbarClass.FFI.non_opt GtkToolbarClass.FFI.p * GInt32.FFI.val_ -> GtkToolItemClass.FFI.opt GtkToolItemClass.FFI.p;) (x1, x2)
    ...
    fun getNthItem self n = (GtkToolbarClass.FFI.withPtr &&&> GInt32.FFI.withVal ---> GtkToolItemClass.FFI.fromOptPtr false) getNthItem_ (self & n)
