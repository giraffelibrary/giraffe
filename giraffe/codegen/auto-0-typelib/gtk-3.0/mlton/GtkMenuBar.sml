structure GtkMenuBar :>
  ...
  struct
    ...
    val newFromModel_ = _import "gtk_menu_bar_new_from_model" : GioMenuModelClass.FFI.notnull GioMenuModelClass.FFI.p -> GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p;
