structure GtkFlowBox :>
  ...
  struct
    ...
    val getChildAtIndex_ = fn x1 & x2 => (_import "gtk_flow_box_get_child_at_index" : GtkFlowBoxClass.FFI.non_opt GtkFlowBoxClass.FFI.p * GInt32.FFI.val_ -> GtkFlowBoxChildClass.FFI.opt GtkFlowBoxChildClass.FFI.p;) (x1, x2)
    val getChildAtPos_ =
      fn
        x1
         & x2
    ...
    val getColumnSpacing_ = _import "gtk_flow_box_get_column_spacing" : GtkFlowBoxClass.FFI.non_opt GtkFlowBoxClass.FFI.p -> GUInt32.FFI.val_;
    ...
    val getMaxChildrenPerLine_ = _import "gtk_flow_box_get_max_children_per_line" : GtkFlowBoxClass.FFI.non_opt GtkFlowBoxClass.FFI.p -> GUInt32.FFI.val_;
    val getMinChildrenPerLine_ = _import "gtk_flow_box_get_min_children_per_line" : GtkFlowBoxClass.FFI.non_opt GtkFlowBoxClass.FFI.p -> GUInt32.FFI.val_;
    val getRowSpacing_ = _import "gtk_flow_box_get_row_spacing" : GtkFlowBoxClass.FFI.non_opt GtkFlowBoxClass.FFI.p -> GUInt32.FFI.val_;
    ...
    val setColumnSpacing_ = fn x1 & x2 => (_import "gtk_flow_box_set_column_spacing" : GtkFlowBoxClass.FFI.non_opt GtkFlowBoxClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val setMaxChildrenPerLine_ = fn x1 & x2 => (_import "gtk_flow_box_set_max_children_per_line" : GtkFlowBoxClass.FFI.non_opt GtkFlowBoxClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val setMinChildrenPerLine_ = fn x1 & x2 => (_import "gtk_flow_box_set_min_children_per_line" : GtkFlowBoxClass.FFI.non_opt GtkFlowBoxClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val setRowSpacing_ = fn x1 & x2 => (_import "gtk_flow_box_set_row_spacing" : GtkFlowBoxClass.FFI.non_opt GtkFlowBoxClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    fun getChildAtIndex self idx = (GtkFlowBoxClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GtkFlowBoxChildClass.FFI.fromOptPtr false) getChildAtIndex_ (self & idx) before GtkFlowBoxClass.FFI.touchPtr self
    ...
    fun getColumnSpacing self = (GtkFlowBoxClass.FFI.withPtr false ---> GUInt32.FFI.fromVal) getColumnSpacing_ self
    fun getHomogeneous self = (GtkFlowBoxClass.FFI.withPtr false ---> GBool.FFI.fromVal) getHomogeneous_ self
    fun getMaxChildrenPerLine self = (GtkFlowBoxClass.FFI.withPtr false ---> GUInt32.FFI.fromVal) getMaxChildrenPerLine_ self
    fun getMinChildrenPerLine self = (GtkFlowBoxClass.FFI.withPtr false ---> GUInt32.FFI.fromVal) getMinChildrenPerLine_ self
    fun getRowSpacing self = (GtkFlowBoxClass.FFI.withPtr false ---> GUInt32.FFI.fromVal) getRowSpacing_ self
    ...
    fun setColumnSpacing self spacing = (GtkFlowBoxClass.FFI.withPtr false &&&> GUInt32.FFI.withVal ---> I) setColumnSpacing_ (self & spacing)
    ...
    fun setMaxChildrenPerLine self nChildren = (GtkFlowBoxClass.FFI.withPtr false &&&> GUInt32.FFI.withVal ---> I) setMaxChildrenPerLine_ (self & nChildren)
    fun setMinChildrenPerLine self nChildren = (GtkFlowBoxClass.FFI.withPtr false &&&> GUInt32.FFI.withVal ---> I) setMinChildrenPerLine_ (self & nChildren)
    fun setRowSpacing self spacing = (GtkFlowBoxClass.FFI.withPtr false &&&> GUInt32.FFI.withVal ---> I) setRowSpacing_ (self & spacing)
