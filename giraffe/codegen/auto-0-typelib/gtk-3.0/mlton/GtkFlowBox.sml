structure GtkFlowBox :>
  ...
  struct
    ...
    val getChildAtIndex_ = fn x1 & x2 => (_import "gtk_flow_box_get_child_at_index" : GtkFlowBoxClass.FFI.notnull GtkFlowBoxClass.FFI.p * GInt32.FFI.val_ -> unit GtkFlowBoxChildClass.FFI.p;) (x1, x2)
    val getChildAtPos_ =
      fn
        x1
         & x2
    ...
    val getColumnSpacing_ = _import "gtk_flow_box_get_column_spacing" : GtkFlowBoxClass.FFI.notnull GtkFlowBoxClass.FFI.p -> GUInt32.FFI.val_;
    ...
    val getMaxChildrenPerLine_ = _import "gtk_flow_box_get_max_children_per_line" : GtkFlowBoxClass.FFI.notnull GtkFlowBoxClass.FFI.p -> GUInt32.FFI.val_;
    val getMinChildrenPerLine_ = _import "gtk_flow_box_get_min_children_per_line" : GtkFlowBoxClass.FFI.notnull GtkFlowBoxClass.FFI.p -> GUInt32.FFI.val_;
    val getRowSpacing_ = _import "gtk_flow_box_get_row_spacing" : GtkFlowBoxClass.FFI.notnull GtkFlowBoxClass.FFI.p -> GUInt32.FFI.val_;
    ...
    val setColumnSpacing_ = fn x1 & x2 => (_import "gtk_flow_box_set_column_spacing" : GtkFlowBoxClass.FFI.notnull GtkFlowBoxClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val setMaxChildrenPerLine_ = fn x1 & x2 => (_import "gtk_flow_box_set_max_children_per_line" : GtkFlowBoxClass.FFI.notnull GtkFlowBoxClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val setMinChildrenPerLine_ = fn x1 & x2 => (_import "gtk_flow_box_set_min_children_per_line" : GtkFlowBoxClass.FFI.notnull GtkFlowBoxClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val setRowSpacing_ = fn x1 & x2 => (_import "gtk_flow_box_set_row_spacing" : GtkFlowBoxClass.FFI.notnull GtkFlowBoxClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
