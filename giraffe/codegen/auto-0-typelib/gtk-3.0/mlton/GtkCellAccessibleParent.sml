structure GtkCellAccessibleParent :>
  ...
  struct
    ...
    val getChildIndex_ = fn x1 & x2 => (_import "gtk_cell_accessible_parent_get_child_index" : GtkCellAccessibleParentClass.FFI.non_opt GtkCellAccessibleParentClass.FFI.p * GtkCellAccessibleClass.FFI.non_opt GtkCellAccessibleClass.FFI.p -> GInt32.FFI.val_;) (x1, x2)
