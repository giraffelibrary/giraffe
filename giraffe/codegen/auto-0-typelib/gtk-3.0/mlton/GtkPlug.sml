structure GtkPlug :>
  ...
  struct
    ...
    val new_ = _import "gtk_plug_new" : GUInt64.FFI.val_ -> GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p;
    val newForDisplay_ = fn x1 & x2 => (_import "gtk_plug_new_for_display" : GdkDisplayClass.FFI.non_opt GdkDisplayClass.FFI.p * GUInt64.FFI.val_ -> GtkWidgetClass.FFI.non_opt GtkWidgetClass.FFI.p;) (x1, x2)
    val construct_ = fn x1 & x2 => (_import "gtk_plug_construct" : GtkPlugClass.FFI.non_opt GtkPlugClass.FFI.p * GUInt64.FFI.val_ -> unit;) (x1, x2)
    ...
    val getId_ = _import "gtk_plug_get_id" : GtkPlugClass.FFI.non_opt GtkPlugClass.FFI.p -> GUInt64.FFI.val_;
