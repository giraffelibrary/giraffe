structure GdkDisplay :>
  ...
  struct
    ...
    val getDefaultCursorSize_ = _import "gdk_display_get_default_cursor_size" : GdkDisplayClass.C.notnull GdkDisplayClass.C.p -> FFI.UInt32.C.val_;
    ...
    val getNScreens_ = _import "gdk_display_get_n_screens" : GdkDisplayClass.C.notnull GdkDisplayClass.C.p -> FFI.Int32.C.val_;
    val getName_ = _import "gdk_display_get_name" : GdkDisplayClass.C.notnull GdkDisplayClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getScreen_ = fn x1 & x2 => (_import "gdk_display_get_screen" : GdkDisplayClass.C.notnull GdkDisplayClass.C.p * FFI.Int32.C.val_ -> GdkScreenClass.C.notnull GdkScreenClass.C.p;) (x1, x2)
    ...
    val setDoubleClickDistance_ = fn x1 & x2 => (_import "gdk_display_set_double_click_distance" : GdkDisplayClass.C.notnull GdkDisplayClass.C.p * FFI.UInt32.C.val_ -> unit;) (x1, x2)
    val setDoubleClickTime_ = fn x1 & x2 => (_import "gdk_display_set_double_click_time" : GdkDisplayClass.C.notnull GdkDisplayClass.C.p * FFI.UInt32.C.val_ -> unit;) (x1, x2)
    ...
    fun getDefaultCursorSize self = (GdkDisplayClass.C.withPtr ---> FFI.UInt32.C.fromVal) getDefaultCursorSize_ self
    ...
    fun getNScreens self = (GdkDisplayClass.C.withPtr ---> FFI.Int32.C.fromVal) getNScreens_ self
    fun getName self = (GdkDisplayClass.C.withPtr ---> Utf8.C.fromPtr false) getName_ self
    fun getScreen self screenNum = (GdkDisplayClass.C.withPtr &&&> FFI.Int32.C.withVal ---> GdkScreenClass.C.fromPtr false) getScreen_ (self & screenNum)
    ...
    fun setDoubleClickDistance self distance = (GdkDisplayClass.C.withPtr &&&> FFI.UInt32.C.withVal ---> I) setDoubleClickDistance_ (self & distance)
    fun setDoubleClickTime self msec = (GdkDisplayClass.C.withPtr &&&> FFI.UInt32.C.withVal ---> I) setDoubleClickTime_ (self & msec)
