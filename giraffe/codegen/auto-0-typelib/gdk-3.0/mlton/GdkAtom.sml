structure GdkAtom :>
  ...
  struct
    val name_ = _import "gdk_atom_name" : GdkAtomRecord.FFI.notnull GdkAtomRecord.FFI.p -> Utf8.FFI.notnull Utf8.FFI.out_p;
    val intern_ =
      fn
        (x1, x2) & x3 =>
          (
    ...
    val internStaticString_ = _import "mlton_gdk_atom_intern_static_string" : Utf8.MLton.p1 * Utf8.FFI.notnull Utf8.MLton.p2 -> GdkAtomRecord.FFI.notnull GdkAtomRecord.FFI.p;
