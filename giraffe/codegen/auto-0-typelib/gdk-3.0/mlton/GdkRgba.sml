structure GdkRgba :>
  ...
  struct
    ...
    val hash_ = _import "gdk_rgba_hash" : GdkRgbaRecord.FFI.non_opt GdkRgbaRecord.FFI.p -> GUInt32.FFI.val_;
    val parse_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    fun hash self = (GdkRgbaRecord.FFI.withPtr false ---> GUInt32.FFI.fromVal) hash_ self
