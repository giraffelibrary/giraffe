structure GdkRgbaRecord :> GDK_RGBA_RECORD =
  struct
    ...
    val new_ = _import "giraffe_gdk_rgba_new" : unit -> notnull p;
    val copy_ = fn x1 & x2 => (_import "giraffe_gdk_rgba_copy" : notnull p * notnull p -> unit;) (x1, x2)
    val free_ = _import "giraffe_gdk_rgba_free" : notnull p -> unit;
    val size_ = _import "giraffe_gdk_rgba_size" : unit -> GUInt.FFI.val_;
    structure Record =
      BoxedValueRecord(
