structure GdkWindow :>
  ...
  struct
    ...
    val atPointer_ = fn x1 & x2 => (_import "gdk_window_at_pointer" : GInt32.FFI.ref_ * GInt32.FFI.ref_ -> GdkWindowClass.FFI.notnull GdkWindowClass.FFI.p;) (x1, x2)
    val constrainSize_ =
      fn
        x1
         & x2
    ...
    val fullscreenOnMonitor_ = fn x1 & x2 => (_import "gdk_window_fullscreen_on_monitor" : GdkWindowClass.FFI.notnull GdkWindowClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val getScaleFactor_ = _import "gdk_window_get_scale_factor" : GdkWindowClass.FFI.notnull GdkWindowClass.FFI.p -> GInt32.FFI.val_;
    ...
    fun fullscreenOnMonitor self monitor = (GdkWindowClass.FFI.withPtr &&&> GInt32.FFI.withVal ---> I) fullscreenOnMonitor_ (self & monitor)
    ...
    fun getScaleFactor self = (GdkWindowClass.FFI.withPtr ---> GInt32.FFI.fromVal) getScaleFactor_ self
