structure Gdk : GDK =
  struct
    ...
    val errorTrapPop_ = _import "gdk_error_trap_pop" : unit -> FFI.Int32.C.val_;
    ...
    val keyvalFromName_ = _import "mlton_gdk_keyval_from_name" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.UInt32.C.val_;
