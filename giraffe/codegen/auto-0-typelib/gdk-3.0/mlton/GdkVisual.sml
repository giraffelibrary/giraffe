structure GdkVisual :>
  ...
  struct
    ...
    val getBestWithBoth_ = fn x1 & x2 => (_import "gdk_visual_get_best_with_both" : FFI.Int32.C.val_ * GdkVisualType.C.val_ -> GdkVisualClass.C.notnull GdkVisualClass.C.p;) (x1, x2)
    val getBestWithDepth_ = _import "gdk_visual_get_best_with_depth" : FFI.Int32.C.val_ -> GdkVisualClass.C.notnull GdkVisualClass.C.p;
    ...
    val getBitsPerRgb_ = _import "gdk_visual_get_bits_per_rgb" : GdkVisualClass.C.notnull GdkVisualClass.C.p -> FFI.Int32.C.val_;
    ...
    val getColormapSize_ = _import "gdk_visual_get_colormap_size" : GdkVisualClass.C.notnull GdkVisualClass.C.p -> FFI.Int32.C.val_;
    val getDepth_ = _import "gdk_visual_get_depth" : GdkVisualClass.C.notnull GdkVisualClass.C.p -> FFI.Int32.C.val_;
