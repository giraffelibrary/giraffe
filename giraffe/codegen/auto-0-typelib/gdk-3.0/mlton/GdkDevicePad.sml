structure GdkDevicePad :>
  ...
  struct
    ...
    val getGroupNModes_ = fn x1 & x2 => (_import "gdk_device_pad_get_group_n_modes" : GdkDevicePadClass.FFI.non_opt GdkDevicePadClass.FFI.p * GInt32.FFI.val_ -> GInt32.FFI.val_;) (x1, x2)
    val getNFeatures_ = fn x1 & x2 => (_import "gdk_device_pad_get_n_features" : GdkDevicePadClass.FFI.non_opt GdkDevicePadClass.FFI.p * GdkDevicePadFeature.FFI.val_ -> GInt32.FFI.val_;) (x1, x2)
    val getNGroups_ = _import "gdk_device_pad_get_n_groups" : GdkDevicePadClass.FFI.non_opt GdkDevicePadClass.FFI.p -> GInt32.FFI.val_;
