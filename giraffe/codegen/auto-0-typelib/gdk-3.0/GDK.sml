signature GDK =
  sig
    ...
    val cairoRectangle : Cairo.ContextRecord.t * Cairo.RectangleIntRecord.t -> unit
    ...
    val rectangleIntersect : Cairo.RectangleIntRecord.t * Cairo.RectangleIntRecord.t -> Cairo.RectangleIntRecord.t option
    val rectangleUnion : Cairo.RectangleIntRecord.t * Cairo.RectangleIntRecord.t -> Cairo.RectangleIntRecord.t
