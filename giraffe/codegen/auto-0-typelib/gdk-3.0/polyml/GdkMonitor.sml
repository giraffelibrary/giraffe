structure GdkMonitor :>
  ...
  struct
    ...
    in
      ...
      val getHeightMm_ = call (getSymbol "gdk_monitor_get_height_mm") (GdkMonitorClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getRefreshRate_ = call (getSymbol "gdk_monitor_get_refresh_rate") (GdkMonitorClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getScaleFactor_ = call (getSymbol "gdk_monitor_get_scale_factor") (GdkMonitorClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getWidthMm_ = call (getSymbol "gdk_monitor_get_width_mm") (GdkMonitorClass.PolyML.cPtr --> GInt32.PolyML.cVal)
