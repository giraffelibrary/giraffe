structure Gdk : GDK =
  struct
    ...
    in
      ...
      val cairoGetDrawingContext_ = call (getSymbol "gdk_cairo_get_drawing_context") (CairoContextRecord.PolyML.cPtr --> GdkDrawingContextClass.PolyML.cOptPtr)
      ...
      val dragMotion_ =
        call (getSymbol "gdk_drag_motion")
          (
            GdkDragContextClass.PolyML.cPtr
             &&> GdkWindowClass.PolyML.cPtr
      ...
      val dragStatus_ =
        call (getSymbol "gdk_drag_status")
          (
            GdkDragContextClass.PolyML.cPtr
             &&> GdkDragAction.PolyML.cVal
             &&> GUInt32.PolyML.cVal
      ...
      val eventGet_ = call (getSymbol "gdk_event_get") (cVoid --> GdkEvent.PolyML.cOptPtr)
      val eventPeek_ = call (getSymbol "gdk_event_peek") (cVoid --> GdkEvent.PolyML.cOptPtr)
      ...
      val init_ = call (getSymbol "gdk_init") (GInt32.PolyML.cRef &&> Utf8CPtrArrayN.PolyML.cInOutRef --> cVoid)
      val initCheck_ = call (getSymbol "gdk_init_check") (GInt32.PolyML.cRef &&> Utf8CPtrArrayN.PolyML.cInOutRef --> GBool.PolyML.cVal)
      val keyboardGrab_ =
      ...
      val keyvalIsUpper_ = call (getSymbol "gdk_keyval_is_upper") (GUInt32.PolyML.cVal --> GBool.PolyML.cVal)
      val keyvalName_ = call (getSymbol "gdk_keyval_name") (GUInt32.PolyML.cVal --> Utf8.PolyML.cOutOptPtr)
      ...
      val offscreenWindowGetEmbedder_ = call (getSymbol "gdk_offscreen_window_get_embedder") (GdkWindowClass.PolyML.cPtr --> GdkWindowClass.PolyML.cOptPtr)
      val offscreenWindowGetSurface_ = call (getSymbol "gdk_offscreen_window_get_surface") (GdkWindowClass.PolyML.cPtr --> CairoSurfaceRecord.PolyML.cOptPtr)
      ...
      val parseArgs_ = call (getSymbol "gdk_parse_args") (GInt32.PolyML.cRef &&> Utf8CPtrArrayN.PolyML.cInOutRef --> cVoid)
      ...
      val pixbufGetFromWindow_ =
        call (getSymbol "gdk_pixbuf_get_from_window")
          (
            GdkWindowClass.PolyML.cPtr
             &&> GInt32.PolyML.cVal
             &&> GInt32.PolyML.cVal
      ...
      val selectionOwnerGet_ = call (getSymbol "gdk_selection_owner_get") (GdkAtomRecord.PolyML.cPtr --> GdkWindowClass.PolyML.cOptPtr)
      val selectionOwnerGetForDisplay_ = call (getSymbol "gdk_selection_owner_get_for_display") (GdkDisplayClass.PolyML.cPtr &&> GdkAtomRecord.PolyML.cPtr --> GdkWindowClass.PolyML.cOptPtr)
      ...
      val selectionSendNotify_ =
        call (getSymbol "gdk_selection_send_notify")
          (
            GdkWindowClass.PolyML.cPtr
             &&> GdkAtomRecord.PolyML.cPtr
             &&> GdkAtomRecord.PolyML.cPtr
      ...
      val testSimulateKey_ =
        call (getSymbol "gdk_test_simulate_key")
          (
            GdkWindowClass.PolyML.cPtr
             &&> GInt32.PolyML.cVal
             &&> GInt32.PolyML.cVal
      ...
      val textPropertyToUtf8ListForDisplay_ =
        call (getSymbol "gdk_text_property_to_utf8_list_for_display")
          (
            GdkDisplayClass.PolyML.cPtr
             &&> GdkAtomRecord.PolyML.cPtr
             &&> GInt32.PolyML.cVal
      ...
      val utf8ToStringTarget_ = call (getSymbol "gdk_utf8_to_string_target") (Utf8.PolyML.cInPtr --> Utf8.PolyML.cOutOptPtr)
    end
    ...
    structure EventAny = GdkEventAny
    structure EventButton = GdkEventButton
    structure EventConfigure = GdkEventConfigure
    structure EventCrossing = GdkEventCrossing
    structure EventDND = GdkEventDND
    structure EventExpose = GdkEventExpose
    structure EventFocus = GdkEventFocus
    structure EventGrabBroken = GdkEventGrabBroken
    structure EventKey = GdkEventKey
    structure EventMotion = GdkEventMotion
    structure EventOwnerChange = GdkEventOwnerChange
    structure EventPadAxis = GdkEventPadAxis
    structure EventPadButton = GdkEventPadButton
    structure EventPadGroupMode = GdkEventPadGroupMode
    structure EventProperty = GdkEventProperty
    structure EventProximity = GdkEventProximity
    structure EventScroll = GdkEventScroll
    structure EventSelection = GdkEventSelection
    structure EventSetting = GdkEventSetting
    structure EventTouch = GdkEventTouch
    structure EventTouchpadPinch = GdkEventTouchpadPinch
    structure EventTouchpadSwipe = GdkEventTouchpadSwipe
    structure EventVisibility = GdkEventVisibility
    structure EventWindowState = GdkEventWindowState
    ...
    fun colorParse spec =
      let
        val color & retVal = (Utf8.FFI.withPtr 0 &&&> GdkColorRecord.FFI.withNewPtr ---> GdkColorRecord.FFI.fromPtr true && GBool.FFI.fromVal) colorParse_ (spec & ())
      in
    ...
    fun eventGet () = (I ---> GdkEvent.FFI.fromOptPtr true) eventGet_ ()
    fun eventPeek () = (I ---> GdkEvent.FFI.fromOptPtr true) eventPeek_ ()
    fun eventRequestMotions event = (GdkEventMotionRecord.FFI.withPtr false ---> I) eventRequestMotions_ event
    ...
    fun init argv =
      let
        ...
        val argc
         ...
         & () =
          (
            GInt32.FFI.withRefVal &&&> Utf8CPtrArrayN.FFI.withRefPtr ~1
             ---> GInt32.FFI.fromVal
    ...
    fun keyvalFromName keyvalName = (Utf8.FFI.withPtr 0 ---> GUInt32.FFI.fromVal) keyvalFromName_ keyvalName
    ...
    fun keyvalName keyval = (GUInt32.FFI.withVal ---> Utf8.FFI.fromOptPtr 0) keyvalName_ keyval
    ...
    fun queryDepths () =
      let
        val depths
         ...
         & () =
          (
            GInt32CArrayN.FFI.withRefOptPtr 0 &&&> GInt32.FFI.withRefVal
    ...
    fun queryVisualTypes () =
      let
        val visualTypes
         ...
         & () =
          (
            GdkVisualTypeCArrayN.FFI.withRefOptPtr 0 &&&> GInt32.FFI.withRefVal
        ...
        val list & retVal =
          (
            GdkDisplayClass.FFI.withPtr false
             ...
             ---> Utf8CPtrArray.FFI.fromPtr ~1 && GInt32.FFI.fromVal
          )
