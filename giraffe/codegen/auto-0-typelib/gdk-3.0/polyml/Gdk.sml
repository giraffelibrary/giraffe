structure Gdk : GDK =
  struct
    ...
    in
      ...
      val keyvalFromName_ = call (load_sym libgdk "gdk_keyval_from_name") (Utf8.PolyML.INPTR --> FFI.UInt32.PolyML.VAL)
      ...
      val keyvalName_ = call (load_sym libgdk "gdk_keyval_name") (FFI.UInt32.PolyML.VAL --> Utf8.PolyML.RETPTR)
