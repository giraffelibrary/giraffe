structure CairoContextRecord :> CAIRO_CONTEXT_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "cairo_reference") (cPtr --> cPtr)
      val free_ = call (getSymbol "cairo_destroy") (cPtr --> PolyMLFFI.cVoid)
    end
    structure Record =
      BoxedRecord(
