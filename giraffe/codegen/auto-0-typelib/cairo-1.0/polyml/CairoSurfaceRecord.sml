structure CairoSurfaceRecord :> CAIRO_SURFACE_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "cairo_surface_reference") (cPtr --> cPtr)
      val free_ = call (getSymbol "cairo_surface_destroy") (cPtr --> PolyMLFFI.cVoid)
    end
    structure Record =
      BoxedRecord(
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "cairo_gobject_surface_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
