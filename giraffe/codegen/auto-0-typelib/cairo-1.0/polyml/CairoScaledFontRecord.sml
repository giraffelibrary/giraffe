structure CairoScaledFontRecord :> CAIRO_SCALED_FONT_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "cairo_scaled_font_reference") (cPtr --> cPtr)
      val free_ = call (getSymbol "cairo_scaled_font_destroy") (cPtr --> cVoid)
    end
    structure Record =
      BoxedRecord(
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "cairo_gobject_scaled_font_get_type") (cVoid --> GObjectType.PolyML.cVal)
