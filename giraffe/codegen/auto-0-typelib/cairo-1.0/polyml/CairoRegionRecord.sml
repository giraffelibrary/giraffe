structure CairoRegionRecord :> CAIRO_REGION_RECORD =
  struct
    ...
    in
      ...
      val free_ = call (getSymbol "cairo_region_destroy") (cPtr --> PolyMLFFI.cVoid)
    end
    structure Record =
      BoxedRecord(
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "cairo_gobject_region_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
