structure CairoRegionRecord :> CAIRO_REGION_RECORD =
  struct
    structure Pointer = CPointerInternal
    type notnull = Pointer.notnull
    type 'a p = 'a Pointer.p
    val dup_ = _import "cairo_region_reference" : notnull p -> notnull p;
    val free_ = _import "cairo_region_destroy" : notnull p -> unit;
    structure Record =
      BoxedRecord(
    ...
    open Record
    val getType_ = _import "cairo_gobject_region_get_type" : unit -> GObjectType.FFI.val_;
