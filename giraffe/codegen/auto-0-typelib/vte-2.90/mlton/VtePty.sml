structure VtePty :>
  ...
  struct
    ...
    val newForeign_ = fn x1 & x2 => (_import "vte_pty_new_foreign" : GInt32.FFI.val_ * (GLibErrorRecord.FFI.opt, GLibErrorRecord.FFI.opt) GLibErrorRecord.FFI.r -> VtePtyClass.FFI.non_opt VtePtyClass.FFI.p;) (x1, x2)
