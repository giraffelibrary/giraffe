structure GIRepository : G_I_REPOSITORY =
  struct
    local
      open PolyMLFFI
    in
      val argInfoGetClosure_ = call (load_sym libgirepository "g_arg_info_get_closure") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val argInfoGetDestroy_ = call (load_sym libgirepository "g_arg_info_get_destroy") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val argInfoIsCallerAllocates_ = call (load_sym libgirepository "g_arg_info_is_caller_allocates") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val argInfoIsOptional_ = call (load_sym libgirepository "g_arg_info_is_optional") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val argInfoIsReturnValue_ = call (load_sym libgirepository "g_arg_info_is_return_value") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val argInfoIsSkip_ = call (load_sym libgirepository "g_arg_info_is_skip") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val argInfoMayBeNull_ = call (load_sym libgirepository "g_arg_info_may_be_null") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val callableInfoGetArg_ = call (load_sym libgirepository "g_callable_info_get_arg") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      ...
      val callableInfoGetNArgs_ = call (load_sym libgirepository "g_callable_info_get_n_args") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val callableInfoMayReturnNull_ = call (load_sym libgirepository "g_callable_info_may_return_null") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val callableInfoSkipReturn_ = call (load_sym libgirepository "g_callable_info_skip_return") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val enumInfoGetMethod_ = call (load_sym libgirepository "g_enum_info_get_method") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val enumInfoGetNMethods_ = call (load_sym libgirepository "g_enum_info_get_n_methods") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val enumInfoGetNValues_ = call (load_sym libgirepository "g_enum_info_get_n_values") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val enumInfoGetValue_ = call (load_sym libgirepository "g_enum_info_get_value") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      ...
      val fieldInfoGetOffset_ = call (load_sym libgirepository "g_field_info_get_offset") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val fieldInfoGetSize_ = call (load_sym libgirepository "g_field_info_get_size") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val interfaceInfoGetConstant_ = call (load_sym libgirepository "g_interface_info_get_constant") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      ...
      val interfaceInfoGetMethod_ = call (load_sym libgirepository "g_interface_info_get_method") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val interfaceInfoGetNConstants_ = call (load_sym libgirepository "g_interface_info_get_n_constants") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val interfaceInfoGetNMethods_ = call (load_sym libgirepository "g_interface_info_get_n_methods") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val interfaceInfoGetNPrerequisites_ = call (load_sym libgirepository "g_interface_info_get_n_prerequisites") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val interfaceInfoGetNProperties_ = call (load_sym libgirepository "g_interface_info_get_n_properties") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val interfaceInfoGetNSignals_ = call (load_sym libgirepository "g_interface_info_get_n_signals") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val interfaceInfoGetNVfuncs_ = call (load_sym libgirepository "g_interface_info_get_n_vfuncs") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val interfaceInfoGetPrerequisite_ = call (load_sym libgirepository "g_interface_info_get_prerequisite") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val interfaceInfoGetProperty_ = call (load_sym libgirepository "g_interface_info_get_property") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val interfaceInfoGetSignal_ = call (load_sym libgirepository "g_interface_info_get_signal") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val interfaceInfoGetVfunc_ = call (load_sym libgirepository "g_interface_info_get_vfunc") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val invokeErrorQuark_ = call (load_sym libgirepository "g_invoke_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
      ...
      val objectInfoGetAbstract_ = call (load_sym libgirepository "g_object_info_get_abstract") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val objectInfoGetConstant_ = call (load_sym libgirepository "g_object_info_get_constant") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val objectInfoGetField_ = call (load_sym libgirepository "g_object_info_get_field") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val objectInfoGetFundamental_ = call (load_sym libgirepository "g_object_info_get_fundamental") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val objectInfoGetInterface_ = call (load_sym libgirepository "g_object_info_get_interface") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val objectInfoGetMethod_ = call (load_sym libgirepository "g_object_info_get_method") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val objectInfoGetNConstants_ = call (load_sym libgirepository "g_object_info_get_n_constants") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val objectInfoGetNFields_ = call (load_sym libgirepository "g_object_info_get_n_fields") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val objectInfoGetNInterfaces_ = call (load_sym libgirepository "g_object_info_get_n_interfaces") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val objectInfoGetNMethods_ = call (load_sym libgirepository "g_object_info_get_n_methods") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val objectInfoGetNProperties_ = call (load_sym libgirepository "g_object_info_get_n_properties") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val objectInfoGetNSignals_ = call (load_sym libgirepository "g_object_info_get_n_signals") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val objectInfoGetNVfuncs_ = call (load_sym libgirepository "g_object_info_get_n_vfuncs") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val objectInfoGetProperty_ = call (load_sym libgirepository "g_object_info_get_property") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      ...
      val objectInfoGetSignal_ = call (load_sym libgirepository "g_object_info_get_signal") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      ...
      val objectInfoGetVfunc_ = call (load_sym libgirepository "g_object_info_get_vfunc") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      ...
      val signalInfoTrueStopsEmit_ = call (load_sym libgirepository "g_signal_info_true_stops_emit") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val structInfoGetAlignment_ = call (load_sym libgirepository "g_struct_info_get_alignment") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GUInt64.PolyML.cVal)
      val structInfoGetField_ = call (load_sym libgirepository "g_struct_info_get_field") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val structInfoGetMethod_ = call (load_sym libgirepository "g_struct_info_get_method") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val structInfoGetNFields_ = call (load_sym libgirepository "g_struct_info_get_n_fields") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val structInfoGetNMethods_ = call (load_sym libgirepository "g_struct_info_get_n_methods") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val structInfoGetSize_ = call (load_sym libgirepository "g_struct_info_get_size") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GUInt64.PolyML.cVal)
      val structInfoIsForeign_ = call (load_sym libgirepository "g_struct_info_is_foreign") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val structInfoIsGtypeStruct_ = call (load_sym libgirepository "g_struct_info_is_gtype_struct") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val typeInfoGetArrayFixedSize_ = call (load_sym libgirepository "g_type_info_get_array_fixed_size") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val typeInfoGetArrayLength_ = call (load_sym libgirepository "g_type_info_get_array_length") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val typeInfoGetParamType_ = call (load_sym libgirepository "g_type_info_get_param_type") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      ...
      val typeInfoIsPointer_ = call (load_sym libgirepository "g_type_info_is_pointer") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val typeInfoIsZeroTerminated_ = call (load_sym libgirepository "g_type_info_is_zero_terminated") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val unionInfoGetAlignment_ = call (load_sym libgirepository "g_union_info_get_alignment") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GUInt64.PolyML.cVal)
      val unionInfoGetDiscriminator_ = call (load_sym libgirepository "g_union_info_get_discriminator") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val unionInfoGetDiscriminatorOffset_ = call (load_sym libgirepository "g_union_info_get_discriminator_offset") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val unionInfoGetField_ = call (load_sym libgirepository "g_union_info_get_field") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val unionInfoGetMethod_ = call (load_sym libgirepository "g_union_info_get_method") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      val unionInfoGetNFields_ = call (load_sym libgirepository "g_union_info_get_n_fields") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val unionInfoGetNMethods_ = call (load_sym libgirepository "g_union_info_get_n_methods") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val unionInfoGetSize_ = call (load_sym libgirepository "g_union_info_get_size") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GUInt64.PolyML.cVal)
      val unionInfoIsDiscriminated_ = call (load_sym libgirepository "g_union_info_is_discriminated") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val valueInfoGetValue_ = call (load_sym libgirepository "g_value_info_get_value") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt64.PolyML.cVal)
      ...
      val vfuncInfoGetOffset_ = call (load_sym libgirepository "g_vfunc_info_get_offset") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
