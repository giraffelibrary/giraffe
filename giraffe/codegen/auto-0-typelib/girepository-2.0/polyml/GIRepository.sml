structure GIRepository : G_I_REPOSITORY =
  struct
    ...
    in
      ...
      val argInfoLoadType_ = call (getSymbol "g_arg_info_load_type") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GIRepositoryBaseInfoRecord.PolyML.cPtr --> cVoid)
      val argInfoMayBeNull_ = call (getSymbol "g_arg_info_may_be_null") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      val callableInfoCanThrowGerror_ = call (getSymbol "g_callable_info_can_throw_gerror") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val callableInfoGetInstanceOwnershipTransfer_ = call (getSymbol "g_callable_info_get_instance_ownership_transfer") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GIRepositoryTransfer.PolyML.cVal)
      ...
      val callableInfoLoadReturnType_ = call (getSymbol "g_callable_info_load_return_type") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> GIRepositoryBaseInfoRecord.PolyML.cPtr --> cVoid)
      ...
      val invokeErrorQuark_ = call (getSymbol "g_invoke_error_quark") (cVoid --> GUInt32.PolyML.cVal)
      ...
      val objectInfoFindSignal_ = call (getSymbol "g_object_info_find_signal") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
      ...
      val registeredTypeInfoGetGType_ = call (getSymbol "g_registered_type_info_get_g_type") (GIRepositoryBaseInfoRecord.PolyML.cPtr --> GObjectType.PolyML.cVal)
      ...
      val structInfoFindField_ = call (getSymbol "g_struct_info_find_field") (GIRepositoryBaseInfoRecord.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> GIRepositoryBaseInfoRecord.PolyML.cPtr)
    ...
    fun argInfoGetDirection info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryDirection.FFI.fromVal) argInfoGetDirection_ info
    fun argInfoGetOwnershipTransfer info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryTransfer.FFI.fromVal) argInfoGetOwnershipTransfer_ info
    fun argInfoGetScope info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryScopeType.FFI.fromVal) argInfoGetScope_ info
    fun argInfoGetType info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) argInfoGetType_ info
    fun argInfoIsCallerAllocates info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) argInfoIsCallerAllocates_ info
    fun argInfoIsOptional info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) argInfoIsOptional_ info
    fun argInfoIsReturnValue info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) argInfoIsReturnValue_ info
    fun argInfoIsSkip info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) argInfoIsSkip_ info
    fun argInfoLoadType info =
      let
        val type' & () = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GIRepositoryBaseInfoRecord.FFI.withNewPtr ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true && I) argInfoLoadType_ (info & ())
      in
        type'
      end
    fun argInfoMayBeNull info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) argInfoMayBeNull_ info
    fun callableInfoCanThrowGerror info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) callableInfoCanThrowGerror_ info
    fun callableInfoGetArg (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) callableInfoGetArg_ (info & n)
    fun callableInfoGetCallerOwns info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryTransfer.FFI.fromVal) callableInfoGetCallerOwns_ info
    fun callableInfoGetInstanceOwnershipTransfer info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryTransfer.FFI.fromVal) callableInfoGetInstanceOwnershipTransfer_ info
    fun callableInfoGetNArgs info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) callableInfoGetNArgs_ info
    ...
    fun callableInfoLoadReturnType info =
      let
        val type' & () = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GIRepositoryBaseInfoRecord.FFI.withNewPtr ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true && I) callableInfoLoadReturnType_ (info & ())
      in
        type'
      end
    fun callableInfoMayReturnNull info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) callableInfoMayReturnNull_ info
    fun callableInfoSkipReturn info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) callableInfoSkipReturn_ info
    fun constantInfoGetType info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) constantInfoGetType_ info
    fun enumInfoGetErrorDomain info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> Utf8.FFI.fromPtr 0) enumInfoGetErrorDomain_ info before GIRepositoryBaseInfoRecord.FFI.touchPtr info
    fun enumInfoGetMethod (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) enumInfoGetMethod_ (info & n)
    fun enumInfoGetNMethods info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) enumInfoGetNMethods_ info
    fun enumInfoGetNValues info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) enumInfoGetNValues_ info
    fun enumInfoGetStorageType info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryTypeTag.FFI.fromVal) enumInfoGetStorageType_ info
    fun enumInfoGetValue (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) enumInfoGetValue_ (info & n)
    fun fieldInfoGetFlags info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryFieldInfoFlags.FFI.fromVal) fieldInfoGetFlags_ info
    fun fieldInfoGetOffset info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) fieldInfoGetOffset_ info
    fun fieldInfoGetSize info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) fieldInfoGetSize_ info
    fun fieldInfoGetType info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) fieldInfoGetType_ info
    fun functionInfoGetFlags info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryFunctionInfoFlags.FFI.fromVal) functionInfoGetFlags_ info
    ...
    fun interfaceInfoFindVfunc (info, name) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> Utf8.FFI.withPtr 0 ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) interfaceInfoFindVfunc_ (info & name)
    fun interfaceInfoGetConstant (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) interfaceInfoGetConstant_ (info & n)
    fun interfaceInfoGetIfaceStruct info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) interfaceInfoGetIfaceStruct_ info
    fun interfaceInfoGetMethod (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) interfaceInfoGetMethod_ (info & n)
    fun interfaceInfoGetNConstants info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) interfaceInfoGetNConstants_ info
    fun interfaceInfoGetNMethods info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) interfaceInfoGetNMethods_ info
    fun interfaceInfoGetNPrerequisites info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) interfaceInfoGetNPrerequisites_ info
    fun interfaceInfoGetNProperties info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) interfaceInfoGetNProperties_ info
    fun interfaceInfoGetNSignals info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) interfaceInfoGetNSignals_ info
    fun interfaceInfoGetNVfuncs info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) interfaceInfoGetNVfuncs_ info
    fun interfaceInfoGetPrerequisite (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) interfaceInfoGetPrerequisite_ (info & n)
    fun interfaceInfoGetProperty (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) interfaceInfoGetProperty_ (info & n)
    fun interfaceInfoGetSignal (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) interfaceInfoGetSignal_ (info & n)
    fun interfaceInfoGetVfunc (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) interfaceInfoGetVfunc_ (info & n)
    fun invokeErrorQuark () = (I ---> GUInt32.FFI.fromVal) invokeErrorQuark_ ()
    fun objectInfoFindMethod (info, name) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> Utf8.FFI.withPtr 0 ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) objectInfoFindMethod_ (info & name)
      ...
      let
        val implementor & retVal =
          (
            GIRepositoryBaseInfoRecord.FFI.withPtr false
             &&&> Utf8.FFI.withPtr 0
             &&&> GIRepositoryBaseInfoRecord.FFI.withRefOptPtr true
    ...
    fun objectInfoFindSignal (info, name) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> Utf8.FFI.withPtr 0 ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) objectInfoFindSignal_ (info & name)
    fun objectInfoFindVfunc (info, name) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> Utf8.FFI.withPtr 0 ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) objectInfoFindVfunc_ (info & name)
    ...
    fun objectInfoGetAbstract info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) objectInfoGetAbstract_ info
    fun objectInfoGetClassStruct info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) objectInfoGetClassStruct_ info
    fun objectInfoGetConstant (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) objectInfoGetConstant_ (info & n)
    fun objectInfoGetField (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) objectInfoGetField_ (info & n)
    fun objectInfoGetFundamental info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) objectInfoGetFundamental_ info
    fun objectInfoGetGetValueFunction info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> Utf8.FFI.fromPtr 0) objectInfoGetGetValueFunction_ info before GIRepositoryBaseInfoRecord.FFI.touchPtr info
    fun objectInfoGetInterface (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) objectInfoGetInterface_ (info & n)
    fun objectInfoGetMethod (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) objectInfoGetMethod_ (info & n)
    fun objectInfoGetNConstants info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) objectInfoGetNConstants_ info
    fun objectInfoGetNFields info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) objectInfoGetNFields_ info
    fun objectInfoGetNInterfaces info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) objectInfoGetNInterfaces_ info
    fun objectInfoGetNMethods info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) objectInfoGetNMethods_ info
    fun objectInfoGetNProperties info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) objectInfoGetNProperties_ info
    fun objectInfoGetNSignals info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) objectInfoGetNSignals_ info
    fun objectInfoGetNVfuncs info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) objectInfoGetNVfuncs_ info
    fun objectInfoGetParent info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) objectInfoGetParent_ info
    fun objectInfoGetProperty (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) objectInfoGetProperty_ (info & n)
    fun objectInfoGetRefFunction info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> Utf8.FFI.fromPtr 0) objectInfoGetRefFunction_ info before GIRepositoryBaseInfoRecord.FFI.touchPtr info
    fun objectInfoGetSetValueFunction info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> Utf8.FFI.fromPtr 0) objectInfoGetSetValueFunction_ info before GIRepositoryBaseInfoRecord.FFI.touchPtr info
    fun objectInfoGetSignal (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) objectInfoGetSignal_ (info & n)
    fun objectInfoGetTypeInit info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> Utf8.FFI.fromPtr 0) objectInfoGetTypeInit_ info before GIRepositoryBaseInfoRecord.FFI.touchPtr info
    fun objectInfoGetTypeName info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> Utf8.FFI.fromPtr 0) objectInfoGetTypeName_ info before GIRepositoryBaseInfoRecord.FFI.touchPtr info
    fun objectInfoGetUnrefFunction info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> Utf8.FFI.fromPtr 0) objectInfoGetUnrefFunction_ info before GIRepositoryBaseInfoRecord.FFI.touchPtr info
    fun objectInfoGetVfunc (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) objectInfoGetVfunc_ (info & n)
    fun propertyInfoGetFlags info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GObjectParamFlags.FFI.fromVal) propertyInfoGetFlags_ info
    fun propertyInfoGetOwnershipTransfer info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryTransfer.FFI.fromVal) propertyInfoGetOwnershipTransfer_ info
    fun propertyInfoGetType info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) propertyInfoGetType_ info
    fun registeredTypeInfoGetGType info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GObjectType.FFI.fromVal) registeredTypeInfoGetGType_ info
    fun registeredTypeInfoGetTypeInit info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> Utf8.FFI.fromPtr 0) registeredTypeInfoGetTypeInit_ info before GIRepositoryBaseInfoRecord.FFI.touchPtr info
    fun registeredTypeInfoGetTypeName info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> Utf8.FFI.fromPtr 0) registeredTypeInfoGetTypeName_ info before GIRepositoryBaseInfoRecord.FFI.touchPtr info
    fun signalInfoGetClassClosure info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) signalInfoGetClassClosure_ info
    fun signalInfoGetFlags info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GObjectSignalFlags.FFI.fromVal) signalInfoGetFlags_ info
    fun signalInfoTrueStopsEmit info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) signalInfoTrueStopsEmit_ info
    fun structInfoFindField (info, name) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> Utf8.FFI.withPtr 0 ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) structInfoFindField_ (info & name)
    fun structInfoFindMethod (info, name) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> Utf8.FFI.withPtr 0 ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) structInfoFindMethod_ (info & name)
    fun structInfoGetAlignment info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GUInt64.FFI.fromVal) structInfoGetAlignment_ info
    fun structInfoGetField (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) structInfoGetField_ (info & n)
    fun structInfoGetMethod (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) structInfoGetMethod_ (info & n)
    fun structInfoGetNFields info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) structInfoGetNFields_ info
    fun structInfoGetNMethods info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) structInfoGetNMethods_ info
    fun structInfoGetSize info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GUInt64.FFI.fromVal) structInfoGetSize_ info
    fun structInfoIsForeign info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) structInfoIsForeign_ info
    fun structInfoIsGtypeStruct info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) structInfoIsGtypeStruct_ info
    fun typeInfoGetArrayFixedSize info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) typeInfoGetArrayFixedSize_ info
    fun typeInfoGetArrayLength info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) typeInfoGetArrayLength_ info
    fun typeInfoGetArrayType info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryArrayType.FFI.fromVal) typeInfoGetArrayType_ info
    fun typeInfoGetInterface info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) typeInfoGetInterface_ info
    fun typeInfoGetParamType (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) typeInfoGetParamType_ (info & n)
    fun typeInfoGetTag info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryTypeTag.FFI.fromVal) typeInfoGetTag_ info
    fun typeInfoIsPointer info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) typeInfoIsPointer_ info
    fun typeInfoIsZeroTerminated info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) typeInfoIsZeroTerminated_ info
    fun typeTagToString type' = (GIRepositoryTypeTag.FFI.withVal ---> Utf8.FFI.fromPtr 0) typeTagToString_ type'
    fun unionInfoFindMethod (info, name) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> Utf8.FFI.withPtr 0 ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) unionInfoFindMethod_ (info & name)
    fun unionInfoGetAlignment info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GUInt64.FFI.fromVal) unionInfoGetAlignment_ info
    fun unionInfoGetDiscriminator (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) unionInfoGetDiscriminator_ (info & n)
    fun unionInfoGetDiscriminatorOffset info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) unionInfoGetDiscriminatorOffset_ info
    fun unionInfoGetDiscriminatorType info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) unionInfoGetDiscriminatorType_ info
    fun unionInfoGetField (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) unionInfoGetField_ (info & n)
    fun unionInfoGetMethod (info, n) = (GIRepositoryBaseInfoRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) unionInfoGetMethod_ (info & n)
    fun unionInfoGetNFields info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) unionInfoGetNFields_ info
    fun unionInfoGetNMethods info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) unionInfoGetNMethods_ info
    fun unionInfoGetSize info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GUInt64.FFI.fromVal) unionInfoGetSize_ info
    fun unionInfoIsDiscriminated info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GBool.FFI.fromVal) unionInfoIsDiscriminated_ info
    fun valueInfoGetValue info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt64.FFI.fromVal) valueInfoGetValue_ info
    fun vfuncInfoGetFlags info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryVFuncInfoFlags.FFI.fromVal) vfuncInfoGetFlags_ info
    fun vfuncInfoGetInvoker info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) vfuncInfoGetInvoker_ info
    fun vfuncInfoGetOffset info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) vfuncInfoGetOffset_ info
    fun vfuncInfoGetSignal info = (GIRepositoryBaseInfoRecord.FFI.withPtr false ---> GIRepositoryBaseInfoRecord.FFI.fromPtr true) vfuncInfoGetSignal_ info
  end
