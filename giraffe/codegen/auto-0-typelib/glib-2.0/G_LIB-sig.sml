signature G_LIB =
  sig
    ...
    val mainContextRefThreadDefault : unit -> MainContextRecord.t
    ...
    val threadSelf : unit -> ThreadRecord.t
    val threadYield : unit -> unit
