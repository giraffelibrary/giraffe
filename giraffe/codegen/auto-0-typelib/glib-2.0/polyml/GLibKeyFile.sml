structure GLibKeyFile :>
  ...
  struct
    ...
    in
      ...
      val getGroups_ = call (getSymbol "g_key_file_get_groups") (GLibKeyFileRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8CArray.PolyML.cOutPtr)
      val getInt64_ =
