structure GLibVariantType :>
  ...
  struct
    ...
    in
      ...
      val newTuple_ = call (getSymbol "g_variant_type_new_tuple") (GLibVariantTypeRecordCVectorN.PolyML.cInPtr &&> GInt32.PolyML.cVal --> GLibVariantTypeRecord.PolyML.cPtr)
