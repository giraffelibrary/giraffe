structure GLibIOCondition :>
  sig
    include G_LIB_I_O_CONDITION
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgobject "g_io_condition_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
