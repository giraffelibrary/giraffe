structure GLibString :>
  ...
  struct
    ...
    in
      ...
      val appendC_ = call (getSymbol "g_string_append_c") (GLibStringRecord.PolyML.cPtr &&> GUInt8.PolyML.cVal --> GLibStringRecord.PolyML.cPtr)
      val appendLen_ =
      ...
      val hash_ = call (getSymbol "g_string_hash") (GLibStringRecord.PolyML.cPtr --> GUInt32.PolyML.cVal)
      val insert_ =
      ...
      val prependC_ = call (getSymbol "g_string_prepend_c") (GLibStringRecord.PolyML.cPtr &&> GUInt8.PolyML.cVal --> GLibStringRecord.PolyML.cPtr)
      val prependLen_ =
      ...
      val setSize_ = call (getSymbol "g_string_set_size") (GLibStringRecord.PolyML.cPtr &&> GUInt64.PolyML.cVal --> GLibStringRecord.PolyML.cPtr)
      val truncate_ = call (getSymbol "g_string_truncate") (GLibStringRecord.PolyML.cPtr &&> GUInt64.PolyML.cVal --> GLibStringRecord.PolyML.cPtr)
