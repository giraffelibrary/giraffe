structure GLibIOChannel :>
  ...
  struct
    ...
    in
      ...
      val readUnichar_ =
        call (getSymbol "g_io_channel_read_unichar")
          (
            GLibIOChannelRecord.PolyML.cPtr
             &&> GChar.PolyML.cRef
             &&> GLibErrorRecord.PolyML.cOutOptRef
      ...
      val unixGetFd_ = call (getSymbol "g_io_channel_unix_get_fd") (GLibIOChannelRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val writeUnichar_ =
      ...
      val errorFromErrno_ = call (getSymbol "g_io_channel_error_from_errno") (GInt32.PolyML.cVal --> GLibIOChannelError.PolyML.cVal)
    end
