structure GLibVariant :>
  ...
  struct
    ...
    in
      ...
      val newBytestringArray_ = call (load_sym libglib "g_variant_new_bytestring_array") (Utf8CVectorN.PolyML.cInPtr &&> GInt64.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      ...
      val newObjv_ = call (load_sym libglib "g_variant_new_objv") (Utf8CVectorN.PolyML.cInPtr &&> GInt64.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      ...
      val newStrv_ = call (load_sym libglib "g_variant_new_strv") (Utf8CVectorN.PolyML.cInPtr &&> GInt64.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      val newTuple_ = call (load_sym libglib "g_variant_new_tuple") (GLibVariantRecordCVectorN.PolyML.cInPtr &&> GUInt64.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      ...
      val compare_ = call (load_sym libglib "g_variant_compare") (GLibVariantRecord.PolyML.cPtr &&> GLibVariantRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val dupBytestring_ = call (load_sym libglib "g_variant_dup_bytestring") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> GUInt8CVectorN.PolyML.cOutPtr)
      val dupBytestringArray_ = call (load_sym libglib "g_variant_dup_bytestring_array") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      val dupObjv_ = call (load_sym libglib "g_variant_dup_objv") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      val dupString_ = call (load_sym libglib "g_variant_dup_string") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8.PolyML.cOutPtr)
      val dupStrv_ = call (load_sym libglib "g_variant_dup_strv") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      ...
      val getBytestringArray_ = call (load_sym libglib "g_variant_get_bytestring_array") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      val getChildValue_ = call (load_sym libglib "g_variant_get_child_value") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cVal --> GLibVariantRecord.PolyML.cPtr)
      ...
      val getObjv_ = call (load_sym libglib "g_variant_get_objv") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      val getSize_ = call (load_sym libglib "g_variant_get_size") (GLibVariantRecord.PolyML.cPtr --> GUInt64.PolyML.cVal)
      val getString_ = call (load_sym libglib "g_variant_get_string") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8.PolyML.cOutPtr)
      val getStrv_ = call (load_sym libglib "g_variant_get_strv") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8CVectorN.PolyML.cOutPtr)
      ...
      val hash_ = call (load_sym libglib "g_variant_hash") (GLibVariantRecord.PolyML.cPtr --> GUInt32.PolyML.cVal)
      ...
      val nChildren_ = call (load_sym libglib "g_variant_n_children") (GLibVariantRecord.PolyML.cPtr --> GUInt64.PolyML.cVal)
      ...
      val parserGetErrorQuark_ = call (load_sym libglib "g_variant_parser_get_error_quark") (PolyMLFFI.cVoid --> GUInt32.PolyML.cVal)
    end
