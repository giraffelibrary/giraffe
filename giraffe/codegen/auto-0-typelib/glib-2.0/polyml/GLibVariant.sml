structure GLibVariant :>
  ...
  struct
    ...
    in
      ...
      val dupBytestring_ = call (getSymbol "g_variant_dup_bytestring") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> GUInt8CArray.PolyML.cOutPtr)
      ...
      val dupObjv_ = call (getSymbol "g_variant_dup_objv") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8CPtrArray.PolyML.cOutPtr)
      val dupString_ = call (getSymbol "g_variant_dup_string") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8.PolyML.cOutPtr)
      val dupStrv_ = call (getSymbol "g_variant_dup_strv") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8CPtrArray.PolyML.cOutPtr)
      ...
      val getObjv_ = call (getSymbol "g_variant_get_objv") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8CPtrArray.PolyML.cOutPtr)
      ...
      val getStrv_ = call (getSymbol "g_variant_get_strv") (GLibVariantRecord.PolyML.cPtr &&> GUInt64.PolyML.cRef --> Utf8CPtrArray.PolyML.cOutPtr)
