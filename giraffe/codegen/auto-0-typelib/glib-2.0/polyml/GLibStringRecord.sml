structure GLibStringRecord :> G_LIB_STRING_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "gstring_copy") (cPtr --> cPtr)
      val free_ = call (getSymbol "gstring_free") (cPtr --> PolyMLFFI.cVoid)
    end
    structure Record =
      BoxedRecord(
