structure GLibSource :>
  ...
  struct
    ...
    in
      ...
      val attach_ = call (load_sym libglib "g_source_attach") (GLibSourceRecord.PolyML.cPtr &&> GLibMainContextRecord.PolyML.cOptPtr --> GUInt32.PolyML.cVal)
      val destroy_ = call (load_sym libglib "g_source_destroy") (GLibSourceRecord.PolyML.cPtr --> PolyMLFFI.cVoid)
      val getCanRecurse_ = call (load_sym libglib "g_source_get_can_recurse") (GLibSourceRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val getId_ = call (load_sym libglib "g_source_get_id") (GLibSourceRecord.PolyML.cPtr --> GUInt32.PolyML.cVal)
      val getName_ = call (load_sym libglib "g_source_get_name") (GLibSourceRecord.PolyML.cPtr --> Utf8.PolyML.cOutPtr)
      val getPriority_ = call (load_sym libglib "g_source_get_priority") (GLibSourceRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getTime_ = call (load_sym libglib "g_source_get_time") (GLibSourceRecord.PolyML.cPtr --> GInt64.PolyML.cVal)
      val isDestroyed_ = call (load_sym libglib "g_source_is_destroyed") (GLibSourceRecord.PolyML.cPtr --> GBool.PolyML.cVal)
      ...
      val setCanRecurse_ = call (load_sym libglib "g_source_set_can_recurse") (GLibSourceRecord.PolyML.cPtr &&> GBool.PolyML.cVal --> PolyMLFFI.cVoid)
      val setName_ = call (load_sym libglib "g_source_set_name") (GLibSourceRecord.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
      val setPriority_ = call (load_sym libglib "g_source_set_priority") (GLibSourceRecord.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val remove_ = call (load_sym libglib "g_source_remove") (GUInt32.PolyML.cVal --> GBool.PolyML.cVal)
      val setNameById_ = call (load_sym libglib "g_source_set_name_by_id") (GUInt32.PolyML.cVal &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
    end
