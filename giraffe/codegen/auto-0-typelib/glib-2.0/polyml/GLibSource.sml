structure GLibSource :>
  ...
  struct
    ...
    in
      ...
      val attach_ = call (load_sym libglib "g_source_attach") (GLibSourceRecord.PolyML.PTR &&> GLibMainContextRecord.PolyML.OPTPTR --> FFI.UInt32.PolyML.VAL)
      ...
      val getId_ = call (load_sym libglib "g_source_get_id") (GLibSourceRecord.PolyML.PTR --> FFI.UInt32.PolyML.VAL)
      val getName_ = call (load_sym libglib "g_source_get_name") (GLibSourceRecord.PolyML.PTR --> Utf8.PolyML.RETPTR)
      val getPriority_ = call (load_sym libglib "g_source_get_priority") (GLibSourceRecord.PolyML.PTR --> FFI.Int32.PolyML.VAL)
      ...
      val setName_ = call (load_sym libglib "g_source_set_name") (GLibSourceRecord.PolyML.PTR &&> Utf8.PolyML.INPTR --> FFI.PolyML.VOID)
      val setPriority_ = call (load_sym libglib "g_source_set_priority") (GLibSourceRecord.PolyML.PTR &&> FFI.Int32.PolyML.VAL --> FFI.PolyML.VOID)
      val remove_ = call (load_sym libglib "g_source_remove") (FFI.UInt32.PolyML.VAL --> FFI.Bool.PolyML.VAL)
      val setNameById_ = call (load_sym libglib "g_source_set_name_by_id") (FFI.UInt32.PolyML.VAL &&> Utf8.PolyML.INPTR --> FFI.PolyML.VOID)
    end
