structure GLibSource :>
  ...
  struct
    ...
    in
      ...
      val setPriority_ = call (load_sym libglib "g_source_set_priority") (GLibSourceRecord.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> PolyMLFFI.cVoid)
      val remove_ = call (load_sym libglib "g_source_remove") (FFI.UInt32.PolyML.cVal --> FFI.Bool.PolyML.cVal)
      val setNameById_ = call (load_sym libglib "g_source_set_name_by_id") (FFI.UInt32.PolyML.cVal &&> Utf8.PolyML.cInPtr --> PolyMLFFI.cVoid)
    end
