structure GLibBytes :>
  ...
  struct
    ...
    val getData_ = fn x1 & x2 => (_import "g_bytes_get_data" : GLibBytesRecord.FFI.notnull GLibBytesRecord.FFI.p * GUInt64.FFI.ref_ -> unit GUInt8CArrayN.FFI.out_p;) (x1, x2)
    ...
    val unrefToData_ = fn x1 & x2 => (_import "g_bytes_unref_to_data" : GLibBytesRecord.FFI.notnull GLibBytesRecord.FFI.p * GUInt64.FFI.ref_ -> GUInt8CArrayN.FFI.notnull GUInt8CArrayN.FFI.out_p;) (x1, x2)
