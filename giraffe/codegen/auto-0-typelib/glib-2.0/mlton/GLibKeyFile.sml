structure GLibKeyFile :>
  ...
  struct
    ...
    val getGroups_ = fn x1 & x2 => (_import "g_key_file_get_groups" : GLibKeyFileRecord.FFI.notnull GLibKeyFileRecord.FFI.p * GUInt64.FFI.ref_ -> Utf8CVector.FFI.notnull Utf8CVector.FFI.out_p;) (x1, x2)
    val getInt64_ =
      fn
        x1
         & (x2, x3)
