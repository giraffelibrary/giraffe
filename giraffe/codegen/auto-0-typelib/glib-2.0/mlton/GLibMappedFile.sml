structure GLibMappedFile :>
  ...
  struct
    ...
    val getLength_ = _import "g_mapped_file_get_length" : GLibMappedFileRecord.FFI.non_opt GLibMappedFileRecord.FFI.p -> GUInt64.FFI.val_;
    ...
    fun getLength self = (GLibMappedFileRecord.FFI.withPtr false ---> GUInt64.FFI.fromVal) getLength_ self
  end
