structure GLibVariant :>
  ...
  struct
    ...
    val dupBytestring_ = fn x1 & x2 => (_import "g_variant_dup_bytestring" : GLibVariantRecord.FFI.non_opt GLibVariantRecord.FFI.p * GUInt64.FFI.ref_ -> GUInt8CArray.FFI.non_opt GUInt8CArray.FFI.out_p;) (x1, x2)
    ...
    val dupObjv_ = fn x1 & x2 => (_import "g_variant_dup_objv" : GLibVariantRecord.FFI.non_opt GLibVariantRecord.FFI.p * GUInt64.FFI.ref_ -> Utf8CPtrArray.FFI.non_opt Utf8CPtrArray.FFI.out_p;) (x1, x2)
    ...
    val dupStrv_ = fn x1 & x2 => (_import "g_variant_dup_strv" : GLibVariantRecord.FFI.non_opt GLibVariantRecord.FFI.p * GUInt64.FFI.ref_ -> Utf8CPtrArray.FFI.non_opt Utf8CPtrArray.FFI.out_p;) (x1, x2)
    ...
    val getObjv_ = fn x1 & x2 => (_import "g_variant_get_objv" : GLibVariantRecord.FFI.non_opt GLibVariantRecord.FFI.p * GUInt64.FFI.ref_ -> Utf8CPtrArray.FFI.non_opt Utf8CPtrArray.FFI.out_p;) (x1, x2)
    ...
    val getStrv_ = fn x1 & x2 => (_import "g_variant_get_strv" : GLibVariantRecord.FFI.non_opt GLibVariantRecord.FFI.p * GUInt64.FFI.ref_ -> Utf8CPtrArray.FFI.non_opt Utf8CPtrArray.FFI.out_p;) (x1, x2)
    ...
    fun compare self two = (GLibVariantRecord.FFI.withPtr false &&&> GLibVariantRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) compare_ (self & two)
    fun dupBytestring self =
      let
        val _ & retVal = (GLibVariantRecord.FFI.withPtr false &&&> GUInt64.FFI.withRefVal ---> GUInt64.FFI.fromVal && GUInt8CArray.FFI.fromPtr ~1) dupBytestring_ (self & GUInt64.null)
      in
        retVal
      end
    fun dupBytestringArray self =
      let
        val length & retVal = (GLibVariantRecord.FFI.withPtr false &&&> GUInt64.FFI.withRefVal ---> GUInt64.FFI.fromVal && Utf8CPtrArrayN.FFI.fromPtr ~1) dupBytestringArray_ (self & GUInt64.null)
      in
        retVal (LargeInt.toInt length)
      end
    fun dupObjv self =
      let
        val _ & retVal = (GLibVariantRecord.FFI.withPtr false &&&> GUInt64.FFI.withRefVal ---> GUInt64.FFI.fromVal && Utf8CPtrArray.FFI.fromPtr ~1) dupObjv_ (self & GUInt64.null)
      in
        retVal
      end
    fun dupString self =
      let
        val length & retVal = (GLibVariantRecord.FFI.withPtr false &&&> GUInt64.FFI.withRefVal ---> GUInt64.FFI.fromVal && Utf8.FFI.fromPtr ~1) dupString_ (self & GUInt64.null)
      in
        (retVal, length)
      end
    fun dupStrv self =
      let
        val _ & retVal = (GLibVariantRecord.FFI.withPtr false &&&> GUInt64.FFI.withRefVal ---> GUInt64.FFI.fromVal && Utf8CPtrArray.FFI.fromPtr ~1) dupStrv_ (self & GUInt64.null)
      in
        retVal
      end
    ...
    fun hash self = (GLibVariantRecord.FFI.withPtr false ---> GUInt32.FFI.fromVal) hash_ self
    ...
    fun nChildren self = (GLibVariantRecord.FFI.withPtr false ---> GUInt64.FFI.fromVal) nChildren_ self
