structure GLibVariantType :>
  ...
  struct
        ...
        (x1, x2) & x3 =>
          (
            _import "mlton_g_variant_type_new_tuple" :
               ...
               * GLibVariantTypeRecordCPtrArrayN.FFI.notnull GLibVariantTypeRecordCPtrArrayN.MLton.p2
               * GInt32.FFI.val_
    ...
    val getStringLength_ = _import "g_variant_type_get_string_length" : GLibVariantTypeRecord.FFI.notnull GLibVariantTypeRecord.FFI.p -> GUInt64.FFI.val_;
    val hash_ = _import "g_variant_type_hash" : GLibVariantTypeRecord.FFI.notnull GLibVariantTypeRecord.FFI.p -> GUInt32.FFI.val_;
