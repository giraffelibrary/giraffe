structure GLibVariantType :>
  ...
  struct
    ...
    val getStringLength_ = _import "g_variant_type_get_string_length" : GLibVariantTypeRecord.FFI.non_opt GLibVariantTypeRecord.FFI.p -> GUInt64.FFI.val_;
    val hash_ = _import "g_variant_type_hash" : GLibVariantTypeRecord.FFI.non_opt GLibVariantTypeRecord.FFI.p -> GUInt32.FFI.val_;
    ...
    val nItems_ = _import "g_variant_type_n_items" : GLibVariantTypeRecord.FFI.non_opt GLibVariantTypeRecord.FFI.p -> GUInt64.FFI.val_;
    ...
    fun newTuple items =
      let
        ...
        val retVal = (GLibVariantTypeRecordCPtrArrayN.FFI.withPtr &&&> GInt32.FFI.withVal ---> GLibVariantTypeRecord.FFI.fromPtr true) newTuple_ (items & length)
      in
        retVal
      end
