structure GLib : G_LIB =
  struct
    ...
    val asciiDigitValue_ = _import "g_ascii_digit_value" : FFI.UInt8.C.val_ -> FFI.Int32.C.val_;
    val asciiDtostr_ =
      fn
        (x1, x2)
         & x3
    ...
    val asciiTolower_ = _import "g_ascii_tolower" : FFI.UInt8.C.val_ -> FFI.UInt8.C.val_;
    val asciiToupper_ = _import "g_ascii_toupper" : FFI.UInt8.C.val_ -> FFI.UInt8.C.val_;
    val asciiXdigitValue_ = _import "g_ascii_xdigit_value" : FFI.UInt8.C.val_ -> FFI.Int32.C.val_;
    val assertWarning_ =
      fn
        (x1, x2)
         & (x3, x4)
    ...
    val basename_ = _import "mlton_g_basename" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val chdir_ = _import "mlton_g_chdir" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Int32.C.val_;
    val checkVersion_ =
      fn
        x1
         & x2
    ...
    val checksumTypeGetLength_ = _import "g_checksum_type_get_length" : GLibChecksumType.C.val_ -> FFI.Int64.C.val_;
    val childWatchSourceNew_ = _import "g_child_watch_source_new" : FFI.Int32.C.val_ -> GLibSourceRecord.C.notnull GLibSourceRecord.C.p;
    ...
    val convertErrorQuark_ = _import "g_convert_error_quark" : unit -> FFI.UInt32.C.val_;
    val datalistClear_ = _import "g_datalist_clear" : GLibDataRecord.C.notnull GLibDataRecord.C.p -> unit;
    val datalistGetFlags_ = _import "g_datalist_get_flags" : GLibDataRecord.C.notnull GLibDataRecord.C.p -> FFI.UInt32.C.val_;
    val datalistInit_ = _import "g_datalist_init" : GLibDataRecord.C.notnull GLibDataRecord.C.p -> unit;
    val datalistSetFlags_ = fn x1 & x2 => (_import "g_datalist_set_flags" : GLibDataRecord.C.notnull GLibDataRecord.C.p * FFI.UInt32.C.val_ -> unit;) (x1, x2)
    val datalistUnsetFlags_ = fn x1 & x2 => (_import "g_datalist_unset_flags" : GLibDataRecord.C.notnull GLibDataRecord.C.p * FFI.UInt32.C.val_ -> unit;) (x1, x2)
    val dateGetDaysInMonth_ = fn x1 & x2 => (_import "g_date_get_days_in_month" : GLibDateMonth.C.val_ * FFI.UInt16.C.val_ -> FFI.UInt8.C.val_;) (x1, x2)
    val dateGetMondayWeeksInYear_ = _import "g_date_get_monday_weeks_in_year" : FFI.UInt16.C.val_ -> FFI.UInt8.C.val_;
    val dateGetSundayWeeksInYear_ = _import "g_date_get_sunday_weeks_in_year" : FFI.UInt16.C.val_ -> FFI.UInt8.C.val_;
    val dateIsLeapYear_ = _import "g_date_is_leap_year" : FFI.UInt16.C.val_ -> FFI.Bool.C.val_;
    val dateStrftime_ =
      fn
        (x1, x2)
         & x3
    ...
    val dateValidDay_ = _import "g_date_valid_day" : FFI.UInt8.C.val_ -> FFI.Bool.C.val_;
    val dateValidDmy_ =
      fn
        x1
         & x2
    ...
    val dateValidYear_ = _import "g_date_valid_year" : FFI.UInt16.C.val_ -> FFI.Bool.C.val_;
    val dcgettext_ =
      fn
        (x1, x2)
         & (x3, x4)
    ...
    val fileErrorFromErrno_ = _import "g_file_error_from_errno" : FFI.Int32.C.val_ -> GLibFileError.C.val_;
    val fileErrorQuark_ = _import "g_file_error_quark" : unit -> FFI.UInt32.C.val_;
    val fileOpenTmp_ =
      fn
        (x1, x2)
         & (x3, x4)
    ...
    val filenameDisplayBasename_ = _import "mlton_g_filename_display_basename" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val filenameDisplayName_ = _import "mlton_g_filename_display_name" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val findProgramInPath_ = _import "mlton_g_find_program_in_path" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val formatSize_ = _import "g_format_size" : FFI.UInt64.C.val_ -> Utf8.C.notnull Utf8.C.out_p;
    val formatSizeForDisplay_ = _import "g_format_size_for_display" : FFI.Int64.C.val_ -> Utf8.C.notnull Utf8.C.out_p;
    val formatSizeFull_ = fn x1 & x2 => (_import "g_format_size_full" : FFI.UInt64.C.val_ * GLibFormatSizeFlags.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
    val getApplicationName_ = _import "g_get_application_name" : unit -> Utf8.C.notnull Utf8.C.out_p;
    val getCharset_ = _import "mlton_g_get_charset" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Bool.C.val_;
    val getCurrentDir_ = _import "g_get_current_dir" : unit -> Utf8.C.notnull Utf8.C.out_p;
    val getCurrentTime_ = _import "g_get_current_time" : GLibTimeValRecord.C.notnull GLibTimeValRecord.C.p -> unit;
    val getFilenameCharsets_ = _import "mlton_g_get_filename_charsets" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Bool.C.val_;
    val getHomeDir_ = _import "g_get_home_dir" : unit -> Utf8.C.notnull Utf8.C.out_p;
    val getHostName_ = _import "g_get_host_name" : unit -> Utf8.C.notnull Utf8.C.out_p;
    val getMonotonicTime_ = _import "g_get_monotonic_time" : unit -> FFI.Int64.C.val_;
    val getPrgname_ = _import "g_get_prgname" : unit -> Utf8.C.notnull Utf8.C.out_p;
    val getRealName_ = _import "g_get_real_name" : unit -> Utf8.C.notnull Utf8.C.out_p;
    val getRealTime_ = _import "g_get_real_time" : unit -> FFI.Int64.C.val_;
    val getTmpDir_ = _import "g_get_tmp_dir" : unit -> Utf8.C.notnull Utf8.C.out_p;
    val getUserCacheDir_ = _import "g_get_user_cache_dir" : unit -> Utf8.C.notnull Utf8.C.out_p;
    val getUserConfigDir_ = _import "g_get_user_config_dir" : unit -> Utf8.C.notnull Utf8.C.out_p;
    val getUserDataDir_ = _import "g_get_user_data_dir" : unit -> Utf8.C.notnull Utf8.C.out_p;
    val getUserName_ = _import "g_get_user_name" : unit -> Utf8.C.notnull Utf8.C.out_p;
    val getUserRuntimeDir_ = _import "g_get_user_runtime_dir" : unit -> Utf8.C.notnull Utf8.C.out_p;
    val getUserSpecialDir_ = _import "g_get_user_special_dir" : GLibUserDirectory.C.val_ -> Utf8.C.notnull Utf8.C.out_p;
    val getenv_ = _import "mlton_g_getenv" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val hostnameIsAsciiEncoded_ = _import "mlton_g_hostname_is_ascii_encoded" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Bool.C.val_;
    val hostnameIsIpAddress_ = _import "mlton_g_hostname_is_ip_address" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Bool.C.val_;
    val hostnameIsNonAscii_ = _import "mlton_g_hostname_is_non_ascii" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Bool.C.val_;
    val hostnameToAscii_ = _import "mlton_g_hostname_to_ascii" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val hostnameToUnicode_ = _import "mlton_g_hostname_to_unicode" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val idleSourceNew_ = _import "g_idle_source_new" : unit -> GLibSourceRecord.C.notnull GLibSourceRecord.C.p;
    val internStaticString_ = _import "mlton_g_intern_static_string" : Utf8.MLton.p1 * unit Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val internString_ = _import "mlton_g_intern_string" : Utf8.MLton.p1 * unit Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val keyFileErrorQuark_ = _import "g_key_file_error_quark" : unit -> FFI.UInt32.C.val_;
    ...
    val mainDepth_ = _import "g_main_depth" : unit -> FFI.Int32.C.val_;
    val markupErrorQuark_ = _import "g_markup_error_quark" : unit -> FFI.UInt32.C.val_;
    ...
    val mkdtemp_ = _import "mlton_g_mkdtemp" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val mkdtempFull_ =
      fn
        (x1, x2) & x3 =>
          (
    ...
    val mkstemp_ = _import "mlton_g_mkstemp" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Int32.C.val_;
    val mkstempFull_ =
      fn
        (x1, x2)
         & x3
    ...
    val onErrorQuery_ = _import "mlton_g_on_error_query" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> unit;
    val onErrorStackTrace_ = _import "mlton_g_on_error_stack_trace" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> unit;
    val optionErrorQuark_ = _import "g_option_error_quark" : unit -> FFI.UInt32.C.val_;
    val pathGetBasename_ = _import "mlton_g_path_get_basename" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val pathGetDirname_ = _import "mlton_g_path_get_dirname" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val pathIsAbsolute_ = _import "mlton_g_path_is_absolute" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Bool.C.val_;
    val pathSkipRoot_ = _import "mlton_g_path_skip_root" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val patternMatch_ =
      fn
        x1
         & x2
    ...
    val quarkFromStaticString_ = _import "mlton_g_quark_from_static_string" : Utf8.MLton.p1 * unit Utf8.MLton.p2 -> FFI.UInt32.C.val_;
    val quarkFromString_ = _import "mlton_g_quark_from_string" : Utf8.MLton.p1 * unit Utf8.MLton.p2 -> FFI.UInt32.C.val_;
    val quarkToString_ = _import "g_quark_to_string" : FFI.UInt32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;
    val quarkTryString_ = _import "mlton_g_quark_try_string" : Utf8.MLton.p1 * unit Utf8.MLton.p2 -> FFI.UInt32.C.val_;
    ...
    val regexErrorQuark_ = _import "g_regex_error_quark" : unit -> FFI.UInt32.C.val_;
    val regexEscapeNul_ =
      fn
        (x1, x2) & x3 =>
          (
    ...
    val rmdir_ = _import "mlton_g_rmdir" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Int32.C.val_;
    ...
    val setApplicationName_ = _import "mlton_g_set_application_name" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> unit;
    val setPrgname_ = _import "mlton_g_set_prgname" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> unit;
    val setenv_ =
      fn
        (x1, x2)
         & (x3, x4)
    ...
    val sourceRemove_ = _import "g_source_remove" : FFI.UInt32.C.val_ -> FFI.Bool.C.val_;
    ...
    val spacedPrimesClosest_ = _import "g_spaced_primes_closest" : FFI.UInt32.C.val_ -> FFI.UInt32.C.val_;
    val spawnClosePid_ = _import "g_spawn_close_pid" : FFI.Int32.C.val_ -> unit;
    ...
    val spawnErrorQuark_ = _import "g_spawn_error_quark" : unit -> FFI.UInt32.C.val_;
    val stpcpy_ =
      fn
        (x1, x2) & (x3, x4) =>
          (
    ...
    val strchomp_ = _import "mlton_g_strchomp" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val strchug_ = _import "mlton_g_strchug" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val strcmp0_ =
      fn
        (x1, x2) & (x3, x4) =>
          (
    ...
    val strcompress_ = _import "mlton_g_strcompress" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val strdelimit_ =
      fn
        (x1, x2)
         & (x3, x4)
    ...
    val strdown_ = _import "mlton_g_strdown" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val strdup_ = _import "mlton_g_strdup" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val strerror_ = _import "g_strerror" : FFI.Int32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;
    val strescape_ =
      fn
        (x1, x2) & (x3, x4) =>
          (
    ...
    val strfreev_ = _import "mlton_g_strfreev" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> unit;
    val stringNew_ = _import "mlton_g_string_new" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> GLibStringRecord.C.notnull GLibStringRecord.C.p;
    val stringNewLen_ =
      fn
        (x1, x2) & x3 =>
          (
    ...
    val stringSizedNew_ = _import "g_string_sized_new" : FFI.UInt64.C.val_ -> GLibStringRecord.C.notnull GLibStringRecord.C.p;
    val stripContext_ =
      fn
        (x1, x2) & (x3, x4) =>
          (
    ...
    val strnfill_ = fn x1 & x2 => (_import "g_strnfill" : FFI.UInt64.C.val_ * FFI.UInt8.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
    val strreverse_ = _import "mlton_g_strreverse" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val strrstr_ =
      fn
        (x1, x2) & (x3, x4) =>
          (
    ...
    val strsignal_ = _import "g_strsignal" : FFI.Int32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;
    val strstrLen_ =
      fn
        (x1, x2)
         & x3
    ...
    val strup_ = _import "mlton_g_strup" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val strvLength_ = _import "mlton_g_strv_length" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.UInt32.C.val_;
    val testBug_ = _import "mlton_g_test_bug" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> unit;
    val testBugBase_ = _import "mlton_g_test_bug_base" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> unit;
    val testFail_ = _import "g_test_fail" : unit -> unit;
    val testLogTypeName_ = _import "g_test_log_type_name" : GLibTestLogType.C.val_ -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val testRun_ = _import "g_test_run" : unit -> FFI.Int32.C.val_;
    val testRunSuite_ = _import "g_test_run_suite" : GLibTestSuiteRecord.C.notnull GLibTestSuiteRecord.C.p -> FFI.Int32.C.val_;
    ...
    val threadErrorQuark_ = _import "g_thread_error_quark" : unit -> FFI.UInt32.C.val_;
    ...
    val threadPoolGetMaxIdleTime_ = _import "g_thread_pool_get_max_idle_time" : unit -> FFI.UInt32.C.val_;
    val threadPoolGetMaxUnusedThreads_ = _import "g_thread_pool_get_max_unused_threads" : unit -> FFI.Int32.C.val_;
    val threadPoolGetNumUnusedThreads_ = _import "g_thread_pool_get_num_unused_threads" : unit -> FFI.UInt32.C.val_;
    val threadPoolSetMaxIdleTime_ = _import "g_thread_pool_set_max_idle_time" : FFI.UInt32.C.val_ -> unit;
    val threadPoolSetMaxUnusedThreads_ = _import "g_thread_pool_set_max_unused_threads" : FFI.Int32.C.val_ -> unit;
    ...
    val timeoutSourceNew_ = _import "g_timeout_source_new" : FFI.UInt32.C.val_ -> GLibSourceRecord.C.notnull GLibSourceRecord.C.p;
    val timeoutSourceNewSeconds_ = _import "g_timeout_source_new_seconds" : FFI.UInt32.C.val_ -> GLibSourceRecord.C.notnull GLibSourceRecord.C.p;
    val trashStackHeight_ = _import "g_trash_stack_height" : GLibTrashStackRecord.C.notnull GLibTrashStackRecord.C.p -> FFI.UInt32.C.val_;
    val unicharBreakType_ = _import "g_unichar_break_type" : FFI.Char.C.val_ -> GLibUnicodeBreakType.C.val_;
    val unicharCombiningClass_ = _import "g_unichar_combining_class" : FFI.Char.C.val_ -> FFI.Int32.C.val_;
    val unicharDigitValue_ = _import "g_unichar_digit_value" : FFI.Char.C.val_ -> FFI.Int32.C.val_;
    ...
    val unlink_ = _import "mlton_g_unlink" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Int32.C.val_;
    val unsetenv_ = _import "mlton_g_unsetenv" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> unit;
    ...
    val usleep_ = _import "g_usleep" : FFI.UInt64.C.val_ -> unit;
    val utf8Casefold_ =
      fn
        (x1, x2) & x3 =>
          (
    ...
    val utf8GetChar_ = _import "mlton_g_utf8_get_char" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Char.C.val_;
    ...
    val utf8PrevChar_ = _import "mlton_g_utf8_prev_char" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> Utf8.C.notnull Utf8.C.out_p;
    val utf8Strchr_ =
      fn
        (x1, x2)
         & x3
    ...
    val variantIsObjectPath_ = _import "mlton_g_variant_is_object_path" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Bool.C.val_;
    val variantIsSignature_ = _import "mlton_g_variant_is_signature" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Bool.C.val_;
    val variantParse_ =
      fn
        x1
         & (x2, x3)
    ...
    val variantTypeChecked_ = _import "mlton_g_variant_type_checked_" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> GLibVariantTypeRecord.C.notnull GLibVariantTypeRecord.C.p;
    val variantTypeStringIsValid_ = _import "mlton_g_variant_type_string_is_valid" : Utf8.MLton.p1 * Utf8.C.notnull Utf8.MLton.p2 -> FFI.Bool.C.val_;
