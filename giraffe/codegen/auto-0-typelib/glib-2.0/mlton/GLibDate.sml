structure GLibDate :>
  ...
  struct
    ...
    val addDays_ = fn x1 & x2 => (_import "g_date_add_days" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val addMonths_ = fn x1 & x2 => (_import "g_date_add_months" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val addYears_ = fn x1 & x2 => (_import "g_date_add_years" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val clamp_ =
      fn
        x1
         & x2
    ...
    val clear_ = fn x1 & x2 => (_import "g_date_clear" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val compare_ = fn x1 & x2 => (_import "g_date_compare" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p * GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p -> GInt32.FFI.val_;) (x1, x2)
    val daysBetween_ = fn x1 & x2 => (_import "g_date_days_between" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p * GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p -> GInt32.FFI.val_;) (x1, x2)
    val getDay_ = _import "g_date_get_day" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p -> GUInt8.FFI.val_;
    val getDayOfYear_ = _import "g_date_get_day_of_year" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p -> GUInt32.FFI.val_;
    val getIso8601WeekOfYear_ = _import "g_date_get_iso8601_week_of_year" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p -> GUInt32.FFI.val_;
    val getJulian_ = _import "g_date_get_julian" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p -> GUInt32.FFI.val_;
    val getMondayWeekOfYear_ = _import "g_date_get_monday_week_of_year" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p -> GUInt32.FFI.val_;
    val getMonth_ = _import "g_date_get_month" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p -> GLibDateMonth.FFI.val_;
    val getSundayWeekOfYear_ = _import "g_date_get_sunday_week_of_year" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p -> GUInt32.FFI.val_;
    val getWeekday_ = _import "g_date_get_weekday" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p -> GLibDateWeekday.FFI.val_;
    val getYear_ = _import "g_date_get_year" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p -> GUInt16.FFI.val_;
    ...
    val setDay_ = fn x1 & x2 => (_import "g_date_set_day" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p * GUInt8.FFI.val_ -> unit;) (x1, x2)
    val setDmy_ =
      fn
        x1
         & x2
    ...
    val subtractDays_ = fn x1 & x2 => (_import "g_date_subtract_days" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val subtractMonths_ = fn x1 & x2 => (_import "g_date_subtract_months" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val subtractYears_ = fn x1 & x2 => (_import "g_date_subtract_years" : GLibDateRecord.FFI.notnull GLibDateRecord.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
