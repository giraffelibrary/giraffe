structure GLibMatchInfo :>
  ...
  struct
    ...
    val fetch_ = fn x1 & x2 => (_import "g_match_info_fetch" : GLibMatchInfoRecord.C.notnull GLibMatchInfoRecord.C.p * FFI.Int32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
    val fetchNamed_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val getString_ = _import "g_match_info_get_string" : GLibMatchInfoRecord.C.notnull GLibMatchInfoRecord.C.p -> Utf8.C.notnull Utf8.C.out_p;
    ...
    fun fetch self matchNum = (GLibMatchInfoRecord.C.withPtr &&&> FFI.Int32.C.withVal ---> Utf8.C.fromPtr true) fetch_ (self & matchNum)
