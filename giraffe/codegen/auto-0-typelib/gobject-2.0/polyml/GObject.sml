structure GObject :
  ...
  struct
    ...
    in
      ...
      val signalListIds_ = call (getSymbol "g_signal_list_ids") (GObjectType.PolyML.cVal &&> GUInt32.PolyML.cRef --> GUInt32CArrayN.PolyML.cOutPtr)
      ...
      val typeChildren_ = call (getSymbol "g_type_children") (GObjectType.PolyML.cVal &&> GUInt32.PolyML.cRef --> GObjectTypeCArrayN.PolyML.cOutPtr)
      ...
      val typeInterfacePrerequisites_ = call (getSymbol "g_type_interface_prerequisites") (GObjectType.PolyML.cVal &&> GUInt32.PolyML.cRef --> GObjectTypeCArrayN.PolyML.cOutPtr)
      val typeInterfaces_ = call (getSymbol "g_type_interfaces") (GObjectType.PolyML.cVal &&> GUInt32.PolyML.cRef --> GObjectTypeCArrayN.PolyML.cOutPtr)
