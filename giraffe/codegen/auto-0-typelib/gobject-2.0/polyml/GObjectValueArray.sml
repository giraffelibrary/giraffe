structure GObjectValueArray :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (getSymbol "g_value_array_new") (GUInt32.PolyML.cVal --> GObjectValueArrayRecord.PolyML.cPtr)
      ...
      val getNth_ = call (getSymbol "g_value_array_get_nth") (GObjectValueArrayRecord.PolyML.cPtr &&> GUInt32.PolyML.cVal --> GObjectValueRecord.PolyML.cPtr)
      val insert_ =
      ...
      val remove_ = call (getSymbol "g_value_array_remove") (GObjectValueArrayRecord.PolyML.cPtr &&> GUInt32.PolyML.cVal --> GObjectValueArrayRecord.PolyML.cPtr)
    end
