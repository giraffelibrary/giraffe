signature G_OBJECT =
  sig
    ...
    val TYPE_FLAG_RESERVED_ID_BIT : LargeInt.int
    ...
    val typeQname : Type.t -> LargeInt.int
    ...
    val valueTypeCompatible : Type.t * Type.t -> bool
    val valueTypeTransformable : Type.t * Type.t -> bool
  end
