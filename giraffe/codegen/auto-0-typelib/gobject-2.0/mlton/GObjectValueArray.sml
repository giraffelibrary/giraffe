structure GObjectValueArray :>
  ...
  struct
    ...
    val new_ = _import "g_value_array_new" : GUInt32.FFI.val_ -> GObjectValueArrayRecord.FFI.notnull GObjectValueArrayRecord.FFI.p;
    ...
    val getNth_ = fn x1 & x2 => (_import "g_value_array_get_nth" : GObjectValueArrayRecord.FFI.notnull GObjectValueArrayRecord.FFI.p * GUInt32.FFI.val_ -> GObjectValueRecord.FFI.notnull GObjectValueRecord.FFI.p;) (x1, x2)
    val insert_ =
      fn
        x1
         & x2
    ...
    val remove_ = fn x1 & x2 => (_import "g_value_array_remove" : GObjectValueArrayRecord.FFI.notnull GObjectValueArrayRecord.FFI.p * GUInt32.FFI.val_ -> GObjectValueArrayRecord.FFI.notnull GObjectValueArrayRecord.FFI.p;) (x1, x2)
