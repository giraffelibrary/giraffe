structure GObject :
  ...
  struct
    ...
    val flagsGetFirstValue_ = fn x1 & x2 => (_import "g_flags_get_first_value" : GObjectFlagsClassRecord.FFI.notnull GObjectFlagsClassRecord.FFI.p * GUInt32.FFI.val_ -> GObjectFlagsValueRecord.FFI.notnull GObjectFlagsValueRecord.FFI.p;) (x1, x2)
    ...
    val signalTypeCclosureNew_ = fn x1 & x2 => (_import "g_signal_type_cclosure_new" : GObjectType.FFI.val_ * GUInt32.FFI.val_ -> GObjectClosureRecord.FFI.notnull GObjectClosureRecord.FFI.p;) (x1, x2)
