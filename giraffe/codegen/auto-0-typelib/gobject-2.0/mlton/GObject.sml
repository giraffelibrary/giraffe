structure GObject :
  ...
  struct
    val enumGetValue_ = fn x1 & x2 => (_import "g_enum_get_value" : GObjectEnumClassRecord.FFI.non_opt GObjectEnumClassRecord.FFI.p * GInt32.FFI.val_ -> GObjectEnumValueRecord.FFI.non_opt GObjectEnumValueRecord.FFI.p;) (x1, x2)
    val enumGetValueByName_ =
      fn
        x1 & (x2, x3) =>
          (
            _import "mlton_g_enum_get_value_by_name" :
              GObjectEnumClassRecord.FFI.non_opt GObjectEnumClassRecord.FFI.p
               * Utf8.MLton.p1
    ...
    val flagsGetFirstValue_ = fn x1 & x2 => (_import "g_flags_get_first_value" : GObjectFlagsClassRecord.FFI.non_opt GObjectFlagsClassRecord.FFI.p * GUInt32.FFI.val_ -> GObjectFlagsValueRecord.FFI.non_opt GObjectFlagsValueRecord.FFI.p;) (x1, x2)
    val flagsGetValueByName_ =
      fn
        x1 & (x2, x3) =>
          (
            _import "mlton_g_flags_get_value_by_name" :
              GObjectFlagsClassRecord.FFI.non_opt GObjectFlagsClassRecord.FFI.p
               * Utf8.MLton.p1
               * Utf8.FFI.non_opt Utf8.MLton.p2
    ...
    val signalListIds_ = fn x1 & x2 => (_import "g_signal_list_ids" : GObjectType.FFI.val_ * GUInt32.FFI.ref_ -> GUInt32CArrayN.FFI.non_opt GUInt32CArrayN.FFI.out_p;) (x1, x2)
    val signalLookup_ =
      fn
        (x1, x2) & x3 =>
          (
    ...
    val signalTypeCclosureNew_ = fn x1 & x2 => (_import "g_signal_type_cclosure_new" : GObjectType.FFI.val_ * GUInt32.FFI.val_ -> GObjectClosureRecord.FFI.non_opt GObjectClosureRecord.FFI.p;) (x1, x2)
    val typeAddClassPrivate_ = fn x1 & x2 => (_import "g_type_add_class_private" : GObjectType.FFI.val_ * GUInt64.FFI.val_ -> unit;) (x1, x2)
    val typeAddInstancePrivate_ = fn x1 & x2 => (_import "g_type_add_instance_private" : GObjectType.FFI.val_ * GUInt64.FFI.val_ -> GInt32.FFI.val_;) (x1, x2)
    ...
    val typeChildren_ = fn x1 & x2 => (_import "g_type_children" : GObjectType.FFI.val_ * GUInt32.FFI.ref_ -> GObjectTypeCArrayN.FFI.non_opt GObjectTypeCArrayN.FFI.out_p;) (x1, x2)
    ...
    val typeGetInstanceCount_ = _import "g_type_get_instance_count" : GObjectType.FFI.val_ -> GInt32.FFI.val_;
    ...
    val typeGetTypeRegistrationSerial_ = _import "g_type_get_type_registration_serial" : unit -> GUInt32.FFI.val_;
    ...
    val typeInterfaceGetPlugin_ = fn x1 & x2 => (_import "g_type_interface_get_plugin" : GObjectType.FFI.val_ * GObjectType.FFI.val_ -> GObjectTypePluginClass.FFI.non_opt GObjectTypePluginClass.FFI.p;) (x1, x2)
    val typeInterfacePrerequisites_ = fn x1 & x2 => (_import "g_type_interface_prerequisites" : GObjectType.FFI.val_ * GUInt32.FFI.ref_ -> GObjectTypeCArrayN.FFI.non_opt GObjectTypeCArrayN.FFI.out_p;) (x1, x2)
    val typeInterfaces_ = fn x1 & x2 => (_import "g_type_interfaces" : GObjectType.FFI.val_ * GUInt32.FFI.ref_ -> GObjectTypeCArrayN.FFI.non_opt GObjectTypeCArrayN.FFI.out_p;) (x1, x2)
    ...
    val typeQname_ = _import "g_type_qname" : GObjectType.FFI.val_ -> GUInt32.FFI.val_;
    val typeQuery_ = fn x1 & x2 => (_import "g_type_query" : GObjectType.FFI.val_ * GObjectTypeQueryRecord.FFI.non_opt GObjectTypeQueryRecord.FFI.p -> unit;) (x1, x2)
    ...
    val typeTestFlags_ = fn x1 & x2 => (_import "g_type_test_flags" : GObjectType.FFI.val_ * GUInt32.FFI.val_ -> GBool.FFI.val_;) (x1, x2)
    val valueTypeCompatible_ = fn x1 & x2 => (_import "g_value_type_compatible" : GObjectType.FFI.val_ * GObjectType.FFI.val_ -> GBool.FFI.val_;) (x1, x2)
    val valueTypeTransformable_ = fn x1 & x2 => (_import "g_value_type_transformable" : GObjectType.FFI.val_ * GObjectType.FFI.val_ -> GBool.FFI.val_;) (x1, x2)
    ...
    fun enumGetValue (enumClass, value) = (GObjectEnumClassRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> GObjectEnumValueRecord.FFI.fromPtr false) enumGetValue_ (enumClass & value) before GObjectEnumClassRecord.FFI.touchPtr enumClass
    ...
    fun flagsGetFirstValue (flagsClass, value) = (GObjectFlagsClassRecord.FFI.withPtr false &&&> GUInt32.FFI.withVal ---> GObjectFlagsValueRecord.FFI.fromPtr false) flagsGetFirstValue_ (flagsClass & value) before GObjectFlagsClassRecord.FFI.touchPtr flagsClass
    ...
    fun signalLookup (name, itype) = (Utf8.FFI.withPtr 0 &&&> GObjectType.FFI.withVal ---> GUInt32.FFI.fromVal) signalLookup_ (name & itype)
