structure VteTerminal :>
  ...
  struct
    ...
    val getCharHeight_ = _import "vte_terminal_get_char_height" : VteTerminalClass.C.notnull VteTerminalClass.C.p -> FFI.Int64.C.val_;
    val getCharWidth_ = _import "vte_terminal_get_char_width" : VteTerminalClass.C.notnull VteTerminalClass.C.p -> FFI.Int64.C.val_;
    val getCjkAmbiguousWidth_ = _import "vte_terminal_get_cjk_ambiguous_width" : VteTerminalClass.C.notnull VteTerminalClass.C.p -> FFI.Int32.C.val_;
    val getColumnCount_ = _import "vte_terminal_get_column_count" : VteTerminalClass.C.notnull VteTerminalClass.C.p -> FFI.Int64.C.val_;
    ...
    val getRowCount_ = _import "vte_terminal_get_row_count" : VteTerminalClass.C.notnull VteTerminalClass.C.p -> FFI.Int64.C.val_;
    ...
    val matchRemove_ = fn x1 & x2 => (_import "vte_terminal_match_remove" : VteTerminalClass.C.notnull VteTerminalClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    ...
    val setCjkAmbiguousWidth_ = fn x1 & x2 => (_import "vte_terminal_set_cjk_ambiguous_width" : VteTerminalClass.C.notnull VteTerminalClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    ...
    val setScrollbackLines_ = fn x1 & x2 => (_import "vte_terminal_set_scrollback_lines" : VteTerminalClass.C.notnull VteTerminalClass.C.p * FFI.Int64.C.val_ -> unit;) (x1, x2)
    val setSize_ =
      fn
        x1
         & x2
    ...
    val watchChild_ = fn x1 & x2 => (_import "vte_terminal_watch_child" : VteTerminalClass.C.notnull VteTerminalClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
