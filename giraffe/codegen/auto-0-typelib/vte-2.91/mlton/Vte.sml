structure Vte : VTE =
  struct
    val getMajorVersion_ = _import "vte_get_major_version" : unit -> FFI.UInt32.C.val_;
    val getMicroVersion_ = _import "vte_get_micro_version" : unit -> FFI.UInt32.C.val_;
    val getMinorVersion_ = _import "vte_get_minor_version" : unit -> FFI.UInt32.C.val_;
