structure GtkSourceCompletionProposal :>
  ...
  struct
    ...
    val hash_ = _import "gtk_source_completion_proposal_hash" : GtkSourceCompletionProposalClass.C.notnull GtkSourceCompletionProposalClass.C.p -> FFI.UInt32.C.val_;
