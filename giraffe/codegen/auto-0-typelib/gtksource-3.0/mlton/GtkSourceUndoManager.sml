structure GtkSourceUndoManager :>
  ...
  struct
    ...
    val canRedo_ = _import "gtk_source_undo_manager_can_redo" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.C.val_;
    ...
    val canUndo_ = _import "gtk_source_undo_manager_can_undo" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.C.val_;
