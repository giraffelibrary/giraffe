structure GtkSourceGutterRenderer :>
  ...
  struct
    ...
    val getSize_ = _import "gtk_source_gutter_renderer_get_size" : GtkSourceGutterRendererClass.C.notnull GtkSourceGutterRendererClass.C.p -> FFI.Int32.C.val_;
    ...
    val setSize_ = fn x1 & x2 => (_import "gtk_source_gutter_renderer_set_size" : GtkSourceGutterRendererClass.C.notnull GtkSourceGutterRendererClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
