structure GtkSourceView :>
  ...
  struct
    ...
    val getIndentWidth_ = _import "gtk_source_view_get_indent_width" : GtkSourceViewClass.FFI.notnull GtkSourceViewClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getRightMarginPosition_ = _import "gtk_source_view_get_right_margin_position" : GtkSourceViewClass.FFI.notnull GtkSourceViewClass.FFI.p -> GUInt32.FFI.val_;
    ...
    val getTabWidth_ = _import "gtk_source_view_get_tab_width" : GtkSourceViewClass.FFI.notnull GtkSourceViewClass.FFI.p -> GUInt32.FFI.val_;
    val getVisualColumn_ = fn x1 & x2 => (_import "gtk_source_view_get_visual_column" : GtkSourceViewClass.FFI.notnull GtkSourceViewClass.FFI.p * GtkTextIterRecord.FFI.notnull GtkTextIterRecord.FFI.p -> GUInt32.FFI.val_;) (x1, x2)
    val indentLines_ =
      fn
        x1
         & x2
    ...
    val setIndentWidth_ = fn x1 & x2 => (_import "gtk_source_view_set_indent_width" : GtkSourceViewClass.FFI.notnull GtkSourceViewClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val setRightMarginPosition_ = fn x1 & x2 => (_import "gtk_source_view_set_right_margin_position" : GtkSourceViewClass.FFI.notnull GtkSourceViewClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    val setTabWidth_ = fn x1 & x2 => (_import "gtk_source_view_set_tab_width" : GtkSourceViewClass.FFI.notnull GtkSourceViewClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val unindentLines_ =
      fn
        x1
         & x2
