structure GtkSourceView :>
  ...
  struct
    ...
    val getIndentWidth_ = _import "gtk_source_view_get_indent_width" : GtkSourceViewClass.C.notnull GtkSourceViewClass.C.p -> FFI.Int32.C.val_;
    ...
    val getRightMarginPosition_ = _import "gtk_source_view_get_right_margin_position" : GtkSourceViewClass.C.notnull GtkSourceViewClass.C.p -> FFI.UInt32.C.val_;
    ...
    val getTabWidth_ = _import "gtk_source_view_get_tab_width" : GtkSourceViewClass.C.notnull GtkSourceViewClass.C.p -> FFI.UInt32.C.val_;
    val getVisualColumn_ = fn x1 & x2 => (_import "gtk_source_view_get_visual_column" : GtkSourceViewClass.C.notnull GtkSourceViewClass.C.p * GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.UInt32.C.val_;) (x1, x2)
    ...
    val setIndentWidth_ = fn x1 & x2 => (_import "gtk_source_view_set_indent_width" : GtkSourceViewClass.C.notnull GtkSourceViewClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    ...
    val setRightMarginPosition_ = fn x1 & x2 => (_import "gtk_source_view_set_right_margin_position" : GtkSourceViewClass.C.notnull GtkSourceViewClass.C.p * FFI.UInt32.C.val_ -> unit;) (x1, x2)
    ...
    val setTabWidth_ = fn x1 & x2 => (_import "gtk_source_view_set_tab_width" : GtkSourceViewClass.C.notnull GtkSourceViewClass.C.p * FFI.UInt32.C.val_ -> unit;) (x1, x2)
