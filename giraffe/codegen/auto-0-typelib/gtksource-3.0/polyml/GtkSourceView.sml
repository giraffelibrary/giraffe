structure GtkSourceView :>
  ...
  struct
    ...
    in
      ...
      val setIndentWidth_ = call (load_sym libgtksourceview "gtk_source_view_set_indent_width") (GtkSourceViewClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      ...
      val setRightMarginPosition_ = call (load_sym libgtksourceview "gtk_source_view_set_right_margin_position") (GtkSourceViewClass.PolyML.cPtr &&> FFI.UInt32.PolyML.cVal --> FFI.PolyML.cVoid)
      ...
      val setTabWidth_ = call (load_sym libgtksourceview "gtk_source_view_set_tab_width") (GtkSourceViewClass.PolyML.cPtr &&> FFI.UInt32.PolyML.cVal --> FFI.PolyML.cVoid)
    end
