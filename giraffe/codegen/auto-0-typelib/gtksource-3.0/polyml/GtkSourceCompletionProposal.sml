structure GtkSourceCompletionProposal :>
  ...
  struct
    ...
    in
      ...
      val changed_ = call (load_sym libgtksourceview "gtk_source_completion_proposal_changed") (GtkSourceCompletionProposalClass.PolyML.cPtr --> FFI.PolyML.cVoid)
      ...
      val hash_ = call (load_sym libgtksourceview "gtk_source_completion_proposal_hash") (GtkSourceCompletionProposalClass.PolyML.cPtr --> FFI.UInt32.PolyML.cVal)
    end
    ...
    fun hash self = (GtkSourceCompletionProposalClass.C.withPtr ---> FFI.UInt32.C.fromVal) hash_ self
    local
