structure GtkSourceCompletionProvider :>
  ...
  struct
    ...
    in
      ...
      val getInteractiveDelay_ = call (load_sym libgtksourceview "gtk_source_completion_provider_get_interactive_delay") (GObjectObjectClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val getPriority_ = call (load_sym libgtksourceview "gtk_source_completion_provider_get_priority") (GObjectObjectClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      val getStartIter_ =
