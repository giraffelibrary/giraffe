structure GtkSourceCompletionProvider :>
  ...
  struct
    ...
    in
      ...
      val getInteractiveDelay_ = call (load_sym libgtksourceview "gtk_source_completion_provider_get_interactive_delay") (GtkSourceCompletionProviderClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getPriority_ = call (load_sym libgtksourceview "gtk_source_completion_provider_get_priority") (GtkSourceCompletionProviderClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getStartIter_ =
      ...
      val match_ = call (load_sym libgtksourceview "gtk_source_completion_provider_match") (GtkSourceCompletionProviderClass.PolyML.cPtr &&> GtkSourceCompletionContextClass.PolyML.cPtr --> GBool.PolyML.cVal)
