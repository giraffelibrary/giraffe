structure GtkSourceGutterRenderer :>
  ...
  struct
    ...
    in
      ...
      val getSize_ = call (load_sym libgtksourceview "gtk_source_gutter_renderer_get_size") (GObjectObjectClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val setSize_ = call (load_sym libgtksourceview "gtk_source_gutter_renderer_set_size") (GObjectObjectClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
