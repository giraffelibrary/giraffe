structure GtkSource : GTK_SOURCE =
  struct
    ...
    in
      ...
      val encodingGetCurrent_ = call (getSymbol "gtk_source_encoding_get_current") (cVoid --> GtkSourceEncodingRecord.PolyML.cPtr)
      val encodingGetFromCharset_ = call (getSymbol "gtk_source_encoding_get_from_charset") (Utf8.PolyML.cInPtr --> GtkSourceEncodingRecord.PolyML.cOptPtr)
      val encodingGetUtf8_ = call (getSymbol "gtk_source_encoding_get_utf8") (cVoid --> GtkSourceEncodingRecord.PolyML.cPtr)
      val fileLoaderErrorQuark_ = call (getSymbol "gtk_source_file_loader_error_quark") (cVoid --> GUInt32.PolyML.cVal)
      val fileSaverErrorQuark_ = call (getSymbol "gtk_source_file_saver_error_quark") (cVoid --> GUInt32.PolyML.cVal)
      val utilsEscapeSearchText_ = call (getSymbol "gtk_source_utils_escape_search_text") (Utf8.PolyML.cInPtr --> Utf8.PolyML.cOutPtr)
      val utilsUnescapeSearchText_ = call (getSymbol "gtk_source_utils_unescape_search_text") (Utf8.PolyML.cInPtr --> Utf8.PolyML.cOutPtr)
    end
    ...
    fun encodingGetFromCharset charset = (Utf8.FFI.withPtr 0 ---> GtkSourceEncodingRecord.FFI.fromOptPtr false) encodingGetFromCharset_ charset before Utf8.FFI.touchPtr charset
