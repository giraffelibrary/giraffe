structure PangoFontset :>
  ...
  struct
    ...
    val getFont_ = fn x1 & x2 => (_import "pango_fontset_get_font" : PangoFontsetClass.C.notnull PangoFontsetClass.C.p * FFI.UInt32.C.val_ -> PangoFontClass.C.notnull PangoFontClass.C.p;) (x1, x2)
