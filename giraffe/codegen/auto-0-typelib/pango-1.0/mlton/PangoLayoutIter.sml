structure PangoLayoutIter :>
  ...
  struct
    ...
    val getBaseline_ = _import "pango_layout_iter_get_baseline" : PangoLayoutIterRecord.FFI.non_opt PangoLayoutIterRecord.FFI.p -> GInt32.FFI.val_;
    ...
    val getIndex_ = _import "pango_layout_iter_get_index" : PangoLayoutIterRecord.FFI.non_opt PangoLayoutIterRecord.FFI.p -> GInt32.FFI.val_;
    ...
    val getRun_ = _import "pango_layout_iter_get_run" : PangoLayoutIterRecord.FFI.non_opt PangoLayoutIterRecord.FFI.p -> PangoGlyphItemRecord.FFI.opt PangoGlyphItemRecord.FFI.p;
    val getRunExtents_ =
      fn
        x1
         & x2
    ...
    val getRunReadonly_ = _import "pango_layout_iter_get_run_readonly" : PangoLayoutIterRecord.FFI.non_opt PangoLayoutIterRecord.FFI.p -> PangoGlyphItemRecord.FFI.opt PangoGlyphItemRecord.FFI.p;
    ...
    fun getRun self = (PangoLayoutIterRecord.FFI.withPtr false ---> PangoGlyphItemRecord.FFI.fromOptPtr false) getRun_ self
    ...
    fun getRunReadonly self = (PangoLayoutIterRecord.FFI.withPtr false ---> PangoGlyphItemRecord.FFI.fromOptPtr false) getRunReadonly_ self
