structure PangoGravity :>
  ...
  struct
    ...
    val getForMatrix_ = _import "pango_gravity_get_for_matrix" : PangoMatrixRecord.FFI.opt PangoMatrixRecord.FFI.p -> FFI.val_;
    val getForScript_ =
      fn
        x1
         & x2
    ...
    fun getForMatrix matrix = (PangoMatrixRecord.FFI.withOptPtr false ---> FFI.fromVal) getForMatrix_ matrix
    fun getForScript
      (
        script,
        baseGravity,
