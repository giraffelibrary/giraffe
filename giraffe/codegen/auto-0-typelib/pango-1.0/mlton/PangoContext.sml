structure PangoContext :>
  ...
  struct
    ...
    val getSerial_ = _import "pango_context_get_serial" : PangoContextClass.FFI.non_opt PangoContextClass.FFI.p -> GUInt32.FFI.val_;
    val listFamilies_ =
      fn
        x1
         & (x2, x3)
    ...
    fun getSerial self = (PangoContextClass.FFI.withPtr false ---> GUInt32.FFI.fromVal) getSerial_ self
