structure PangoFontDescription :>
  ...
  struct
    ...
    fun getSize self = (PangoFontDescriptionRecord.FFI.withPtr false ---> GInt32.FFI.fromVal) getSize_ self
    ...
    fun hash self = (PangoFontDescriptionRecord.FFI.withPtr false ---> GUInt32.FFI.fromVal) hash_ self
    ...
    fun setSize self size = (PangoFontDescriptionRecord.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) setSize_ (self & size)
