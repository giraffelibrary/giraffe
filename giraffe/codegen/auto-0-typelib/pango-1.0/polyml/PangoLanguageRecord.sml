structure PangoLanguageRecord :> PANGO_LANGUAGE_RECORD =
  struct
    ...
    local
      open PolyMLFFI
    in
      val dup_ = call (getSymbol "pango_language_copy") (cPtr --> cPtr)
      val free_ = call (getSymbol "pango_language_free") (cPtr --> PolyMLFFI.cVoid)
    end
    structure Record =
      BoxedRecord(
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "pango_language_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
