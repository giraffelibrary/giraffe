structure PangoLayout :>
  ...
  struct
    ...
    in
      ...
      val getBaseline_ = call (load_sym libpango "pango_layout_get_baseline") (PangoLayoutClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getCharacterCount_ = call (load_sym libpango "pango_layout_get_character_count") (PangoLayoutClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getHeight_ = call (load_sym libpango "pango_layout_get_height") (PangoLayoutClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getIndent_ = call (load_sym libpango "pango_layout_get_indent") (PangoLayoutClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getLine_ = call (load_sym libpango "pango_layout_get_line") (PangoLayoutClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PangoLayoutLineRecord.PolyML.cPtr)
      val getLineCount_ = call (load_sym libpango "pango_layout_get_line_count") (PangoLayoutClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getLineReadonly_ = call (load_sym libpango "pango_layout_get_line_readonly") (PangoLayoutClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PangoLayoutLineRecord.PolyML.cPtr)
      val getLogAttrs_ =
      ...
      val getSpacing_ = call (load_sym libpango "pango_layout_get_spacing") (PangoLayoutClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val getUnknownGlyphsCount_ = call (load_sym libpango "pango_layout_get_unknown_glyphs_count") (PangoLayoutClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getWidth_ = call (load_sym libpango "pango_layout_get_width") (PangoLayoutClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val setHeight_ = call (load_sym libpango "pango_layout_set_height") (PangoLayoutClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val setIndent_ = call (load_sym libpango "pango_layout_set_indent") (PangoLayoutClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setSpacing_ = call (load_sym libpango "pango_layout_set_spacing") (PangoLayoutClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val setWidth_ = call (load_sym libpango "pango_layout_set_width") (PangoLayoutClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> PolyMLFFI.cVoid)
