structure Pango : PANGO =
  struct
    ...
    in
      ...
      val findBaseDir_ = call (load_sym libpango "pango_find_base_dir") (Utf8.PolyML.cInPtr &&> GInt32.PolyML.cVal --> PangoDirection.PolyML.cVal)
      ...
      val quantizeLineGeometry_ = call (load_sym libpango "pango_quantize_line_geometry") (GInt32.PolyML.cRef &&> GInt32.PolyML.cRef --> PolyMLFFI.cVoid)
      ...
      val unitsFromDouble_ = call (load_sym libpango "pango_units_from_double") (GDouble.PolyML.cVal --> GInt32.PolyML.cVal)
      val unitsToDouble_ = call (load_sym libpango "pango_units_to_double") (GInt32.PolyML.cVal --> GDouble.PolyML.cVal)
      val version_ = call (load_sym libpango "pango_version") (PolyMLFFI.cVoid --> GInt32.PolyML.cVal)
      val versionCheck_ =
