structure GioDBusSubtreeFlags :>
  sig
    include GIO_D_BUS_SUBTREE_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_dbus_subtree_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
