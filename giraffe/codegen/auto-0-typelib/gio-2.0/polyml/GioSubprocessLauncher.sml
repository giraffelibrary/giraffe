structure GioSubprocessLauncher :>
  ...
  struct
    ...
    in
      ...
      val takeStderrFd_ = call (getSymbol "g_subprocess_launcher_take_stderr_fd") (GioSubprocessLauncherClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val takeStdinFd_ = call (getSymbol "g_subprocess_launcher_take_stdin_fd") (GioSubprocessLauncherClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
      val takeStdoutFd_ = call (getSymbol "g_subprocess_launcher_take_stdout_fd") (GioSubprocessLauncherClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
    ...
    fun takeStderrFd self fd = (GioSubprocessLauncherClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) takeStderrFd_ (self & fd)
    fun takeStdinFd self fd = (GioSubprocessLauncherClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) takeStdinFd_ (self & fd)
    fun takeStdoutFd self fd = (GioSubprocessLauncherClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) takeStdoutFd_ (self & fd)
