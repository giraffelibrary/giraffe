structure GioMountOperation :>
  ...
  struct
    ...
    in
      ...
      val getChoice_ = call (getSymbol "g_mount_operation_get_choice") (GioMountOperationClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val setChoice_ = call (getSymbol "g_mount_operation_set_choice") (GioMountOperationClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
