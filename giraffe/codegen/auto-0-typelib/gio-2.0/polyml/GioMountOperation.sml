structure GioMountOperation :>
  ...
  struct
    ...
    in
      ...
      val getChoice_ = call (load_sym libgio "g_mount_operation_get_choice") (GObjectObjectClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val setChoice_ = call (load_sym libgio "g_mount_operation_set_choice") (GObjectObjectClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
