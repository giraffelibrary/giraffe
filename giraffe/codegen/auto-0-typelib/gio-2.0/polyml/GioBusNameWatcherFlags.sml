structure GioBusNameWatcherFlags :>
  sig
    include GIO_BUS_NAME_WATCHER_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_bus_name_watcher_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
