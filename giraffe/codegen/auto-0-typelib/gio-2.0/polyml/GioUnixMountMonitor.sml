structure GioUnixMountMonitor :>
  ...
  struct
    ...
    in
      ...
      val setRateLimit_ = call (load_sym libgio "g_unix_mount_monitor_set_rate_limit") (GioUnixMountMonitorClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
    end
