structure GioBufferedInputStream :>
  ...
  struct
    ...
    in
      ...
      val newSized_ = call (load_sym libgio "g_buffered_input_stream_new_sized") (GObjectObjectClass.PolyML.cPtr &&> FFI.UInt64.PolyML.cVal --> GObjectObjectClass.PolyML.cPtr)
      val fill_ =
      ...
      val getAvailable_ = call (load_sym libgio "g_buffered_input_stream_get_available") (GObjectObjectClass.PolyML.cPtr --> FFI.UInt64.PolyML.cVal)
      val getBufferSize_ = call (load_sym libgio "g_buffered_input_stream_get_buffer_size") (GObjectObjectClass.PolyML.cPtr --> FFI.UInt64.PolyML.cVal)
      val readByte_ =
      ...
      val setBufferSize_ = call (load_sym libgio "g_buffered_input_stream_set_buffer_size") (GObjectObjectClass.PolyML.cPtr &&> FFI.UInt64.PolyML.cVal --> FFI.PolyML.cVoid)
    end
