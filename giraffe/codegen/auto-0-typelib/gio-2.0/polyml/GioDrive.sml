structure GioDrive :>
  ...
  struct
    ...
    in
      ...
      val canStartDegraded_ = call (load_sym libgio "g_drive_can_start_degraded") (GioDriveClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val canStop_ = call (load_sym libgio "g_drive_can_stop") (GioDriveClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      ...
      val hasMedia_ = call (load_sym libgio "g_drive_has_media") (GioDriveClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val hasVolumes_ = call (load_sym libgio "g_drive_has_volumes") (GioDriveClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val isMediaCheckAutomatic_ = call (load_sym libgio "g_drive_is_media_check_automatic") (GioDriveClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val isMediaRemovable_ = call (load_sym libgio "g_drive_is_media_removable") (GioDriveClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
