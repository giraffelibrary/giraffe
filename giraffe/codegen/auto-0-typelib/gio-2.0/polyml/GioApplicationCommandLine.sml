structure GioApplicationCommandLine :>
  ...
  struct
    ...
    in
      ...
      val getCwd_ = call (load_sym libgio "g_application_command_line_get_cwd") (GObjectObjectClass.PolyML.PTR --> Utf8.PolyML.RETPTR)
      val getExitStatus_ = call (load_sym libgio "g_application_command_line_get_exit_status") (GObjectObjectClass.PolyML.PTR --> FFI.Int32.PolyML.VAL)
      ...
      val getenv_ = call (load_sym libgio "g_application_command_line_getenv") (GObjectObjectClass.PolyML.PTR &&> Utf8.PolyML.INPTR --> Utf8.PolyML.RETPTR)
      val setExitStatus_ = call (load_sym libgio "g_application_command_line_set_exit_status") (GObjectObjectClass.PolyML.PTR &&> FFI.Int32.PolyML.VAL --> FFI.PolyML.VOID)
    end
