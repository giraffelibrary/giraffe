structure GioSimpleAsyncResult :>
  ...
  struct
    ...
    in
      ...
      val setOpResGssize_ = call (load_sym libgio "g_simple_async_result_set_op_res_gssize") (GioSimpleAsyncResultClass.PolyML.cPtr &&> FFI.Int64.PolyML.cVal --> FFI.PolyML.cVoid)
    end
