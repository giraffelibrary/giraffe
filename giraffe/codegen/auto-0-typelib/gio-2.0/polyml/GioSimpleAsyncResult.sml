structure GioSimpleAsyncResult :>
  ...
  struct
    ...
    in
      ...
      val getOpResGssize_ = call (load_sym libgio "g_simple_async_result_get_op_res_gssize") (GioSimpleAsyncResultClass.PolyML.cPtr --> GInt64.PolyML.cVal)
      ...
      val setOpResGssize_ = call (load_sym libgio "g_simple_async_result_set_op_res_gssize") (GioSimpleAsyncResultClass.PolyML.cPtr &&> GInt64.PolyML.cVal --> PolyMLFFI.cVoid)
    end
