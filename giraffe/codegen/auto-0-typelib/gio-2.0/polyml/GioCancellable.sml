structure GioCancellable :>
  ...
  struct
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "g_cancellable_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
      val new_ = call (getSymbol "g_cancellable_new") (PolyMLFFI.cVoid --> GioCancellableClass.PolyML.cPtr)
      val getCurrent_ = call (getSymbol "g_cancellable_get_current") (PolyMLFFI.cVoid --> GioCancellableClass.PolyML.cPtr)
      val cancel_ = call (getSymbol "g_cancellable_cancel") (GioCancellableClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val disconnect_ = call (getSymbol "g_cancellable_disconnect") (GioCancellableClass.PolyML.cPtr &&> GUInt64.PolyML.cVal --> PolyMLFFI.cVoid)
      ...
      val popCurrent_ = call (getSymbol "g_cancellable_pop_current") (GioCancellableClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val pushCurrent_ = call (getSymbol "g_cancellable_push_current") (GioCancellableClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val releaseFd_ = call (getSymbol "g_cancellable_release_fd") (GioCancellableClass.PolyML.cPtr --> PolyMLFFI.cVoid)
      val reset_ = call (getSymbol "g_cancellable_reset") (GioCancellableClass.PolyML.cPtr --> PolyMLFFI.cVoid)
