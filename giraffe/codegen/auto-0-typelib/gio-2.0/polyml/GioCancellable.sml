structure GioCancellable :>
  ...
  struct
    ...
    in
      ...
      val disconnect_ = call (load_sym libgio "g_cancellable_disconnect") (GioCancellableClass.PolyML.cPtr &&> GUInt64.PolyML.cVal --> PolyMLFFI.cVoid)
      val getFd_ = call (load_sym libgio "g_cancellable_get_fd") (GioCancellableClass.PolyML.cPtr --> GInt32.PolyML.cVal)
