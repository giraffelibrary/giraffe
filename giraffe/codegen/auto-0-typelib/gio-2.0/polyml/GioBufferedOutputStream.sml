structure GioBufferedOutputStream :>
  ...
  struct
    ...
    in
      ...
      val newSized_ = call (load_sym libgio "g_buffered_output_stream_new_sized") (GioOutputStreamClass.PolyML.cPtr &&> GUInt64.PolyML.cVal --> GioOutputStreamClass.PolyML.cPtr)
      ...
      val getBufferSize_ = call (load_sym libgio "g_buffered_output_stream_get_buffer_size") (GioBufferedOutputStreamClass.PolyML.cPtr --> GUInt64.PolyML.cVal)
      ...
      val setBufferSize_ = call (load_sym libgio "g_buffered_output_stream_set_buffer_size") (GioBufferedOutputStreamClass.PolyML.cPtr &&> GUInt64.PolyML.cVal --> PolyMLFFI.cVoid)
    end
