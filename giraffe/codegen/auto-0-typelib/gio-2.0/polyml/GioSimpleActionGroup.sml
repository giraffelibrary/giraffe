structure GioSimpleActionGroup :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgio "g_simple_action_group_new") (FFI.PolyML.cVoid --> GioSimpleActionGroupClass.PolyML.cPtr)
      val insert_ = call (load_sym libgio "g_simple_action_group_insert") (GioSimpleActionGroupClass.PolyML.cPtr &&> GioActionClass.PolyML.cPtr --> FFI.PolyML.cVoid)
      ...
      val remove_ = call (load_sym libgio "g_simple_action_group_remove") (GioSimpleActionGroupClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> FFI.PolyML.cVoid)
    end
