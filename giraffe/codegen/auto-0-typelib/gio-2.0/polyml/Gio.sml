structure Gio : GIO =
  struct
    local
      open PolyMLFFI
    in
      val actionNameIsValid_ = call (getSymbol "g_action_name_is_valid") (Utf8.PolyML.cInPtr --> GBool.PolyML.cVal)
      ...
      val actionPrintDetailedName_ = call (getSymbol "g_action_print_detailed_name") (Utf8.PolyML.cInPtr &&> GLibVariantRecord.PolyML.cOptPtr --> Utf8.PolyML.cOutPtr)
      ...
      val appInfoGetDefaultForType_ = call (getSymbol "g_app_info_get_default_for_type") (Utf8.PolyML.cInPtr &&> GBool.PolyML.cVal --> GioAppInfoClass.PolyML.cPtr)
      val appInfoGetDefaultForUriScheme_ = call (getSymbol "g_app_info_get_default_for_uri_scheme") (Utf8.PolyML.cInPtr --> GioAppInfoClass.PolyML.cPtr)
      ...
      val appInfoLaunchDefaultForUriFinish_ = call (getSymbol "g_app_info_launch_default_for_uri_finish") (GioAsyncResultClass.PolyML.cPtr &&> GLibErrorRecord.PolyML.cOutOptRef --> GBool.PolyML.cVal)
      val appInfoResetTypeAssociations_ = call (getSymbol "g_app_info_reset_type_associations") (Utf8.PolyML.cInPtr --> cVoid)
      ...
      val busUnownName_ = call (getSymbol "g_bus_unown_name") (GUInt32.PolyML.cVal --> cVoid)
      val busUnwatchName_ = call (getSymbol "g_bus_unwatch_name") (GUInt32.PolyML.cVal --> cVoid)
      ...
      val fileNewForCommandlineArg_ = call (getSymbol "g_file_new_for_commandline_arg") (Utf8.PolyML.cInPtr --> GioFileClass.PolyML.cPtr)
      val fileNewForCommandlineArgAndCwd_ = call (getSymbol "g_file_new_for_commandline_arg_and_cwd") (Utf8.PolyML.cInPtr &&> Utf8.PolyML.cInPtr --> GioFileClass.PolyML.cPtr)
      val fileNewForPath_ = call (getSymbol "g_file_new_for_path") (Utf8.PolyML.cInPtr --> GioFileClass.PolyML.cPtr)
      val fileNewForUri_ = call (getSymbol "g_file_new_for_uri") (Utf8.PolyML.cInPtr --> GioFileClass.PolyML.cPtr)
      val fileNewTmp_ =
        call (getSymbol "g_file_new_tmp")
          (
            Utf8.PolyML.cInOptPtr
             &&> GioFileIOStreamClass.PolyML.cOutRef
             &&> GLibErrorRecord.PolyML.cOutOptRef
      ...
      val ioExtensionPointLookup_ = call (getSymbol "g_io_extension_point_lookup") (Utf8.PolyML.cInPtr --> GioIOExtensionPointRecord.PolyML.cPtr)
      val ioExtensionPointRegister_ = call (getSymbol "g_io_extension_point_register") (Utf8.PolyML.cInPtr --> GioIOExtensionPointRecord.PolyML.cPtr)
      ...
      val networkMonitorGetDefault_ = call (getSymbol "g_network_monitor_get_default") (cVoid --> GioNetworkMonitorClass.PolyML.cPtr)
      val networkingInit_ = call (getSymbol "g_networking_init") (cVoid --> cVoid)
      val pollableSourceNew_ = call (getSymbol "g_pollable_source_new") (GObjectObjectClass.PolyML.cPtr --> GLibSourceRecord.PolyML.cPtr)
      val pollableSourceNewFull_ =
        call (getSymbol "g_pollable_source_new_full")
          (
            GObjectObjectClass.PolyML.cPtr
             &&> GLibSourceRecord.PolyML.cOptPtr
             &&> GioCancellableClass.PolyML.cOptPtr
      ...
      val proxyGetDefaultForProtocol_ = call (getSymbol "g_proxy_get_default_for_protocol") (Utf8.PolyML.cInPtr --> GioProxyClass.PolyML.cPtr)
      val proxyResolverGetDefault_ = call (getSymbol "g_proxy_resolver_get_default") (cVoid --> GioProxyResolverClass.PolyML.cPtr)
      val resolverErrorQuark_ = call (getSymbol "g_resolver_error_quark") (cVoid --> GUInt32.PolyML.cVal)
      val resourceErrorQuark_ = call (getSymbol "g_resource_error_quark") (cVoid --> GUInt32.PolyML.cVal)
      val resourceLoad_ = call (getSymbol "g_resource_load") (Utf8.PolyML.cInPtr &&> GLibErrorRecord.PolyML.cOutOptRef --> GioResourceRecord.PolyML.cPtr)
      val resourcesEnumerateChildren_ =
        call (getSymbol "g_resources_enumerate_children")
          (
            Utf8.PolyML.cInPtr
      ...
      val resourcesLookupData_ =
        call (getSymbol "g_resources_lookup_data")
          (
            Utf8.PolyML.cInPtr
             &&> GioResourceLookupFlags.PolyML.cVal
             &&> GLibErrorRecord.PolyML.cOutOptRef
      ...
      val resourcesOpenStream_ =
        call (getSymbol "g_resources_open_stream")
          (
            Utf8.PolyML.cInPtr
             &&> GioResourceLookupFlags.PolyML.cVal
             &&> GLibErrorRecord.PolyML.cOutOptRef
      ...
      val resourcesRegister_ = call (getSymbol "g_resources_register") (GioResourceRecord.PolyML.cPtr --> cVoid)
      val resourcesUnregister_ = call (getSymbol "g_resources_unregister") (GioResourceRecord.PolyML.cPtr --> cVoid)
      val settingsSchemaSourceGetDefault_ = call (getSymbol "g_settings_schema_source_get_default") (cVoid --> GioSettingsSchemaSourceRecord.PolyML.cPtr)
      val tlsBackendGetDefault_ = call (getSymbol "g_tls_backend_get_default") (cVoid --> GioTlsBackendClass.PolyML.cPtr)
      ...
      val tlsErrorQuark_ = call (getSymbol "g_tls_error_quark") (cVoid --> GUInt32.PolyML.cVal)
      val tlsFileDatabaseNew_ = call (getSymbol "g_tls_file_database_new") (Utf8.PolyML.cInPtr &&> GLibErrorRecord.PolyML.cOutOptRef --> GioTlsFileDatabaseClass.PolyML.cPtr)
      ...
      val unixMountCompare_ = call (getSymbol "g_unix_mount_compare") (GioUnixMountEntryRecord.PolyML.cPtr &&> GioUnixMountEntryRecord.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val unixMountGuessSymbolicIcon_ = call (getSymbol "g_unix_mount_guess_symbolic_icon") (GioUnixMountEntryRecord.PolyML.cPtr --> GioIconClass.PolyML.cPtr)
    ...
    fun actionNameIsValid actionName = (Utf8.FFI.withPtr 0 ---> GBool.FFI.fromVal) actionNameIsValid_ actionName
    ...
    fun actionPrintDetailedName (actionName, targetValue) = (Utf8.FFI.withPtr 0 &&&> GLibVariantRecord.FFI.withOptPtr false ---> Utf8.FFI.fromPtr ~1) actionPrintDetailedName_ (actionName & targetValue)
    ...
    fun appInfoGetDefaultForType (contentType, mustSupportUris) = (Utf8.FFI.withPtr 0 &&&> GBool.FFI.withVal ---> GioAppInfoClass.FFI.fromPtr true) appInfoGetDefaultForType_ (contentType & mustSupportUris)
    fun appInfoGetDefaultForUriScheme uriScheme = (Utf8.FFI.withPtr 0 ---> GioAppInfoClass.FFI.fromPtr true) appInfoGetDefaultForUriScheme_ uriScheme
    ...
    fun appInfoLaunchDefaultForUriFinish result = (GioAsyncResultClass.FFI.withPtr false &&&> GLibErrorRecord.handleError ---> ignore) appInfoLaunchDefaultForUriFinish_ (result & [])
    fun appInfoResetTypeAssociations contentType = (Utf8.FFI.withPtr 0 ---> I) appInfoResetTypeAssociations_ contentType
    ...
    fun fileNewForCommandlineArg arg = (Utf8.FFI.withPtr 0 ---> GioFileClass.FFI.fromPtr true) fileNewForCommandlineArg_ arg
    fun fileNewForCommandlineArgAndCwd (arg, cwd) = (Utf8.FFI.withPtr 0 &&&> Utf8.FFI.withPtr 0 ---> GioFileClass.FFI.fromPtr true) fileNewForCommandlineArgAndCwd_ (arg & cwd)
    fun fileNewForPath path = (Utf8.FFI.withPtr 0 ---> GioFileClass.FFI.fromPtr true) fileNewForPath_ path
    fun fileNewForUri uri = (Utf8.FFI.withPtr 0 ---> GioFileClass.FFI.fromPtr true) fileNewForUri_ uri
    fun fileNewTmp tmpl =
      let
        val iostream & retVal =
          (
    ...
    fun fileParseName parseName = (Utf8.FFI.withPtr 0 ---> GioFileClass.FFI.fromPtr true) fileParseName_ parseName
    fun iconDeserialize value = (GLibVariantRecord.FFI.withPtr false ---> GioIconClass.FFI.fromPtr true) iconDeserialize_ value
    ...
    fun proxyGetDefaultForProtocol protocol = (Utf8.FFI.withPtr 0 ---> GioProxyClass.FFI.fromPtr true) proxyGetDefaultForProtocol_ protocol
    ...
    fun resourceLoad filename = (Utf8.FFI.withPtr 0 &&&> GLibErrorRecord.handleError ---> GioResourceRecord.FFI.fromPtr true) resourceLoad_ (filename & [])
    ...
    fun tlsFileDatabaseNew anchors = (Utf8.FFI.withPtr 0 &&&> GLibErrorRecord.handleError ---> GioTlsFileDatabaseClass.FFI.fromPtr true) tlsFileDatabaseNew_ (anchors & [])
