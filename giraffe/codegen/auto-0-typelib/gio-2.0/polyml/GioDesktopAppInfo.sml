structure GioDesktopAppInfo :>
  ...
  struct
    ...
    in
      ...
      val getIsHidden_ = call (load_sym libgio "g_desktop_app_info_get_is_hidden") (GioDesktopAppInfoClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val getNodisplay_ = call (load_sym libgio "g_desktop_app_info_get_nodisplay") (GioDesktopAppInfoClass.PolyML.cPtr --> FFI.Bool.PolyML.cVal)
      val getShowIn_ = call (load_sym libgio "g_desktop_app_info_get_show_in") (GioDesktopAppInfoClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> FFI.Bool.PolyML.cVal)
    end
