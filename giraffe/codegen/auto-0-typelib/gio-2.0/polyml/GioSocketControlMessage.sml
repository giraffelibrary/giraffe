structure GioSocketControlMessage :>
  ...
  struct
    ...
    in
      ...
      val getLevel_ = call (load_sym libgio "g_socket_control_message_get_level") (GioSocketControlMessageClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getMsgType_ = call (load_sym libgio "g_socket_control_message_get_msg_type") (GioSocketControlMessageClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getSize_ = call (load_sym libgio "g_socket_control_message_get_size") (GioSocketControlMessageClass.PolyML.cPtr --> GUInt64.PolyML.cVal)
    end
