structure GioBusNameOwnerFlags :> GIO_BUS_NAME_OWNER_FLAGS =
  struct
    local
      fun NONE () = 0w0
    in
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_bus_name_owner_flags_get_type") (PolyMLFFI.cVoid --> GObjectType.PolyML.cVal)
