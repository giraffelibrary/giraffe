structure GioDBusPropertyInfoFlags :>
  sig
    include GIO_D_BUS_PROPERTY_INFO_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libgio "g_dbus_property_info_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
