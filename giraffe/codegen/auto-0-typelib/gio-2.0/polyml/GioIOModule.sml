structure GioIOModule :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgio "g_io_module_new") (Utf8.PolyML.INPTR --> GObjectObjectClass.PolyML.PTR)
    ...
    fun new filename = (Utf8.C.withConstPtr ---> GioIOModuleClass.C.fromPtr true) new_ filename
