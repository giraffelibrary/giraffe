structure GioInetSocketAddress :>
  ...
  struct
    ...
    in
      ...
      val newFromString_ = call (getSymbol "g_inet_socket_address_new_from_string") (Utf8.PolyML.cInPtr &&> GUInt32.PolyML.cVal --> GioSocketAddressClass.PolyML.cPtr)
    ...
    fun newFromString (address, port) = (Utf8.FFI.withPtr &&&> GUInt32.FFI.withVal ---> GioInetSocketAddressClass.FFI.fromPtr true) newFromString_ (address & port)
