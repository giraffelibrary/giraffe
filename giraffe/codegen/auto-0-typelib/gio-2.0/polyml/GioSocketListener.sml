structure GioSocketListener :>
  ...
  struct
    ...
    in
      ...
      val setBacklog_ = call (getSymbol "g_socket_listener_set_backlog") (GioSocketListenerClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> cVoid)
    end
    ...
    fun setBacklog self listenBacklog = (GioSocketListenerClass.FFI.withPtr false &&&> GInt32.FFI.withVal ---> I) setBacklog_ (self & listenBacklog)
    local
