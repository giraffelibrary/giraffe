structure GioListModel :>
  ...
  struct
    ...
    val getNItems_ = _import "g_list_model_get_n_items" : GioListModelClass.FFI.notnull GioListModelClass.FFI.p -> GUInt32.FFI.val_;
    val getItem_ = fn x1 & x2 => (_import "g_list_model_get_object" : GioListModelClass.FFI.notnull GioListModelClass.FFI.p * GUInt32.FFI.val_ -> unit GObjectObjectClass.FFI.p;) (x1, x2)
    val itemsChanged_ =
      fn
        x1
         & x2
