structure GioListModel :>
  ...
  struct
    ...
    val getNItems_ = _import "g_list_model_get_n_items" : GioListModelClass.FFI.non_opt GioListModelClass.FFI.p -> GUInt32.FFI.val_;
    val getItem_ = fn x1 & x2 => (_import "g_list_model_get_object" : GioListModelClass.FFI.non_opt GioListModelClass.FFI.p * GUInt32.FFI.val_ -> GObjectObjectClass.FFI.opt GObjectObjectClass.FFI.p;) (x1, x2)
    val itemsChanged_ =
      fn
        x1
         & x2
    ...
    fun getNItems self = (GioListModelClass.FFI.withPtr false ---> GUInt32.FFI.fromVal) getNItems_ self
    fun getItem self position = (GioListModelClass.FFI.withPtr false &&&> GUInt32.FFI.withVal ---> GObjectObjectClass.FFI.fromOptPtr true) getItem_ (self & position)
    fun itemsChanged
      self
      (
        position,
