structure GioMenuModel :>
  ...
  struct
    ...
    val getNItems_ = _import "g_menu_model_get_n_items" : GioMenuModelClass.FFI.notnull GioMenuModelClass.FFI.p -> GInt32.FFI.val_;
    ...
    val iterateItemAttributes_ = fn x1 & x2 => (_import "g_menu_model_iterate_item_attributes" : GioMenuModelClass.FFI.notnull GioMenuModelClass.FFI.p * GInt32.FFI.val_ -> GioMenuAttributeIterClass.FFI.notnull GioMenuAttributeIterClass.FFI.p;) (x1, x2)
    val iterateItemLinks_ = fn x1 & x2 => (_import "g_menu_model_iterate_item_links" : GioMenuModelClass.FFI.notnull GioMenuModelClass.FFI.p * GInt32.FFI.val_ -> GioMenuLinkIterClass.FFI.notnull GioMenuLinkIterClass.FFI.p;) (x1, x2)
