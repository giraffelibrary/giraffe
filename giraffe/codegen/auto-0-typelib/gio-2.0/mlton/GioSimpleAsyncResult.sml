structure GioSimpleAsyncResult :>
  ...
  struct
    ...
    val getOpResGssize_ = _import "g_simple_async_result_get_op_res_gssize" : GioSimpleAsyncResultClass.FFI.notnull GioSimpleAsyncResultClass.FFI.p -> GInt64.FFI.val_;
    ...
    val setCheckCancellable_ = fn x1 & x2 => (_import "g_simple_async_result_set_check_cancellable" : GioSimpleAsyncResultClass.FFI.notnull GioSimpleAsyncResultClass.FFI.p * unit GioCancellableClass.FFI.p -> unit;) (x1, x2)
    ...
    val setOpResGssize_ = fn x1 & x2 => (_import "g_simple_async_result_set_op_res_gssize" : GioSimpleAsyncResultClass.FFI.notnull GioSimpleAsyncResultClass.FFI.p * GInt64.FFI.val_ -> unit;) (x1, x2)
