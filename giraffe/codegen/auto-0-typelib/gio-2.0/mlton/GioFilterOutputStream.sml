structure GioFilterOutputStream :>
  ...
  struct
    ...
    val getBaseStream_ = _import "g_filter_output_stream_get_base_stream" : GioFilterOutputStreamClass.C.notnull GioFilterOutputStreamClass.C.p -> GioOutputStreamClass.C.notnull GioOutputStreamClass.C.p;
    val getCloseBaseStream_ = _import "g_filter_output_stream_get_close_base_stream" : GioFilterOutputStreamClass.C.notnull GioFilterOutputStreamClass.C.p -> FFI.Bool.C.val_;
    val setCloseBaseStream_ = fn x1 & x2 => (_import "g_filter_output_stream_set_close_base_stream" : GioFilterOutputStreamClass.C.notnull GioFilterOutputStreamClass.C.p * FFI.Bool.C.val_ -> unit;) (x1, x2)
