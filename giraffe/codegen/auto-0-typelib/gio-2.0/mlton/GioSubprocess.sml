structure GioSubprocess :>
  ...
  struct
    ...
    val getExitStatus_ = _import "g_subprocess_get_exit_status" : GioSubprocessClass.FFI.notnull GioSubprocessClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getStatus_ = _import "g_subprocess_get_status" : GioSubprocessClass.FFI.notnull GioSubprocessClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getTermSig_ = _import "g_subprocess_get_term_sig" : GioSubprocessClass.FFI.notnull GioSubprocessClass.FFI.p -> GInt32.FFI.val_;
    val sendSignal_ = fn x1 & x2 => (_import "g_subprocess_send_signal" : GioSubprocessClass.FFI.notnull GioSubprocessClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    val wait_ =
      fn
        x1
         & x2
