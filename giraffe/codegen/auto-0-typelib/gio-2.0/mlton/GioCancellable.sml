structure GioCancellable :>
  ...
  struct
    ...
    val disconnect_ = fn x1 & x2 => (_import "g_cancellable_disconnect" : GioCancellableClass.C.notnull GioCancellableClass.C.p * FFI.UInt64.C.val_ -> unit;) (x1, x2)
    val getFd_ = _import "g_cancellable_get_fd" : GioCancellableClass.C.notnull GioCancellableClass.C.p -> FFI.Int32.C.val_;
