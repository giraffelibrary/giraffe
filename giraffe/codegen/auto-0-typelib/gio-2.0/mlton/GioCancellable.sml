structure GioCancellable :>
  ...
  struct
    ...
    val disconnect_ = fn x1 & x2 => (_import "g_cancellable_disconnect" : GioCancellableClass.FFI.notnull GioCancellableClass.FFI.p * GUInt64.FFI.val_ -> unit;) (x1, x2)
    val getFd_ = _import "g_cancellable_get_fd" : GioCancellableClass.FFI.notnull GioCancellableClass.FFI.p -> GInt32.FFI.val_;
