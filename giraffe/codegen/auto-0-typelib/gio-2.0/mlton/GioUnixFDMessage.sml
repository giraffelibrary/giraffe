structure GioUnixFDMessage :>
  ...
  struct
    ...
    val stealFds_ = fn x1 & x2 => (_import "g_unix_fd_message_steal_fds" : GioUnixFDMessageClass.FFI.notnull GioUnixFDMessageClass.FFI.p * GInt32.FFI.ref_ -> GInt32CArrayN.FFI.notnull GInt32CArrayN.FFI.out_p;) (x1, x2)
