structure GioBufferedInputStream :>
  ...
  struct
    ...
    val newSized_ = fn x1 & x2 => (_import "g_buffered_input_stream_new_sized" : GioInputStreamClass.FFI.non_opt GioInputStreamClass.FFI.p * GUInt64.FFI.val_ -> GioInputStreamClass.FFI.non_opt GioInputStreamClass.FFI.p;) (x1, x2)
    val fill_ =
      fn
        x1
         & x2
    ...
    val getAvailable_ = _import "g_buffered_input_stream_get_available" : GioBufferedInputStreamClass.FFI.non_opt GioBufferedInputStreamClass.FFI.p -> GUInt64.FFI.val_;
    val getBufferSize_ = _import "g_buffered_input_stream_get_buffer_size" : GioBufferedInputStreamClass.FFI.non_opt GioBufferedInputStreamClass.FFI.p -> GUInt64.FFI.val_;
    val peek_ =
      fn
        x1
         & (x2, x3)
    ...
    val peekBuffer_ = fn x1 & x2 => (_import "g_buffered_input_stream_peek_buffer" : GioBufferedInputStreamClass.FFI.non_opt GioBufferedInputStreamClass.FFI.p * GUInt64.FFI.ref_ -> GUInt8CArrayN.FFI.non_opt GUInt8CArrayN.FFI.out_p;) (x1, x2)
    val readByte_ =
      fn
        x1
         & x2
    ...
    val setBufferSize_ = fn x1 & x2 => (_import "g_buffered_input_stream_set_buffer_size" : GioBufferedInputStreamClass.FFI.non_opt GioBufferedInputStreamClass.FFI.p * GUInt64.FFI.val_ -> unit;) (x1, x2)
