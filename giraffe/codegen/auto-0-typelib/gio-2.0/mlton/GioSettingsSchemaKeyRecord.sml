structure GioSettingsSchemaKeyRecord :> GIO_SETTINGS_SCHEMA_KEY_RECORD =
  struct
    structure Pointer = CPointerInternal
    type opt = Pointer.opt
    type non_opt = Pointer.non_opt
    type 'a p = 'a Pointer.p
    val dup_ = _import "g_settings_schema_key_ref" : non_opt p -> non_opt p;
    val free_ = _import "g_settings_schema_key_unref" : non_opt p -> unit;
    structure Record =
      BoxedRecord(
