structure GioMenuItem :>
  ...
  struct
    ...
    val newFromModel_ = fn x1 & x2 => (_import "g_menu_item_new_from_model" : GioMenuModelClass.FFI.non_opt GioMenuModelClass.FFI.p * GInt32.FFI.val_ -> GioMenuItemClass.FFI.non_opt GioMenuItemClass.FFI.p;) (x1, x2)
    val newSection_ =
      fn
        (x1, x2) & x3 =>
          (
