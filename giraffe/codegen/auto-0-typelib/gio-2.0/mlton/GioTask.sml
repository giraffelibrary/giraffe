structure GioTask :>
  ...
  struct
    ...
    val getPriority_ = _import "g_task_get_priority" : GioTaskClass.FFI.notnull GioTaskClass.FFI.p -> GInt32.FFI.val_;
    ...
    val propagateInt_ = fn x1 & x2 => (_import "g_task_propagate_int" : GioTaskClass.FFI.notnull GioTaskClass.FFI.p * (unit, unit) GLibErrorRecord.FFI.r -> GInt64.FFI.val_;) (x1, x2)
    ...
    val returnInt_ = fn x1 & x2 => (_import "g_task_return_int" : GioTaskClass.FFI.notnull GioTaskClass.FFI.p * GInt64.FFI.val_ -> unit;) (x1, x2)
    ...
    val setPriority_ = fn x1 & x2 => (_import "g_task_set_priority" : GioTaskClass.FFI.notnull GioTaskClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
