structure GioTask :>
  ...
  struct
    ...
    val getPriority_ = _import "g_task_get_priority" : GioTaskClass.FFI.non_opt GioTaskClass.FFI.p -> GInt32.FFI.val_;
    ...
    val propagateInt_ = fn x1 & x2 => (_import "g_task_propagate_int" : GioTaskClass.FFI.non_opt GioTaskClass.FFI.p * (GLibErrorRecord.FFI.opt, GLibErrorRecord.FFI.opt) GLibErrorRecord.FFI.r -> GInt64.FFI.val_;) (x1, x2)
    ...
    val returnInt_ = fn x1 & x2 => (_import "g_task_return_int" : GioTaskClass.FFI.non_opt GioTaskClass.FFI.p * GInt64.FFI.val_ -> unit;) (x1, x2)
    ...
    val setPriority_ = fn x1 & x2 => (_import "g_task_set_priority" : GioTaskClass.FFI.non_opt GioTaskClass.FFI.p * GInt32.FFI.val_ -> unit;) (x1, x2)
    ...
    fun getPriority self = (GioTaskClass.FFI.withPtr ---> GInt32.FFI.fromVal) getPriority_ self
    ...
    fun propagateInt self = (GioTaskClass.FFI.withPtr &&&> GLibErrorRecord.handleError ---> GInt64.FFI.fromVal) propagateInt_ (self & [])
    ...
    fun returnInt self result = (GioTaskClass.FFI.withPtr &&&> GInt64.FFI.withVal ---> I) returnInt_ (self & result)
    ...
    fun setPriority self priority = (GioTaskClass.FFI.withPtr &&&> GInt32.FFI.withVal ---> I) setPriority_ (self & priority)
