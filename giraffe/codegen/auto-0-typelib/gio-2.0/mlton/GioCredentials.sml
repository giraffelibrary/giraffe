structure GioCredentials :>
  ...
  struct
    ...
    val getUnixPid_ = fn x1 & x2 => (_import "g_credentials_get_unix_pid" : GioCredentialsClass.FFI.notnull GioCredentialsClass.FFI.p * (unit, unit) GLibErrorRecord.FFI.r -> GInt32.FFI.val_;) (x1, x2)
