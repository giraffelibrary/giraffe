structure GioCredentials :>
  ...
  struct
    ...
    val getUnixPid_ = fn x1 & x2 => (_import "g_credentials_get_unix_pid" : GioCredentialsClass.FFI.non_opt GioCredentialsClass.FFI.p * (GLibErrorRecord.FFI.opt, GLibErrorRecord.FFI.opt) GLibErrorRecord.FFI.r -> GInt32.FFI.val_;) (x1, x2)
    val getUnixUser_ = fn x1 & x2 => (_import "g_credentials_get_unix_user" : GioCredentialsClass.FFI.non_opt GioCredentialsClass.FFI.p * (GLibErrorRecord.FFI.opt, GLibErrorRecord.FFI.opt) GLibErrorRecord.FFI.r -> GUInt32.FFI.val_;) (x1, x2)
    val isSameUser_ =
      fn
        x1
         & x2
