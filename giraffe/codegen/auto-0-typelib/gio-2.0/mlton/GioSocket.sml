structure GioSocket :>
  ...
  struct
    ...
    val getAvailableBytes_ = _import "g_socket_get_available_bytes" : GioSocketClass.FFI.notnull GioSocketClass.FFI.p -> GInt64.FFI.val_;
    ...
    val getMulticastTtl_ = _import "g_socket_get_multicast_ttl" : GioSocketClass.FFI.notnull GioSocketClass.FFI.p -> GUInt32.FFI.val_;
    val getOption_ =
      fn
        x1
         & x2
    ...
    val getTtl_ = _import "g_socket_get_ttl" : GioSocketClass.FFI.notnull GioSocketClass.FFI.p -> GUInt32.FFI.val_;
    ...
    val setMulticastTtl_ = fn x1 & x2 => (_import "g_socket_set_multicast_ttl" : GioSocketClass.FFI.notnull GioSocketClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val setOption_ =
      fn
        x1
         & x2
    ...
    val setTtl_ = fn x1 & x2 => (_import "g_socket_set_ttl" : GioSocketClass.FFI.notnull GioSocketClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
    val shutdown_ =
      fn
        x1
         & x2
    ...
    fun getAvailableBytes self = (GioSocketClass.FFI.withPtr ---> GInt64.FFI.fromVal) getAvailableBytes_ self
    ...
    fun getMulticastTtl self = (GioSocketClass.FFI.withPtr ---> GUInt32.FFI.fromVal) getMulticastTtl_ self
    ...
    fun getTtl self = (GioSocketClass.FFI.withPtr ---> GUInt32.FFI.fromVal) getTtl_ self
    ...
    fun setMulticastTtl self ttl = (GioSocketClass.FFI.withPtr &&&> GUInt32.FFI.withVal ---> I) setMulticastTtl_ (self & ttl)
    fun setOption
      self
      (
        level,
    ...
    fun setTtl self ttl = (GioSocketClass.FFI.withPtr &&&> GUInt32.FFI.withVal ---> I) setTtl_ (self & ttl)
