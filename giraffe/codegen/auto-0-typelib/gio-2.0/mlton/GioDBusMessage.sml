structure GioDBusMessage :>
  ...
  struct
    ...
    val getArg0_ = _import "g_dbus_message_get_arg0" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val getDestination_ = _import "g_dbus_message_get_destination" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getErrorName_ = _import "g_dbus_message_get_error_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val getInterface_ = _import "g_dbus_message_get_interface" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getLocked_ = _import "g_dbus_message_get_locked" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.C.val_;
    val getMember_ = _import "g_dbus_message_get_member" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val getPath_ = _import "g_dbus_message_get_path" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val getSender_ = _import "g_dbus_message_get_sender" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    val getSerial_ = _import "g_dbus_message_get_serial" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.UInt32.C.val_;
    val getSignature_ = _import "g_dbus_message_get_signature" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> Utf8.C.notnull Utf8.C.out_p;
    ...
    val print_ = fn x1 & x2 => (_import "g_dbus_message_print" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.UInt32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
