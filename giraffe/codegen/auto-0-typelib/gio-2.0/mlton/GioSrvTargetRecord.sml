structure GioSrvTargetRecord :> GIO_SRV_TARGET_RECORD =
  struct
    structure Pointer = CPointerInternal
    type notnull = Pointer.notnull
    type 'a p = 'a Pointer.p
    val dup_ = _import "g_srv_target_copy" : notnull p -> notnull p;
    val free_ = _import "g_srv_target_free" : notnull p -> unit;
    structure Record =
      BoxedRecord(
