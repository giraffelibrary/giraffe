structure GioApplicationCommandLine :>
  ...
  struct
    ...
    val getExitStatus_ = _import "g_application_command_line_get_exit_status" : GioApplicationCommandLineClass.C.notnull GioApplicationCommandLineClass.C.p -> FFI.Int32.C.val_;
    ...
    val setExitStatus_ = fn x1 & x2 => (_import "g_application_command_line_set_exit_status" : GioApplicationCommandLineClass.C.notnull GioApplicationCommandLineClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    ...
    fun getExitStatus self = (GioApplicationCommandLineClass.C.withPtr ---> FFI.Int32.C.fromVal) getExitStatus_ self
    ...
    fun setExitStatus self exitStatus = (GioApplicationCommandLineClass.C.withPtr &&&> FFI.Int32.C.withVal ---> I) setExitStatus_ (self & exitStatus)
    local
      open Property
    in
