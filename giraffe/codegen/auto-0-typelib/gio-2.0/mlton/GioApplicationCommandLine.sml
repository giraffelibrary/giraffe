structure GioApplicationCommandLine :>
  ...
  struct
    ...
    fun getArguments self =
      let
        val argc & retVal = (GioApplicationCommandLineClass.FFI.withPtr &&&> GInt32.FFI.withRefVal ---> GInt32.FFI.fromVal && Utf8CPtrArrayN.FFI.fromPtr 2) getArguments_ (self & GInt32.null)
      in
