structure GioApplicationCommandLine :>
  ...
  struct
    ...
    val getArguments_ = fn x1 & x2 => (_import "g_application_command_line_get_arguments" : GioApplicationCommandLineClass.FFI.notnull GioApplicationCommandLineClass.FFI.p * GInt32.FFI.ref_ -> Utf8CArrayN.FFI.notnull Utf8CArrayN.FFI.out_p;) (x1, x2)
    ...
    val getEnviron_ = _import "g_application_command_line_get_environ" : GioApplicationCommandLineClass.FFI.notnull GioApplicationCommandLineClass.FFI.p -> Utf8CArray.FFI.notnull Utf8CArray.FFI.out_p;
    ...
    fun getArguments self =
      let
        val argc & retVal = (GioApplicationCommandLineClass.FFI.withPtr &&&> GInt32.FFI.withRefVal ---> GInt32.FFI.fromVal && Utf8CArrayN.FFI.fromPtr 2) getArguments_ (self & GInt32.null)
      in
