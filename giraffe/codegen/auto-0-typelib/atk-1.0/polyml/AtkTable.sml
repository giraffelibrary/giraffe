structure AtkTable :>
  ...
  struct
    ...
    in
      ...
      val getColumnHeader_ = call (getSymbol "atk_table_get_column_header") (AtkTableClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> AtkObjectClass.PolyML.cPtr)
      val getIndexAt_ =
      ...
      val getRowDescription_ = call (getSymbol "atk_table_get_row_description") (AtkTableClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> Utf8.PolyML.cOutPtr)
      val getRowExtentAt_ =
      ...
      val getRowHeader_ = call (getSymbol "atk_table_get_row_header") (AtkTableClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> AtkObjectClass.PolyML.cPtr)
