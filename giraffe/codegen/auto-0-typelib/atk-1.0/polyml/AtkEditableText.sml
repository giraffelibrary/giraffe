structure AtkEditableText :>
  ...
  struct
    ...
    in
      ...
      val pasteText_ = call (load_sym libatk "atk_editable_text_paste_text") (AtkEditableTextClass.PolyML.cPtr &&> FFI.Int32.PolyML.cVal --> FFI.PolyML.cVoid)
      val setTextContents_ = call (load_sym libatk "atk_editable_text_set_text_contents") (AtkEditableTextClass.PolyML.cPtr &&> Utf8.PolyML.cInPtr --> FFI.PolyML.cVoid)
    end
