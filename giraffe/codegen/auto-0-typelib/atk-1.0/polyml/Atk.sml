structure Atk : ATK =
  struct
    ...
    in
      ...
      val removeFocusTracker_ = call (load_sym libatk "atk_remove_focus_tracker") (FFI.UInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val removeGlobalEventListener_ = call (load_sym libatk "atk_remove_global_event_listener") (FFI.UInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val removeKeyEventListener_ = call (load_sym libatk "atk_remove_key_event_listener") (FFI.UInt32.PolyML.cVal --> PolyMLFFI.cVoid)
