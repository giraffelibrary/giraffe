structure Atk : ATK =
  struct
    ...
    in
      ...
      val textAttributeGetValue_ = call (load_sym libatk "atk_text_attribute_get_value") (AtkTextAttribute.PolyML.VAL &&> FFI.Int32.PolyML.VAL --> FFI.String.PolyML.RETPTR)
    ...
    fun textAttributeGetValue attr index = (AtkTextAttribute.C.withVal &&&> FFI.Int32.C.withVal ---> FFI.String.C.fromPtr false) textAttributeGetValue_ (attr & index)
