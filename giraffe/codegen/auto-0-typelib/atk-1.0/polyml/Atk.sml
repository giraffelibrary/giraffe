structure Atk : ATK =
  struct
    ...
    in
      ...
      val removeFocusTracker_ = call (getSymbol "atk_remove_focus_tracker") (GUInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val removeGlobalEventListener_ = call (getSymbol "atk_remove_global_event_listener") (GUInt32.PolyML.cVal --> PolyMLFFI.cVoid)
      val removeKeyEventListener_ = call (getSymbol "atk_remove_key_event_listener") (GUInt32.PolyML.cVal --> PolyMLFFI.cVoid)
