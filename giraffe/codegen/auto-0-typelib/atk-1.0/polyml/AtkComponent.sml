structure AtkComponent :>
  ...
  struct
    ...
    in
      ...
      val getMdiZorder_ = call (load_sym libatk "atk_component_get_mdi_zorder") (GObjectObjectClass.PolyML.cPtr --> FFI.Int32.PolyML.cVal)
      ...
      val removeFocusHandler_ = call (load_sym libatk "atk_component_remove_focus_handler") (GObjectObjectClass.PolyML.cPtr &&> FFI.UInt32.PolyML.cVal --> FFI.PolyML.cVoid)
      val setExtents_ =
