structure AtkHyperlinkStateFlags :>
  sig
    include ATK_HYPERLINK_STATE_FLAGS
    structure PolyML :
      sig
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (load_sym libatk "atk_hyperlink_state_flags_get_type") (FFI.PolyML.cVoid --> GObjectType.PolyML.cVal)
