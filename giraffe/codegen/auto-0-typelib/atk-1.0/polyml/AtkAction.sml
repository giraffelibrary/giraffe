structure AtkAction :>
  ...
  struct
    ...
    in
      ...
      val getLocalizedName_ = call (getSymbol "atk_action_get_localized_name") (AtkActionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> Utf8.PolyML.cOutPtr)
      val getNActions_ = call (getSymbol "atk_action_get_n_actions") (AtkActionClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getName_ = call (getSymbol "atk_action_get_name") (AtkActionClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> Utf8.PolyML.cOutPtr)
      val setDescription_ =
