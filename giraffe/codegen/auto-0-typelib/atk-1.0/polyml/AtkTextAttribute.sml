structure AtkTextAttribute :> ATK_TEXT_ATTRIBUTE =
  struct
    ...
    local
      open PolyMLFFI
    in
      val getType_ = call (getSymbol "atk_text_attribute_get_type") (cVoid --> GObjectType.PolyML.cVal)
    ...
    in
      ...
      val getValue_ = call (getSymbol "atk_text_attribute_get_value") (PolyML.cVal &&> GInt32.PolyML.cVal --> Utf8.PolyML.cOutOptPtr)
