structure AtkText :>
  ...
  struct
    ...
    in
      ...
      val getCaretOffset_ = call (load_sym libatk "atk_text_get_caret_offset") (AtkTextClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getCharacterAtOffset_ = call (load_sym libatk "atk_text_get_character_at_offset") (AtkTextClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> GChar.PolyML.cVal)
      val getCharacterCount_ = call (load_sym libatk "atk_text_get_character_count") (AtkTextClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      val getNSelections_ = call (load_sym libatk "atk_text_get_n_selections") (AtkTextClass.PolyML.cPtr --> GInt32.PolyML.cVal)
      ...
      val removeSelection_ = call (load_sym libatk "atk_text_remove_selection") (AtkTextClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> GBool.PolyML.cVal)
      val setCaretOffset_ = call (load_sym libatk "atk_text_set_caret_offset") (AtkTextClass.PolyML.cPtr &&> GInt32.PolyML.cVal --> GBool.PolyML.cVal)
      val setSelection_ =
