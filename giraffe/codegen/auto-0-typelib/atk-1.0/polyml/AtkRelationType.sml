structure AtkRelationType :>
  ...
  struct
    ...
    local
      open PolyMLFFI
    in
      val forName_ = call (load_sym libatk "atk_relation_type_for_name") (Utf8.PolyML.INPTR --> PolyML.VAL)
      val getName_ = call (load_sym libatk "atk_relation_type_get_name") (PolyML.VAL --> Utf8.PolyML.RETPTR)
