structure AtkTableCell :>
  ...
  struct
    ...
    fun getColumnSpan self = (AtkTableCellClass.FFI.withPtr ---> GInt32.FFI.fromVal) getColumnSpan_ self
    ...
    fun getRowSpan self = (AtkTableCellClass.FFI.withPtr ---> GInt32.FFI.fromVal) getRowSpan_ self
