structure AtkRelationSet :>
  ...
  struct
    ...
    val getNRelations_ = _import "atk_relation_set_get_n_relations" : AtkRelationSetClass.C.notnull AtkRelationSetClass.C.p -> FFI.Int32.C.val_;
    val getRelation_ = fn x1 & x2 => (_import "atk_relation_set_get_relation" : AtkRelationSetClass.C.notnull AtkRelationSetClass.C.p * FFI.Int32.C.val_ -> AtkRelationClass.C.notnull AtkRelationClass.C.p;) (x1, x2)
