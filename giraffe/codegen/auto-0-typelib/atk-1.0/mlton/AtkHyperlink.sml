structure AtkHyperlink :>
  ...
  struct
    ...
    val getEndIndex_ = _import "atk_hyperlink_get_end_index" : AtkHyperlinkClass.FFI.non_opt AtkHyperlinkClass.FFI.p -> GInt32.FFI.val_;
    val getNAnchors_ = _import "atk_hyperlink_get_n_anchors" : AtkHyperlinkClass.FFI.non_opt AtkHyperlinkClass.FFI.p -> GInt32.FFI.val_;
    val getObject_ = fn x1 & x2 => (_import "atk_hyperlink_get_object" : AtkHyperlinkClass.FFI.non_opt AtkHyperlinkClass.FFI.p * GInt32.FFI.val_ -> AtkObjectClass.FFI.non_opt AtkObjectClass.FFI.p;) (x1, x2)
    val getStartIndex_ = _import "atk_hyperlink_get_start_index" : AtkHyperlinkClass.FFI.non_opt AtkHyperlinkClass.FFI.p -> GInt32.FFI.val_;
    val getUri_ = fn x1 & x2 => (_import "atk_hyperlink_get_uri" : AtkHyperlinkClass.FFI.non_opt AtkHyperlinkClass.FFI.p * GInt32.FFI.val_ -> Utf8.FFI.non_opt Utf8.FFI.out_p;) (x1, x2)
