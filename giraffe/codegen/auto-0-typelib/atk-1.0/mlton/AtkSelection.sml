structure AtkSelection :>
  ...
  struct
    ...
    val refSelection_ = fn x1 & x2 => (_import "atk_selection_ref_selection" : AtkSelectionClass.FFI.notnull AtkSelectionClass.FFI.p * GInt32.FFI.val_ -> unit AtkObjectClass.FFI.p;) (x1, x2)
