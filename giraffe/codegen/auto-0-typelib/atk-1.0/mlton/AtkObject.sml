structure AtkObject :>
  ...
  struct
    ...
    val getIndexInParent_ = _import "atk_object_get_index_in_parent" : AtkObjectClass.C.notnull AtkObjectClass.C.p -> FFI.Int32.C.val_;
    val getNAccessibleChildren_ = _import "atk_object_get_n_accessible_children" : AtkObjectClass.C.notnull AtkObjectClass.C.p -> FFI.Int32.C.val_;
    ...
    val refAccessibleChild_ = fn x1 & x2 => (_import "atk_object_ref_accessible_child" : AtkObjectClass.C.notnull AtkObjectClass.C.p * FFI.Int32.C.val_ -> AtkObjectClass.C.notnull AtkObjectClass.C.p;) (x1, x2)
    ...
    val removePropertyChangeHandler_ = fn x1 & x2 => (_import "atk_object_remove_property_change_handler" : AtkObjectClass.C.notnull AtkObjectClass.C.p * FFI.UInt32.C.val_ -> unit;) (x1, x2)
