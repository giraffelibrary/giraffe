structure AtkObject :>
  ...
  struct
    ...
    val getIndexInParent_ = _import "atk_object_get_index_in_parent" : AtkObjectClass.FFI.non_opt AtkObjectClass.FFI.p -> GInt32.FFI.val_;
    val getLayer_ = _import "atk_object_get_layer" : AtkObjectClass.FFI.non_opt AtkObjectClass.FFI.p -> AtkLayer.FFI.val_;
    val getMdiZorder_ = _import "atk_object_get_mdi_zorder" : AtkObjectClass.FFI.non_opt AtkObjectClass.FFI.p -> GInt32.FFI.val_;
    val getNAccessibleChildren_ = _import "atk_object_get_n_accessible_children" : AtkObjectClass.FFI.non_opt AtkObjectClass.FFI.p -> GInt32.FFI.val_;
    ...
    val refAccessibleChild_ = fn x1 & x2 => (_import "atk_object_ref_accessible_child" : AtkObjectClass.FFI.non_opt AtkObjectClass.FFI.p * GInt32.FFI.val_ -> AtkObjectClass.FFI.non_opt AtkObjectClass.FFI.p;) (x1, x2)
    ...
    val removePropertyChangeHandler_ = fn x1 & x2 => (_import "atk_object_remove_property_change_handler" : AtkObjectClass.FFI.non_opt AtkObjectClass.FFI.p * GUInt32.FFI.val_ -> unit;) (x1, x2)
