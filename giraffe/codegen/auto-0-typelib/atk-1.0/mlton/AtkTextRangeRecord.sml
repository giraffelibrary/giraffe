structure AtkTextRangeRecord :> ATK_TEXT_RANGE_RECORD =
  struct
    structure Pointer = CPointer(GMemory)
    type opt = Pointer.opt
    type non_opt = Pointer.non_opt
    type 'a p = 'a Pointer.p
    val dup_ = _import "atk_text_range_copy" : non_opt p -> non_opt p;
    val free_ = _import "atk_text_range_free" : non_opt p -> unit;
    structure Record =
      BoxedRecord(
