structure AtkTable :>
  ...
  struct
    ...
    val getColumnDescription_ = fn x1 & x2 => (_import "atk_table_get_column_description" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
    ...
    val getRowDescription_ = fn x1 & x2 => (_import "atk_table_get_row_description" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
    val getRowExtentAt_ =
      fn
        x1
         & x2
