structure AtkTable :>
  ...
  struct
    ...
    val addColumnSelection_ = fn x1 & x2 => (_import "atk_table_add_column_selection" : AtkTableClass.C.notnull AtkTableClass.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    val addRowSelection_ = fn x1 & x2 => (_import "atk_table_add_row_selection" : AtkTableClass.C.notnull AtkTableClass.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    ...
    val getColumnAtIndex_ = fn x1 & x2 => (_import "atk_table_get_column_at_index" : AtkTableClass.C.notnull AtkTableClass.C.p * FFI.Int32.C.val_ -> FFI.Int32.C.val_;) (x1, x2)
    val getColumnDescription_ = fn x1 & x2 => (_import "atk_table_get_column_description" : AtkTableClass.C.notnull AtkTableClass.C.p * FFI.Int32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
    ...
    val getColumnHeader_ = fn x1 & x2 => (_import "atk_table_get_column_header" : AtkTableClass.C.notnull AtkTableClass.C.p * FFI.Int32.C.val_ -> AtkObjectClass.C.notnull AtkObjectClass.C.p;) (x1, x2)
    val getIndexAt_ =
      fn
        x1
         & x2
    ...
    val getNColumns_ = _import "atk_table_get_n_columns" : AtkTableClass.C.notnull AtkTableClass.C.p -> FFI.Int32.C.val_;
    val getNRows_ = _import "atk_table_get_n_rows" : AtkTableClass.C.notnull AtkTableClass.C.p -> FFI.Int32.C.val_;
    val getRowAtIndex_ = fn x1 & x2 => (_import "atk_table_get_row_at_index" : AtkTableClass.C.notnull AtkTableClass.C.p * FFI.Int32.C.val_ -> FFI.Int32.C.val_;) (x1, x2)
    val getRowDescription_ = fn x1 & x2 => (_import "atk_table_get_row_description" : AtkTableClass.C.notnull AtkTableClass.C.p * FFI.Int32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
    val getRowExtentAt_ =
      fn
        x1
         & x2
    ...
    val getRowHeader_ = fn x1 & x2 => (_import "atk_table_get_row_header" : AtkTableClass.C.notnull AtkTableClass.C.p * FFI.Int32.C.val_ -> AtkObjectClass.C.notnull AtkObjectClass.C.p;) (x1, x2)
    ...
    val isColumnSelected_ = fn x1 & x2 => (_import "atk_table_is_column_selected" : AtkTableClass.C.notnull AtkTableClass.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    val isRowSelected_ = fn x1 & x2 => (_import "atk_table_is_row_selected" : AtkTableClass.C.notnull AtkTableClass.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    val isSelected_ =
      fn
        x1
         & x2
    ...
    val removeColumnSelection_ = fn x1 & x2 => (_import "atk_table_remove_column_selection" : AtkTableClass.C.notnull AtkTableClass.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    val removeRowSelection_ = fn x1 & x2 => (_import "atk_table_remove_row_selection" : AtkTableClass.C.notnull AtkTableClass.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
