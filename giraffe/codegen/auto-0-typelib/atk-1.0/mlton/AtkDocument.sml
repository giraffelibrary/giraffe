structure AtkDocument :>
  ...
  struct
    ...
    val getCurrentPageNumber_ = _import "atk_document_get_current_page_number" : AtkDocumentClass.FFI.non_opt AtkDocumentClass.FFI.p -> GInt32.FFI.val_;
    ...
    val getPageCount_ = _import "atk_document_get_page_count" : AtkDocumentClass.FFI.non_opt AtkDocumentClass.FFI.p -> GInt32.FFI.val_;
