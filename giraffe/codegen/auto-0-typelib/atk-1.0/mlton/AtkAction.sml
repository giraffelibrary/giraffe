structure AtkAction :>
  ...
  struct
    ...
    val doAction_ = fn x1 & x2 => (_import "atk_action_do_action" : AtkActionClass.C.notnull AtkActionClass.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    val getDescription_ = fn x1 & x2 => (_import "atk_action_get_description" : AtkActionClass.C.notnull AtkActionClass.C.p * FFI.Int32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
    val getKeybinding_ = fn x1 & x2 => (_import "atk_action_get_keybinding" : AtkActionClass.C.notnull AtkActionClass.C.p * FFI.Int32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
    val getLocalizedName_ = fn x1 & x2 => (_import "atk_action_get_localized_name" : AtkActionClass.C.notnull AtkActionClass.C.p * FFI.Int32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
    val getNActions_ = _import "atk_action_get_n_actions" : AtkActionClass.C.notnull AtkActionClass.C.p -> FFI.Int32.C.val_;
    val getName_ = fn x1 & x2 => (_import "atk_action_get_name" : AtkActionClass.C.notnull AtkActionClass.C.p * FFI.Int32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
    val setDescription_ =
      fn
        x1
         & x2
