structure AtkAction :>
  ...
  struct
    ...
    val getDescription_ = fn x1 & x2 => (_import "atk_action_get_description" : AtkActionClass.FFI.notnull AtkActionClass.FFI.p * GInt32.FFI.val_ -> Utf8.FFI.notnull Utf8.FFI.out_p;) (x1, x2)
    val getKeybinding_ = fn x1 & x2 => (_import "atk_action_get_keybinding" : AtkActionClass.FFI.notnull AtkActionClass.FFI.p * GInt32.FFI.val_ -> Utf8.FFI.notnull Utf8.FFI.out_p;) (x1, x2)
    val getLocalizedName_ = fn x1 & x2 => (_import "atk_action_get_localized_name" : AtkActionClass.FFI.notnull AtkActionClass.FFI.p * GInt32.FFI.val_ -> Utf8.FFI.notnull Utf8.FFI.out_p;) (x1, x2)
    val getNActions_ = _import "atk_action_get_n_actions" : AtkActionClass.FFI.notnull AtkActionClass.FFI.p -> GInt32.FFI.val_;
    val getName_ = fn x1 & x2 => (_import "atk_action_get_name" : AtkActionClass.FFI.notnull AtkActionClass.FFI.p * GInt32.FFI.val_ -> Utf8.FFI.notnull Utf8.FFI.out_p;) (x1, x2)
    val setDescription_ =
      fn
        x1
         & x2
