structure AtkGObjectAccessible :>
  ...
  struct
    ...
    fun forObject obj = (GObjectObjectClass.FFI.withPtr false ---> AtkObjectClass.FFI.fromPtr false) forObject_ obj before GObjectObjectClass.FFI.touchPtr obj
    fun getObject self = (AtkGObjectAccessibleClass.FFI.withPtr false ---> GObjectObjectClass.FFI.fromPtr false) getObject_ self before AtkGObjectAccessibleClass.FFI.touchPtr self
  end
