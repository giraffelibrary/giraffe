structure AtkMisc :>
  ...
  struct
    ...
    val getInstance_ = _import "atk_misc_get_instance" : unit -> AtkMiscClass.FFI.non_opt AtkMiscClass.FFI.p;
    val threadsEnter_ = _import "atk_misc_threads_enter" : AtkMiscClass.FFI.non_opt AtkMiscClass.FFI.p -> unit;
    val threadsLeave_ = _import "atk_misc_threads_leave" : AtkMiscClass.FFI.non_opt AtkMiscClass.FFI.p -> unit;
