structure AtkHypertext :>
  ...
  struct
    ...
    val getLink_ = fn x1 & x2 => (_import "atk_hypertext_get_link" : AtkHypertextClass.FFI.non_opt AtkHypertextClass.FFI.p * GInt32.FFI.val_ -> AtkHyperlinkClass.FFI.non_opt AtkHyperlinkClass.FFI.p;) (x1, x2)
    val getLinkIndex_ = fn x1 & x2 => (_import "atk_hypertext_get_link_index" : AtkHypertextClass.FFI.non_opt AtkHypertextClass.FFI.p * GInt32.FFI.val_ -> GInt32.FFI.val_;) (x1, x2)
    val getNLinks_ = _import "atk_hypertext_get_n_links" : AtkHypertextClass.FFI.non_opt AtkHypertextClass.FFI.p -> GInt32.FFI.val_;
