structure AtkHypertext :>
  ...
  struct
    ...
    val getLink_ = fn x1 & x2 => (_import "atk_hypertext_get_link" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.C.val_ -> GObjectObjectClass.C.notnull GObjectObjectClass.C.p;) (x1, x2)
    val getLinkIndex_ = fn x1 & x2 => (_import "atk_hypertext_get_link_index" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.C.val_ -> FFI.Int32.C.val_;) (x1, x2)
    val getNLinks_ = _import "atk_hypertext_get_n_links" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.C.val_;
