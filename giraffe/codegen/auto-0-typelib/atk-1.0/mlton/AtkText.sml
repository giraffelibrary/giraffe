structure AtkText :>
  ...
  struct
    ...
    val getCaretOffset_ = _import "atk_text_get_caret_offset" : AtkTextClass.C.notnull AtkTextClass.C.p -> FFI.Int32.C.val_;
    val getCharacterAtOffset_ = fn x1 & x2 => (_import "atk_text_get_character_at_offset" : AtkTextClass.C.notnull AtkTextClass.C.p * FFI.Int32.C.val_ -> FFI.Char.C.val_;) (x1, x2)
    val getCharacterCount_ = _import "atk_text_get_character_count" : AtkTextClass.C.notnull AtkTextClass.C.p -> FFI.Int32.C.val_;
    val getNSelections_ = _import "atk_text_get_n_selections" : AtkTextClass.C.notnull AtkTextClass.C.p -> FFI.Int32.C.val_;
    ...
    val removeSelection_ = fn x1 & x2 => (_import "atk_text_remove_selection" : AtkTextClass.C.notnull AtkTextClass.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    val setCaretOffset_ = fn x1 & x2 => (_import "atk_text_set_caret_offset" : AtkTextClass.C.notnull AtkTextClass.C.p * FFI.Int32.C.val_ -> FFI.Bool.C.val_;) (x1, x2)
    val setSelection_ =
      fn
        x1
         & x2
