structure Atk : ATK =
  struct
    ...
    val relationTypeForName_ = _import "mlton_atk_relation_type_for_name" : Utf8.MLton.p1 * Utf8.FFI.non_opt Utf8.MLton.p2 -> AtkRelationType.FFI.val_;
    val relationTypeGetName_ = _import "atk_relation_type_get_name" : AtkRelationType.FFI.val_ -> Utf8.FFI.non_opt Utf8.FFI.out_p;
    val relationTypeRegister_ = _import "mlton_atk_relation_type_register" : Utf8.MLton.p1 * Utf8.FFI.non_opt Utf8.MLton.p2 -> AtkRelationType.FFI.val_;
    ...
    val roleForName_ = _import "mlton_atk_role_for_name" : Utf8.MLton.p1 * Utf8.FFI.non_opt Utf8.MLton.p2 -> AtkRole.FFI.val_;
    val roleGetLocalizedName_ = _import "atk_role_get_localized_name" : AtkRole.FFI.val_ -> Utf8.FFI.non_opt Utf8.FFI.out_p;
    val roleGetName_ = _import "atk_role_get_name" : AtkRole.FFI.val_ -> Utf8.FFI.non_opt Utf8.FFI.out_p;
    val roleRegister_ = _import "mlton_atk_role_register" : Utf8.MLton.p1 * Utf8.FFI.non_opt Utf8.MLton.p2 -> AtkRole.FFI.val_;
    val stateTypeForName_ = _import "mlton_atk_state_type_for_name" : Utf8.MLton.p1 * Utf8.FFI.non_opt Utf8.MLton.p2 -> AtkStateType.FFI.val_;
    val stateTypeGetName_ = _import "atk_state_type_get_name" : AtkStateType.FFI.val_ -> Utf8.FFI.non_opt Utf8.FFI.out_p;
    val stateTypeRegister_ = _import "mlton_atk_state_type_register" : Utf8.MLton.p1 * Utf8.FFI.non_opt Utf8.MLton.p2 -> AtkStateType.FFI.val_;
    val textAttributeForName_ = _import "mlton_atk_text_attribute_for_name" : Utf8.MLton.p1 * Utf8.FFI.non_opt Utf8.MLton.p2 -> AtkTextAttribute.FFI.val_;
    val textAttributeGetName_ = _import "atk_text_attribute_get_name" : AtkTextAttribute.FFI.val_ -> Utf8.FFI.non_opt Utf8.FFI.out_p;
    val textAttributeGetValue_ = fn x1 & x2 => (_import "atk_text_attribute_get_value" : AtkTextAttribute.FFI.val_ * GInt32.FFI.val_ -> Utf8.FFI.opt Utf8.FFI.out_p;) (x1, x2)
    val textAttributeRegister_ = _import "mlton_atk_text_attribute_register" : Utf8.MLton.p1 * Utf8.FFI.non_opt Utf8.MLton.p2 -> AtkTextAttribute.FFI.val_;
    val valueTypeGetLocalizedName_ = _import "atk_value_type_get_localized_name" : AtkValueType.FFI.val_ -> Utf8.FFI.non_opt Utf8.FFI.out_p;
    val valueTypeGetName_ = _import "atk_value_type_get_name" : AtkValueType.FFI.val_ -> Utf8.FFI.non_opt Utf8.FFI.out_p;
    ...
    fun relationTypeForName name = (Utf8.FFI.withPtr 0 ---> AtkRelationType.FFI.fromVal) relationTypeForName_ name
    fun relationTypeGetName type' = (AtkRelationType.FFI.withVal ---> Utf8.FFI.fromPtr 0) relationTypeGetName_ type'
    fun relationTypeRegister name = (Utf8.FFI.withPtr 0 ---> AtkRelationType.FFI.fromVal) relationTypeRegister_ name
    ...
    fun roleForName name = (Utf8.FFI.withPtr 0 ---> AtkRole.FFI.fromVal) roleForName_ name
    ...
    fun roleRegister name = (Utf8.FFI.withPtr 0 ---> AtkRole.FFI.fromVal) roleRegister_ name
    fun stateTypeForName name = (Utf8.FFI.withPtr 0 ---> AtkStateType.FFI.fromVal) stateTypeForName_ name
    fun stateTypeGetName type' = (AtkStateType.FFI.withVal ---> Utf8.FFI.fromPtr 0) stateTypeGetName_ type'
    fun stateTypeRegister name = (Utf8.FFI.withPtr 0 ---> AtkStateType.FFI.fromVal) stateTypeRegister_ name
    fun textAttributeForName name = (Utf8.FFI.withPtr 0 ---> AtkTextAttribute.FFI.fromVal) textAttributeForName_ name
    ...
    fun textAttributeRegister name = (Utf8.FFI.withPtr 0 ---> AtkTextAttribute.FFI.fromVal) textAttributeRegister_ name
