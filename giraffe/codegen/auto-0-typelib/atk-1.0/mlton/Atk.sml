structure Atk : ATK =
  struct
    ...
    val removeFocusTracker_ = _import "atk_remove_focus_tracker" : FFI.UInt32.C.val_ -> unit;
    val removeGlobalEventListener_ = _import "atk_remove_global_event_listener" : FFI.UInt32.C.val_ -> unit;
    val removeKeyEventListener_ = _import "atk_remove_key_event_listener" : FFI.UInt32.C.val_ -> unit;
    ...
    val textAttributeGetValue_ = fn x1 & x2 => (_import "atk_text_attribute_get_value" : AtkTextAttribute.C.val_ * FFI.Int32.C.val_ -> Utf8.C.notnull Utf8.C.out_p;) (x1, x2)
    ...
    fun relationTypeForName name = (Utf8.C.withConstPtr ---> AtkRelationType.C.fromVal) relationTypeForName_ name
    fun relationTypeGetName type' = (AtkRelationType.C.withVal ---> Utf8.C.fromPtr false) relationTypeGetName_ type'
    fun relationTypeRegister name = (Utf8.C.withConstPtr ---> AtkRelationType.C.fromVal) relationTypeRegister_ name
    ...
    fun roleForName name = (Utf8.C.withConstPtr ---> AtkRole.C.fromVal) roleForName_ name
    ...
    fun roleRegister name = (Utf8.C.withConstPtr ---> AtkRole.C.fromVal) roleRegister_ name
    fun stateTypeForName name = (Utf8.C.withConstPtr ---> AtkStateType.C.fromVal) stateTypeForName_ name
    fun stateTypeGetName type' = (AtkStateType.C.withVal ---> Utf8.C.fromPtr false) stateTypeGetName_ type'
    fun stateTypeRegister name = (Utf8.C.withConstPtr ---> AtkStateType.C.fromVal) stateTypeRegister_ name
    fun textAttributeForName name = (Utf8.C.withConstPtr ---> AtkTextAttribute.C.fromVal) textAttributeForName_ name
    ...
    fun textAttributeRegister name = (Utf8.C.withConstPtr ---> AtkTextAttribute.C.fromVal) textAttributeRegister_ name
