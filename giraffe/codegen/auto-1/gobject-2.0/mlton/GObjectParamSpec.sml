structure GObjectParamSpec :>
  ...
  struct
    ...
    val getQdata_ = fn x1 & x2 => (_import "g_param_spec_get_qdata" : GObjectParamSpecClass.C.notnull GObjectParamSpecClass.C.p * FFI.UInt32.C.val_ -> unit;) (x1, x2)
    ...
    val setQdata_ = fn x1 & x2 => (_import "g_param_spec_set_qdata" : GObjectParamSpecClass.C.notnull GObjectParamSpecClass.C.p * FFI.UInt32.C.val_ -> unit;) (x1, x2)
    val stealQdata_ = fn x1 & x2 => (_import "g_param_spec_steal_qdata" : GObjectParamSpecClass.C.notnull GObjectParamSpecClass.C.p * FFI.UInt32.C.val_ -> unit;) (x1, x2)
    ...
    fun getQdata self quark = (GObjectParamSpecClass.C.withPtr &&&> FFI.UInt32.C.withVal ---> I) getQdata_ (self & quark)
    fun getRedirectTarget self = (GObjectParamSpecClass.C.withPtr ---> GObjectParamSpecClass.C.fromPtr false) getRedirectTarget_ self
    fun setQdata self quark = (GObjectParamSpecClass.C.withPtr &&&> FFI.UInt32.C.withVal ---> I) setQdata_ (self & quark)
    fun stealQdata self quark = (GObjectParamSpecClass.C.withPtr &&&> FFI.UInt32.C.withVal ---> I) stealQdata_ (self & quark)
  end
