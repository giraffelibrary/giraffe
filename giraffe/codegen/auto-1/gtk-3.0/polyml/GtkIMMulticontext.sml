structure GtkIMMulticontext :>
  ...
  struct
    ...
    in
      ...
      val getContextId_ = call (load_sym libgtk "gtk_im_multicontext_get_context_id") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      val setContextId_ = call (load_sym libgtk "gtk_im_multicontext_set_context_id") (GObjectObjectClass.PolyML.PTR &&> FFI.PolyML.String.INPTR --> FFI.PolyML.VOID)
    end
    ...
    fun getContextId self = (GObjectObjectClass.C.withPtr ---> FFI.String.fromPtr false) getContextId_ self
    fun setContextId self contextId = (GObjectObjectClass.C.withPtr &&&> FFI.String.withConstPtr ---> I) setContextId_ (self & contextId)
  end
