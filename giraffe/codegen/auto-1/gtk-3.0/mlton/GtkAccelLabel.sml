structure GtkAccelLabel :>
  ...
  struct
    ...
    val getAccelWidth_ = _import "gtk_accel_label_get_accel_width" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.UInt32.val_;
    val refetch_ = _import "gtk_accel_label_refetch" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
