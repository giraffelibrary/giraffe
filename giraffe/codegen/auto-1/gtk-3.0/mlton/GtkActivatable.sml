structure GtkActivatable :>
  ...
  struct
    ...
    val getUseActionAppearance_ = _import "gtk_activatable_get_use_action_appearance" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    ...
    val setUseActionAppearance_ = fn x1 & x2 => (_import "gtk_activatable_set_use_action_appearance" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Bool.val_ -> unit;) (x1, x2)
    ...
    fun getUseActionAppearance self = (GObjectObjectClass.C.withPtr ---> FFI.Bool.fromVal) getUseActionAppearance_ self
    ...
    fun setUseActionAppearance self useAppearance = (GObjectObjectClass.C.withPtr &&&> FFI.Bool.withVal ---> I) setUseActionAppearance_ (self & useAppearance)
