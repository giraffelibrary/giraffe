structure GtkPrintOperationPreview :>
  ...
  struct
    ...
    val isSelected_ = fn x1 & x2 => (_import "gtk_print_operation_preview_is_selected" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val renderPage_ = fn x1 & x2 => (_import "gtk_print_operation_preview_render_page" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    ...
    fun isSelected self pageNr = (GObjectObjectClass.C.withPtr &&&> FFI.Int32.withVal ---> FFI.Bool.fromVal) isSelected_ (self & pageNr)
    fun renderPage self pageNr = (GObjectObjectClass.C.withPtr &&&> FFI.Int32.withVal ---> I) renderPage_ (self & pageNr)
    local
