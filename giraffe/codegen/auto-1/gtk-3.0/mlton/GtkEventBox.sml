structure GtkEventBox :>
  ...
  struct
    ...
    val getAboveChild_ = _import "gtk_event_box_get_above_child" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val getVisibleWindow_ = _import "gtk_event_box_get_visible_window" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val setAboveChild_ = fn x1 & x2 => (_import "gtk_event_box_set_above_child" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Bool.val_ -> unit;) (x1, x2)
    val setVisibleWindow_ = fn x1 & x2 => (_import "gtk_event_box_set_visible_window" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Bool.val_ -> unit;) (x1, x2)
