structure GtkTextIter :>
  ...
  struct
    ...
    val backwardChar_ = _import "gtk_text_iter_backward_char" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val backwardChars_ = fn x1 & x2 => (_import "gtk_text_iter_backward_chars" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val backwardCursorPosition_ = _import "gtk_text_iter_backward_cursor_position" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val backwardCursorPositions_ = fn x1 & x2 => (_import "gtk_text_iter_backward_cursor_positions" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val backwardLine_ = _import "gtk_text_iter_backward_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val backwardLines_ = fn x1 & x2 => (_import "gtk_text_iter_backward_lines" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val backwardSearch_ =
      fn
        x1
         & (x2, x3)
    ...
    val backwardSentenceStart_ = _import "gtk_text_iter_backward_sentence_start" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val backwardSentenceStarts_ = fn x1 & x2 => (_import "gtk_text_iter_backward_sentence_starts" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val backwardToTagToggle_ = fn x1 & x2 => (_import "gtk_text_iter_backward_to_tag_toggle" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * unit GObjectObjectClass.C.p -> FFI.Bool.val_;) (x1, x2)
    val backwardVisibleCursorPosition_ = _import "gtk_text_iter_backward_visible_cursor_position" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val backwardVisibleCursorPositions_ = fn x1 & x2 => (_import "gtk_text_iter_backward_visible_cursor_positions" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val backwardVisibleLine_ = _import "gtk_text_iter_backward_visible_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val backwardVisibleLines_ = fn x1 & x2 => (_import "gtk_text_iter_backward_visible_lines" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val backwardVisibleWordStart_ = _import "gtk_text_iter_backward_visible_word_start" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val backwardVisibleWordStarts_ = fn x1 & x2 => (_import "gtk_text_iter_backward_visible_word_starts" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val backwardWordStart_ = _import "gtk_text_iter_backward_word_start" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val backwardWordStarts_ = fn x1 & x2 => (_import "gtk_text_iter_backward_word_starts" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val beginsTag_ = fn x1 & x2 => (_import "gtk_text_iter_begins_tag" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * unit GObjectObjectClass.C.p -> FFI.Bool.val_;) (x1, x2)
    val canInsert_ = fn x1 & x2 => (_import "gtk_text_iter_can_insert" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Bool.val_ -> FFI.Bool.val_;) (x1, x2)
    val compare_ = fn x1 & x2 => (_import "gtk_text_iter_compare" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.val_;) (x1, x2)
    ...
    val editable_ = fn x1 & x2 => (_import "gtk_text_iter_editable" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Bool.val_ -> FFI.Bool.val_;) (x1, x2)
    val endsLine_ = _import "gtk_text_iter_ends_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val endsSentence_ = _import "gtk_text_iter_ends_sentence" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val endsTag_ = fn x1 & x2 => (_import "gtk_text_iter_ends_tag" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * unit GObjectObjectClass.C.p -> FFI.Bool.val_;) (x1, x2)
    val endsWord_ = _import "gtk_text_iter_ends_word" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val equal_ = fn x1 & x2 => (_import "gtk_text_iter_equal" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;) (x1, x2)
    val forwardChar_ = _import "gtk_text_iter_forward_char" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val forwardChars_ = fn x1 & x2 => (_import "gtk_text_iter_forward_chars" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val forwardCursorPosition_ = _import "gtk_text_iter_forward_cursor_position" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val forwardCursorPositions_ = fn x1 & x2 => (_import "gtk_text_iter_forward_cursor_positions" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val forwardLine_ = _import "gtk_text_iter_forward_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val forwardLines_ = fn x1 & x2 => (_import "gtk_text_iter_forward_lines" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val forwardSearch_ =
      fn
        x1
         & (x2, x3)
    ...
    val forwardSentenceEnd_ = _import "gtk_text_iter_forward_sentence_end" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val forwardSentenceEnds_ = fn x1 & x2 => (_import "gtk_text_iter_forward_sentence_ends" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val forwardToEnd_ = _import "gtk_text_iter_forward_to_end" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> unit;
    val forwardToLineEnd_ = _import "gtk_text_iter_forward_to_line_end" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val forwardToTagToggle_ = fn x1 & x2 => (_import "gtk_text_iter_forward_to_tag_toggle" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * unit GObjectObjectClass.C.p -> FFI.Bool.val_;) (x1, x2)
    val forwardVisibleCursorPosition_ = _import "gtk_text_iter_forward_visible_cursor_position" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val forwardVisibleCursorPositions_ = fn x1 & x2 => (_import "gtk_text_iter_forward_visible_cursor_positions" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val forwardVisibleLine_ = _import "gtk_text_iter_forward_visible_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val forwardVisibleLines_ = fn x1 & x2 => (_import "gtk_text_iter_forward_visible_lines" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val forwardVisibleWordEnd_ = _import "gtk_text_iter_forward_visible_word_end" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val forwardVisibleWordEnds_ = fn x1 & x2 => (_import "gtk_text_iter_forward_visible_word_ends" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val forwardWordEnd_ = _import "gtk_text_iter_forward_word_end" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val forwardWordEnds_ = fn x1 & x2 => (_import "gtk_text_iter_forward_word_ends" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> FFI.Bool.val_;) (x1, x2)
    val getAttributes_ = fn x1 & x2 => (_import "gtk_text_iter_get_attributes" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GtkTextAttributesRecord.C.notnull GtkTextAttributesRecord.C.p -> FFI.Bool.val_;) (x1, x2)
    ...
    val getBytesInLine_ = _import "gtk_text_iter_get_bytes_in_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.val_;
    val getChar_ = _import "gtk_text_iter_get_char" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Char.val_;
    val getCharsInLine_ = _import "gtk_text_iter_get_chars_in_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.val_;
    ...
    val getLine_ = _import "gtk_text_iter_get_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.val_;
    val getLineIndex_ = _import "gtk_text_iter_get_line_index" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.val_;
    val getLineOffset_ = _import "gtk_text_iter_get_line_offset" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.val_;
    val getOffset_ = _import "gtk_text_iter_get_offset" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.val_;
    ...
    val getSlice_ = fn x1 & x2 => (_import "gtk_text_iter_get_slice" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.String.notnull FFI.String.out_p;) (x1, x2)
    val getText_ = fn x1 & x2 => (_import "gtk_text_iter_get_text" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.String.notnull FFI.String.out_p;) (x1, x2)
    val getVisibleLineIndex_ = _import "gtk_text_iter_get_visible_line_index" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.val_;
    val getVisibleLineOffset_ = _import "gtk_text_iter_get_visible_line_offset" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Int32.val_;
    val getVisibleSlice_ = fn x1 & x2 => (_import "gtk_text_iter_get_visible_slice" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.String.notnull FFI.String.out_p;) (x1, x2)
    val getVisibleText_ = fn x1 & x2 => (_import "gtk_text_iter_get_visible_text" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.String.notnull FFI.String.out_p;) (x1, x2)
    val hasTag_ = fn x1 & x2 => (_import "gtk_text_iter_has_tag" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;) (x1, x2)
    val inRange_ =
      fn
        x1
         & x2
    ...
    val insideSentence_ = _import "gtk_text_iter_inside_sentence" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val insideWord_ = _import "gtk_text_iter_inside_word" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val isCursorPosition_ = _import "gtk_text_iter_is_cursor_position" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val isEnd_ = _import "gtk_text_iter_is_end" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val isStart_ = _import "gtk_text_iter_is_start" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    ...
    val setLine_ = fn x1 & x2 => (_import "gtk_text_iter_set_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    val setLineIndex_ = fn x1 & x2 => (_import "gtk_text_iter_set_line_index" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    val setLineOffset_ = fn x1 & x2 => (_import "gtk_text_iter_set_line_offset" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    val setOffset_ = fn x1 & x2 => (_import "gtk_text_iter_set_offset" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    val setVisibleLineIndex_ = fn x1 & x2 => (_import "gtk_text_iter_set_visible_line_index" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    val setVisibleLineOffset_ = fn x1 & x2 => (_import "gtk_text_iter_set_visible_line_offset" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    val startsLine_ = _import "gtk_text_iter_starts_line" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val startsSentence_ = _import "gtk_text_iter_starts_sentence" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val startsWord_ = _import "gtk_text_iter_starts_word" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p -> FFI.Bool.val_;
    val togglesTag_ = fn x1 & x2 => (_import "gtk_text_iter_toggles_tag" : GtkTextIterRecord.C.notnull GtkTextIterRecord.C.p * unit GObjectObjectClass.C.p -> FFI.Bool.val_;) (x1, x2)
