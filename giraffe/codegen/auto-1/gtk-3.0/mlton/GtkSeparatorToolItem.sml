structure GtkSeparatorToolItem :>
  ...
  struct
    ...
    val getDraw_ = _import "gtk_separator_tool_item_get_draw" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val setDraw_ = fn x1 & x2 => (_import "gtk_separator_tool_item_set_draw" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Bool.val_ -> unit;) (x1, x2)
