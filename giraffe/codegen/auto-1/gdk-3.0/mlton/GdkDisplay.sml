structure GdkDisplay :>
  ...
  struct
    ...
    val getNScreens_ = _import "gdk_display_get_n_screens" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val getName_ = _import "gdk_display_get_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    val getScreen_ = fn x1 & x2 => (_import "gdk_display_get_screen" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.val_ -> GObjectObjectClass.C.notnull GObjectObjectClass.C.p;) (x1, x2)
    val hasPending_ = _import "gdk_display_has_pending" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val isClosed_ = _import "gdk_display_is_closed" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    ...
    val supportsCursorColor_ = _import "gdk_display_supports_cursor_color" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val supportsInputShapes_ = _import "gdk_display_supports_input_shapes" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val supportsSelectionNotification_ = _import "gdk_display_supports_selection_notification" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val supportsShapes_ = _import "gdk_display_supports_shapes" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
