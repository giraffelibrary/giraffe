structure AtkPlug :>
  ...
  struct
    ...
    val getId_ = _import "atk_plug_get_id" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    ...
    fun getId self = (GObjectObjectClass.C.withPtr ---> FFI.String.fromPtr true) getId_ self
  end
