structure AtkStateSet :>
  ...
  struct
    ...
    val addState_ = fn x1 & x2 => (_import "atk_state_set_add_state" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * AtkStateType.C.val_ -> FFI.Bool.val_;) (x1, x2)
    ...
    val containsState_ = fn x1 & x2 => (_import "atk_state_set_contains_state" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * AtkStateType.C.val_ -> FFI.Bool.val_;) (x1, x2)
    val isEmpty_ = _import "atk_state_set_is_empty" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    ...
    val removeState_ = fn x1 & x2 => (_import "atk_state_set_remove_state" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * AtkStateType.C.val_ -> FFI.Bool.val_;) (x1, x2)
