structure Atk : ATK =
  struct
    ...
    val removeFocusTracker_ = _import "atk_remove_focus_tracker" : FFI.UInt32.val_ -> unit;
    val removeGlobalEventListener_ = _import "atk_remove_global_event_listener" : FFI.UInt32.val_ -> unit;
    val removeKeyEventListener_ = _import "atk_remove_key_event_listener" : FFI.UInt32.val_ -> unit;
