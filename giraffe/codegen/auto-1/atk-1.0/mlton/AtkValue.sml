structure AtkValue :>
  ...
  struct
    ...
    val setCurrentValue_ = fn x1 & x2 => (_import "atk_value_set_current_value" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * GObjectValueRecord.C.notnull GObjectValueRecord.C.p -> FFI.Bool.val_;) (x1, x2)
