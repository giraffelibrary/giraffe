structure Atk : ATK =
  struct
    ...
    in
      ...
      val removeFocusTracker_ = call (load_sym libatk "atk_remove_focus_tracker") (FFI.PolyML.UInt32.VAL --> FFI.PolyML.VOID)
      val removeGlobalEventListener_ = call (load_sym libatk "atk_remove_global_event_listener") (FFI.PolyML.UInt32.VAL --> FFI.PolyML.VOID)
      val removeKeyEventListener_ = call (load_sym libatk "atk_remove_key_event_listener") (FFI.PolyML.UInt32.VAL --> FFI.PolyML.VOID)
    ...
    fun removeFocusTracker trackerId = (FFI.UInt32.withVal ---> I) removeFocusTracker_ trackerId
    fun removeGlobalEventListener listenerId = (FFI.UInt32.withVal ---> I) removeGlobalEventListener_ listenerId
    fun removeKeyEventListener listenerId = (FFI.UInt32.withVal ---> I) removeKeyEventListener_ listenerId
