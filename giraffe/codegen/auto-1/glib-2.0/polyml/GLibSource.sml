structure GLibSource :>
  ...
  struct
    ...
    in
      ...
      val attach_ = call (load_sym libglib "g_source_attach") (GLibSourceRecord.PolyML.PTR &&> GLibMainContextRecord.PolyML.OPTPTR --> FFI.PolyML.UInt32.VAL)
      ...
      val getId_ = call (load_sym libglib "g_source_get_id") (GLibSourceRecord.PolyML.PTR --> FFI.PolyML.UInt32.VAL)
      ...
      val remove_ = call (load_sym libglib "g_source_remove") (FFI.PolyML.UInt32.VAL --> FFI.PolyML.Bool.VAL)
      val setNameById_ = call (load_sym libglib "g_source_set_name_by_id") (FFI.PolyML.UInt32.VAL &&> FFI.PolyML.String.INPTR --> FFI.PolyML.VOID)
    end
    ...
    fun attach self context = (GLibSourceRecord.C.withPtr &&&> GLibMainContextRecord.C.withOptPtr ---> FFI.UInt32.fromVal) attach_ (self & context)
    ...
    fun getId self = (GLibSourceRecord.C.withPtr ---> FFI.UInt32.fromVal) getId_ self
    ...
    fun remove tag = (FFI.UInt32.withVal ---> FFI.Bool.fromVal) remove_ tag
    fun setNameById tag name = (FFI.UInt32.withVal &&&> FFI.String.withConstPtr ---> I) setNameById_ (tag & name)
  end
