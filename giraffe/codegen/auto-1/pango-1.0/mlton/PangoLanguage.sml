structure PangoLanguage :>
  ...
  struct
    ...
    val getSampleString_ = _import "pango_language_get_sample_string" : PangoLanguageRecord.C.notnull PangoLanguageRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val includesScript_ = fn x1 & x2 => (_import "pango_language_includes_script" : PangoLanguageRecord.C.notnull PangoLanguageRecord.C.p * PangoScript.C.val_ -> FFI.Bool.val_;) (x1, x2)
    val matches_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val toString_ = _import "pango_language_to_string" : PangoLanguageRecord.C.notnull PangoLanguageRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val fromString_ = _import "mlton_pango_language_from_string" : cstring * unit CPointer.t -> PangoLanguageRecord.C.notnull PangoLanguageRecord.C.p;
