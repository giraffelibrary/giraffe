structure GIRepository : G_I_REPOSITORY =
  struct
    val argInfoGetClosure_ = _import "g_arg_info_get_closure" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val argInfoGetDestroy_ = _import "g_arg_info_get_destroy" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    ...
    val argInfoIsCallerAllocates_ = _import "g_arg_info_is_caller_allocates" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Bool.val_;
    val argInfoIsOptional_ = _import "g_arg_info_is_optional" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Bool.val_;
    val argInfoIsReturnValue_ = _import "g_arg_info_is_return_value" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Bool.val_;
    val argInfoIsSkip_ = _import "g_arg_info_is_skip" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Bool.val_;
    ...
    val argInfoMayBeNull_ = _import "g_arg_info_may_be_null" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Bool.val_;
    ...
    val callableInfoGetArg_ = fn x1 & x2 => (_import "g_callable_info_get_arg" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    ...
    val callableInfoGetNArgs_ = _import "g_callable_info_get_n_args" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    ...
    val callableInfoMayReturnNull_ = _import "g_callable_info_may_return_null" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Bool.val_;
    val callableInfoSkipReturn_ = _import "g_callable_info_skip_return" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Bool.val_;
    ...
    val enumInfoGetErrorDomain_ = _import "g_enum_info_get_error_domain" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val enumInfoGetMethod_ = fn x1 & x2 => (_import "g_enum_info_get_method" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    val enumInfoGetNMethods_ = _import "g_enum_info_get_n_methods" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val enumInfoGetNValues_ = _import "g_enum_info_get_n_values" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    ...
    val enumInfoGetValue_ = fn x1 & x2 => (_import "g_enum_info_get_value" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    ...
    val fieldInfoGetOffset_ = _import "g_field_info_get_offset" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val fieldInfoGetSize_ = _import "g_field_info_get_size" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    ...
    val functionInfoGetSymbol_ = _import "g_function_info_get_symbol" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    ...
    val infoTypeToString_ = _import "g_info_type_to_string" : GIRepositoryInfoType.C.val_ -> FFI.String.notnull FFI.String.out_p;
    ...
    val interfaceInfoGetConstant_ = fn x1 & x2 => (_import "g_interface_info_get_constant" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    ...
    val interfaceInfoGetMethod_ = fn x1 & x2 => (_import "g_interface_info_get_method" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    val interfaceInfoGetNConstants_ = _import "g_interface_info_get_n_constants" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val interfaceInfoGetNMethods_ = _import "g_interface_info_get_n_methods" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val interfaceInfoGetNPrerequisites_ = _import "g_interface_info_get_n_prerequisites" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val interfaceInfoGetNProperties_ = _import "g_interface_info_get_n_properties" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val interfaceInfoGetNSignals_ = _import "g_interface_info_get_n_signals" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val interfaceInfoGetNVfuncs_ = _import "g_interface_info_get_n_vfuncs" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val interfaceInfoGetPrerequisite_ = fn x1 & x2 => (_import "g_interface_info_get_prerequisite" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    ...
    val objectInfoGetAbstract_ = _import "g_object_info_get_abstract" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Bool.val_;
    ...
    val objectInfoGetConstant_ = fn x1 & x2 => (_import "g_object_info_get_constant" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    val objectInfoGetField_ = fn x1 & x2 => (_import "g_object_info_get_field" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    val objectInfoGetFundamental_ = _import "g_object_info_get_fundamental" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Bool.val_;
    val objectInfoGetGetValueFunction_ = _import "g_object_info_get_get_value_function" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val objectInfoGetInterface_ = fn x1 & x2 => (_import "g_object_info_get_interface" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    val objectInfoGetMethod_ = fn x1 & x2 => (_import "g_object_info_get_method" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    val objectInfoGetNConstants_ = _import "g_object_info_get_n_constants" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val objectInfoGetNFields_ = _import "g_object_info_get_n_fields" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val objectInfoGetNInterfaces_ = _import "g_object_info_get_n_interfaces" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val objectInfoGetNMethods_ = _import "g_object_info_get_n_methods" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val objectInfoGetNProperties_ = _import "g_object_info_get_n_properties" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val objectInfoGetNSignals_ = _import "g_object_info_get_n_signals" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    val objectInfoGetNVfuncs_ = _import "g_object_info_get_n_vfuncs" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    ...
    val objectInfoGetProperty_ = fn x1 & x2 => (_import "g_object_info_get_property" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    val objectInfoGetRefFunction_ = _import "g_object_info_get_ref_function" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val objectInfoGetSetValueFunction_ = _import "g_object_info_get_set_value_function" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val objectInfoGetSignal_ = fn x1 & x2 => (_import "g_object_info_get_signal" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    val objectInfoGetTypeInit_ = _import "g_object_info_get_type_init" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val objectInfoGetTypeName_ = _import "g_object_info_get_type_name" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val objectInfoGetUnrefFunction_ = _import "g_object_info_get_unref_function" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val objectInfoGetVfunc_ = fn x1 & x2 => (_import "g_object_info_get_vfunc" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    ...
    val registeredTypeInfoGetTypeInit_ = _import "g_registered_type_info_get_type_init" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    val registeredTypeInfoGetTypeName_ = _import "g_registered_type_info_get_type_name" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.String.notnull FFI.String.out_p;
    ...
    val signalInfoTrueStopsEmit_ = _import "g_signal_info_true_stops_emit" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Bool.val_;
    ...
    val typeInfoGetArrayLength_ = _import "g_type_info_get_array_length" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
    ...
    val typeInfoGetParamType_ = fn x1 & x2 => (_import "g_type_info_get_param_type" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    ...
    val typeInfoIsPointer_ = _import "g_type_info_is_pointer" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Bool.val_;
    val typeInfoIsZeroTerminated_ = _import "g_type_info_is_zero_terminated" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Bool.val_;
    val typeTagToString_ = _import "g_type_tag_to_string" : GIRepositoryTypeTag.C.val_ -> FFI.String.notnull FFI.String.out_p;
    ...
    val unionInfoGetField_ = fn x1 & x2 => (_import "g_union_info_get_field" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p * FFI.Int32.val_ -> GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p;) (x1, x2)
    ...
    val vfuncInfoGetOffset_ = _import "g_vfunc_info_get_offset" : GIRepositoryBaseInfoRecord.C.notnull GIRepositoryBaseInfoRecord.C.p -> FFI.Int32.val_;
