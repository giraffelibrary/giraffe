structure GioBufferedOutputStream :>
  ...
  struct
    ...
    val newSized_ = fn x1 & x2 => (_import "g_buffered_output_stream_new_sized" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.UInt64.val_ -> GObjectObjectClass.C.notnull GObjectObjectClass.C.p;) (x1, x2)
    ...
    val getBufferSize_ = _import "g_buffered_output_stream_get_buffer_size" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.UInt64.val_;
    ...
    val setBufferSize_ = fn x1 & x2 => (_import "g_buffered_output_stream_set_buffer_size" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.UInt64.val_ -> unit;) (x1, x2)
