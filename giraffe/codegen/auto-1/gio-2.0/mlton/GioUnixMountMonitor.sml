structure GioUnixMountMonitor :>
  ...
  struct
    ...
    val setRateLimit_ = fn x1 & x2 => (_import "g_unix_mount_monitor_set_rate_limit" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    type 'a class_t = 'a GioUnixMountMonitorClass.t
    val getType = (I ---> GObjectType.C.fromVal) getType_
    fun new () = (I ---> GioUnixMountMonitorClass.C.fromPtr true) new_ ()
    fun setRateLimit self limitMsec = (GObjectObjectClass.C.withPtr &&&> FFI.Int32.withVal ---> I) setRateLimit_ (self & limitMsec)
    local
