structure GioUnixOutputStream :>
  ...
  struct
    ...
    val new_ = fn x1 & x2 => (_import "g_unix_output_stream_new" : FFI.Int32.val_ * FFI.Bool.val_ -> GObjectObjectClass.C.notnull GObjectObjectClass.C.p;) (x1, x2)
    val getCloseFd_ = _import "g_unix_output_stream_get_close_fd" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val getFd_ = _import "g_unix_output_stream_get_fd" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val setCloseFd_ = fn x1 & x2 => (_import "g_unix_output_stream_set_close_fd" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Bool.val_ -> unit;) (x1, x2)
    ...
    fun new fd closeFd = (FFI.Int32.withVal &&&> FFI.Bool.withVal ---> GioUnixOutputStreamClass.C.fromPtr true) new_ (fd & closeFd)
