structure GioUnixOutputStream :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgio "g_unix_output_stream_new") (FFI.PolyML.Int32.VAL &&> FFI.PolyML.Bool.VAL --> GObjectObjectClass.PolyML.PTR)
      val getCloseFd_ = call (load_sym libgio "g_unix_output_stream_get_close_fd") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.Bool.VAL)
      val getFd_ = call (load_sym libgio "g_unix_output_stream_get_fd") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.Int32.VAL)
      val setCloseFd_ = call (load_sym libgio "g_unix_output_stream_set_close_fd") (GObjectObjectClass.PolyML.PTR &&> FFI.PolyML.Bool.VAL --> FFI.PolyML.VOID)
    end
