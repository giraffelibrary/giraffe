structure GioDBusObjectManagerClient :>
  ...
  struct
    ...
    in
      ...
      val getName_ = call (load_sym libgio "g_dbus_object_manager_client_get_name") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      val getNameOwner_ = call (load_sym libgio "g_dbus_object_manager_client_get_name_owner") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.String.RETPTR)
    end
