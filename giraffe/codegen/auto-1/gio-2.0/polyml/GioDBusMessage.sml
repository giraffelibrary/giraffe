structure GioDBusMessage :>
  ...
  struct
    ...
    in
      ...
      val getArg0_ = call (load_sym libgio "g_dbus_message_get_arg0") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      ...
      val getDestination_ = call (load_sym libgio "g_dbus_message_get_destination") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      val getErrorName_ = call (load_sym libgio "g_dbus_message_get_error_name") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      ...
      val getInterface_ = call (load_sym libgio "g_dbus_message_get_interface") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      ...
      val setErrorName_ = call (load_sym libgio "g_dbus_message_set_error_name") (GObjectObjectClass.PolyML.PTR &&> FFI.PolyML.String.INPTR --> FFI.PolyML.VOID)
