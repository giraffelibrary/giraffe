structure GdkPixbufPixbufLoader :>
  ...
  struct
    ...
    val close_ = fn x1 & x2 => (_import "gdk_pixbuf_loader_close" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * (unit, unit) GLibErrorRecord.C.r -> FFI.Bool.val_;) (x1, x2)
