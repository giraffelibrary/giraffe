structure GdkPixbufPixbufAnimation :>
  ...
  struct
    ...
    val getHeight_ = _import "gdk_pixbuf_animation_get_height" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    ...
    val getWidth_ = _import "gdk_pixbuf_animation_get_width" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val isStaticImage_ = _import "gdk_pixbuf_animation_is_static_image" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
