...
*)
    ...
    val getEvents_ = _import "gtk_widget_get_events" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> GdkEventMask.C.val_;
    ...
    val setEvents_ = fn x1 & x2 => (_import "gtk_widget_set_events" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * GdkEventMask.C.val_ -> unit;) (x1, x2)
...
*)
    ...
    fun setEvents self events = (GObjectObjectClass.C.withPtr &&&> GdkEventMask.C.withVal ---> I) setEvents_ (self & events)
