structure VteTerminal :>
  VTE_TERMINAL
    ...
    where type writeflags_t = VteWriteFlags.t
    where type cursorblinkmode_t = VteCursorBlinkMode.t
    where type cursorshape_t = VteCursorShape.t
    where type erasebinding_t = VteEraseBinding.t
  ...
  struct
    ...
    val getCjkAmbiguousWidth_ = _import "vte_terminal_get_cjk_ambiguous_width" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.C.val_;
    ...
    val setCjkAmbiguousWidth_ = fn x1 & x2 => (_import "vte_terminal_set_cjk_ambiguous_width" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.C.val_ -> unit;) (x1, x2)
    ...
    type writeflags_t = VteWriteFlags.t
    type cursorblinkmode_t = VteCursorBlinkMode.t
    type cursorshape_t = VteCursorShape.t
    type erasebinding_t = VteEraseBinding.t
    ...
    fun setCjkAmbiguousWidth self width = (GObjectObjectClass.C.withPtr &&&> FFI.Int32.C.withVal ---> I) setCjkAmbiguousWidth_ (self & width)
