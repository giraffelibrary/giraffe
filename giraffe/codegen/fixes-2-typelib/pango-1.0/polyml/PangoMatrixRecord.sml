structure PangoMatrixRecord :>
  sig
    include PANGO_MATRIX_RECORD
  ...
  struct
    ...
    in
      val copy_ =
        call
          (load_sym libpango "pango_matrix_copy")
          (PTR --> PTR);

      val free_sym = load_sym libpango "pango_matrix_free";
    end
    ...
    in
      val getType_ =
        call
          (load_sym libpango "pango_matrix_get_type")
