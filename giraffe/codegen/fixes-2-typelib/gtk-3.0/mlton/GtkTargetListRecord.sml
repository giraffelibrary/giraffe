structure GtkTargetListRecord :>
  ...
  struct
    ...
    val ref_ = _import "gtk_target_list_ref" : notnull p -> notnull p;

    val unref_ = _import "gtk_target_list_unref" : notnull p -> unit;
    ...
    val getType_ =
      _import "gtk_target_list_get_type" : unit -> GObjectType.C.val_;
