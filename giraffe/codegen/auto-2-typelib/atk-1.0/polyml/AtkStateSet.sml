structure AtkStateSet :>
  ...
  struct
    ...
    in
      ...
      val addState_ = call (load_sym libatk "atk_state_set_add_state") (GObjectObjectClass.PolyML.PTR &&> AtkStateType.PolyML.VAL --> FFI.Bool.PolyML.VAL)
      ...
      val containsState_ = call (load_sym libatk "atk_state_set_contains_state") (GObjectObjectClass.PolyML.PTR &&> AtkStateType.PolyML.VAL --> FFI.Bool.PolyML.VAL)
      val isEmpty_ = call (load_sym libatk "atk_state_set_is_empty") (GObjectObjectClass.PolyML.PTR --> FFI.Bool.PolyML.VAL)
      ...
      val removeState_ = call (load_sym libatk "atk_state_set_remove_state") (GObjectObjectClass.PolyML.PTR &&> AtkStateType.PolyML.VAL --> FFI.Bool.PolyML.VAL)
