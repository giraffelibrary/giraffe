structure PangoLayoutIterRecord :>
  sig
    include PANGO_LAYOUT_ITER_RECORD
  end =
  struct
    ...
    val free_ =  _import "pango_layout_iter_free" : notnull p -> unit;
    ...
    val getType_ =
      _import "pango_layout_iter_get_type" : unit -> GObjectType.C.val_;
