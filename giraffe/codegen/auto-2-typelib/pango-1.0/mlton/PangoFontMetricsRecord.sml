structure PangoFontMetricsRecord :>
  ...
  struct
    ...
    val ref_ = _import "pango_font_metrics_ref" : notnull p -> notnull p;

    val unref_ = _import "pango_font_metrics_unref" : notnull p -> unit;
    ...
    val getType_ =
      _import "pango_font_metrics_get_type" : unit -> GObjectType.C.val_;
