structure GtkIconInfoRecord :>
  sig
    include GTK_ICON_INFO_RECORD
  ...
  struct
    ...
    in
      val copy_ =
        call
          (load_sym libgtk "gtk_icon_info_copy")
          (PTR --> PTR);

      val free_sym = load_sym libgtk "gtk_icon_info_free";
    end
    ...
    in
      val getType_ =
        call
          (load_sym libgtk "gtk_icon_info_get_type")
