structure PangoAttrListRecord :>
  sig
    include PANGO_ATTR_LIST_RECORD
  end =
  struct
    ...
    val ref_ = _import "pango_attr_list_ref" : notnull p -> notnull p;

    val unref_ = _import "pango_attr_list_unref" : notnull p -> unit;
    ...
    val getType_ =
      _import "pango_attr_list_get_type" : unit -> GObjectType.C.val_;
