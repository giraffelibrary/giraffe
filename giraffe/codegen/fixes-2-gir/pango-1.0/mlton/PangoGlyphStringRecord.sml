structure PangoGlyphStringRecord :>
  sig
    include PANGO_GLYPH_STRING_RECORD
  end =
  struct
    type notnull = CPointer.notnull
    type 'a p = 'a CPointer.p

    val new_ = _import "pango_glyph_string_new" : unit -> notnull p;

    val copy_ = _import "pango_glyph_string_copy" : notnull p -> notnull p;

    val free_ =  _import "pango_glyph_string_free" : notnull p -> unit;
    ...
    val getType_ =
      _import "pango_glyph_string_get_type" : unit -> GObjectType.C.val_;
