structure PangoLanguageRecord :>
  sig
    include PANGO_LANGUAGE_RECORD
  end =
  struct
    type notnull = CPointer.notnull
    type 'a p = 'a CPointer.p

    val copy_ = _import "pango_language_copy" : notnull p -> notnull p;

    val free_ = _import "pango_language_free" : notnull p -> unit;
    ...
    val getType_ =
      _import "pango_language_get_type" : unit -> GObjectType.C.val_;
