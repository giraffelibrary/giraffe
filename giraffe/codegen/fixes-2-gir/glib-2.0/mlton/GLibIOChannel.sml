structure GLibIOChannel :>
  ...
  struct
    ...
    val unixNew_ = _import "g_io_channel_unix_new" : FileDesc.FFI.val_ -> GLibIOChannelRecord.FFI.notnull GLibIOChannelRecord.FFI.p;
    ...
    val getBufferSize_ = _import "g_io_channel_get_buffer_size" : GLibIOChannelRecord.FFI.notnull GLibIOChannelRecord.FFI.p -> GSize.FFI.val_;
    ...
    val setBufferSize_ = fn x1 & x2 => (_import "g_io_channel_set_buffer_size" : GLibIOChannelRecord.FFI.notnull GLibIOChannelRecord.FFI.p * GSize.FFI.val_ -> unit;) (x1, x2)
    ...
    val unixGetFd_ = _import "g_io_channel_unix_get_fd" : GLibIOChannelRecord.FFI.notnull GLibIOChannelRecord.FFI.p -> FileDesc.FFI.val_;
    val writeUnichar_ =
      fn
        x1
         & x2
