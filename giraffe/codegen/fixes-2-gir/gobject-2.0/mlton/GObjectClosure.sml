  ...
  struct
    ...
    val new_ =
      _import "giraffe_g_closure_new" :
        ClosureMarshal.FFI.closure -> GObjectClosureRecord.FFI.non_opt GObjectClosureRecord.FFI.p;
    ...
    fun new marshaller func =
      (ClosureMarshal.FFI.withClosure ---> GObjectClosureRecord.FFI.fromPtr false)
        new_
        (marshaller, func)
