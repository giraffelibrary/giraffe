structure CairoSurfaceRecord :>
  sig
    include CAIRO_SURFACE_RECORD
  end =
  struct
    type notnull = CPointer.notnull
    type 'a p = 'a CPointer.p

    val ref_ = _import "cairo_surface_reference" : notnull p -> notnull p;

    val unref_ = _import "cairo_surface_destroy" : notnull p -> unit;
    ...
    val getType_ =
      _import "cairo_gobject_surface_get_type" : unit -> GObjectType.C.val_;
