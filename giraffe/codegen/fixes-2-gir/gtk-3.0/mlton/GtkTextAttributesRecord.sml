structure GtkTextAttributesRecord :>
  sig
    include GTK_TEXT_ATTRIBUTES_RECORD
  end =
  struct
    type notnull = CPointer.notnull
    type 'a p = 'a CPointer.p

    val new_ = _import "gtk_text_attributes_new" : unit -> notnull p;

    val ref_ = _import "gtk_text_attributes_ref" : notnull p -> notnull p;

    val unref_ = _import "gtk_text_attributes_unref" : notnull p -> unit;
    ...
    val getType_ =
      _import "gtk_text_attributes_get_type" : unit -> GObjectType.C.val_;
