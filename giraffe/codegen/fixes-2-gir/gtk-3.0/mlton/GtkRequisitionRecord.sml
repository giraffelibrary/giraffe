structure GtkRequisitionRecord :>
  ...
  struct
    ...
    val new_ = _import "gtk_requisition_new" : unit -> notnull p;

    val copy_ = _import "gtk_requisition_copy" : notnull p -> notnull p;

    val free_ = _import "gtk_requisition_free" : notnull p -> unit;
    ...
    val getType_ =
      _import "gtk_requisition_get_type" : unit -> GObjectType.C.val_;
