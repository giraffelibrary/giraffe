structure GtkTreeIterRecord :>
  sig
    include GTK_TREE_ITER_RECORD
  end =
  struct
    ...
    val copy_ = _import "gtk_tree_iter_copy" : notnull p -> notnull p;

    val free_ = _import "gtk_tree_iter_free" : notnull p -> unit;
    ...
    val getType_ =
      _import "gtk_tree_iter_get_type" : unit -> GObjectType.C.val_;
