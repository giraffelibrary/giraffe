structure GtkIconSourceRecord :>
  sig
    include GTK_ICON_SOURCE_RECORD
  end =
  struct
    ...
    val new_ = _import "gtk_icon_source_new" : unit -> notnull p;

    val copy_ = _import "gtk_icon_source_copy" : notnull p -> notnull p;

    val free_ = _import "gtk_icon_source_free" : notnull p -> unit;
    ...
    val getType_ =
      _import "gtk_icon_source_get_type" : unit -> GObjectType.C.val_;
