structure GtkIconSetRecord :>
  ...
  struct
    ...
    val new_ = _import "gtk_icon_set_new" : unit -> notnull p;

    val copy_ = _import "gtk_icon_set_copy" : notnull p -> notnull p;

    val free_ = _import "gtk_icon_set_free" : notnull p -> unit;
    ...
    val getType_ =
      _import "gtk_icon_set_get_type" : unit -> GObjectType.C.val_;
