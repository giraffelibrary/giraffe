structure GtkWidget :>
  ...
  struct
    ...
    val addEvents_ = fn x1 & x2 => (_import "gtk_widget_add_events" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GdkEventMask.FFI.val_ -> unit;) (x1, x2)
    ...
    val getEvents_ = _import "gtk_widget_get_events" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p -> GdkEventMask.FFI.val_;
    ...
    val setEvents_ = fn x1 & x2 => (_import "gtk_widget_set_events" : GtkWidgetClass.FFI.notnull GtkWidgetClass.FFI.p * GdkEventMask.FFI.val_ -> unit;) (x1, x2)
