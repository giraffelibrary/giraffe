  ...
  sig
    ...
    structure AccelMap :
      GTK_ACCEL_MAP
        ...
        where type accel_key_record_t = AccelKeyRecord.t
    structure Accessible :
      GTK_ACCESSIBLE
        where type 'a class_t = 'a AccessibleClass.t
        where type 'a widget_class_t = 'a WidgetClass.t
    structure Action :
      GTK_ACTION
        where type 'a class_t = 'a ActionClass.t
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type 'a widget_class_t = 'a WidgetClass.t
        where type 'a accel_group_class_t = 'a AccelGroupClass.t
    ...
    structure Buildable :
      GTK_BUILDABLE
        ...
        where type 'a builder_class_t = 'a BuilderClass.t
    structure Builder :
      GTK_BUILDER
    ...
    structure CellArea :
      GTK_CELL_AREA
        ...
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type 'a cell_layout_class_t = 'a CellLayoutClass.t
        ...
        where type 'a cell_area_context_class_t = 'a CellAreaContextClass.t
        where type 'a widget_class_t = 'a WidgetClass.t
        where type orientation_t = Orientation.t
        where type tree_iter_record_t = TreeIterRecord.t
        where type 'a tree_model_class_t = 'a TreeModelClass.t
        where type 'a cell_editable_class_t = 'a CellEditableClass.t
        where type 'a cell_renderer_class_t = 'a CellRendererClass.t
    structure CellAreaBoxClass :
      GTK_CELL_AREA_BOX_CLASS
        where type 'a cell_area_class_t = 'a CellAreaClass.t
    ...
    structure CellRenderer :
      GTK_CELL_RENDERER
        ...
        where type requisition_record_t = RequisitionRecord.t
        where type size_request_mode_t = SizeRequestMode.t
    ...
    structure Clipboard :
      GTK_CLIPBOARD
        ...
        where type selection_data_record_t = SelectionDataRecord.t
        where type 'a text_buffer_class_t = 'a TextBufferClass.t
    ...
    structure CssProvider :
      GTK_CSS_PROVIDER
        ...
        where type 'a style_provider_class_t = 'a StyleProviderClass.t
    ...
    structure FileChooser :
      GTK_FILE_CHOOSER
        ...
        where type 'a file_filter_class_t = 'a FileFilterClass.t
        where type 'a widget_class_t = 'a WidgetClass.t
    structure FileFilter :
      GTK_FILE_FILTER
        where type 'a class_t = 'a FileFilterClass.t
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type file_filter_info_record_t = FileFilterInfoRecord.t
    ...
    structure IMContextSimpleClass :
      GTK_I_M_CONTEXT_SIMPLE_CLASS
        where type 'a i_m_context_class_t = 'a IMContextClass.t
    ...
    structure IconFactory :
      GTK_ICON_FACTORY
        ...
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type icon_set_record_t = IconSetRecord.t
    structure IconInfo :
      GTK_ICON_INFO
        where type record_t = IconInfoRecord.t
        where type 'a icon_theme_class_t = 'a IconThemeClass.t
        where type 'a style_context_class_t = 'a StyleContextClass.t
    structure IconSet :
      GTK_ICON_SET
        where type record_t = IconSetRecord.t
        where type icon_source_record_t = IconSourceRecord.t
        where type 'a style_context_class_t = 'a StyleContextClass.t
    structure IconSize :
      GTK_ICON_SIZE
        where type 'a settings_class_t = 'a SettingsClass.t
    ...
    structure IconTheme :
      GTK_ICON_THEME
        ...
        where type icon_info_record_t = IconInfoRecord.t
    ...
    structure ListStore :
      GTK_LIST_STORE
        ...
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type 'a tree_drag_dest_class_t = 'a TreeDragDestClass.t
        where type 'a tree_drag_source_class_t = 'a TreeDragSourceClass.t
        where type 'a tree_model_class_t = 'a TreeModelClass.t
        where type 'a tree_sortable_class_t = 'a TreeSortableClass.t
        where type tree_iter_record_t = TreeIterRecord.t
    structure MiscClass :
      GTK_MISC_CLASS
        where type 'a widget_class_t = 'a WidgetClass.t
    ...
    structure PageSetup :
      GTK_PAGE_SETUP
        ...
        where type paper_size_record_t = PaperSizeRecord.t
    ...
    structure RecentChooser :
      GTK_RECENT_CHOOSER
        ...
        where type recent_info_record_t = RecentInfoRecord.t
        where type 'a recent_filter_class_t = 'a RecentFilterClass.t
        where type 'a recent_manager_class_t = 'a RecentManagerClass.t
    ...
    structure RecentFilter :
      GTK_RECENT_FILTER
        ...
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type recent_filter_info_record_t = RecentFilterInfoRecord.t
    ...
    structure RecentManager :
      GTK_RECENT_MANAGER
        ...
        where type recent_data_record_t = RecentDataRecord.t
        where type recent_info_record_t = RecentInfoRecord.t
    ...
    structure Scrollable :
      GTK_SCROLLABLE
        ...
        where type 'a adjustment_class_t = 'a AdjustmentClass.t
    ...
    structure StyleContext :
      GTK_STYLE_CONTEXT
        ...
        where type border_record_t = BorderRecord.t
        where type region_flags_t = RegionFlags.t
        where type icon_set_record_t = IconSetRecord.t
        where type 'a style_provider_class_t = 'a StyleProviderClass.t
        where type junction_sides_t = JunctionSides.t
        where type widget_path_record_t = WidgetPathRecord.t
        where type state_flags_t = StateFlags.t
        where type state_type_t = StateType.t
        where type text_direction_t = TextDirection.t
    structure StyleProperties :
      GTK_STYLE_PROPERTIES
        ...
        where type 'a style_provider_class_t = 'a StyleProviderClass.t
        where type symbolic_color_record_t = SymbolicColorRecord.t
        where type state_flags_t = StateFlags.t
    structure StyleProvider :
      GTK_STYLE_PROVIDER
        where type 'a class_t = 'a StyleProviderClass.t
        where type 'a icon_factory_class_t = 'a IconFactoryClass.t
        where type 'a style_properties_class_t = 'a StylePropertiesClass.t
        where type state_flags_t = StateFlags.t
        where type widget_path_record_t = WidgetPathRecord.t
    ...
    structure TextBuffer :
      GTK_TEXT_BUFFER
        ...
        where type 'a text_child_anchor_class_t = 'a TextChildAnchorClass.t
        where type 'a text_mark_class_t = 'a TextMarkClass.t
        where type 'a clipboard_class_t = 'a ClipboardClass.t
        where type text_iter_record_t = TextIterRecord.t
        where type 'a text_tag_class_t = 'a TextTagClass.t
        where type target_list_record_t = TargetListRecord.t
        where type 'a text_tag_table_class_t = 'a TextTagTableClass.t
    ...
    structure TextIter :
      GTK_TEXT_ITER
        ...
        where type text_attributes_record_t = TextAttributesRecord.t
        where type 'a text_buffer_class_t = 'a TextBufferClass.t
        where type 'a text_child_anchor_class_t = 'a TextChildAnchorClass.t
        where type 'a text_tag_class_t = 'a TextTagClass.t
    structure TextMark :
    ...
    structure ToolShell :
      GTK_TOOL_SHELL
        ...
        where type orientation_t = Orientation.t
        where type 'a size_group_class_t = 'a SizeGroupClass.t
    structure Tooltip :
      GTK_TOOLTIP
    ...
    structure TreeDragDest :
      GTK_TREE_DRAG_DEST
        ...
        where type selection_data_record_t = SelectionDataRecord.t
        where type tree_path_record_t = TreePathRecord.t
    ...
    structure ActionGroup :
      GTK_ACTION_GROUP
        ...
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type action_entry_t = ActionEntry.t
        where type 'a widget_class_t = 'a WidgetClass.t
        where type 'a action_class_t = 'a ActionClass.t
    structure ArrowClass :
      GTK_ARROW_CLASS
        where type 'a misc_class_t = 'a MiscClass.t
    structure BinClass :
      GTK_BIN_CLASS
        where type 'a container_class_t = 'a ContainerClass.t
    structure BoxClass :
      GTK_BOX_CLASS
        where type 'a container_class_t = 'a ContainerClass.t
    structure Calendar :
    ...
    structure CellAreaBox :
      GTK_CELL_AREA_BOX
        ...
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type 'a cell_layout_class_t = 'a CellLayoutClass.t
        where type 'a orientable_class_t = 'a OrientableClass.t
        where type 'a cell_renderer_class_t = 'a CellRendererClass.t
    structure CellRendererAccelClass :
      GTK_CELL_RENDERER_ACCEL_CLASS
        where type 'a cell_renderer_text_class_t = 'a CellRendererTextClass.t
    ...
    structure HSeparatorClass :
      GTK_H_SEPARATOR_CLASS
        where type 'a separator_class_t = 'a SeparatorClass.t
    ...
    structure RadioActionClass :
      GTK_RADIO_ACTION_CLASS
        where type 'a toggle_action_class_t = 'a ToggleActionClass.t
    structure Range :
      GTK_RANGE
    ...
    structure RecentAction :
      GTK_RECENT_ACTION
        ...
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type 'a recent_chooser_class_t = 'a RecentChooserClass.t
        where type 'a recent_manager_class_t = 'a RecentManagerClass.t
    structure ScaleClass :
      GTK_SCALE_CLASS
        where type 'a range_class_t = 'a RangeClass.t
    ...
    structure Settings :
      GTK_SETTINGS
        ...
        where type 'a style_provider_class_t = 'a StyleProviderClass.t
        where type settings_value_record_t = SettingsValueRecord.t
    ...
    structure SpinButtonClass :
      GTK_SPIN_BUTTON_CLASS
        where type 'a entry_class_t = 'a EntryClass.t
    structure Spinner :
      GTK_SPINNER
    ...
    structure Switch :
      GTK_SWITCH
        ...
        where type 'a activatable_class_t = 'a ActivatableClass.t
        where type 'a buildable_class_t = 'a BuildableClass.t
    ...
    structure AccelLabelClass :
      GTK_ACCEL_LABEL_CLASS
        where type 'a label_class_t = 'a LabelClass.t
    structure AlignmentClass :
      GTK_ALIGNMENT_CLASS
        where type 'a bin_class_t = 'a BinClass.t
    structure AppChooserWidgetClass :
      GTK_APP_CHOOSER_WIDGET_CLASS
        where type 'a box_class_t = 'a BoxClass.t
    structure Arrow :
      GTK_ARROW
    ...
    structure HPanedClass :
      GTK_H_PANED_CLASS
        where type 'a paned_class_t = 'a PanedClass.t
    structure HScaleClass :
      GTK_H_SCALE_CLASS
        where type 'a scale_class_t = 'a ScaleClass.t
    structure HScrollbarClass :
      GTK_H_SCROLLBAR_CLASS
        where type 'a scrollbar_class_t = 'a ScrollbarClass.t
    ...
    structure IMMulticontext :
      GTK_I_M_MULTICONTEXT
        ...
        where type 'a menu_shell_class_t = 'a MenuShellClass.t
    structure IconView :
      GTK_ICON_VIEW
        where type 'a class_t = 'a IconViewClass.t
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type 'a cell_layout_class_t = 'a CellLayoutClass.t
        where type 'a scrollable_class_t = 'a ScrollableClass.t
        where type tree_iter_record_t = TreeIterRecord.t
        where type icon_view_drop_position_t = IconViewDropPosition.t
        where type 'a cell_renderer_class_t = 'a CellRendererClass.t
        where type 'a tooltip_class_t = 'a TooltipClass.t
        where type tree_path_record_t = TreePathRecord.t
    ...
    structure SpinButton :
      GTK_SPIN_BUTTON
        ...
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type 'a cell_editable_class_t = 'a CellEditableClass.t
        where type 'a editable_class_t = 'a EditableClass.t
    ...
    structure TreeSelection :
      GTK_TREE_SELECTION
        ...
        where type 'a tree_model_class_t = 'a TreeModelClass.t
        where type 'a tree_view_class_t = 'a TreeViewClass.t
        where type tree_iter_record_t = TreeIterRecord.t
        where type tree_path_record_t = TreePathRecord.t
        where type selection_mode_t = SelectionMode.t
    structure TreeView :
      GTK_TREE_VIEW
        ...
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type 'a scrollable_class_t = 'a ScrollableClass.t
        where type 'a tree_selection_class_t = 'a TreeSelectionClass.t
        ...
        where type 'a tree_view_column_class_t = 'a TreeViewColumnClass.t
        where type 'a tree_model_class_t = 'a TreeModelClass.t
    structure VBoxClass :
      GTK_V_BOX_CLASS
        where type 'a box_class_t = 'a BoxClass.t
    ...
    structure AppChooserButtonClass :
      GTK_APP_CHOOSER_BUTTON_CLASS
        where type 'a combo_box_class_t = 'a ComboBoxClass.t
    structure AppChooserWidget :
      GTK_APP_CHOOSER_WIDGET
        where type 'a class_t = 'a AppChooserWidgetClass.t
        where type 'a app_chooser_class_t = 'a AppChooserClass.t
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type 'a orientable_class_t = 'a OrientableClass.t
        where type 'a menu_class_t = 'a MenuClass.t
    ...
    structure AspectFrameClass :
      GTK_ASPECT_FRAME_CLASS
        where type 'a frame_class_t = 'a FrameClass.t
    ...
    structure CheckMenuItemClass :
      GTK_CHECK_MENU_ITEM_CLASS
        where type 'a menu_item_class_t = 'a MenuItemClass.t
    structure ColorButtonClass :
      GTK_COLOR_BUTTON_CLASS
        where type 'a button_class_t = 'a ButtonClass.t
    ...
    structure Entry :
      GTK_ENTRY
        ...
        where type movement_step_t = MovementStep.t
        where type 'a menu_class_t = 'a MenuClass.t
        where type 'a entry_buffer_class_t = 'a EntryBufferClass.t
        where type 'a entry_completion_class_t = 'a EntryCompletionClass.t
        where type border_record_t = BorderRecord.t
        where type image_type_t = ImageType.t
        where type shadow_type_t = ShadowType.t
    structure EventBox :
    ...
    structure FileChooserButton :
      GTK_FILE_CHOOSER_BUTTON
        ...
        where type file_chooser_action_t = FileChooserAction.t
        where type 'a widget_class_t = 'a WidgetClass.t
        where type 'a file_chooser_class_t = 'a FileChooserClass.t
    ...
    structure FontChooserWidget :
      GTK_FONT_CHOOSER_WIDGET
        ...
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type 'a font_chooser_class_t = 'a FontChooserClass.t
        where type 'a orientable_class_t = 'a OrientableClass.t
    ...
    structure HButtonBoxClass :
      GTK_H_BUTTON_BOX_CLASS
        where type 'a button_box_class_t = 'a ButtonBoxClass.t
    structure HPaned :
      GTK_H_PANED
    ...
    structure PrintOperation :
      GTK_PRINT_OPERATION
        ...
        where type 'a window_class_t = 'a WindowClass.t
        where type 'a print_operation_preview_class_t = 'a PrintOperationPreviewClass.t
        where type 'a print_context_class_t = 'a PrintContextClass.t
        where type 'a widget_class_t = 'a WidgetClass.t
        where type 'a page_setup_class_t = 'a PageSetupClass.t
        where type 'a print_settings_class_t = 'a PrintSettingsClass.t
    ...
    structure SeparatorToolItemClass :
      GTK_SEPARATOR_TOOL_ITEM_CLASS
        where type 'a tool_item_class_t = 'a ToolItemClass.t
    ...
    structure ToolItemGroup :
      GTK_TOOL_ITEM_GROUP
        ...
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type 'a tool_shell_class_t = 'a ToolShellClass.t
        where type 'a tool_item_class_t = 'a ToolItemClass.t
        where type relief_style_t = ReliefStyle.t
        where type 'a widget_class_t = 'a WidgetClass.t
    structure ToolPalette :
      GTK_TOOL_PALETTE
        ...
        where type 'a orientable_class_t = 'a OrientableClass.t
        where type 'a scrollable_class_t = 'a ScrollableClass.t
        where type target_entry_record_t = TargetEntryRecord.t
        where type dest_defaults_t = DestDefaults.t
        where type 'a widget_class_t = 'a WidgetClass.t
        where type selection_data_record_t = SelectionDataRecord.t
        where type 'a tool_item_class_t = 'a ToolItemClass.t
        where type tool_palette_drag_targets_t = ToolPaletteDragTargets.t
        where type 'a tool_item_group_class_t = 'a ToolItemGroupClass.t
        where type icon_size_t = IconSize.t
        where type toolbar_style_t = ToolbarStyle.t
    structure Toolbar :
      GTK_TOOLBAR
    ...
    structure Widget :
      GTK_WIDGET
        ...
        where type 'a settings_class_t = 'a SettingsClass.t
        where type 'a style_context_class_t = 'a StyleContextClass.t
        where type 'a rc_style_class_t = 'a RcStyleClass.t
        where type state_type_t = StateType.t
        where type 'a accel_group_class_t = 'a AccelGroupClass.t
        where type 'a window_class_t = 'a WindowClass.t
        where type allocation_record_t = AllocationRecord.t
        where type text_direction_t = TextDirection.t
    ...
    structure Window :
      GTK_WINDOW
        ...
        where type 'a buildable_class_t = 'a BuildableClass.t
        where type 'a window_group_class_t = 'a WindowGroupClass.t
        where type 'a accel_group_class_t = 'a AccelGroupClass.t
        where type 'a widget_class_t = 'a WidgetClass.t
        where type 'a application_class_t = 'a ApplicationClass.t
    ...
    structure AboutDialogClass :
      GTK_ABOUT_DIALOG_CLASS
        where type 'a dialog_class_t = 'a DialogClass.t
    ...
    structure CheckButtonClass :
      GTK_CHECK_BUTTON_CLASS
        where type 'a toggle_button_class_t = 'a ToggleButtonClass.t
    ...
    structure MenuToolButtonClass :
      GTK_MENU_TOOL_BUTTON_CLASS
        where type 'a tool_button_class_t = 'a ToolButtonClass.t
    ...
    structure RadioMenuItemClass :
      GTK_RADIO_MENU_ITEM_CLASS
        where type 'a check_menu_item_class_t = 'a CheckMenuItemClass.t
    ...
    structure VolumeButtonClass :
      GTK_VOLUME_BUTTON_CLASS
        where type 'a scale_button_class_t = 'a ScaleButtonClass.t
    ...
    structure RadioButtonClass :
      GTK_RADIO_BUTTON_CLASS
        where type 'a check_button_class_t = 'a CheckButtonClass.t
    ...
    structure RadioToolButtonClass :
      GTK_RADIO_TOOL_BUTTON_CLASS
        where type 'a toggle_tool_button_class_t = 'a ToggleToolButtonClass.t
