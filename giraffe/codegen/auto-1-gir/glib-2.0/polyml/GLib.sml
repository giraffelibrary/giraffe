structure GLib : G_LIB =
  struct
    local
      open PolyMLFFI
    in
      val access_ = call (load_sym libglib "g_access") (FFI.String.PolyML.INPTR &&> FFI.Int.PolyML.VAL --> FFI.Int.PolyML.VAL)
      ...
      val asciiStrcasecmp_ = call (load_sym libglib "g_ascii_strcasecmp") (FFI.String.PolyML.INPTR &&> FFI.String.PolyML.INPTR --> FFI.Int.PolyML.VAL)
      val asciiStrdown_ = call (load_sym libglib "g_ascii_strdown") (FFI.String.PolyML.INPTR &&> FFI.SSize.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      ...
      val asciiStrup_ = call (load_sym libglib "g_ascii_strup") (FFI.String.PolyML.INPTR &&> FFI.SSize.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      ...
      val chdir_ = call (load_sym libglib "g_chdir") (FFI.String.PolyML.INPTR --> FFI.Int.PolyML.VAL)
      val checkVersion_ =
      ...
      val markupEscapeText_ = call (load_sym libglib "g_markup_escape_text") (FFI.String.PolyML.INPTR &&> FFI.SSize.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      ...
      val mkdirWithParents_ = call (load_sym libglib "g_mkdir_with_parents") (FFI.String.PolyML.INPTR &&> FFI.Int.PolyML.VAL --> FFI.Int.PolyML.VAL)
      val mkdtemp_ = call (load_sym libglib "g_mkdtemp") (FFI.String.PolyML.INPTR --> FFI.String.PolyML.RETPTR)
      val mkdtempFull_ = call (load_sym libglib "g_mkdtemp_full") (FFI.String.PolyML.INPTR &&> FFI.Int.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val mkstemp_ = call (load_sym libglib "g_mkstemp") (FFI.String.PolyML.INPTR --> FFI.Int.PolyML.VAL)
      val mkstempFull_ =
      ...
      val quarkFromStaticString_ = call (load_sym libglib "g_quark_from_static_string") (FFI.String.PolyML.INOPTPTR --> GLibQuark.PolyML.VAL)
      val quarkFromString_ = call (load_sym libglib "g_quark_from_string") (FFI.String.PolyML.INOPTPTR --> GLibQuark.PolyML.VAL)
      val quarkToString_ = call (load_sym libglib "g_quark_to_string") (GLibQuark.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val quarkTryString_ = call (load_sym libglib "g_quark_try_string") (FFI.String.PolyML.INOPTPTR --> GLibQuark.PolyML.VAL)
      ...
      val regexEscapeNul_ = call (load_sym libglib "g_regex_escape_nul") (FFI.String.PolyML.INPTR &&> FFI.Int.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      ...
      val rmdir_ = call (load_sym libglib "g_rmdir") (FFI.String.PolyML.INPTR --> FFI.Int.PolyML.VAL)
      ...
      val sourceSetNameById_ = call (load_sym libglib "g_source_set_name_by_id") (FFI.UInt.PolyML.VAL &&> FFI.String.PolyML.INPTR --> FFI.PolyML.VOID)
      ...
      val strcasecmp_ = call (load_sym libglib "g_strcasecmp") (FFI.String.PolyML.INPTR &&> FFI.String.PolyML.INPTR --> FFI.Int.PolyML.VAL)
      ...
      val strcmp0_ = call (load_sym libglib "g_strcmp0") (FFI.String.PolyML.INPTR &&> FFI.String.PolyML.INPTR --> FFI.Int.PolyML.VAL)
      ...
      val strerror_ = call (load_sym libglib "g_strerror") (FFI.Int.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      ...
      val stringNewLen_ = call (load_sym libglib "g_string_new_len") (FFI.String.PolyML.INPTR &&> FFI.SSize.PolyML.VAL --> GLibStringRecord.PolyML.PTR)
      ...
      val strndup_ = call (load_sym libglib "g_strndup") (FFI.String.PolyML.INPTR &&> FFI.Size.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val strnfill_ = call (load_sym libglib "g_strnfill") (FFI.Size.PolyML.VAL &&> FFI.Char.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      ...
      val strsignal_ = call (load_sym libglib "g_strsignal") (FFI.Int.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val strstrLen_ =
      ...
      val strvLength_ = call (load_sym libglib "g_strv_length") (FFI.String.PolyML.INPTR --> FFI.UInt.PolyML.VAL)
      ...
      val unicharToUtf8_ = call (load_sym libglib "g_unichar_to_utf8") (FFI.Char.PolyML.VAL &&> FFI.String.PolyML.INPTR --> FFI.Int.PolyML.VAL)
      ...
      val unlink_ = call (load_sym libglib "g_unlink") (FFI.String.PolyML.INPTR --> FFI.Int.PolyML.VAL)
      ...
      val utf8Casefold_ = call (load_sym libglib "g_utf8_casefold") (FFI.String.PolyML.INPTR &&> FFI.SSize.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val utf8Collate_ = call (load_sym libglib "g_utf8_collate") (FFI.String.PolyML.INPTR &&> FFI.String.PolyML.INPTR --> FFI.Int.PolyML.VAL)
      val utf8CollateKey_ = call (load_sym libglib "g_utf8_collate_key") (FFI.String.PolyML.INPTR &&> FFI.SSize.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val utf8CollateKeyForFilename_ = call (load_sym libglib "g_utf8_collate_key_for_filename") (FFI.String.PolyML.INPTR &&> FFI.SSize.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      ...
      val utf8GetCharValidated_ = call (load_sym libglib "g_utf8_get_char_validated") (FFI.String.PolyML.INPTR &&> FFI.SSize.PolyML.VAL --> FFI.Char.PolyML.VAL)
      val utf8Normalize_ =
      ...
      val utf8OffsetToPointer_ = call (load_sym libglib "g_utf8_offset_to_pointer") (FFI.String.PolyML.INPTR &&> FFI.Long.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val utf8PointerToOffset_ = call (load_sym libglib "g_utf8_pointer_to_offset") (FFI.String.PolyML.INPTR &&> FFI.String.PolyML.INPTR --> FFI.Long.PolyML.VAL)
      ...
      val utf8Strdown_ = call (load_sym libglib "g_utf8_strdown") (FFI.String.PolyML.INPTR &&> FFI.SSize.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val utf8Strlen_ = call (load_sym libglib "g_utf8_strlen") (FFI.String.PolyML.INPTR &&> FFI.SSize.PolyML.VAL --> FFI.Long.PolyML.VAL)
      val utf8Strncpy_ =
      ...
      val utf8Strreverse_ = call (load_sym libglib "g_utf8_strreverse") (FFI.String.PolyML.INPTR &&> FFI.SSize.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val utf8Strup_ = call (load_sym libglib "g_utf8_strup") (FFI.String.PolyML.INPTR &&> FFI.SSize.PolyML.VAL --> FFI.String.PolyML.RETPTR)
      val utf8Substring_ =
