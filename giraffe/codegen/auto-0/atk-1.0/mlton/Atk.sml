structure Atk : ATK =
  struct
    ...
    val relationTypeGetName_ = _import "atk_relation_type_get_name" : AtkRelationType.C.val_ -> FFI.String.notnull FFI.String.out_p;
    val relationTypeRegister_ = _import "mlton_atk_relation_type_register" : cstring * unit CPointer.t -> AtkRelationType.C.val_;
    val removeFocusTracker_ = _import "atk_remove_focus_tracker" : FFI.Word32.val_ -> unit;
    val removeGlobalEventListener_ = _import "atk_remove_global_event_listener" : FFI.Word32.val_ -> unit;
    val removeKeyEventListener_ = _import "atk_remove_key_event_listener" : FFI.Word32.val_ -> unit;
    val roleForName_ = _import "mlton_atk_role_for_name" : cstring * unit CPointer.t -> AtkRole.C.val_;
    val roleGetLocalizedName_ = _import "atk_role_get_localized_name" : AtkRole.C.val_ -> FFI.String.notnull FFI.String.out_p;
    val roleGetName_ = _import "atk_role_get_name" : AtkRole.C.val_ -> FFI.String.notnull FFI.String.out_p;
    ...
    val stateTypeGetName_ = _import "atk_state_type_get_name" : AtkStateType.C.val_ -> FFI.String.notnull FFI.String.out_p;
    ...
    val textAttributeGetName_ = _import "atk_text_attribute_get_name" : AtkTextAttribute.C.val_ -> FFI.String.notnull FFI.String.out_p;
    val textAttributeGetValue_ = fn x1 & x2 => (_import "atk_text_attribute_get_value" : AtkTextAttribute.C.val_ * FFI.Int32.val_ -> FFI.String.notnull FFI.String.out_p;) (x1, x2)
