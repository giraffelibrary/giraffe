structure GtkToolItemGroup :>
  ...
  struct
    ...
    val getCollapsed_ = _import "gtk_tool_item_group_get_collapsed" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val getDropItem_ =
      fn
        x1
         & x2
    ...
    val setCollapsed_ = fn x1 & x2 => (_import "gtk_tool_item_group_set_collapsed" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Bool.val_ -> unit;) (x1, x2)
