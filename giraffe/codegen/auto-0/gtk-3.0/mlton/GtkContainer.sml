structure GtkContainer :>
  ...
  struct
    ...
    val getBorderWidth_ = _import "gtk_container_get_border_width" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Word32.val_;
    ...
    val setBorderWidth_ = fn x1 & x2 => (_import "gtk_container_set_border_width" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Word32.val_ -> unit;) (x1, x2)
    ...
    val setReallocateRedraws_ = fn x1 & x2 => (_import "gtk_container_set_reallocate_redraws" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Bool.val_ -> unit;) (x1, x2)
    ...
    fun getBorderWidth self = (GObjectObjectClass.C.withPtr ---> FFI.Word32.fromVal) getBorderWidth_ self
    ...
    fun setBorderWidth self borderWidth = (GObjectObjectClass.C.withPtr &&&> FFI.Word32.withVal ---> I) setBorderWidth_ (self & borderWidth)
    ...
    fun setReallocateRedraws self needsRedraws = (GObjectObjectClass.C.withPtr &&&> FFI.Bool.withVal ---> I) setReallocateRedraws_ (self & needsRedraws)
