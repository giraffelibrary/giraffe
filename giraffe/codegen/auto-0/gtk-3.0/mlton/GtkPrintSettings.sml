structure GtkPrintSettings :>
  ...
  struct
    ...
    val getCollate_ = _import "gtk_print_settings_get_collate" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val getDefaultSource_ = _import "gtk_print_settings_get_default_source" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    val getDither_ = _import "gtk_print_settings_get_dither" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    val getDouble_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val getFinishings_ = _import "gtk_print_settings_get_finishings" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    val getInt_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val getMediaType_ = _import "gtk_print_settings_get_media_type" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    val getNCopies_ = _import "gtk_print_settings_get_n_copies" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val getNumberUp_ = _import "gtk_print_settings_get_number_up" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    ...
    val getOutputBin_ = _import "gtk_print_settings_get_output_bin" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    ...
    val getPaperHeight_ = fn x1 & x2 => (_import "gtk_print_settings_get_paper_height" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * GtkUnit.C.val_ -> FFI.Double.val_;) (x1, x2)
    ...
    val getPaperWidth_ = fn x1 & x2 => (_import "gtk_print_settings_get_paper_width" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * GtkUnit.C.val_ -> FFI.Double.val_;) (x1, x2)
    ...
    val getPrinter_ = _import "gtk_print_settings_get_printer" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    val getPrinterLpi_ = _import "gtk_print_settings_get_printer_lpi" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Double.val_;
    ...
    val getResolution_ = _import "gtk_print_settings_get_resolution" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val getResolutionX_ = _import "gtk_print_settings_get_resolution_x" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val getResolutionY_ = _import "gtk_print_settings_get_resolution_y" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val getReverse_ = _import "gtk_print_settings_get_reverse" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val getScale_ = _import "gtk_print_settings_get_scale" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Double.val_;
    val getUseColor_ = _import "gtk_print_settings_get_use_color" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val hasKey_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val setCollate_ = fn x1 & x2 => (_import "gtk_print_settings_set_collate" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Bool.val_ -> unit;) (x1, x2)
    ...
    val setNCopies_ = fn x1 & x2 => (_import "gtk_print_settings_set_n_copies" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    val setNumberUp_ = fn x1 & x2 => (_import "gtk_print_settings_set_number_up" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    ...
    val setPrinterLpi_ = fn x1 & x2 => (_import "gtk_print_settings_set_printer_lpi" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Double.val_ -> unit;) (x1, x2)
    ...
    val setResolution_ = fn x1 & x2 => (_import "gtk_print_settings_set_resolution" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.val_ -> unit;) (x1, x2)
    ...
    val setReverse_ = fn x1 & x2 => (_import "gtk_print_settings_set_reverse" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Bool.val_ -> unit;) (x1, x2)
    val setScale_ = fn x1 & x2 => (_import "gtk_print_settings_set_scale" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Double.val_ -> unit;) (x1, x2)
    val setUseColor_ = fn x1 & x2 => (_import "gtk_print_settings_set_use_color" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Bool.val_ -> unit;) (x1, x2)
    val toFile_ =
      fn
        x1
         & (x2, x3)
