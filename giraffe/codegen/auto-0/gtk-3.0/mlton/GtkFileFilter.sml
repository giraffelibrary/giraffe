structure GtkFileFilter :>
  ...
  struct
    ...
    val filter_ = fn x1 & x2 => (_import "gtk_file_filter_filter" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * GtkFileFilterInfoRecord.C.notnull GtkFileFilterInfoRecord.C.p -> FFI.Bool.val_;) (x1, x2)
    val getName_ = _import "gtk_file_filter_get_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
