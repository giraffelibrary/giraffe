structure GtkPlug :>
  ...
  struct
    ...
    val new_ = _import "gtk_plug_new" : FFI.Word64.val_ -> GObjectObjectClass.C.notnull GObjectObjectClass.C.p;
    val newForDisplay_ = fn x1 & x2 => (_import "gtk_plug_new_for_display" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Word64.val_ -> GObjectObjectClass.C.notnull GObjectObjectClass.C.p;) (x1, x2)
    val construct_ = fn x1 & x2 => (_import "gtk_plug_construct" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Word64.val_ -> unit;) (x1, x2)
    ...
    val getId_ = _import "gtk_plug_get_id" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Word64.val_;
