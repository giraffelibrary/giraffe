structure GtkTreeDragSource :>
  ...
  struct
    ...
    in
      ...
      val dragDataDelete_ = call (load_sym libgtk "gtk_tree_drag_source_drag_data_delete") (GObjectObjectClass.PolyML.PTR &&> GtkTreePathRecord.PolyML.PTR --> FFI.PolyML.Bool.VAL)
      val rowDraggable_ = call (load_sym libgtk "gtk_tree_drag_source_row_draggable") (GObjectObjectClass.PolyML.PTR &&> GtkTreePathRecord.PolyML.PTR --> FFI.PolyML.Bool.VAL)
    end
