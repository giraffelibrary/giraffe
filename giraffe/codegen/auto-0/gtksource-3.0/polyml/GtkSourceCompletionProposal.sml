structure GtkSourceCompletionProposal :>
  ...
  struct
    ...
    in
      ...
      val equal_ = call (load_sym libgtksourceview "gtk_source_completion_proposal_equal") (GObjectObjectClass.PolyML.PTR &&> GObjectObjectClass.PolyML.PTR --> FFI.PolyML.Bool.VAL)
      ...
      val getInfo_ = call (load_sym libgtksourceview "gtk_source_completion_proposal_get_info") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      val getLabel_ = call (load_sym libgtksourceview "gtk_source_completion_proposal_get_label") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      val getMarkup_ = call (load_sym libgtksourceview "gtk_source_completion_proposal_get_markup") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      val getText_ = call (load_sym libgtksourceview "gtk_source_completion_proposal_get_text") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      val hash_ = call (load_sym libgtksourceview "gtk_source_completion_proposal_hash") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.Word32.VAL)
    end
    ...
    fun hash self = (GObjectObjectClass.C.withPtr ---> FFI.Word32.fromVal) hash_ self
    local
