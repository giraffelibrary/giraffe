structure PangoFontFace :>
  ...
  struct
    ...
    in
      ...
      val getFaceName_ = call (load_sym libpango "pango_font_face_get_face_name") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      val isSynthesized_ = call (load_sym libpango "pango_font_face_is_synthesized") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.Bool.VAL)
    end
