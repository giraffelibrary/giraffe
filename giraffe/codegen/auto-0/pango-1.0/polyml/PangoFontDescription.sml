structure PangoFontDescription :>
  ...
  struct
    ...
    in
      ...
      val equal_ = call (load_sym libpango "pango_font_description_equal") (PangoFontDescriptionRecord.PolyML.PTR &&> PangoFontDescriptionRecord.PolyML.PTR --> FFI.PolyML.Bool.VAL)
      val getFamily_ = call (load_sym libpango "pango_font_description_get_family") (PangoFontDescriptionRecord.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      ...
      val getSize_ = call (load_sym libpango "pango_font_description_get_size") (PangoFontDescriptionRecord.PolyML.PTR --> FFI.PolyML.Int32.VAL)
      val getSizeIsAbsolute_ = call (load_sym libpango "pango_font_description_get_size_is_absolute") (PangoFontDescriptionRecord.PolyML.PTR --> FFI.PolyML.Bool.VAL)
      ...
      val setAbsoluteSize_ = call (load_sym libpango "pango_font_description_set_absolute_size") (PangoFontDescriptionRecord.PolyML.PTR &&> FFI.PolyML.Double.VAL --> FFI.PolyML.VOID)
      val setFamily_ = call (load_sym libpango "pango_font_description_set_family") (PangoFontDescriptionRecord.PolyML.PTR &&> FFI.PolyML.String.INPTR --> FFI.PolyML.VOID)
      val setFamilyStatic_ = call (load_sym libpango "pango_font_description_set_family_static") (PangoFontDescriptionRecord.PolyML.PTR &&> FFI.PolyML.String.INPTR --> FFI.PolyML.VOID)
      ...
      val setSize_ = call (load_sym libpango "pango_font_description_set_size") (PangoFontDescriptionRecord.PolyML.PTR &&> FFI.PolyML.Int32.VAL --> FFI.PolyML.VOID)
      ...
      val toFilename_ = call (load_sym libpango "pango_font_description_to_filename") (PangoFontDescriptionRecord.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      val toString_ = call (load_sym libpango "pango_font_description_to_string") (PangoFontDescriptionRecord.PolyML.PTR --> FFI.PolyML.String.RETPTR)
      ...
      val fromString_ = call (load_sym libpango "pango_font_description_from_string") (FFI.PolyML.String.INPTR --> PangoFontDescriptionRecord.PolyML.PTR)
    end
    ...
    fun equal self desc2 = (PangoFontDescriptionRecord.C.withPtr &&&> PangoFontDescriptionRecord.C.withPtr ---> FFI.Bool.fromVal) equal_ (self & desc2)
    fun getFamily self = (PangoFontDescriptionRecord.C.withPtr ---> FFI.String.fromPtr false) getFamily_ self
    ...
    fun getSize self = (PangoFontDescriptionRecord.C.withPtr ---> FFI.Int32.fromVal) getSize_ self
    fun getSizeIsAbsolute self = (PangoFontDescriptionRecord.C.withPtr ---> FFI.Bool.fromVal) getSizeIsAbsolute_ self
    ...
    fun setAbsoluteSize self size = (PangoFontDescriptionRecord.C.withPtr &&&> FFI.Double.withVal ---> I) setAbsoluteSize_ (self & size)
    fun setFamily self family = (PangoFontDescriptionRecord.C.withPtr &&&> FFI.String.withConstPtr ---> I) setFamily_ (self & family)
    fun setFamilyStatic self family = (PangoFontDescriptionRecord.C.withPtr &&&> FFI.String.withConstPtr ---> I) setFamilyStatic_ (self & family)
    fun setGravity self gravity = (PangoFontDescriptionRecord.C.withPtr &&&> PangoGravity.C.withVal ---> I) setGravity_ (self & gravity)
    fun setSize self size = (PangoFontDescriptionRecord.C.withPtr &&&> FFI.Int32.withVal ---> I) setSize_ (self & size)
    ...
    fun toFilename self = (PangoFontDescriptionRecord.C.withPtr ---> FFI.String.fromPtr true) toFilename_ self
    fun toString self = (PangoFontDescriptionRecord.C.withPtr ---> FFI.String.fromPtr true) toString_ self
    fun unsetFields self toUnset = (PangoFontDescriptionRecord.C.withPtr &&&> PangoFontMask.C.withVal ---> I) unsetFields_ (self & toUnset)
    fun fromString str = (FFI.String.withConstPtr ---> PangoFontDescriptionRecord.C.fromPtr true) fromString_ str
  end
