structure GioDBusMessage :>
  ...
  struct
    ...
    val getNumUnixFds_ = _import "g_dbus_message_get_num_unix_fds" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.UInt32.val_;
    ...
    val getReplySerial_ = _import "g_dbus_message_get_reply_serial" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.UInt32.val_;
    ...
    val getSerial_ = _import "g_dbus_message_get_serial" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.UInt32.val_;
    ...
    val print_ = fn x1 & x2 => (_import "g_dbus_message_print" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.UInt32.val_ -> FFI.String.notnull FFI.String.out_p;) (x1, x2)
    ...
    val setNumUnixFds_ = fn x1 & x2 => (_import "g_dbus_message_set_num_unix_fds" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.UInt32.val_ -> unit;) (x1, x2)
    val setPath_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val setReplySerial_ = fn x1 & x2 => (_import "g_dbus_message_set_reply_serial" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.UInt32.val_ -> unit;) (x1, x2)
    val setSender_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val setSerial_ = fn x1 & x2 => (_import "g_dbus_message_set_serial" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.UInt32.val_ -> unit;) (x1, x2)
    val setSignature_ =
      fn
        x1 & (x2, x3) =>
          (
