structure GioDBusMessage :>
  ...
  struct
    ...
    val getArg0_ = _import "g_dbus_message_get_arg0" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    ...
    val getDestination_ = _import "g_dbus_message_get_destination" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    val getErrorName_ = _import "g_dbus_message_get_error_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    ...
    val getInterface_ = _import "g_dbus_message_get_interface" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    val getLocked_ = _import "g_dbus_message_get_locked" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val getMember_ = _import "g_dbus_message_get_member" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    ...
    val getNumUnixFds_ = _import "g_dbus_message_get_num_unix_fds" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Word32.val_;
    val getPath_ = _import "g_dbus_message_get_path" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    val getReplySerial_ = _import "g_dbus_message_get_reply_serial" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Word32.val_;
    val getSender_ = _import "g_dbus_message_get_sender" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    val getSerial_ = _import "g_dbus_message_get_serial" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Word32.val_;
    val getSignature_ = _import "g_dbus_message_get_signature" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    ...
    val print_ = fn x1 & x2 => (_import "g_dbus_message_print" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Word32.val_ -> FFI.String.notnull FFI.String.out_p;) (x1, x2)
    ...
    val setNumUnixFds_ = fn x1 & x2 => (_import "g_dbus_message_set_num_unix_fds" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Word32.val_ -> unit;) (x1, x2)
    val setPath_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val setReplySerial_ = fn x1 & x2 => (_import "g_dbus_message_set_reply_serial" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Word32.val_ -> unit;) (x1, x2)
    val setSender_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val setSerial_ = fn x1 & x2 => (_import "g_dbus_message_set_serial" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Word32.val_ -> unit;) (x1, x2)
    val setSignature_ =
      fn
        x1 & (x2, x3) =>
          (
    ...
    val toGerror_ = fn x1 & x2 => (_import "g_dbus_message_to_gerror" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * (unit, unit) GLibErrorRecord.C.r -> FFI.Bool.val_;) (x1, x2)
    ...
    fun getArg0 self = (GObjectObjectClass.C.withPtr ---> FFI.String.fromPtr false) getArg0_ self
    ...
    fun getDestination self = (GObjectObjectClass.C.withPtr ---> FFI.String.fromPtr false) getDestination_ self
    fun getErrorName self = (GObjectObjectClass.C.withPtr ---> FFI.String.fromPtr false) getErrorName_ self
    ...
    fun getInterface self = (GObjectObjectClass.C.withPtr ---> FFI.String.fromPtr false) getInterface_ self
    ...
    fun setErrorName self value = (GObjectObjectClass.C.withPtr &&&> FFI.String.withConstPtr ---> I) setErrorName_ (self & value)
