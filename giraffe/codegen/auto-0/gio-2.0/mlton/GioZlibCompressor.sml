structure GioZlibCompressor :>
  ...
  struct
    ...
    val new_ = fn x1 & x2 => (_import "g_zlib_compressor_new" : GioZlibCompressorFormat.C.val_ * FFI.Int32.val_ -> GObjectObjectClass.C.notnull GObjectObjectClass.C.p;) (x1, x2)
    ...
    fun new format level = (GioZlibCompressorFormat.C.withVal &&&> FFI.Int32.withVal ---> GioZlibCompressorClass.C.fromPtr true) new_ (format & level)
