structure GioCharsetConverter :>
  ...
  struct
    ...
    val getNumFallbacks_ = _import "g_charset_converter_get_num_fallbacks" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Word32.val_;
    ...
    fun getNumFallbacks self = (GObjectObjectClass.C.withPtr ---> FFI.Word32.fromVal) getNumFallbacks_ self
