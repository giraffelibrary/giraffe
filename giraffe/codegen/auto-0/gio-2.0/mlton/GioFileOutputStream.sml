structure GioFileOutputStream :>
  ...
  struct
    ...
    val getEtag_ = _import "g_file_output_stream_get_etag" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    val queryInfo_ =
      fn
        x1
         & (x2, x3)
    ...
    fun getEtag self = (GObjectObjectClass.C.withPtr ---> FFI.String.fromPtr true) getEtag_ self
