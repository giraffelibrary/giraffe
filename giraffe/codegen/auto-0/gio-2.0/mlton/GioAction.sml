structure GioAction :>
  ...
  struct
    ...
    val getEnabled_ = _import "g_action_get_enabled" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val getName_ = _import "g_action_get_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    ...
    fun getEnabled self = (GObjectObjectClass.C.withPtr ---> FFI.Bool.fromVal) getEnabled_ self
