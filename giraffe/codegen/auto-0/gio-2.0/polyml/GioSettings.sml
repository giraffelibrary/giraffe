structure GioSettings :>
  ...
  struct
    ...
    in
      ...
      val new_ = call (load_sym libgio "g_settings_new") (FFI.PolyML.String.INPTR --> GObjectObjectClass.PolyML.PTR)
      val newWithBackend_ = call (load_sym libgio "g_settings_new_with_backend") (FFI.PolyML.String.INPTR &&> GioSettingsBackendRecord.PolyML.PTR --> GObjectObjectClass.PolyML.PTR)
      ...
      val newWithPath_ = call (load_sym libgio "g_settings_new_with_path") (FFI.PolyML.String.INPTR &&> FFI.PolyML.String.INPTR --> GObjectObjectClass.PolyML.PTR)
      val sync_ = call (load_sym libgio "g_settings_sync") (FFI.PolyML.VOID --> FFI.PolyML.VOID)
      val unbind_ = call (load_sym libgio "g_settings_unbind") (FFI.PolyML.String.INPTR --> FFI.PolyML.VOID)
      ...
      val getBoolean_ = call (load_sym libgio "g_settings_get_boolean") (GObjectObjectClass.PolyML.PTR &&> FFI.PolyML.String.INPTR --> FFI.PolyML.Bool.VAL)
      ...
      val reset_ = call (load_sym libgio "g_settings_reset") (GObjectObjectClass.PolyML.PTR &&> FFI.PolyML.String.INPTR --> FFI.PolyML.VOID)
