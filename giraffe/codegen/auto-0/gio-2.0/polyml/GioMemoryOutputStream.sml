structure GioMemoryOutputStream :>
  ...
  struct
    ...
    in
      ...
      val getDataSize_ = call (load_sym libgio "g_memory_output_stream_get_data_size") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.UInt64.VAL)
      val getSize_ = call (load_sym libgio "g_memory_output_stream_get_size") (GObjectObjectClass.PolyML.PTR --> FFI.PolyML.UInt64.VAL)
