structure PangoCairoFontMap :>
  ...
  struct
    ...
    val getResolution_ = _import "pango_cairo_font_map_get_resolution" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Double.val_;
    val setDefault_ = _import "pango_cairo_font_map_set_default" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> unit;
    val setResolution_ = fn x1 & x2 => (_import "pango_cairo_font_map_set_resolution" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Double.val_ -> unit;) (x1, x2)
