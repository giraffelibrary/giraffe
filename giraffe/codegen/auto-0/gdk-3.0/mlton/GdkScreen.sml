structure GdkScreen :>
  ...
  struct
    ...
    val height_ = _import "gdk_screen_height" : unit -> FFI.Int32.val_;
    val heightMm_ = _import "gdk_screen_height_mm" : unit -> FFI.Int32.val_;
    val width_ = _import "gdk_screen_width" : unit -> FFI.Int32.val_;
    val widthMm_ = _import "gdk_screen_width_mm" : unit -> FFI.Int32.val_;
    ...
    val getHeight_ = _import "gdk_screen_get_height" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val getHeightMm_ = _import "gdk_screen_get_height_mm" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    ...
    val getMonitorAtWindow_ = fn x1 & x2 => (_import "gdk_screen_get_monitor_at_window" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;) (x1, x2)
    ...
    val getMonitorHeightMm_ = fn x1 & x2 => (_import "gdk_screen_get_monitor_height_mm" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.val_ -> FFI.Int32.val_;) (x1, x2)
    val getMonitorPlugName_ = fn x1 & x2 => (_import "gdk_screen_get_monitor_plug_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.val_ -> FFI.String.notnull FFI.String.out_p;) (x1, x2)
    val getMonitorWidthMm_ = fn x1 & x2 => (_import "gdk_screen_get_monitor_width_mm" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Int32.val_ -> FFI.Int32.val_;) (x1, x2)
    val getNMonitors_ = _import "gdk_screen_get_n_monitors" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val getNumber_ = _import "gdk_screen_get_number" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val getPrimaryMonitor_ = _import "gdk_screen_get_primary_monitor" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val getResolution_ = _import "gdk_screen_get_resolution" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Double.val_;
    ...
    val getWidth_ = _import "gdk_screen_get_width" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val getWidthMm_ = _import "gdk_screen_get_width_mm" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Int32.val_;
    val isComposited_ = _import "gdk_screen_is_composited" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.Bool.val_;
    val makeDisplayName_ = _import "gdk_screen_make_display_name" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p -> FFI.String.notnull FFI.String.out_p;
    ...
    val setResolution_ = fn x1 & x2 => (_import "gdk_screen_set_resolution" : GObjectObjectClass.C.notnull GObjectObjectClass.C.p * FFI.Double.val_ -> unit;) (x1, x2)
