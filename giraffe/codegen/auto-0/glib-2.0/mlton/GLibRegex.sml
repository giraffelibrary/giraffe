structure GLibRegex :>
  ...
  struct
    ...
    val getCaptureCount_ = _import "g_regex_get_capture_count" : GLibRegexRecord.C.notnull GLibRegexRecord.C.p -> FFI.Int32.val_;
    ...
    val getMaxBackref_ = _import "g_regex_get_max_backref" : GLibRegexRecord.C.notnull GLibRegexRecord.C.p -> FFI.Int32.val_;
    val getPattern_ = _import "g_regex_get_pattern" : GLibRegexRecord.C.notnull GLibRegexRecord.C.p -> FFI.String.notnull FFI.String.out_p;
