structure GLibSource :>
  ...
  struct
    ...
    val attach_ = fn x1 & x2 => (_import "g_source_attach" : GLibSourceRecord.C.notnull GLibSourceRecord.C.p * GLibMainContextRecord.C.notnull GLibMainContextRecord.C.p -> FFI.Word32.val_;) (x1, x2)
