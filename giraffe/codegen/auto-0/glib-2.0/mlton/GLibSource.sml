structure GLibSource :>
  ...
  struct
    ...
    val attach_ = fn x1 & x2 => (_import "g_source_attach" : GLibSourceRecord.C.notnull GLibSourceRecord.C.p * GLibMainContextRecord.C.notnull GLibMainContextRecord.C.p -> FFI.UInt32.val_;) (x1, x2)
    ...
    val getId_ = _import "g_source_get_id" : GLibSourceRecord.C.notnull GLibSourceRecord.C.p -> FFI.UInt32.val_;
    ...
    val remove_ = _import "g_source_remove" : FFI.UInt32.val_ -> FFI.Bool.val_;
    val setNameById_ =
      fn
        x1 & (x2, x3) =>
          (
