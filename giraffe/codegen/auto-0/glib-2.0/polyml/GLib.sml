structure GLib : G_LIB =
  struct
    ...
    in
      ...
      val asciiDigitValue_ = call (load_sym libglib "g_ascii_digit_value") (FFI.PolyML.UInt8.VAL --> FFI.PolyML.Int32.VAL)
      val asciiDtostr_ =
      ...
      val asciiTolower_ = call (load_sym libglib "g_ascii_tolower") (FFI.PolyML.UInt8.VAL --> FFI.PolyML.UInt8.VAL)
      val asciiToupper_ = call (load_sym libglib "g_ascii_toupper") (FFI.PolyML.UInt8.VAL --> FFI.PolyML.UInt8.VAL)
      val asciiXdigitValue_ = call (load_sym libglib "g_ascii_xdigit_value") (FFI.PolyML.UInt8.VAL --> FFI.PolyML.Int32.VAL)
      val assertWarning_ =
      ...
      val atomicPointerAnd_ = call (load_sym libglib "g_atomic_pointer_and") (FFI.PolyML.UInt64.VAL --> FFI.PolyML.UInt64.VAL)
      ...
      val atomicPointerOr_ = call (load_sym libglib "g_atomic_pointer_or") (FFI.PolyML.UInt64.VAL --> FFI.PolyML.UInt64.VAL)
      val atomicPointerSet_ = call (load_sym libglib "g_atomic_pointer_set") (FFI.PolyML.VOID --> FFI.PolyML.VOID)
      val atomicPointerXor_ = call (load_sym libglib "g_atomic_pointer_xor") (FFI.PolyML.UInt64.VAL --> FFI.PolyML.UInt64.VAL)
      val basename_ = call (load_sym libglib "g_basename") (FFI.PolyML.String.INPTR --> FFI.PolyML.String.RETPTR)
      val bitNthLsf_ = call (load_sym libglib "g_bit_nth_lsf") (FFI.PolyML.UInt64.VAL &&> FFI.PolyML.Int32.VAL --> FFI.PolyML.Int32.VAL)
      val bitNthMsf_ = call (load_sym libglib "g_bit_nth_msf") (FFI.PolyML.UInt64.VAL &&> FFI.PolyML.Int32.VAL --> FFI.PolyML.Int32.VAL)
      val bitStorage_ = call (load_sym libglib "g_bit_storage") (FFI.PolyML.UInt64.VAL --> FFI.PolyML.UInt32.VAL)
      val blowChunks_ = call (load_sym libglib "g_blow_chunks") (FFI.PolyML.VOID --> FFI.PolyML.VOID)
      val bookmarkFileErrorQuark_ = call (load_sym libglib "g_bookmark_file_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      ...
      val convertErrorQuark_ = call (load_sym libglib "g_convert_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      val datalistClear_ = call (load_sym libglib "g_datalist_clear") (GLibDataRecord.PolyML.PTR --> FFI.PolyML.VOID)
      val datalistGetFlags_ = call (load_sym libglib "g_datalist_get_flags") (GLibDataRecord.PolyML.PTR --> FFI.PolyML.UInt32.VAL)
      val datalistInit_ = call (load_sym libglib "g_datalist_init") (GLibDataRecord.PolyML.PTR --> FFI.PolyML.VOID)
      val datalistSetFlags_ = call (load_sym libglib "g_datalist_set_flags") (GLibDataRecord.PolyML.PTR &&> FFI.PolyML.UInt32.VAL --> FFI.PolyML.VOID)
      val datalistUnsetFlags_ = call (load_sym libglib "g_datalist_unset_flags") (GLibDataRecord.PolyML.PTR &&> FFI.PolyML.UInt32.VAL --> FFI.PolyML.VOID)
      val datasetDestroy_ = call (load_sym libglib "g_dataset_destroy") (FFI.PolyML.VOID --> FFI.PolyML.VOID)
      val dateGetDaysInMonth_ = call (load_sym libglib "g_date_get_days_in_month") (GLibDateMonth.PolyML.VAL &&> FFI.PolyML.UInt16.VAL --> FFI.PolyML.UInt8.VAL)
      val dateGetMondayWeeksInYear_ = call (load_sym libglib "g_date_get_monday_weeks_in_year") (FFI.PolyML.UInt16.VAL --> FFI.PolyML.UInt8.VAL)
      val dateGetSundayWeeksInYear_ = call (load_sym libglib "g_date_get_sunday_weeks_in_year") (FFI.PolyML.UInt16.VAL --> FFI.PolyML.UInt8.VAL)
      val dateIsLeapYear_ = call (load_sym libglib "g_date_is_leap_year") (FFI.PolyML.UInt16.VAL --> FFI.PolyML.Bool.VAL)
      val dateStrftime_ =
      ...
      val dateTimeHash_ = call (load_sym libglib "g_date_time_hash") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      val dateValidDay_ = call (load_sym libglib "g_date_valid_day") (FFI.PolyML.UInt8.VAL --> FFI.PolyML.Bool.VAL)
      val dateValidDmy_ =
      ...
      val dateValidJulian_ = call (load_sym libglib "g_date_valid_julian") (FFI.PolyML.UInt32.VAL --> FFI.PolyML.Bool.VAL)
      ...
      val dateValidYear_ = call (load_sym libglib "g_date_valid_year") (FFI.PolyML.UInt16.VAL --> FFI.PolyML.Bool.VAL)
      val dcgettext_ =
      ...
      val directHash_ = call (load_sym libglib "g_direct_hash") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      val dngettext_ =
      ...
      val doubleHash_ = call (load_sym libglib "g_double_hash") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      val dpgettext_ =
      ...
      val fileErrorQuark_ = call (load_sym libglib "g_file_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      val fileOpenTmp_ =
      ...
      val formatSize_ = call (load_sym libglib "g_format_size") (FFI.PolyML.UInt64.VAL --> FFI.PolyML.String.RETPTR)
      val formatSizeForDisplay_ = call (load_sym libglib "g_format_size_for_display") (FFI.PolyML.Int64.VAL --> FFI.PolyML.String.RETPTR)
      val formatSizeFull_ = call (load_sym libglib "g_format_size_full") (FFI.PolyML.UInt64.VAL &&> GLibFormatSizeFlags.PolyML.VAL --> FFI.PolyML.String.RETPTR)
      ...
      val hookDestroy_ = call (load_sym libglib "g_hook_destroy") (GLibHookListRecord.PolyML.PTR &&> FFI.PolyML.UInt64.VAL --> FFI.PolyML.Bool.VAL)
      ...
      val int64Hash_ = call (load_sym libglib "g_int64_hash") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      val intEqual_ = call (load_sym libglib "g_int_equal") (FFI.PolyML.VOID --> FFI.PolyML.Bool.VAL)
      val intHash_ = call (load_sym libglib "g_int_hash") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      ...
      val ioChannelErrorQuark_ = call (load_sym libglib "g_io_channel_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      ...
      val keyFileErrorQuark_ = call (load_sym libglib "g_key_file_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      ...
      val logRemoveHandler_ = call (load_sym libglib "g_log_remove_handler") (FFI.PolyML.String.INPTR &&> FFI.PolyML.UInt32.VAL --> FFI.PolyML.VOID)
      ...
      val markupErrorQuark_ = call (load_sym libglib "g_markup_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      ...
      val optionErrorQuark_ = call (load_sym libglib "g_option_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      ...
      val quarkFromStaticString_ = call (load_sym libglib "g_quark_from_static_string") (FFI.PolyML.String.INOPTPTR --> FFI.PolyML.UInt32.VAL)
      val quarkFromString_ = call (load_sym libglib "g_quark_from_string") (FFI.PolyML.String.INOPTPTR --> FFI.PolyML.UInt32.VAL)
      val quarkToString_ = call (load_sym libglib "g_quark_to_string") (FFI.PolyML.UInt32.VAL --> FFI.PolyML.String.RETPTR)
      val quarkTryString_ = call (load_sym libglib "g_quark_try_string") (FFI.PolyML.String.INOPTPTR --> FFI.PolyML.UInt32.VAL)
      ...
      val randomInt_ = call (load_sym libglib "g_random_int") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      ...
      val randomSetSeed_ = call (load_sym libglib "g_random_set_seed") (FFI.PolyML.UInt32.VAL --> FFI.PolyML.VOID)
      ...
      val regexErrorQuark_ = call (load_sym libglib "g_regex_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      ...
      val shellErrorQuark_ = call (load_sym libglib "g_shell_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      ...
      val sliceFree1_ = call (load_sym libglib "g_slice_free1") (FFI.PolyML.UInt64.VAL --> FFI.PolyML.VOID)
      val sliceFreeChainWithOffset_ = call (load_sym libglib "g_slice_free_chain_with_offset") (FFI.PolyML.UInt64.VAL &&> FFI.PolyML.UInt64.VAL --> FFI.PolyML.VOID)
      ...
      val sourceRemove_ = call (load_sym libglib "g_source_remove") (FFI.PolyML.UInt32.VAL --> FFI.PolyML.Bool.VAL)
      val sourceSetNameById_ = call (load_sym libglib "g_source_set_name_by_id") (FFI.PolyML.UInt32.VAL &&> FFI.PolyML.String.INPTR --> FFI.PolyML.VOID)
      val spacedPrimesClosest_ = call (load_sym libglib "g_spaced_primes_closest") (FFI.PolyML.UInt32.VAL --> FFI.PolyML.UInt32.VAL)
      ...
      val spawnErrorQuark_ = call (load_sym libglib "g_spawn_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      ...
      val strHash_ = call (load_sym libglib "g_str_hash") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      val strcanon_ =
      ...
      val stringSizedNew_ = call (load_sym libglib "g_string_sized_new") (FFI.PolyML.UInt64.VAL --> GLibStringRecord.PolyML.PTR)
      ...
      val strndup_ = call (load_sym libglib "g_strndup") (FFI.PolyML.String.INPTR &&> FFI.PolyML.UInt64.VAL --> FFI.PolyML.String.RETPTR)
      val strnfill_ = call (load_sym libglib "g_strnfill") (FFI.PolyML.UInt64.VAL &&> FFI.PolyML.UInt8.VAL --> FFI.PolyML.String.RETPTR)
      ...
      val strvLength_ = call (load_sym libglib "g_strv_length") (FFI.PolyML.String.INPTR --> FFI.PolyML.UInt32.VAL)
      ...
      val testTrapFork_ = call (load_sym libglib "g_test_trap_fork") (FFI.PolyML.UInt64.VAL &&> GLibTestTrapFlags.PolyML.VAL --> FFI.PolyML.Bool.VAL)
      ...
      val threadErrorQuark_ = call (load_sym libglib "g_thread_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      ...
      val threadPoolGetMaxIdleTime_ = call (load_sym libglib "g_thread_pool_get_max_idle_time") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      ...
      val threadPoolGetNumUnusedThreads_ = call (load_sym libglib "g_thread_pool_get_num_unused_threads") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
      val threadPoolSetMaxIdleTime_ = call (load_sym libglib "g_thread_pool_set_max_idle_time") (FFI.PolyML.UInt32.VAL --> FFI.PolyML.VOID)
      ...
      val timeoutSourceNew_ = call (load_sym libglib "g_timeout_source_new") (FFI.PolyML.UInt32.VAL --> GLibSourceRecord.PolyML.PTR)
      val timeoutSourceNewSeconds_ = call (load_sym libglib "g_timeout_source_new_seconds") (FFI.PolyML.UInt32.VAL --> GLibSourceRecord.PolyML.PTR)
      val trashStackHeight_ = call (load_sym libglib "g_trash_stack_height") (GLibTrashStackRecord.PolyML.PTR --> FFI.PolyML.UInt32.VAL)
      ...
      val unicodeScriptFromIso15924_ = call (load_sym libglib "g_unicode_script_from_iso15924") (FFI.PolyML.UInt32.VAL --> GLibUnicodeScript.PolyML.VAL)
      val unicodeScriptToIso15924_ = call (load_sym libglib "g_unicode_script_to_iso15924") (GLibUnicodeScript.PolyML.VAL --> FFI.PolyML.UInt32.VAL)
      ...
      val usleep_ = call (load_sym libglib "g_usleep") (FFI.PolyML.UInt64.VAL --> FFI.PolyML.VOID)
      ...
      val variantParserGetErrorQuark_ = call (load_sym libglib "g_variant_parser_get_error_quark") (FFI.PolyML.VOID --> FFI.PolyML.UInt32.VAL)
    ...
    fun asciiDigitValue c = (FFI.UInt8.withVal ---> FFI.Int32.fromVal) asciiDigitValue_ c
    ...
    fun asciiTolower c = (FFI.UInt8.withVal ---> FFI.UInt8.fromVal) asciiTolower_ c
    fun asciiToupper c = (FFI.UInt8.withVal ---> FFI.UInt8.fromVal) asciiToupper_ c
    fun asciiXdigitValue c = (FFI.UInt8.withVal ---> FFI.Int32.fromVal) asciiXdigitValue_ c
    ...
    fun atomicPointerAnd val' = (FFI.UInt64.withVal ---> FFI.UInt64.fromVal) atomicPointerAnd_ val'
    fun atomicPointerCompareAndExchange () = (I ---> FFI.Bool.fromVal) atomicPointerCompareAndExchange_ ()
    fun atomicPointerOr val' = (FFI.UInt64.withVal ---> FFI.UInt64.fromVal) atomicPointerOr_ val'
    fun atomicPointerSet () = (I ---> I) atomicPointerSet_ ()
    fun atomicPointerXor val' = (FFI.UInt64.withVal ---> FFI.UInt64.fromVal) atomicPointerXor_ val'
    fun basename fileName = (FFI.String.withConstPtr ---> FFI.String.fromPtr false) basename_ fileName
    fun bitNthLsf mask nthBit = (FFI.UInt64.withVal &&&> FFI.Int32.withVal ---> FFI.Int32.fromVal) bitNthLsf_ (mask & nthBit)
    fun bitNthMsf mask nthBit = (FFI.UInt64.withVal &&&> FFI.Int32.withVal ---> FFI.Int32.fromVal) bitNthMsf_ (mask & nthBit)
    fun bitStorage number = (FFI.UInt64.withVal ---> FFI.UInt32.fromVal) bitStorage_ number
    fun blowChunks () = (I ---> I) blowChunks_ ()
    fun bookmarkFileErrorQuark () = (I ---> FFI.UInt32.fromVal) bookmarkFileErrorQuark_ ()
    ...
    fun convertErrorQuark () = (I ---> FFI.UInt32.fromVal) convertErrorQuark_ ()
    fun datalistClear datalist = (GLibDataRecord.C.withPtr ---> I) datalistClear_ datalist
    fun datalistGetFlags datalist = (GLibDataRecord.C.withPtr ---> FFI.UInt32.fromVal) datalistGetFlags_ datalist
    fun datalistInit datalist = (GLibDataRecord.C.withPtr ---> I) datalistInit_ datalist
    fun datalistSetFlags datalist flags = (GLibDataRecord.C.withPtr &&&> FFI.UInt32.withVal ---> I) datalistSetFlags_ (datalist & flags)
    fun datalistUnsetFlags datalist flags = (GLibDataRecord.C.withPtr &&&> FFI.UInt32.withVal ---> I) datalistUnsetFlags_ (datalist & flags)
    fun datasetDestroy () = (I ---> I) datasetDestroy_ ()
    fun dateGetDaysInMonth month year = (GLibDateMonth.C.withVal &&&> FFI.UInt16.withVal ---> FFI.UInt8.fromVal) dateGetDaysInMonth_ (month & year)
    fun dateGetMondayWeeksInYear year = (FFI.UInt16.withVal ---> FFI.UInt8.fromVal) dateGetMondayWeeksInYear_ year
    fun dateGetSundayWeeksInYear year = (FFI.UInt16.withVal ---> FFI.UInt8.fromVal) dateGetSundayWeeksInYear_ year
    fun dateIsLeapYear year = (FFI.UInt16.withVal ---> FFI.Bool.fromVal) dateIsLeapYear_ year
    ...
    fun dateTimeHash () = (I ---> FFI.UInt32.fromVal) dateTimeHash_ ()
    fun dateValidDay day = (FFI.UInt8.withVal ---> FFI.Bool.fromVal) dateValidDay_ day
    ...
    fun dateValidJulian julianDate = (FFI.UInt32.withVal ---> FFI.Bool.fromVal) dateValidJulian_ julianDate
    ...
    fun dateValidYear year = (FFI.UInt16.withVal ---> FFI.Bool.fromVal) dateValidYear_ year
    ...
    fun directHash () = (I ---> FFI.UInt32.fromVal) directHash_ ()
    ...
    fun doubleHash () = (I ---> FFI.UInt32.fromVal) doubleHash_ ()
    ...
    fun fileErrorQuark () = (I ---> FFI.UInt32.fromVal) fileErrorQuark_ ()
    ...
    fun formatSize size = (FFI.UInt64.withVal ---> FFI.String.fromPtr true) formatSize_ size
    fun formatSizeForDisplay size = (FFI.Int64.withVal ---> FFI.String.fromPtr true) formatSizeForDisplay_ size
    fun formatSizeFull size flags = (FFI.UInt64.withVal &&&> GLibFormatSizeFlags.C.withVal ---> FFI.String.fromPtr true) formatSizeFull_ (size & flags)
    ...
    fun hookDestroy hookList hookId = (GLibHookListRecord.C.withPtr &&&> FFI.UInt64.withVal ---> FFI.Bool.fromVal) hookDestroy_ (hookList & hookId)
    ...
    fun int64Hash () = (I ---> FFI.UInt32.fromVal) int64Hash_ ()
    fun intEqual () = (I ---> FFI.Bool.fromVal) intEqual_ ()
    fun intHash () = (I ---> FFI.UInt32.fromVal) intHash_ ()
    ...
    fun ioChannelErrorQuark () = (I ---> FFI.UInt32.fromVal) ioChannelErrorQuark_ ()
    ...
    fun keyFileErrorQuark () = (I ---> FFI.UInt32.fromVal) keyFileErrorQuark_ ()
    ...
    fun logRemoveHandler logDomain handlerId = (FFI.String.withConstPtr &&&> FFI.UInt32.withVal ---> I) logRemoveHandler_ (logDomain & handlerId)
    ...
    fun markupErrorQuark () = (I ---> FFI.UInt32.fromVal) markupErrorQuark_ ()
    ...
    fun optionErrorQuark () = (I ---> FFI.UInt32.fromVal) optionErrorQuark_ ()
    ...
    fun quarkFromStaticString string = (FFI.String.withConstOptPtr ---> FFI.UInt32.fromVal) quarkFromStaticString_ string
    fun quarkFromString string = (FFI.String.withConstOptPtr ---> FFI.UInt32.fromVal) quarkFromString_ string
    fun quarkToString quark = (FFI.UInt32.withVal ---> FFI.String.fromPtr false) quarkToString_ quark
    fun quarkTryString string = (FFI.String.withConstOptPtr ---> FFI.UInt32.fromVal) quarkTryString_ string
    ...
    fun randomInt () = (I ---> FFI.UInt32.fromVal) randomInt_ ()
    fun randomIntRange begin end' = (FFI.Int32.withVal &&&> FFI.Int32.withVal ---> FFI.Int32.fromVal) randomIntRange_ (begin & end')
    fun randomSetSeed seed = (FFI.UInt32.withVal ---> I) randomSetSeed_ seed
    ...
    fun regexErrorQuark () = (I ---> FFI.UInt32.fromVal) regexErrorQuark_ ()
    ...
    fun shellErrorQuark () = (I ---> FFI.UInt32.fromVal) shellErrorQuark_ ()
    ...
    fun sliceFree1 blockSize = (FFI.UInt64.withVal ---> I) sliceFree1_ blockSize
    fun sliceFreeChainWithOffset blockSize nextOffset = (FFI.UInt64.withVal &&&> FFI.UInt64.withVal ---> I) sliceFreeChainWithOffset_ (blockSize & nextOffset)
    ...
    fun sourceRemove tag = (FFI.UInt32.withVal ---> FFI.Bool.fromVal) sourceRemove_ tag
    fun sourceSetNameById tag name = (FFI.UInt32.withVal &&&> FFI.String.withConstPtr ---> I) sourceSetNameById_ (tag & name)
    fun spacedPrimesClosest num = (FFI.UInt32.withVal ---> FFI.UInt32.fromVal) spacedPrimesClosest_ num
    ...
    fun spawnErrorQuark () = (I ---> FFI.UInt32.fromVal) spawnErrorQuark_ ()
    ...
    fun strHash () = (I ---> FFI.UInt32.fromVal) strHash_ ()
    ...
    fun stringSizedNew dflSize = (FFI.UInt64.withVal ---> GLibStringRecord.C.fromPtr true) stringSizedNew_ dflSize
    ...
    fun strndup str n = (FFI.String.withConstPtr &&&> FFI.UInt64.withVal ---> FFI.String.fromPtr true) strndup_ (str & n)
    fun strnfill length fillChar = (FFI.UInt64.withVal &&&> FFI.UInt8.withVal ---> FFI.String.fromPtr true) strnfill_ (length & fillChar)
    ...
    fun strvLength strArray = (FFI.String.withConstPtr ---> FFI.UInt32.fromVal) strvLength_ strArray
    ...
    fun testTrapFork usecTimeout testTrapFlags = (FFI.UInt64.withVal &&&> GLibTestTrapFlags.C.withVal ---> FFI.Bool.fromVal) testTrapFork_ (usecTimeout & testTrapFlags)
    ...
    fun threadErrorQuark () = (I ---> FFI.UInt32.fromVal) threadErrorQuark_ ()
    ...
    fun threadPoolGetMaxIdleTime () = (I ---> FFI.UInt32.fromVal) threadPoolGetMaxIdleTime_ ()
    fun threadPoolGetMaxUnusedThreads () = (I ---> FFI.Int32.fromVal) threadPoolGetMaxUnusedThreads_ ()
    fun threadPoolGetNumUnusedThreads () = (I ---> FFI.UInt32.fromVal) threadPoolGetNumUnusedThreads_ ()
    fun threadPoolSetMaxIdleTime interval = (FFI.UInt32.withVal ---> I) threadPoolSetMaxIdleTime_ interval
    ...
    fun timeoutSourceNew interval = (FFI.UInt32.withVal ---> GLibSourceRecord.C.fromPtr true) timeoutSourceNew_ interval
    fun timeoutSourceNewSeconds interval = (FFI.UInt32.withVal ---> GLibSourceRecord.C.fromPtr true) timeoutSourceNewSeconds_ interval
    fun trashStackHeight stackP = (GLibTrashStackRecord.C.withPtr ---> FFI.UInt32.fromVal) trashStackHeight_ stackP
    ...
    fun unicodeScriptFromIso15924 iso15924 = (FFI.UInt32.withVal ---> GLibUnicodeScript.C.fromVal) unicodeScriptFromIso15924_ iso15924
    fun unicodeScriptToIso15924 script = (GLibUnicodeScript.C.withVal ---> FFI.UInt32.fromVal) unicodeScriptToIso15924_ script
    ...
    fun usleep microseconds = (FFI.UInt64.withVal ---> I) usleep_ microseconds
    ...
    fun variantParserGetErrorQuark () = (I ---> FFI.UInt32.fromVal) variantParserGetErrorQuark_ ()
