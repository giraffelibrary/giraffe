structure GLibSource :>
  ...
  struct
    ...
    in
      ...
      val attach_ = call (load_sym libglib "g_source_attach") (GLibSourceRecord.PolyML.PTR &&> GLibMainContextRecord.PolyML.PTR --> FFI.PolyML.UInt32.VAL)
    ...
    fun attach self context = (GLibSourceRecord.C.withPtr &&&> GLibMainContextRecord.C.withPtr ---> FFI.UInt32.fromVal) attach_ (self & context)
