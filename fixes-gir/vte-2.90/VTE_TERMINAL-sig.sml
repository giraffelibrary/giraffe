signature VTE_TERMINAL =
  sig
    ...
    val emulationChangedSig : ('a class, unit, unit) Signal.t
    ...
    val statusLineChangedSig : ('a class, unit, unit) Signal.t
